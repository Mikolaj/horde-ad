...
testVTOPP = do
  ...
  printGradient6Pretty renames (simplifyArtifact6 artifact6)
    @?= "\\s0 dret v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 -> let v23 = tfromList [tsum (v3 * tconstant (tkonst 784 (tconst 7.0))), tsum (v4 * tconstant (tkonst 784 (tconst 7.0))), tsum (v5 * tconstant (tkonst 784 (tconst 7.0)))] + v6 ; v24 = tfromList [tsum (v7 * v23), tsum (v8 * v23), tsum (v9 * v23), tsum (v10 * v23)] + v11 ; x25 = dret ! [4] ; x26 = dret ! [3] ; x27 = dret ! [2] ; x28 = dret ! [1] ; x29 = dret ! [0] ; v30 = v12 * tkonst 5 x29 + v13 * tkonst 5 x28 + v14 * tkonst 5 x27 + v15 * tkonst 5 x26 + v16 * tkonst 5 x25 ; x31 = v30 ! [3] ; x32 = v30 ! [2] ; x33 = v30 ! [1] ; x34 = v30 ! [0] ; v35 = v7 * tkonst 4 x34 + v8 * tkonst 4 x33 + v9 * tkonst 4 x32 + v10 * tkonst 4 x31 in (tfromList [], tconstant (tkonst 784 (tconst 7.0)) * tkonst 784 (v35 ! [0]), tconstant (tkonst 784 (tconst 7.0)) * tkonst 784 (v35 ! [1]), tconstant (tkonst 784 (tconst 7.0)) * tkonst 784 (v35 ! [2]), v35, v23 * tkonst 3 x34, v23 * tkonst 3 x33, v23 * tkonst 3 x32, v23 * tkonst 3 x31, v30, v24 * tkonst 4 x29, v24 * tkonst 4 x28, v24 * tkonst 4 x27, v24 * tkonst 4 x26, v24 * tkonst 4 x25, dret)"
  printPrimal6Pretty renames (simplifyArtifact6 artifact6)
    @?= "\\s0 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 -> let v23 = tfromList [tsum (v3 * tconstant (tkonst 784 (tconst 7.0))), tsum (v4 * tconstant (tkonst 784 (tconst 7.0))), tsum (v5 * tconstant (tkonst 784 (tconst 7.0)))] + v6 ; v24 = tfromList [tsum (v7 * v23), tsum (v8 * v23), tsum (v9 * v23), tsum (v10 * v23)] + v11 in tfromList [tsum (v12 * v24), tsum (v13 * v24), tsum (v14 * v24), tsum (v15 * v24), tsum (v16 * v24)] + v17"
...
testVTOPPNonLin = do
  ...
  printGradient6Pretty renames (simplifyArtifact6 artifact6nonLin)
    @?= "\\s0 dret v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 -> let v31 = recip (tconstant (tkonst 3 (tconst 1.0)) + exp (negate (tfromList [tsum (v3 * tconstant (tkonst 784 (tconst 7.0))), tsum (v4 * tconstant (tkonst 784 (tconst 7.0))), tsum (v5 * tconstant (tkonst 784 (tconst 7.0)))] + v6))) ; v38 = recip (tconstant (tkonst 4 (tconst 1.0)) + exp (negate (tfromList [tsum (v7 * v31), tsum (v8 * v31), tsum (v9 * v31), tsum (v10 * v31)] + v11))) ; v42 = exp (tfromList [tsum (v12 * v38), tsum (v13 * v38), tsum (v14 * v38), tsum (v15 * v38), tsum (v16 * v38)] + v17) ; x43 = tsum v42 ; v45 = v42 * (tkonst 5 (negate (recip (x43 * x43)) * tsum (v42 * dret)) + tkonst 5 (recip x43) * dret) ; x46 = v45 ! [4] ; x47 = v45 ! [3] ; x48 = v45 ! [2] ; x49 = v45 ! [1] ; x50 = v45 ! [0] ; v53 = (v38 * (tconstant (tkonst 4 (tconst 1.0)) - v38)) * (v12 * tkonst 5 x50 + v13 * tkonst 5 x49 + v14 * tkonst 5 x48 + v15 * tkonst 5 x47 + v16 * tkonst 5 x46) ; x54 = v53 ! [3] ; x55 = v53 ! [2] ; x56 = v53 ! [1] ; x57 = v53 ! [0] ; v60 = (v31 * (tconstant (tkonst 3 (tconst 1.0)) - v31)) * (v7 * tkonst 4 x57 + v8 * tkonst 4 x56 + v9 * tkonst 4 x55 + v10 * tkonst 4 x54) in (tfromList [], tconstant (tkonst 784 (tconst 7.0)) * tkonst 784 (v60 ! [0]), tconstant (tkonst 784 (tconst 7.0)) * tkonst 784 (v60 ! [1]), tconstant (tkonst 784 (tconst 7.0)) * tkonst 784 (v60 ! [2]), v60, v31 * tkonst 3 x57, v31 * tkonst 3 x56, v31 * tkonst 3 x55, v31 * tkonst 3 x54, v53, v38 * tkonst 4 x50, v38 * tkonst 4 x49, v38 * tkonst 4 x48, v38 * tkonst 4 x47, v38 * tkonst 4 x46, v45)"
...
testVT2OPP = do
  ...
  printGradient6Pretty renames (simplifyArtifact6 artifact6)
    @?= "\\s0 dret m3 v4 m5 v6 m7 v8 -> let m13 = tkonst 4 (tsum (ttranspose [1,0] (tconstant (tkonst 3 (tkonst 784 (tconst 7.0))) * m3)) + v4) ; v15 = tsum (m7 * ttranspose [1,0] (tkonst 4 dret)) ; v16 = tsum (m5 * ttranspose [1,0] (tkonst 3 v15)) in (tfromList [], tconstant (tkonst 3 (tkonst 784 (tconst 7.0))) * ttranspose [1,0] (tkonst 784 v16), v16, m13 * ttranspose [1,0] (tkonst 3 v15), v15, tkonst 5 (tsum (ttranspose [1,0] (m13 * m5)) + v6) * ttranspose [1,0] (tkonst 4 dret), dret)"
  printPrimal6Pretty renames (simplifyArtifact6 artifact6)
...
testVT2OPPNonLin = do
  ...
  printGradient6Pretty renames (simplifyArtifact6 artifact6nonLin)
    @?= "\\s0 dret m3 v4 m5 v6 m7 v8 -> let v21 = recip (tconstant (tkonst 3 (tconst 1.0)) + exp (negate (tsum (ttranspose [1,0] (tconstant (tkonst 3 (tkonst 784 (tconst 7.0))) * m3)) + v4))) ; v28 = recip (tconstant (tkonst 4 (tconst 1.0)) + exp (negate (tsum (ttranspose [1,0] (tkonst 4 v21 * m5)) + v6))) ; v32 = exp (tsum (ttranspose [1,0] (tkonst 5 v28 * m7)) + v8) ; x33 = tsum v32 ; v35 = v32 * (tkonst 5 (negate (recip (x33 * x33)) * tsum (v32 * dret)) + tkonst 5 (recip x33) * dret) ; v38 = (v28 * (tconstant (tkonst 4 (tconst 1.0)) - v28)) * tsum (m7 * ttranspose [1,0] (tkonst 4 v35)) ; v41 = (v21 * (tconstant (tkonst 3 (tconst 1.0)) - v21)) * tsum (m5 * ttranspose [1,0] (tkonst 3 v38)) in (tfromList [], tconstant (tkonst 3 (tkonst 784 (tconst 7.0))) * ttranspose [1,0] (tkonst 784 v41), v41, tkonst 4 v21 * ttranspose [1,0] (tkonst 3 v38), v38, tkonst 5 v28 * ttranspose [1,0] (tkonst 4 v35), v35)"
  printPrimal6Pretty renames (simplifyArtifact6 artifact6nonLin)
