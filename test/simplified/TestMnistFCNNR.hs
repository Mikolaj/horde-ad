...
testVTOPP = do
  ...
  printGradient6Pretty renames (simplifyArtifact6 artifact6nonLin)
    @?= "\\s0 dret x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 -> let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x27 = let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in let x28 = tconstant (tkonst 2 (tconst 1.0)) - x27 in let x29 = x27 * x28 in let x31 = tfromList [tsum (x6 * x27), tsum (x7 * x27), tsum (x8 * x27)] + x9 in let x34 = let x32 = exp (negate x31) in let x33 = tconstant (tkonst 3 (tconst 1.0)) + x32 in recip x33 in let x35 = tconstant (tkonst 3 (tconst 1.0)) - x34 in let x36 = x34 * x35 in let x38 = exp (tfromList [tsum (x10 * x34), tsum (x11 * x34), tsum (x12 * x34), tsum (x13 * x34)] + x14) in let x39 = tsum x38 in let x40 = tkonst 4 (recip x39) in let x41 = x38 * (tkonst 4 (negate (recip (x39 * x39)) * tsum (x38 * dret)) + x40 * dret) in let x42 = x41 ! [3] in let x43 = x41 ! [2] in let x44 = x41 ! [1] in let x45 = x41 ! [0] in let x46 = x10 * tkonst 4 x45 + x11 * tkonst 4 x44 + x12 * tkonst 4 x43 + x13 * tkonst 4 x42 in let x47 = x34 * (x31 * x46) in let x48 = x36 * x46 in let x49 = x48 ! [2] in let x50 = x48 ! [1] in let x51 = x48 ! [0] in let x52 = x6 * tkonst 3 x51 + x7 * tkonst 3 x50 + x8 * tkonst 3 x49 in let x53 = x27 * (x24 * x52) in let x54 = x29 * x52 in let x55 = x54 ! [1] in let x56 = x54 ! [0] in (tfromList [], x23 * tkonst 784 x56, x23 * tkonst 784 x55, x54, x27 * tkonst 2 x51, x27 * tkonst 2 x50, x27 * tkonst 2 x49, x48, x34 * tkonst 3 x45, x34 * tkonst 3 x44, x34 * tkonst 3 x43, x34 * tkonst 3 x42, x41)"
  printPrimal6Pretty renames (simplifyArtifact6 artifact6nonLin)
    @?= "\\s0 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 -> let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x27 = let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in let x28 = tconstant (tkonst 2 (tconst 1.0)) - x27 in let x29 = x27 * x28 in let x31 = tfromList [tsum (x6 * x27), tsum (x7 * x27), tsum (x8 * x27)] + x9 in let x34 = let x32 = exp (negate x31) in let x33 = tconstant (tkonst 3 (tconst 1.0)) + x32 in recip x33 in let x35 = tconstant (tkonst 3 (tconst 1.0)) - x34 in let x36 = x34 * x35 in let x38 = exp (tfromList [tsum (x10 * x34), tsum (x11 * x34), tsum (x12 * x34), tsum (x13 * x34)] + x14) in let x39 = tsum x38 in let x40 = tkonst 4 (recip x39) in x40 * x38"
