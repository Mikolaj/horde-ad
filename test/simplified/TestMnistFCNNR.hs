...
testVTOPPNonLin = do
  ...
  printGradient6Pretty renames artifact6nonLin
    @?= "\\s0 dret v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 -> let v26 = tkonst 784 (tconst 7.0) ; v27 = tfromList [tsum (v3 * v26), tsum (v4 * v26), tsum (v5 * v26)] + v6 ; v30 = let v28 = exp (negate v27) ; v29 = tkonst 3 (tconst 1.0) + v28 in recip v29 ; v31 = tkonst 3 (tconst 1.0) - v30 ; v32 = v30 * v31 ; v33 = tfromList [tsum (v7 * v30), tsum (v8 * v30), tsum (v9 * v30), tsum (v10 * v30)] + v11 ; v36 = let v34 = exp (negate v33) ; v35 = tkonst 4 (tconst 1.0) + v34 in recip v35 ; v37 = tkonst 4 (tconst 1.0) - v36 ; v38 = v36 * v37 ; v39 = exp (tfromList [tsum (v12 * v36), tsum (v13 * v36), tsum (v14 * v36), tsum (v15 * v36), tsum (v16 * v36)] + v17) ; x40 = tsum v39 ; v41 = tkonst 5 (recip x40) ; v42 = v39 * (tkonst 5 (negate (recip (x40 * x40)) * tsum (v39 * dret)) + v41 * dret) ; x43 = v42 ! [4] ; x44 = v42 ! [3] ; x45 = v42 ! [2] ; x46 = v42 ! [1] ; x47 = v42 ! [0] ; v48 = v12 * tkonst 5 x47 + v13 * tkonst 5 x46 + v14 * tkonst 5 x45 + v15 * tkonst 5 x44 + v16 * tkonst 5 x43 ; v49 = v36 * (v33 * v48) ; v50 = v38 * v48 ; x51 = v50 ! [3] ; x52 = v50 ! [2] ; x53 = v50 ! [1] ; x54 = v50 ! [0] ; v55 = v7 * tkonst 4 x54 + v8 * tkonst 4 x53 + v9 * tkonst 4 x52 + v10 * tkonst 4 x51 ; v56 = v30 * (v27 * v55) ; v57 = v32 * v55 ; x58 = v57 ! [2] ; x59 = v57 ! [1] ; x60 = v57 ! [0] in (tfromList [], v26 * tkonst 784 x60, v26 * tkonst 784 x59, v26 * tkonst 784 x58, v57, v30 * tkonst 3 x54, v30 * tkonst 3 x53, v30 * tkonst 3 x52, v30 * tkonst 3 x51, v50, v36 * tkonst 4 x47, v36 * tkonst 4 x46, v36 * tkonst 4 x45, v36 * tkonst 4 x44, v36 * tkonst 4 x43, v42)"
  printPrimal6Pretty renames artifact6nonLin
    @?= "\\s0 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 -> let v26 = tkonst 784 (tconst 7.0) ; v27 = tfromList [tsum (v3 * v26), tsum (v4 * v26), tsum (v5 * v26)] + v6 ; v30 = let v28 = exp (negate v27) ; v29 = tkonst 3 (tconst 1.0) + v28 in recip v29 ; v31 = tkonst 3 (tconst 1.0) - v30 ; v32 = v30 * v31 ; v33 = tfromList [tsum (v7 * v30), tsum (v8 * v30), tsum (v9 * v30), tsum (v10 * v30)] + v11 ; v36 = let v34 = exp (negate v33) ; v35 = tkonst 4 (tconst 1.0) + v34 in recip v35 ; v37 = tkonst 4 (tconst 1.0) - v36 ; v38 = v36 * v37 ; v39 = exp (tfromList [tsum (v12 * v36), tsum (v13 * v36), tsum (v14 * v36), tsum (v15 * v36), tsum (v16 * v36)] + v17) ; v40 = tsum v39 ; v41 = tkonst 5 (recip x40) in v41 * v39"
  printGradient6Pretty renames (simplifyArtifact6 artifact6nonLin)
    @?= "\\s0 dret v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 -> let v26 = tconstant (tkonst 784 (tconst 7.0)) ; v30 = recip (tconstant (tkonst 3 (tconst 1.0)) + exp (negate (tfromList [tsum (v3 * v26), tsum (v4 * v26), tsum (v5 * v26)] + v6))) ; v36 = recip (tconstant (tkonst 4 (tconst 1.0)) + exp (negate (tfromList [tsum (v7 * v30), tsum (v8 * v30), tsum (v9 * v30), tsum (v10 * v30)] + v11))) ; v39 = exp (tfromList [tsum (v12 * v36), tsum (v13 * v36), tsum (v14 * v36), tsum (v15 * v36), tsum (v16 * v36)] + v17) ; x40 = tsum v39 ; v42 = v39 * (tkonst 5 (negate (recip (x40 * x40)) * tsum (v39 * dret)) + tkonst 5 (recip x40) * dret) ; x43 = v42 ! [4] ; x44 = v42 ! [3] ; x45 = v42 ! [2] ; x46 = v42 ! [1] ; x47 = v42 ! [0] ; v50 = (v36 * (tconstant (tkonst 4 (tconst 1.0)) - v36)) * (v12 * tkonst 5 x47 + v13 * tkonst 5 x46 + v14 * tkonst 5 x45 + v15 * tkonst 5 x44 + v16 * tkonst 5 x43) ; x51 = v50 ! [3] ; x52 = v50 ! [2] ; x53 = v50 ! [1] ; x54 = v50 ! [0] ; v57 = (v30 * (tconstant (tkonst 3 (tconst 1.0)) - v30)) * (v7 * tkonst 4 x54 + v8 * tkonst 4 x53 + v9 * tkonst 4 x52 + v10 * tkonst 4 x51) in (tfromList [], v26 * tkonst 784 (v57 ! [0]), v26 * tkonst 784 (v57 ! [1]), v26 * tkonst 784 (v57 ! [2]), v57, v30 * tkonst 3 x54, v30 * tkonst 3 x53, v30 * tkonst 3 x52, v30 * tkonst 3 x51, v50, v36 * tkonst 4 x47, v36 * tkonst 4 x46, v36 * tkonst 4 x45, v36 * tkonst 4 x44, v36 * tkonst 4 x43, v42)"
  printPrimal6Pretty renames (simplifyArtifact6 artifact6nonLin)
    @?= "\\s0 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17 -> let v26 = tconstant (tkonst 784 (tconst 7.0)) ; v30 = recip (tconstant (tkonst 3 (tconst 1.0)) + exp (negate (tfromList [tsum (v3 * v26), tsum (v4 * v26), tsum (v5 * v26)] + v6))) ; v36 = recip (tconstant (tkonst 4 (tconst 1.0)) + exp (negate (tfromList [tsum (v7 * v30), tsum (v8 * v30), tsum (v9 * v30), tsum (v10 * v30)] + v11))) ; v39 = exp (tfromList [tsum (v12 * v36), tsum (v13 * v36), tsum (v14 * v36), tsum (v15 * v36), tsum (v16 * v36)] + v17) in tkonst 5 (recip (tsum v39)) * v39"
