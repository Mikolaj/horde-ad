...
testVTOPP = do
  ...
  printGradient6Pretty renames artifact6nonLin
    @?= "\\s0 dret x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 -> let x23 = tkonst 784 (tconst 7.0) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x27 = let x25 = exp (negate x24) in let x26 = tkonst 2 (tconst 1.0) + x25 in recip x26 in let x28 = tkonst 2 (tconst 1.0) - x27 in let x29 = x27 * x28 in let x30 = tfromList [tsum (x6 * x27), tsum (x7 * x27), tsum (x8 * x27)] + x9 in let x33 = let x31 = exp (negate x30) in let x32 = tkonst 3 (tconst 1.0) + x31 in recip x32 in let x34 = tkonst 3 (tconst 1.0) - x33 in let x35 = x33 * x34 in let x36 = exp (tfromList [tsum (x10 * x33), tsum (x11 * x33), tsum (x12 * x33), tsum (x13 * x33)] + x14) in let x37 = tsum x36 in let x38 = tkonst 4 (recip x37) in let x39 = x36 * (tkonst 4 (negate (recip (x37 * x37)) * tsum (x36 * dret)) + x38 * dret) in let x40 = x39 ! [3] in let x41 = x39 ! [2] in let x42 = x39 ! [1] in let x43 = x39 ! [0] in let x44 = x10 * tkonst 4 x43 + x11 * tkonst 4 x42 + x12 * tkonst 4 x41 + x13 * tkonst 4 x40 in let x45 = x33 * (x30 * x44) in let x46 = x35 * x44 in let x47 = x46 ! [2] in let x48 = x46 ! [1] in let x49 = x46 ! [0] in let x50 = x6 * tkonst 3 x49 + x7 * tkonst 3 x48 + x8 * tkonst 3 x47 in let x51 = x27 * (x24 * x50) in let x52 = x29 * x50 in let x53 = x52 ! [1] in let x54 = x52 ! [0] in (tfromList [], x23 * tkonst 784 x54, x23 * tkonst 784 x53, x52, x27 * tkonst 2 x49, x27 * tkonst 2 x48, x27 * tkonst 2 x47, x46, x33 * tkonst 3 x43, x33 * tkonst 3 x42, x33 * tkonst 3 x41, x33 * tkonst 3 x40, x39)"
  printPrimal6Pretty renames artifact6nonLin
    @?= "\\s0 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 -> let x23 = tkonst 784 (tconst 7.0) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x27 = let x25 = exp (negate x24) in let x26 = tkonst 2 (tconst 1.0) + x25 in recip x26 in let x28 = tkonst 2 (tconst 1.0) - x27 in let x29 = x27 * x28 in let x30 = tfromList [tsum (x6 * x27), tsum (x7 * x27), tsum (x8 * x27)] + x9 in let x33 = let x31 = exp (negate x30) in let x32 = tkonst 3 (tconst 1.0) + x31 in recip x32 in let x34 = tkonst 3 (tconst 1.0) - x33 in let x35 = x33 * x34 in let x36 = exp (tfromList [tsum (x10 * x33), tsum (x11 * x33), tsum (x12 * x33), tsum (x13 * x33)] + x14) in let x37 = tsum x36 in let x38 = tkonst 4 (recip x37) in x38 * x36"
  printGradient6Pretty renames (simplifyArtifact6 artifact6nonLin)
    @?= "\\s0 dret x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 -> let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x27 = let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in let x28 = tconstant (tkonst 2 (tconst 1.0)) - x27 in let x29 = x27 * x28 in let x30 = tfromList [tsum (x6 * x27), tsum (x7 * x27), tsum (x8 * x27)] + x9 in let x33 = let x31 = exp (negate x30) in let x32 = tconstant (tkonst 3 (tconst 1.0)) + x31 in recip x32 in let x34 = tconstant (tkonst 3 (tconst 1.0)) - x33 in let x35 = x33 * x34 in let x36 = exp (tfromList [tsum (x10 * x33), tsum (x11 * x33), tsum (x12 * x33), tsum (x13 * x33)] + x14) in let x37 = tsum x36 in let x38 = tkonst 4 (recip x37) in let x39 = x36 * (tkonst 4 (negate (recip (x37 * x37)) * tsum (x36 * dret)) + x38 * dret) in let x40 = x39 ! [3] in let x41 = x39 ! [2] in let x42 = x39 ! [1] in let x43 = x39 ! [0] in let x44 = x10 * tkonst 4 x43 + x11 * tkonst 4 x42 + x12 * tkonst 4 x41 + x13 * tkonst 4 x40 in let x45 = x33 * (x30 * x44) in let x46 = x35 * x44 in let x47 = x46 ! [2] in let x48 = x46 ! [1] in let x49 = x46 ! [0] in let x50 = x6 * tkonst 3 x49 + x7 * tkonst 3 x48 + x8 * tkonst 3 x47 in let x51 = x27 * (x24 * x50) in let x52 = x29 * x50 in let x53 = x52 ! [1] in let x54 = x52 ! [0] in (tfromList [], x23 * tkonst 784 x54, x23 * tkonst 784 x53, x52, x27 * tkonst 2 x49, x27 * tkonst 2 x48, x27 * tkonst 2 x47, x46, x33 * tkonst 3 x43, x33 * tkonst 3 x42, x33 * tkonst 3 x41, x33 * tkonst 3 x40, x39)"
