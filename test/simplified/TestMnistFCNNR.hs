...
testVTOPP = do
  ...
  printGradient6Pretty renames (simplifyArtifact6 artifact6nonLin)
    @?= "\\s0 dret x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 -> let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x27 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in let x28 = tconstant (tkonst 2 (tconst 1.0)) - x27 in let x29 = x27 * x28 in let x30 = let x27 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in x27 in let x31 = tfromList [tsum (x6 * x30), tsum (x7 * x30), tsum (x8 * x30)] + x9 in let x34 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x27 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in let x28 = tconstant (tkonst 2 (tconst 1.0)) - x27 in let x29 = x27 * x28 in let x30 = let x27 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in x27 in let x31 = tfromList [tsum (x6 * x30), tsum (x7 * x30), tsum (x8 * x30)] + x9 in let x32 = exp (negate x31) in let x33 = tconstant (tkonst 3 (tconst 1.0)) + x32 in recip x33 in let x35 = tconstant (tkonst 3 (tconst 1.0)) - x34 in let x36 = x34 * x35 in let x37 = let x34 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x27 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in let x28 = tconstant (tkonst 2 (tconst 1.0)) - x27 in let x29 = x27 * x28 in let x30 = let x27 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in x27 in let x31 = tfromList [tsum (x6 * x30), tsum (x7 * x30), tsum (x8 * x30)] + x9 in let x32 = exp (negate x31) in let x33 = tconstant (tkonst 3 (tconst 1.0)) + x32 in recip x33 in x34 in let x38 = exp (tfromList [tsum (x10 * x37), tsum (x11 * x37), tsum (x12 * x37), tsum (x13 * x37)] + x14) in let x39 = tsum x38 in let x40 = tkonst 4 (recip x39) in let x41 = x38 * (tkonst 4 (negate (recip (x39 * x39)) * tsum (x38 * dret)) + x40 * dret) in let x42 = x41 ! [3] in let x43 = x41 ! [2] in let x44 = x41 ! [1] in let x45 = x41 ! [0] in let x46 = x10 * tkonst 4 x45 + x11 * tkonst 4 x44 + x12 * tkonst 4 x43 + x13 * tkonst 4 x42 in let x47 = x34 * (x31 * x46) in let x48 = x36 * x46 in let x49 = x48 ! [2] in let x50 = x48 ! [1] in let x51 = x48 ! [0] in let x52 = x6 * tkonst 3 x51 + x7 * tkonst 3 x50 + x8 * tkonst 3 x49 in let x53 = x27 * (x24 * x52) in let x54 = x29 * x52 in let x55 = x54 ! [1] in let x56 = x54 ! [0] in (tfromList [], x23 * tkonst 784 x56, x23 * tkonst 784 x55, x54, x30 * tkonst 2 x51, x30 * tkonst 2 x50, x30 * tkonst 2 x49, x48, x37 * tkonst 3 x45, x37 * tkonst 3 x44, x37 * tkonst 3 x43, x37 * tkonst 3 x42, x41)"
  printPrimal6Pretty renames (simplifyArtifact6 artifact6nonLin)
    @?= "\\s0 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 -> let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x27 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in let x28 = tconstant (tkonst 2 (tconst 1.0)) - x27 in let x29 = x27 * x28 in let x30 = let x27 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in x27 in let x31 = tfromList [tsum (x6 * x30), tsum (x7 * x30), tsum (x8 * x30)] + x9 in let x34 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x27 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in let x28 = tconstant (tkonst 2 (tconst 1.0)) - x27 in let x29 = x27 * x28 in let x30 = let x27 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in x27 in let x31 = tfromList [tsum (x6 * x30), tsum (x7 * x30), tsum (x8 * x30)] + x9 in let x32 = exp (negate x31) in let x33 = tconstant (tkonst 3 (tconst 1.0)) + x32 in recip x33 in let x35 = tconstant (tkonst 3 (tconst 1.0)) - x34 in let x36 = x34 * x35 in let x37 = let x34 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x27 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in let x28 = tconstant (tkonst 2 (tconst 1.0)) - x27 in let x29 = x27 * x28 in let x30 = let x27 = let x23 = tconstant (tkonst 784 (tconst 7.0)) in let x24 = tfromList [tsum (x3 * x23), tsum (x4 * x23)] + x5 in let x25 = exp (negate x24) in let x26 = tconstant (tkonst 2 (tconst 1.0)) + x25 in recip x26 in x27 in let x31 = tfromList [tsum (x6 * x30), tsum (x7 * x30), tsum (x8 * x30)] + x9 in let x32 = exp (negate x31) in let x33 = tconstant (tkonst 3 (tconst 1.0)) + x32 in recip x33 in x34 in let x38 = exp (tfromList [tsum (x10 * x37), tsum (x11 * x37), tsum (x12 * x37), tsum (x13 * x37)] + x14) in let x39 = tsum x38 in let x40 = tkonst 4 (recip x39) in x40 * x38"
...
testVT2OPP = do
  ...
  printGradient6Simple renames (simplifyArtifact6 artifact6nonLin)
    @?= "\\s0 dret x3 x4 x5 x6 x7 x8 -> dlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> dlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> dlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (exp (negate x18)) (\\x19 -> tlet (tconstant (tkonst 2 (tconst 1.0)) + x19) (\\x20 -> recip x20))))) (\\x21 -> dlet (tconstant (tkonst 2 (tconst 1.0)) - x21) (\\x22 -> dlet (x21 * x22) (\\x23 -> dlet (tkonst 3 (tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (exp (negate x18)) (\\x19 -> tlet (tconstant (tkonst 2 (tconst 1.0)) + x19) (\\x20 -> recip x20))))) (\\x21 -> x21))) (\\x24 -> dlet (tsum (ttranspose [1,0] (x24 * x5)) + x6) (\\x25 -> dlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (exp (negate x18)) (\\x19 -> tlet (tconstant (tkonst 2 (tconst 1.0)) + x19) (\\x20 -> recip x20))))) (\\x21 -> tlet (tconstant (tkonst 2 (tconst 1.0)) - x21) (\\x22 -> tlet (x21 * x22) (\\x23 -> tlet (tkonst 3 (tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (exp (negate x18)) (\\x19 -> tlet (tconstant (tkonst 2 (tconst 1.0)) + x19) (\\x20 -> recip x20))))) (\\x21 -> x21))) (\\x24 -> tlet (tsum (ttranspose [1,0] (x24 * x5)) + x6) (\\x25 -> tlet (exp (negate x25)) (\\x26 -> tlet (tconstant (tkonst 3 (tconst 1.0)) + x26) (\\x27 -> recip x27)))))))))) (\\x28 -> dlet (tconstant (tkonst 3 (tconst 1.0)) - x28) (\\x29 -> dlet (x28 * x29) (\\x30 -> dlet (tkonst 4 (tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (exp (negate x18)) (\\x19 -> tlet (tconstant (tkonst 2 (tconst 1.0)) + x19) (\\x20 -> recip x20))))) (\\x21 -> tlet (tconstant (tkonst 2 (tconst 1.0)) - x21) (\\x22 -> tlet (x21 * x22) (\\x23 -> tlet (tkonst 3 (tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (exp (negate x18)) (\\x19 -> tlet (tconstant (tkonst 2 (tconst 1.0)) + x19) (\\x20 -> recip x20))))) (\\x21 -> x21))) (\\x24 -> tlet (tsum (ttranspose [1,0] (x24 * x5)) + x6) (\\x25 -> tlet (exp (negate x25)) (\\x26 -> tlet (tconstant (tkonst 3 (tconst 1.0)) + x26) (\\x27 -> recip x27)))))))))) (\\x28 -> x28))) (\\x31 -> dlet (exp (tsum (ttranspose [1,0] (x31 * x7)) + x8)) (\\x32 -> dlet (tsum x32) (\\x33 -> dlet (tkonst 4 (recip x33)) (\\x34 -> dlet (x32 * (tkonst 4 (negate (recip (x33 * x33)) * tsum (x32 * dret)) + x34 * dret)) (\\x35 -> dlet (tgather [4,3] x35 (\\[i45, i46] -> [i45])) (\\x36 -> dlet (tsum (x7 * x36)) (\\x37 -> dlet (x28 * (x25 * x37)) (\\x38 -> dlet (x30 * x37) (\\x39 -> dlet (tgather [3,2] x39 (\\[i47, i48] -> [i47])) (\\x40 -> dlet (tsum (x5 * x40)) (\\x41 -> dlet (x21 * (x18 * x41)) (\\x42 -> dlet (x23 * x41) (\\x43 -> dlet (tgather [2,784] x43 (\\[i49, i50] -> [i49])) (\\x44 -> dmkDomains (fromList [dfromR (tfromList []), dfromR (x17 * x44), dfromR x43, dfromR (x24 * x40), dfromR x39, dfromR (x31 * x36), dfromR x35])))))))))))))))))))))))))"
  printPrimal6Simple renames (simplifyArtifact6 artifact6nonLin)
    @?= "\\s0 x3 x4 x5 x6 x7 x8 -> tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (exp (negate x18)) (\\x19 -> tlet (tconstant (tkonst 2 (tconst 1.0)) + x19) (\\x20 -> recip x20))))) (\\x21 -> tlet (tconstant (tkonst 2 (tconst 1.0)) - x21) (\\x22 -> tlet (x21 * x22) (\\x23 -> tlet (tkonst 3 (tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (exp (negate x18)) (\\x19 -> tlet (tconstant (tkonst 2 (tconst 1.0)) + x19) (\\x20 -> recip x20))))) (\\x21 -> x21))) (\\x24 -> tlet (tsum (ttranspose [1,0] (x24 * x5)) + x6) (\\x25 -> tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (exp (negate x18)) (\\x19 -> tlet (tconstant (tkonst 2 (tconst 1.0)) + x19) (\\x20 -> recip x20))))) (\\x21 -> tlet (tconstant (tkonst 2 (tconst 1.0)) - x21) (\\x22 -> tlet (x21 * x22) (\\x23 -> tlet (tkonst 3 (tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (exp (negate x18)) (\\x19 -> tlet (tconstant (tkonst 2 (tconst 1.0)) + x19) (\\x20 -> recip x20))))) (\\x21 -> x21))) (\\x24 -> tlet (tsum (ttranspose [1,0] (x24 * x5)) + x6) (\\x25 -> tlet (exp (negate x25)) (\\x26 -> tlet (tconstant (tkonst 3 (tconst 1.0)) + x26) (\\x27 -> recip x27)))))))))) (\\x28 -> tlet (tconstant (tkonst 3 (tconst 1.0)) - x28) (\\x29 -> tlet (x28 * x29) (\\x30 -> tlet (tkonst 4 (tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (exp (negate x18)) (\\x19 -> tlet (tconstant (tkonst 2 (tconst 1.0)) + x19) (\\x20 -> recip x20))))) (\\x21 -> tlet (tconstant (tkonst 2 (tconst 1.0)) - x21) (\\x22 -> tlet (x21 * x22) (\\x23 -> tlet (tkonst 3 (tlet (tlet (tconstant (tkonst 2 (tkonst 784 (tconst 7.0)))) (\\x17 -> tlet (tsum (ttranspose [1,0] (x17 * x3)) + x4) (\\x18 -> tlet (exp (negate x18)) (\\x19 -> tlet (tconstant (tkonst 2 (tconst 1.0)) + x19) (\\x20 -> recip x20))))) (\\x21 -> x21))) (\\x24 -> tlet (tsum (ttranspose [1,0] (x24 * x5)) + x6) (\\x25 -> tlet (exp (negate x25)) (\\x26 -> tlet (tconstant (tkonst 3 (tconst 1.0)) + x26) (\\x27 -> recip x27)))))))))) (\\x28 -> x28))) (\\x31 -> tlet (exp (tsum (ttranspose [1,0] (x31 * x7)) + x8)) (\\x32 -> tlet (tsum x32) (\\x33 -> tlet (tkonst 4 (recip x33)) (\\x34 -> x34 * x32))))))))))))))"
