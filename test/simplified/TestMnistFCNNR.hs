...
testVT2OPP = do
  ...
  printGradient6Pretty renames (simplifyArtifact6 artifact6)
    @?= "\\s0 dret m3 v4 m5 v6 m7 v8 -> let m13 = tkonst 4 (tsum (ttranspose [1,0] (tconstant (tkonst 3 (tkonst 784 (tconst 7.0))) * m3)) + v4) ; m15 = ttranspose [1,0] (tkonst 4 dret) ; v16 = tsum (m7 * m15) ; m17 = ttranspose [1,0] (tkonst 3 v16) ; v18 = tsum (m5 * m17) in (tfromList [], tconstant (tkonst 3 (tkonst 784 (tconst 7.0))) * ttranspose [1,0] (tkonst 784 v18), v18, m13 * m17, v16, tkonst 5 (tsum (ttranspose [1,0] (m13 * m5)) + v6) * m15, dret)"
  printPrimal6Pretty renames (simplifyArtifact6 artifact6)
