...
tensorADValMnistTestsRNNA = testGroup "RNN ADVal MNIST tests"
  [ mnistTestCaseRNNA "RNNA 1 epoch, 1 batch" 1 1 64 4
                       (0.75 :: Double)
...
tensorADValMnistTestsRNNI = testGroup "RNN ADVal MNIST tests"
  [ mnistTestCaseRNNI "RNNI 1 epoch, 1 batch" 1 1 64 4
                       (0.75 :: Double)
