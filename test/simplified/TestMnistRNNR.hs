...
testRNNOPP = do
  ...
  printArtifactPrimalPretty renames (simplifyArtifact artifactRev)
    @?= "\\x1 -> rfromS (smatmul2 (sfromR (tproject1 (tproject2 m1))) (tanh (stranspose (sreplicate (sfromR (tproject2 (tproject2 (tproject1 m1))))) + smatmul2 (sfromR (tproject1 (tproject1 (tproject2 (tproject1 m1))))) (tanh (stranspose (sreplicate (sfromR (tproject2 (tproject1 (tproject1 m1))))) + smatmul2 (sfromR (tproject1 (tproject1 (tproject1 (tproject1 m1))))) (sreplicate (sreplicate (sscalar 7.0))) + smatmul2 (sfromR (tproject2 (tproject1 (tproject1 (tproject1 m1))))) (sreplicate (sreplicate (sscalar 0.0))))) + smatmul2 (sfromR (tproject2 (tproject1 (tproject2 (tproject1 m1))))) (sreplicate (sreplicate (sscalar 0.0))))) + stranspose (sreplicate (sfromR (tproject2 (tproject2 m1)))))"
