...
testRNNOPP = do
  ...
  printGradient6Pretty renames (simplifyArtifact6 artifact6)
    @?= "\\s0 dret m3 m4 v5 m6 m7 v8 m9 v10 -> let m15 = tanh (ttranspose [1,0] (tkonst 1 v5) + tsum (ttranspose [2,1,0] (tkonst 1 m3) * ttranspose [1,0] (tkonst 1 (tkonst 1 (tkonst 1 (tconst 7.0))))) + tsum (ttranspose [2,1,0] (tkonst 1 m4) * ttranspose [1,0] (tkonst 1 (tkonst 1 (tkonst 1 (tconst 0.0)))))) ; m18 = tanh (ttranspose [1,0] (tkonst 1 v5) + tsum (ttranspose [2,1,0] (tkonst 1 m3) * ttranspose [1,0] (tkonst 1 (tkonst 1 (tkonst 1 (tconst 7.0))))) + tsum (ttranspose [2,1,0] (tkonst 1 m4) * ttranspose [1,0] (tkonst 1 (tkonst 1 (tkonst 1 (tconst 0.0)))))) ; m20 = tanh (ttranspose [1,0] (tkonst 1 v8) + tsum (ttranspose [2,1,0] (tkonst 1 m6) * ttranspose [1,0] (tkonst 1 m18)) + tsum (ttranspose [2,1,0] (tkonst 1 m7) * ttranspose [1,0] (tkonst 1 (tkonst 1 (tkonst 1 (tconst 0.0)))))) ; m22 = tappend (tconstant (tkonst 1 (tkonst 1 (tconst 0.0)))) (tappend (tsum (ttranspose [1,2,0] (tkonst 1 m9) * ttranspose [1,0] (tkonst 1 dret))) (tconstant (tkonst 0 (tkonst 1 (tconst 0.0))))) ; m23 = (tconstant (tkonst 1 (tkonst 1 (tconst 1.0))) - m20 * m20) * tslice 1 1 m22 ; m24 = (tconstant (tkonst 1 (tkonst 1 (tconst 1.0))) - m18 * m18) * tsum (ttranspose [1,2,0] (tkonst 1 m6) * ttranspose [1,0] (tkonst 1 m23)) ; m25 = (tconstant (tkonst 1 (tkonst 1 (tconst 1.0))) - m15 * m15) * tslice 0 1 m22 in (tfromList [], tsum (ttranspose [2,0,1] (tkonst 1 (tkonst 1 (tkonst 1 (tconst 7.0)))) * ttranspose [2,1,0] (tkonst 1 m25)) + tsum (ttranspose [2,0,1] (tkonst 1 (tkonst 1 (tkonst 1 (tconst 7.0)))) * ttranspose [2,1,0] (tkonst 1 m24)), tsum (ttranspose [2,1,0] (ttranspose [1,0] (tkonst 1 (tkonst 1 (tkonst 1 (tconst 0.0)))) * tkonst 1 m25)) + tsum (ttranspose [2,1,0] (ttranspose [1,0] (tkonst 1 (tkonst 1 (tkonst 1 (tconst 0.0)))) * tkonst 1 m24)), tsum (ttranspose [1,0] m25) + tsum (ttranspose [1,0] m24), tsum (ttranspose [2,0,1] (tkonst 1 m18) * ttranspose [2,1,0] (tkonst 1 m23)), tsum (ttranspose [2,1,0] (ttranspose [1,0] (tkonst 1 (tkonst 1 (tkonst 1 (tconst 0.0)))) * tkonst 1 m23)), tsum (ttranspose [1,0] m23), tsum (ttranspose [2,0,1] (tkonst 10 m20) * ttranspose [2,1,0] (tkonst 1 dret)), tsum (ttranspose [1,0] dret))"
...
testRNNOPP2 = do
  ...
  printGradient6Pretty renames (simplifyArtifact6 artifact6)
    @?= "\\s0 dret m3 m4 v5 m6 m7 v8 m9 v10 -> let m16 = tanh (ttranspose [1,0] (tkonst 2 v5) + tsum (ttranspose [2,1,0] (tkonst 2 m3) * ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 7.0))))) + tsum (ttranspose [2,1,0] (tkonst 2 m4) * ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 0.0)))))) ; m19 = tanh (ttranspose [1,0] (tkonst 2 v5) + tsum (ttranspose [2,1,0] (tkonst 2 m3) * ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 7.0))))) + tsum (ttranspose [2,1,0] (tkonst 2 m4) * ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 0.0)))))) ; m21 = tanh (ttranspose [1,0] (tkonst 2 v8) + tsum (ttranspose [2,1,0] (tkonst 2 m6) * ttranspose [1,0] (tkonst 2 m19)) + tsum (ttranspose [2,1,0] (tkonst 2 m7) * ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 0.0)))))) ; m22 = tappend m16 m21 ; t24 = ttranspose [1,0] (tkonst 2 (tslice 0 2 m22)) ; m25 = tanh (ttranspose [1,0] (tkonst 2 v5) + tsum (ttranspose [2,1,0] (tkonst 2 m3) * ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 7.0))))) + tsum (ttranspose [2,1,0] (tkonst 2 m4) * t24)) ; t27 = ttranspose [1,0] (tkonst 2 (tslice 0 2 m22)) ; m28 = tanh (ttranspose [1,0] (tkonst 2 v5) + tsum (ttranspose [2,1,0] (tkonst 2 m3) * ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 7.0))))) + tsum (ttranspose [2,1,0] (tkonst 2 m4) * t27)) ; t29 = ttranspose [1,0] (tkonst 2 (tslice 2 2 m22)) ; m30 = tanh (ttranspose [1,0] (tkonst 2 v8) + tsum (ttranspose [2,1,0] (tkonst 2 m6) * ttranspose [1,0] (tkonst 2 m28)) + tsum (ttranspose [2,1,0] (tkonst 2 m7) * t29)) ; m32 = tappend (tconstant (tkonst 2 (tkonst 2 (tconst 0.0)))) (tappend (tsum (ttranspose [1,2,0] (tkonst 2 m9) * ttranspose [1,0] (tkonst 2 dret))) (tconstant (tkonst 0 (tkonst 2 (tconst 0.0))))) ; m33 = (tconstant (tkonst 2 (tkonst 2 (tconst 1.0))) - m30 * m30) * tslice 2 2 m32 ; m34 = (tconstant (tkonst 2 (tkonst 2 (tconst 1.0))) - m28 * m28) * tsum (ttranspose [1,2,0] (tkonst 2 m6) * ttranspose [1,0] (tkonst 2 m33)) ; m35 = (tconstant (tkonst 2 (tkonst 2 (tconst 1.0))) - m25 * m25) * tslice 0 2 m32 ; m36 = tappend (tconstant (tkonst 0 (tkonst 2 (tconst 0.0)))) (tappend (tsum (ttranspose [1,2,0] (tkonst 2 m4) * ttranspose [1,0] (tkonst 2 m35))) (tconstant (tkonst 2 (tkonst 2 (tconst 0.0))))) + tappend (tconstant (tkonst 0 (tkonst 2 (tconst 0.0)))) (tappend (tsum (ttranspose [1,2,0] (tkonst 2 m4) * ttranspose [1,0] (tkonst 2 m34))) (tconstant (tkonst 2 (tkonst 2 (tconst 0.0))))) + tappend (tconstant (tkonst 2 (tkonst 2 (tconst 0.0)))) (tappend (tsum (ttranspose [1,2,0] (tkonst 2 m7) * ttranspose [1,0] (tkonst 2 m33))) (tconstant (tkonst 0 (tkonst 2 (tconst 0.0))))) ; m37 = (tconstant (tkonst 2 (tkonst 2 (tconst 1.0))) - m21 * m21) * tslice 2 2 m36 ; m38 = (tconstant (tkonst 2 (tkonst 2 (tconst 1.0))) - m19 * m19) * tsum (ttranspose [1,2,0] (tkonst 2 m6) * ttranspose [1,0] (tkonst 2 m37)) ; m39 = (tconstant (tkonst 2 (tkonst 2 (tconst 1.0))) - m16 * m16) * tslice 0 2 m36 in (tfromList [], tsum (ttranspose [2,0,1] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 7.0)))) * ttranspose [2,1,0] (tkonst 2 m39)) + tsum (ttranspose [2,0,1] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 7.0)))) * ttranspose [2,1,0] (tkonst 2 m38)) + tsum (ttranspose [2,0,1] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 7.0)))) * ttranspose [2,1,0] (tkonst 2 m35)) + tsum (ttranspose [2,0,1] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 7.0)))) * ttranspose [2,1,0] (tkonst 2 m34)), tsum (ttranspose [2,1,0] (ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 0.0)))) * tkonst 2 m39)) + tsum (ttranspose [2,1,0] (ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 0.0)))) * tkonst 2 m38)) + tsum (ttranspose [2,1,0] (t24 * tkonst 2 m35)) + tsum (ttranspose [2,1,0] (t27 * tkonst 2 m34)), tsum (ttranspose [1,0] m39) + tsum (ttranspose [1,0] m38) + tsum (ttranspose [1,0] m35) + tsum (ttranspose [1,0] m34), tsum (ttranspose [2,0,1] (tkonst 2 m19) * ttranspose [2,1,0] (tkonst 2 m37)) + tsum (ttranspose [2,0,1] (tkonst 2 m28) * ttranspose [2,1,0] (tkonst 2 m33)), tsum (ttranspose [2,1,0] (ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 0.0)))) * tkonst 2 m37)) + tsum (ttranspose [2,1,0] (t29 * tkonst 2 m33)), tsum (ttranspose [1,0] m37) + tsum (ttranspose [1,0] m33), tsum (ttranspose [2,0,1] (tkonst 10 m30) * ttranspose [2,1,0] (tkonst 2 dret)), tsum (ttranspose [1,0] dret))"
  printPrimal6Pretty renames (simplifyArtifact6 artifact6)
    @?= "\\s0 m3 m4 v5 m6 m7 v8 m9 v10 -> let m22 = tappend (tanh (ttranspose [1,0] (tkonst 2 v5) + tsum (ttranspose [2,1,0] (tkonst 2 m3) * ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 7.0))))) + tsum (ttranspose [2,1,0] (tkonst 2 m4) * ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 0.0))))))) (tanh (ttranspose [1,0] (tkonst 2 v8) + tsum (ttranspose [2,1,0] (tkonst 2 m6) * ttranspose [1,0] (tkonst 2 (tanh (ttranspose [1,0] (tkonst 2 v5) + tsum (ttranspose [2,1,0] (tkonst 2 m3) * ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 7.0))))) + tsum (ttranspose [2,1,0] (tkonst 2 m4) * ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 0.0))))))))) + tsum (ttranspose [2,1,0] (tkonst 2 m7) * ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 0.0))))))) in tsum (ttranspose [2,1,0] (tkonst 2 m9) * ttranspose [1,0] (tkonst 10 (tanh (ttranspose [1,0] (tkonst 2 v8) + tsum (ttranspose [2,1,0] (tkonst 2 m6) * ttranspose [1,0] (tkonst 2 (tanh (ttranspose [1,0] (tkonst 2 v5) + tsum (ttranspose [2,1,0] (tkonst 2 m3) * ttranspose [1,0] (tkonst 2 (tkonst 2 (tkonst 2 (tconst 7.0))))) + tsum (ttranspose [2,1,0] (tkonst 2 m4) * ttranspose [1,0] (tkonst 2 (tslice 0 2 m22))))))) + tsum (ttranspose [2,1,0] (tkonst 2 m7) * ttranspose [1,0] (tkonst 2 (tslice 2 2 m22))))))) + ttranspose [1,0] (tkonst 2 v10)"
