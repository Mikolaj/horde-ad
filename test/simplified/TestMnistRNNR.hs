...
testRNNOPP = do
  ...
  printGradient6Pretty renames (simplifyArtifact artifactRev)
    @?= "\\m19 m1 m2 v3 m4 m5 v6 m7 v8 -> let m12 = tanh (rtranspose [1,0] (rreplicate 1 v3) + rsum (rtranspose [2,1,0] (rreplicate 1 m1) * rtranspose [1,0] (rreplicate 1 (rreplicate 1 (rreplicate 1 7.0)))) + rsum (rtranspose [2,1,0] (rreplicate 1 m2) * rtranspose [1,0] (rreplicate 1 (rreplicate 1 (rreplicate 1 0.0))))) ; m14 = tanh (rtranspose [1,0] (rreplicate 1 v3) + rsum (rtranspose [2,1,0] (rreplicate 1 m1) * rtranspose [1,0] (rreplicate 1 (rreplicate 1 (rreplicate 1 7.0)))) + rsum (rtranspose [2,1,0] (rreplicate 1 m2) * rtranspose [1,0] (rreplicate 1 (rreplicate 1 (rreplicate 1 0.0))))) ; m17 = tanh (rtranspose [1,0] (rreplicate 1 v6) + rsum (rtranspose [2,1,0] (rreplicate 1 m4) * rtranspose [1,0] (rreplicate 1 m14)) + rsum (rtranspose [2,1,0] (rreplicate 1 m5) * rtranspose [1,0] (rreplicate 1 (rreplicate 1 (rreplicate 1 0.0))))) ; m20 = rappend (rconst (fromList [1,1] [0.0])) (rappend (rsum (rtranspose [1,2,0] (rreplicate 1 m7) * rtranspose [1,0] (rreplicate 1 m19))) (rreplicate 0 (rreplicate 1 0.0))) ; m21 = (rconst (fromList [1,1] [1.0]) - m17 * m17) * rslice 1 1 m20 ; m24 = (rconst (fromList [1,1] [1.0]) - m14 * m14) * rsum (rtranspose [1,2,0] (rreplicate 1 m4) * rtranspose [1,0] (rreplicate 1 m21)) ; m26 = (rconst (fromList [1,1] [1.0]) - m12 * m12) * rslice 0 1 m20 in [rsum (rtranspose [2,0,1] (rreplicate 1 (rreplicate 1 (rreplicate 1 7.0))) * rtranspose [2,1,0] (rreplicate 1 m26)) + rsum (rtranspose [2,0,1] (rreplicate 1 (rreplicate 1 (rreplicate 1 7.0))) * rtranspose [2,1,0] (rreplicate 1 m24)), rsum (rtranspose [2,0,1] (rreplicate 1 (rreplicate 1 (rreplicate 1 0.0))) * rtranspose [2,1,0] (rreplicate 1 m26)) + rsum (rtranspose [2,0,1] (rreplicate 1 (rreplicate 1 (rreplicate 1 0.0))) * rtranspose [2,1,0] (rreplicate 1 m24)), rsum (rtranspose [1,0] m26) + rsum (rtranspose [1,0] m24), rsum (rtranspose [2,0,1] (rreplicate 1 m14) * rtranspose [2,1,0] (rreplicate 1 m21)), rsum (rtranspose [2,0,1] (rreplicate 1 (rreplicate 1 (rreplicate 1 0.0))) * rtranspose [2,1,0] (rreplicate 1 m21)), rsum (rtranspose [1,0] m21), rsum (rtranspose [2,0,1] (rreplicate 10 m17) * rtranspose [2,1,0] (rreplicate 1 m19)), rsum (rtranspose [1,0] m19)]"
