...
testCNNOPP = do
  ...
  printArtifactPretty renames artifactRev
    @?= "\\m345 x1 -> let w252 = rtranspose [4,1,0,2,3] (rreplicate 1 (rreshape [1,4,4,4] (rgather [1,4,4,1,1,2,2] (tconcrete (FTKR [2] FTKScalar) (rfromListLinear [2] [7.0,0.0])) (\\[i238, i239, i240, i241, i242, i243, i244] -> [ifF ((0 <=. i238 + i241 &&* 1 >. i238 + i241) &&* ((0 <=. i242 &&* 1 >. i242) &&* ((0 <=. i239 + i243 &&* 4 >. i239 + i243) &&* (0 <=. i240 + i244 &&* 4 >. i240 + i244)))) 0 1])))) ; w253 = rtranspose [4,0,3,1,2] (rreplicate 1 (rreplicate 4 (rreplicate 4 (rreshape [1,4] (rgather [1,1,1,2,2] (rfromVector (fromList [rgather [1,1,1,2,2] (tproject1 (tproject1 (tproject1 u1))) (\\[i245, i246] -> [i245 + i246]), rreplicate 1 (rreplicate 1 (rreplicate 1 (rreplicate 2 (rreplicate 2 (rscalar 0.0)))))])) (\\[i247, i248, i249, i250, i251] -> [ifF ((0 <=. i247 + i248 &&* 1 >. i247 + i248) &&* ((0 <=. i249 &&* 1 >. i249) &&* ((0 <=. i250 &&* 2 >. i250) &&* (0 <=. i251 &&* 2 >. i251)))) 0 1, i247, i248, i249, i250, i251])))))) ; w254 = rreplicate 1 (rreplicate 1 (rreplicate 2 (rreplicate 2 (rreplicate 1 (rreplicate 1 (rreplicate 2 (rreplicate 2 (rsum (w252 * w253) + rtranspose [0,3,1,2] (rreplicate 1 (rreplicate 4 (rreplicate 4 (tproject2 (tproject1 (tproject1 u1)))))))))))))) ; w271 = rgather [1,1,2,2,1,1,2,2] (tconcrete (FTKR [2] FTKScalar) (rfromListLinear [2] [0.0,1.0])) (\\[i255, i256, i257, i258, i259, i260, i261, i262] -> [ifF (w254 ! [i255, i256, i257, i258, i259, i260, i261, i262, i255, i256, 0, 0] <=. rscalar 0.0) 0 1]) ; w272 = rgather [1,1,2,2,1,1,2,2] w254 (\\[i263, i264, i265, i266, i267, i268, i269, i270] -> [i263, i264, i265, i266, i267, i268, i269, i270, i263, i264, 0, 0]) ; w281 = rreplicate 1 (rreplicate 2 (rreplicate 2 (rreplicate 1 (rreplicate 1 (rreplicate 2 (rreplicate 2 (rgather [1,1,2,2,1,1,2,2] (rfromVector (fromList [w271 * w272, rreplicate 1 (rreplicate 1 (rreplicate 2 (rreplicate 2 (rreplicate 1 (rreplicate 1 (rreplicate 2 (rreplicate 2 (rscalar 0.0))))))))])) (\\[i273, i274, i275, i276, i277, i278, i279, i280] -> [ifF ((0 <=. i273 + i277 &&* 1 >. i273 + i277) &&* ((0 <=. i274 + i278 &&* 1 >. i274 + i278) &&* ((0 <=. 2 * i275 + i279 &&* 4 >. 2 * i275 + i279) &&* (0 <=. 2 * i276 + i280 &&* 4 >. 2 * i276 + i280)))) 0 1, i273, i274, i275, i276, i277, i278, i279, i280])))))))) ; x289 = rscalar 2 * rscalar 1 ; w304 = rtranspose [4,1,0,2,3] (rreplicate 1 (rreshape [1,2,2,4] (rgather [1,2,2,1,1,2,2] (rfromVector (fromList [rgather [1,2,2,1,1,2,2] w281 (\\[i282, i283, i284, i285, i286, i287, i288] -> [i282, i283, i284, i285, i286, i287, i288, i282, i286, i283, i284, remF (quotF (rmaxIndex (rreshape [4] (w281 ! [i282, i283, i284, i285, i286, i287, i288, i282, i286, i283, i284]))) (rscalar 2 * i289)) (rscalar 1), remF (quotF (rmaxIndex (rreshape [4] (w281 ! [i282, i283, i284, i285, i286, i287, i288, i282, i286, i283, i284]))) (rscalar 2 * rscalar 2)) (rscalar 1), remF (quotF (rmaxIndex (rreshape [4] (w281 ! [i282, i283, i284, i285, i286, i287, i288, i282, i286, i283, i284]))) (rscalar 2)) (rscalar 2), remF (rmaxIndex (rreshape [4] (w281 ! [i282, i283, i284, i285, i286, i287, i288, i282, i286, i283, i284]))) (rscalar 2)]), rreplicate 1 (rreplicate 2 (rreplicate 2 (rreplicate 1 (rreplicate 1 (rreplicate 2 (rreplicate 2 (rscalar 0.0)))))))])) (\\[i290, i291, i292, i293, i294, i295, i296] -> [ifF ((0 <=. i290 + i293 &&* 1 >. i290 + i293) &&* ((0 <=. i294 &&* 1 >. i294) &&* ((0 <=. i291 + i295 &&* 2 >. i291 + i295) &&* (0 <=. i292 + i296 &&* 2 >. i292 + i296)))) 0 1, i290, i291, i292, i293, i294, i295, i296])))) ; w305 = rtranspose [4,0,3,1,2] (rreplicate 1 (rreplicate 2 (rreplicate 2 (rreshape [1,4] (rgather [1,1,1,2,2] (rfromVector (fromList [rgather [1,1,1,2,2] (tproject1 (tproject2 (tproject1 u1))) (\\[i297, i298] -> [i297 + i298]), rreplicate 1 (rreplicate 1 (rreplicate 1 (rreplicate 2 (rreplicate 2 (rscalar 0.0)))))])) (\\[i299, i300, i301, i302, i303] -> [ifF ((0 <=. i299 + i300 &&* 1 >. i299 + i300) &&* ((0 <=. i301 &&* 1 >. i301) &&* ((0 <=. i302 &&* 2 >. i302) &&* (0 <=. i303 &&* 2 >. i303)))) 0 1, i299, i300, i301, i302, i303])))))) ; w306 = rreplicate 1 (rreplicate 1 (rreplicate 1 (rreplicate 1 (rreplicate 1 (rreplicate 1 (rreplicate 2 (rreplicate 2 (rsum (w304 * w305) + rtranspose [0,3,1,2] (rreplicate 1 (rreplicate 2 (rreplicate 2 (tproject2 (tproject2 (tproject1 u1)))))))))))))) ; w323 = rgather [1,1,1,1,1,1,2,2] (tconcrete (FTKR [2] FTKScalar) (rfromListLinear [2] [0.0,1.0])) (\\[i307, i308, i309, i310, i311, i312, i313, i314] -> [ifF (w306 ! [i307, i308, i309, i310, i311, i312, i313, i314, i307, i308, 0, 0] <=. rscalar 0.0) 0 1]) ; w324 = rgather [1,1,1,1,1,1,2,2] w306 (\\[i315, i316, i317, i318, i319, i320, i321, i322] -> [i315, i316, i317, i318, i319, i320, i321, i322, i315, i316, 0, 0]) ; w333 = rgather [1,1,1,1,1,1,2,2] (rfromVector (fromList [w323 * w324, rreplicate 1 (rreplicate 1 (rreplicate 1 (rreplicate 1 (rreplicate 1 (rreplicate 1 (rreplicate 2 (rreplicate 2 (rscalar 0.0))))))))])) (\\[i325, i326, i327, i328, i329, i330, i331, i332] -> [ifF ((0 <=. i325 + i329 &&* 1 >. i325 + i329) &&* ((0 <=. i326 + i330 &&* 1 >. i326 + i330) &&* ((0 <=. 2 * i327 + i331 &&* 2 >. 2 * i327 + i331) &&* (0 <=. 2 * i328 + i332 &&* 2 >. 2 * i328 + i332)))) 0 1, i325, i326, i327, i328, i329, i330, i331, i332]) ; x338 = rscalar 2 * rscalar 1 ; t339 = rtranspose [1,0] (rreplicate 1 (rtranspose [1,0] (rreshape [1,1] (rgather [1,1,1,1] w333 (\\[i334, i335, i336, i337] -> [i334, i335, i336, i337, remF (quotF (rmaxIndex (rreshape [4] (w333 ! [i334, i335, i336, i337]))) (rscalar 2 * i338)) (rscalar 1), remF (quotF (rmaxIndex (rreshape [4] (w333 ! [i334, i335, i336, i337]))) (rscalar 2 * rscalar 2)) (rscalar 1), remF (quotF (rmaxIndex (rreshape [4] (w333 ! [i334, i335, i336, i337]))) (rscalar 2)) (rscalar 2), remF (rmaxIndex (rreshape [4] (w333 ! [i334, i335, i336, i337]))) (rscalar 2)]))))) ; m340 = rsum (rtranspose [2,1,0] (rreplicate 1 (tproject1 (tproject1 (tproject2 u1)))) * t339) + rtranspose [1,0] (rreplicate 1 (tproject2 (tproject1 (tproject2 u1)))) ; m343 = rgather [1,1] (tconcrete (FTKR [2] FTKScalar) (rfromListLinear [2] [0.0,1.0])) (\\[i341, i342] -> [ifF (m340 ! [i341, i342] <=. rscalar 0.0) 0 1]) ; t344 = rtranspose [1,0] (rreplicate 10 (m343 * m340)) ; m346 = m343 * rsum (rtranspose [1,0] (rtranspose [2,1,0] (rreplicate 1 (tproject1 (tproject2 (tproject2 u1)))) * rreplicate 1 m345)) ; t347 = rreplicate 1 m346 ; x352 = rscalar 2 * rscalar 1 ; w361 = rscatter [2,1,1,1,1,1,1,2,2] (rscatter [1,1,1,1,1,1,2,2] (rreshape [1,1,1,1] (rtranspose [1,0] (rsum (rtranspose [1,0] (rtranspose [2,1,0] (rreplicate 1 (tproject1 (tproject1 (tproject2 u1)))) * t347))))) (\\[i348, i349, i350, i351] -> [i348, i349, i350, i351, remF (quotF (rmaxIndex (rreshape [4] (w333 ! [i348, i349, i350, i351]))) (rscalar 2 * i352)) (rscalar 1), remF (quotF (rmaxIndex (rreshape [4] (w333 ! [i348, i349, i350, i351]))) (rscalar 2 * rscalar 2)) (rscalar 1), remF (quotF (rmaxIndex (rreshape [4] (w333 ! [i348, i349, i350, i351]))) (rscalar 2)) (rscalar 2), remF (rmaxIndex (rreshape [4] (w333 ! [i348, i349, i350, i351]))) (rscalar 2)])) (\\[i353, i354, i355, i356, i357, i358, i359, i360] -> [ifF ((0 <=. i353 + i357 &&* 1 >. i353 + i357) &&* ((0 <=. i354 + i358 &&* 1 >. i354 + i358) &&* ((0 <=. 2 * i355 + i359 &&* 2 >. 2 * i355 + i359) &&* (0 <=. 2 * i356 + i360 &&* 2 >. 2 * i356 + i360)))) 0 1, i353, i354, i355, i356, i357, i358, i359, i360]) ; u370 = rsum (rsum (rsum (rsum (rsum (rsum (rsum (rsum (rscatter [1,1,1,1,1,1,2,2,1,1,2,2] (w323 * w361 ! [0]) (\\[i362, i363, i364, i365, i366, i367, i368, i369] -> [i362, i363, i364, i365, i366, i367, i368, i369, i362, i363, 0, 0]))))))))) ; w371 = rreplicate 4 u370 ; w377 = rscatter [2,1,1,1,2,2] (rreshape [1,1,1,2,2] (rsum (rsum (rsum (rtranspose [1,3,4,2,0] (w304 * w371)))))) (\\[i372, i373, i374, i375, i376] -> [ifF ((0 <=. i372 + i373 &&* 1 >. i372 + i373) &&* ((0 <=. i374 &&* 1 >. i374) &&* ((0 <=. i375 &&* 2 >. i375) &&* (0 <=. i376 &&* 2 >. i376)))) 0 1, i372, i373, i374, i375, i376]) ; w387 = rscatter [2,1,2,2,1,1,2,2] (rreshape [1,2,2,1,1,2,2] (rsum (rtranspose [2,1,3,4,0] (w305 * w371)))) (\\[i380, i381, i382, i383, i384, i385, i386] -> [ifF ((0 <=. i380 + i383 &&* 1 >. i380 + i383) &&* ((0 <=. i384 &&* 1 >. i384) &&* ((0 <=. i381 + i385 &&* 2 >. i381 + i385) &&* (0 <=. i382 + i386 &&* 2 >. i382 + i386)))) 0 1, i380, i381, i382, i383, i384, i385, i386]) ; x395 = rscalar 2 * rscalar 1 ; w404 = rscatter [2,1,1,2,2,1,1,2,2] (rsum (rsum (rsum (rsum (rsum (rsum (rsum (rscatter [1,2,2,1,1,2,2,1,1,2,2,1,1,2,2] (w387 ! [0]) (\\[i388, i389, i390, i391, i392, i393, i394] -> [i388, i389, i390, i391, i392, i393, i394, i388, i392, i389, i390, remF (quotF (rmaxIndex (rreshape [4] (w281 ! [i388, i389, i390, i391, i392, i393, i394, i388, i392, i389, i390]))) (rscalar 2 * i395)) (rscalar 1), remF (quotF (rmaxIndex (rreshape [4] (w281 ! [i388, i389, i390, i391, i392, i393, i394, i388, i392, i389, i390]))) (rscalar 2 * rscalar 2)) (rscalar 1), remF (quotF (rmaxIndex (rreshape [4] (w281 ! [i388, i389, i390, i391, i392, i393, i394, i388, i392, i389, i390]))) (rscalar 2)) (rscalar 2), remF (rmaxIndex (rreshape [4] (w281 ! [i388, i389, i390, i391, i392, i393, i394, i388, i392, i389, i390]))) (rscalar 2)]))))))))) (\\[i396, i397, i398, i399, i400, i401, i402, i403] -> [ifF ((0 <=. i396 + i400 &&* 1 >. i396 + i400) &&* ((0 <=. i397 + i401 &&* 1 >. i397 + i401) &&* ((0 <=. 2 * i398 + i402 &&* 4 >. 2 * i398 + i402) &&* (0 <=. 2 * i399 + i403 &&* 4 >. 2 * i399 + i403)))) 0 1, i396, i397, i398, i399, i400, i401, i402, i403]) ; u413 = rsum (rsum (rsum (rsum (rsum (rsum (rsum (rsum (rscatter [1,1,2,2,1,1,2,2,1,1,4,4] (w271 * w404 ! [0]) (\\[i405, i406, i407, i408, i409, i410, i411, i412] -> [i405, i406, i407, i408, i409, i410, i411, i412, i405, i406, 0, 0]))))))))) ; w419 = rscatter [2,1,1,1,2,2] (rreshape [1,1,1,2,2] (rsum (rsum (rsum (rtranspose [1,3,4,2,0] (w252 * rreplicate 4 u413)))))) (\\[i414, i415, i416, i417, i418] -> [ifF ((0 <=. i414 + i415 &&* 1 >. i414 + i415) &&* ((0 <=. i416 &&* 1 >. i416) &&* ((0 <=. i417 &&* 2 >. i417) &&* (0 <=. i418 &&* 2 >. i418)))) 0 1, i414, i415, i416, i417, i418]) in tpair (tpair (tpair (rscatter [1,1,2,2] (w419 ! [0]) (\\[i420, i421] -> [i420 + i421]), rsum (rsum (rsum (rtranspose [0,2,3,1] u413)))), tpair (rscatter [1,1,2,2] (w377 ! [0]) (\\[i378, i379] -> [i378 + i379]), rsum (rsum (rsum (rtranspose [0,2,3,1] u370))))), tpair (tpair (rsum (rtranspose [2,1,0] (t339 * t347)), rsum (rtranspose [1,0] m346)), tpair (rsum (rtranspose [2,1,0] (t344 * rreplicate 1 m345)), rsum (rtranspose [1,0] m345))))"
