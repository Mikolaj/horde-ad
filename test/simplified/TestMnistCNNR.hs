    ...
    in testCase name $ do
       ...
       let envInit = extendEnvR varGlyph (tconstant astGlyph)
           ...
           (((varDtAgain, vars1Again), gradientRaw, primal, sh), _) =
             revProduceArtifact @Nat @AstRanked False g envInit domainsInit
...
testCNNOPP = do
  ...
  printGradient6Pretty renames artifactRev
    @?= "\\dret u2 v3 u4 v5 m6 v7 m8 v9 -> let w353 = ttranspose [1,0] (treplicate 1 (tgather [1,4,4,1,1,2,2] (tfromList [tgather [1,4,4,1,1,2,2] (tgather [4,4,1,1,2,2] (tgather [4,1,1,2,2] (tgather [1,1,2,2] (tgather [1,2,2] (tgather [2,2] (treplicate 2 (tconst 7.0)) (\\[i285, i286] -> [i286])) (\\[i287, i288, i289] -> [i288, i289])) (\\[i290, i291, i292, i293] -> [i291, i292, i293])) (\\[i294, i295, i296, i297, i298] -> [i295, i296, i297, i298])) (\\[i299, i300, i301, i302, i303, i304] -> [i300, i301, i302, i303, i304])) (\\[i305, i306, i307, i308, i309, i310, i311] -> [i306, i307, i308, i309, i310, i311]), tgather [1,4,4,1,1,2,2] (tgather [4,4,1,1,2,2] (tgather [4,1,1,2,2] (tgather [1,1,2,2] (tgather [1,2,2] (tgather [2,2] (treplicate 2 (tconst 0.0)) (\\[i312, i313] -> [i313])) (\\[i314, i315, i316] -> [i315, i316])) (\\[i317, i318, i319, i320] -> [i318, i319, i320])) (\\[i321, i322, i323, i324, i325] -> [i322, i323, i324, i325])) (\\[i326, i327, i328, i329, i330, i331] -> [i327, i328, i329, i330, i331])) (\\[i332, i333, i334, i335, i336, i337, i338] -> [i333, i334, i335, i336, i337, i338])]) (\\[i339, i340, i341, i342, i343, i344, i345] -> [ifF ((0 <=. i339 + i342 &&* 1 >. i339 + i342) &&* ((0 <=. i343 &&* 1 >. i343) &&* ((0 <=. i340 + i344 &&* 4 >. i340 + i344) &&* (0 <=. i341 + i345 &&* 4 >. i341 + i345)))) 0 1, i339, i340, i341, i342, i343, i344, i345]))) ; w354 = ttranspose [0,3,1,2] (treplicate 1 (treplicate 4 (treplicate 4 (tgather [1,1,1,2,2] (tfromList [tgather [1,1,1,2,2] u2 (\\[i346, i347] -> [i346 + i347]), treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0)))))]) (\\[i348, i349, i350, i351, i352] -> [ifF ((0 <=. i348 + i349 &&* 1 >. i348 + i349) &&* ((0 <=. i350 &&* 1 >. i350) &&* ((0 <=. i351 &&* 2 >. i351) &&* (0 <=. i352 &&* 2 >. i352)))) 0 1, i348, i349, i350, i351, i352]))))) ; w355 = treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (tsum (ttranspose [4,0,1,2,3] (treshape [1,1,4,4,4] (w353 * w354))) + ttranspose [0,3,1,2] (treplicate 1 (treplicate 4 (treplicate 4 v3)))))))))) ; w375 = tgather [1,1,2,2,1,1,2,4] (tconst (fromList [2] [0.0,1.0])) (\\[i360, i361, i362, i363, i364, i365, i366, i367] -> [ifF (w355 ! [i360, i361, i362, i363, i364, i365, i366, let w356 = ttranspose [5,0,1,2,6,3,4] (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w356 ! [i360, i361, i362, i363, i364, i365, i366], let w357 = ttranspose [0,5,1,2,3,6,4] (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w357 ! [i360, i361, i362, i363, i364, i365, i366], let v358 = tconst (fromList [2] [0,1]) ; w359 = ttranspose [0,1,5,2,3,4] (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (treplicate 2 (tconst 2) * v358)) + treplicate 2 (tconst (fromList [2] [0,1])))))))) in w359 ! [i360, i361, i362, i363, i364, i365, i366], i367] <=. tconst 0.0) 0 1]) ; w376 = tgather [1,1,2,2,1,1,2,4] w355 (\\[i368, i369, i370, i371, i372, i373, i374] -> [i368, i369, i370, i371, i372, i373, i374, let w356 = ttranspose [5,0,1,2,6,3,4] (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w356 ! [i368, i369, i370, i371, i372, i373, i374], let w357 = ttranspose [0,5,1,2,3,6,4] (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w357 ! [i368, i369, i370, i371, i372, i373, i374], let v358 = tconst (fromList [2] [0,1]) ; w359 = ttranspose [0,1,5,2,3,4] (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (treplicate 2 (tconst 2) * v358)) + treplicate 2 (tconst (fromList [2] [0,1])))))))) in w359 ! [i368, i369, i370, i371, i372, i373, i374]]) ; w393 = treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (tgather [1,1,2,2,1,1,2,2] (tfromList [tgather [1,1,2,2,1,1,2,2] (w375 * w376) (\\[i377, i378, i379, i380, i381, i382, i383, i384] -> [i377, i378, i379, i380, i381, i382, i383, 2 * i380 + i384]), treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0))))))))]) (\\[i385, i386, i387, i388, i389, i390, i391, i392] -> [ifF ((0 <=. i385 + i389 &&* 1 >. i385 + i389) &&* ((0 <=. i386 + i390 &&* 1 >. i386 + i390) &&* ((0 <=. 2 * i387 + i391 &&* 4 >. 2 * i387 + i391) &&* (0 <=. 2 * i388 + i392 &&* 4 >. 2 * i388 + i392)))) 0 1, i385, i386, i387, i388, i389, i390, i391, i392]))))))) ; w421 = ttranspose [1,0] (treplicate 1 (tgather [1,2,2,1,1,2,2] (tfromList [tgather [1,2,2,1,1,2,2] w393 (\\[i396, i397, i398, i399, i400, i401, i402] -> [i396, i397, i398, i399, i400, i401, let w394 = ttranspose [4,0,1,5,2,3] (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0]))))))) in w394 ! [i396, i397, i398, i399, i400, i401], i400, let w395 = ttranspose [0,4,1,2,3] (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (tconst (fromList [2] [0,1]))) + treplicate 2 (tconst (fromList [2] [0,1]))))))) in w395 ! [i396, i397, i398, i399, i400, i401], i398 + i402, 0, 0, rem (quot (tmaxIndex (tgather [4] (w393 ! [i396, i397, i398, i399, i400, i401, let w394 = ttranspose [4,0,1,5,2,3] (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0]))))))) in w394 ! [i396, i397, i398, i399, i400, i401], i400, let w395 = ttranspose [0,4,1,2,3] (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (tconst (fromList [2] [0,1]))) + treplicate 2 (tconst (fromList [2] [0,1]))))))) in w395 ! [i396, i397, i398, i399, i400, i401], let i403 = i398 + i402 in i403, 0, 0]) (\\[i404] -> [rem (quot i404 2) 2, rem i404 2]))) 2) 2, rem (tmaxIndex (tgather [4] (w393 ! [i396, i397, i398, i399, i400, i401, let w394 = ttranspose [4,0,1,5,2,3] (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0]))))))) in w394 ! [i396, i397, i398, i399, i400, i401], i400, let w395 = ttranspose [0,4,1,2,3] (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (tconst (fromList [2] [0,1]))) + treplicate 2 (tconst (fromList [2] [0,1]))))))) in w395 ! [i396, i397, i398, i399, i400, i401], let i405 = i398 + i402 in i405, 0, 0]) (\\[i406] -> [rem (quot i406 2) 2, rem i406 2]))) 2]), treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0)))))))]) (\\[i407, i408, i409, i410, i411, i412, i413] -> [ifF ((0 <=. i407 + i410 &&* 1 >. i407 + i410) &&* ((0 <=. i411 &&* 1 >. i411) &&* ((0 <=. i408 + i412 &&* 2 >. i408 + i412) &&* (0 <=. i409 + i413 &&* 2 >. i409 + i413)))) 0 1, i407, i408, i409, i410, i411, i412, i413]))) ; w422 = ttranspose [0,3,1,2] (treplicate 1 (treplicate 2 (treplicate 2 (tgather [1,1,1,2,2] (tfromList [tgather [1,1,1,2,2] u4 (\\[i414, i415] -> [i414 + i415]), treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0)))))]) (\\[i416, i417, i418, i419, i420] -> [ifF ((0 <=. i416 + i417 &&* 1 >. i416 + i417) &&* ((0 <=. i418 &&* 1 >. i418) &&* ((0 <=. i419 &&* 2 >. i419) &&* (0 <=. i420 &&* 2 >. i420)))) 0 1, i416, i417, i418, i419, i420]))))) ; w423 = treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (tsum (ttranspose [4,0,1,2,3] (treshape [1,1,2,2,4] (w421 * w422))) + ttranspose [0,3,1,2] (treplicate 1 (treplicate 2 (treplicate 2 v5)))))))))) ; w443 = tgather [1,1,1,1,1,1,2,2] (tconst (fromList [2] [0.0,1.0])) (\\[i428, i429, i430, i431, i432, i433, i434, i435] -> [ifF (w423 ! [i428, i429, i430, i431, i432, i433, i434, let w424 = ttranspose [5,0,1,2,6,3,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w424 ! [i428, i429, i430, i431, i432, i433, i434], let w425 = ttranspose [0,5,1,2,3,6,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w425 ! [i428, i429, i430, i431, i432, i433, i434], let v426 = tconst (fromList [1] [0]) ; w427 = ttranspose [0,1,5,2,3,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (treplicate 1 (tconst 2) * v426)) + treplicate 1 (tconst (fromList [2] [0,1])))))))) in w427 ! [i428, i429, i430, i431, i432, i433, i434], i435] <=. tconst 0.0) 0 1]) ; w444 = tgather [1,1,1,1,1,1,2,2] w423 (\\[i436, i437, i438, i439, i440, i441, i442] -> [i436, i437, i438, i439, i440, i441, i442, let w424 = ttranspose [5,0,1,2,6,3,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w424 ! [i436, i437, i438, i439, i440, i441, i442], let w425 = ttranspose [0,5,1,2,3,6,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w425 ! [i436, i437, i438, i439, i440, i441, i442], let v426 = tconst (fromList [1] [0]) ; w427 = ttranspose [0,1,5,2,3,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (treplicate 1 (tconst 2) * v426)) + treplicate 1 (tconst (fromList [2] [0,1])))))))) in w427 ! [i436, i437, i438, i439, i440, i441, i442]]) ; w461 = tgather [1,1,1,1,1,1,2,2] (tfromList [tgather [1,1,1,1,1,1,2,2] (w443 * w444) (\\[i445, i446, i447, i448, i449, i450, i451, i452] -> [i445, i446, i447, i448, i449, i450, i451, 2 * i448 + i452]), treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0))))))))]) (\\[i453, i454, i455, i456, i457, i458, i459, i460] -> [ifF ((0 <=. i453 + i457 &&* 1 >. i453 + i457) &&* ((0 <=. i454 + i458 &&* 1 >. i454 + i458) &&* ((0 <=. 2 * i455 + i459 &&* 2 >. 2 * i455 + i459) &&* (0 <=. 2 * i456 + i460 &&* 2 >. 2 * i456 + i460)))) 0 1, i453, i454, i455, i456, i457, i458, i459, i460]) ; t468 = ttranspose [1,0] (treplicate 1 (ttranspose [1,0] (treshape [1,1] (tgather [1,1,1,1] w461 (\\[i462, i463, i464, i465] -> [i462, i463, i464, i465, 0, 0, rem (quot (tmaxIndex (tgather [4] (w461 ! [i462, i463, i464, i465, 0, 0]) (\\[i466] -> [rem (quot i466 2) 2, rem i466 2]))) 2) 2, rem (tmaxIndex (tgather [4] (w461 ! [i462, i463, i464, i465, 0, 0]) (\\[i467] -> [rem (quot i467 2) 2, rem i467 2]))) 2]))))) ; m469 = tsum (ttranspose [2,1,0] (treplicate 1 m6) * t468) + ttranspose [1,0] (treplicate 1 v7) ; m472 = tgather [1,1] (tconst (fromList [2] [0.0,1.0])) (\\[i470, i471] -> [ifF (m469 ! [i470, i471] <=. tconst 0.0) 0 1]) ; t473 = ttranspose [1,0] (treplicate 10 (m472 * m469)) ; m474 = m472 * tsum (ttranspose [1,2,0] (treplicate 1 m8) * ttranspose [1,0] (treplicate 1 dret)) ; w489 = tscatter [2,1,1,1,1,1,1,2,2] (tscatter [1,1,1,1,1,1,2,2] (treshape [1,1,1,1] (tsum (ttranspose [1,0] (treplicate 1 m6) * ttranspose [1,2,0] (treplicate 1 m474)))) (\\[i475, i476, i477, i478] -> [i475, i476, i477, i478, 0, 0, rem (quot (tmaxIndex (tgather [4] (w461 ! [i475, i476, i477, i478, 0, 0]) (\\[i479] -> [rem (quot i479 2) 2, rem i479 2]))) 2) 2, rem (tmaxIndex (tgather [4] (w461 ! [i475, i476, i477, i478, 0, 0]) (\\[i480] -> [rem (quot i480 2) 2, rem i480 2]))) 2])) (\\[i481, i482, i483, i484, i485, i486, i487, i488] -> [ifF ((0 <=. i481 + i485 &&* 1 >. i481 + i485) &&* ((0 <=. i482 + i486 &&* 1 >. i482 + i486) &&* ((0 <=. 2 * i483 + i487 &&* 2 >. 2 * i483 + i487) &&* (0 <=. 2 * i484 + i488 &&* 2 >. 2 * i484 + i488)))) 0 1, i481, i482, i483, i484, i485, i486, i487, i488]) ; u505 = tscatter [1,1,2,2] (w443 * tscatter [1,1,1,1,1,1,2,2] (w489 ! [0]) (\\[i490, i491, i492, i493, i494, i495, i496, i497] -> [i490, i491, i492, i493, i494, i495, i496, 2 * i493 + i497])) (\\[i498, i499, i500, i501, i502, i503, i504] -> [let w424 = ttranspose [5,0,1,2,6,3,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w424 ! [i498, i499, i500, i501, i502, i503, i504], let w425 = ttranspose [0,5,1,2,3,6,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w425 ! [i498, i499, i500, i501, i502, i503, i504], let v426 = tconst (fromList [1] [0]) ; w427 = ttranspose [0,1,5,2,3,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (treplicate 1 (tconst 2) * v426)) + treplicate 1 (tconst (fromList [2] [0,1])))))))) in w427 ! [i498, i499, i500, i501, i502, i503, i504]]) ; w506 = treshape [1,1,2,2,1,1,2,2] (ttranspose [1,2,3,4,0] (treplicate 4 u505)) ; w512 = tscatter [2,1,1,1,2,2] (tsum (tsum (tsum (ttranspose [0,2,3,1] (w421 * w506))))) (\\[i507, i508, i509, i510, i511] -> [ifF ((0 <=. i507 + i508 &&* 1 >. i507 + i508) &&* ((0 <=. i509 &&* 1 >. i509) &&* ((0 <=. i510 &&* 2 >. i510) &&* (0 <=. i511 &&* 2 >. i511)))) 0 1, i507, i508, i509, i510, i511]) ; w522 = tscatter [2,1,2,2,1,1,2,2] (tsum (ttranspose [1,0] (w422 * w506))) (\\[i515, i516, i517, i518, i519, i520, i521] -> [ifF ((0 <=. i515 + i518 &&* 1 >. i515 + i518) &&* ((0 <=. i519 &&* 1 >. i519) &&* ((0 <=. i516 + i520 &&* 2 >. i516 + i520) &&* (0 <=. i517 + i521 &&* 2 >. i517 + i521)))) 0 1, i515, i516, i517, i518, i519, i520, i521]) ; w542 = tscatter [2,1,1,2,2,1,1,2,2] (tscatter [1,1,2,2,1,1,2,2] (w522 ! [0]) (\\[i523, i524, i525, i526, i527, i528, i529] -> [let w394 = ttranspose [4,0,1,5,2,3] (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0]))))))) in w394 ! [i523, i524, i525, i526, i527, i528], i527, let w395 = ttranspose [0,4,1,2,3] (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (tconst (fromList [2] [0,1]))) + treplicate 2 (tconst (fromList [2] [0,1]))))))) in w395 ! [i523, i524, i525, i526, i527, i528], i525 + i529, 0, 0, rem (quot (tmaxIndex (tgather [4] (w393 ! [i523, i524, i525, i526, i527, i528, let w394 = ttranspose [4,0,1,5,2,3] (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0]))))))) in w394 ! [i523, i524, i525, i526, i527, i528], i527, let w395 = ttranspose [0,4,1,2,3] (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (tconst (fromList [2] [0,1]))) + treplicate 2 (tconst (fromList [2] [0,1]))))))) in w395 ! [i523, i524, i525, i526, i527, i528], let i530 = i525 + i529 in i530, 0, 0]) (\\[i531] -> [rem (quot i531 2) 2, rem i531 2]))) 2) 2, rem (tmaxIndex (tgather [4] (w393 ! [i523, i524, i525, i526, i527, i528, let w394 = ttranspose [4,0,1,5,2,3] (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0]))))))) in w394 ! [i523, i524, i525, i526, i527, i528], i527, let w395 = ttranspose [0,4,1,2,3] (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (tconst (fromList [2] [0,1]))) + treplicate 2 (tconst (fromList [2] [0,1]))))))) in w395 ! [i523, i524, i525, i526, i527, i528], let i532 = i525 + i529 in i532, 0, 0]) (\\[i533] -> [rem (quot i533 2) 2, rem i533 2]))) 2])) (\\[i534, i535, i536, i537, i538, i539, i540, i541] -> [ifF ((0 <=. i534 + i538 &&* 1 >. i534 + i538) &&* ((0 <=. i535 + i539 &&* 1 >. i535 + i539) &&* ((0 <=. 2 * i536 + i540 &&* 4 >. 2 * i536 + i540) &&* (0 <=. 2 * i537 + i541 &&* 4 >. 2 * i537 + i541)))) 0 1, i534, i535, i536, i537, i538, i539, i540, i541]) ; u558 = tscatter [1,1,4,4] (w375 * tscatter [1,1,2,2,1,1,2,4] (w542 ! [0]) (\\[i543, i544, i545, i546, i547, i548, i549, i550] -> [i543, i544, i545, i546, i547, i548, i549, 2 * i546 + i550])) (\\[i551, i552, i553, i554, i555, i556, i557] -> [let w356 = ttranspose [5,0,1,2,6,3,4] (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w356 ! [i551, i552, i553, i554, i555, i556, i557], let w357 = ttranspose [0,5,1,2,3,6,4] (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w357 ! [i551, i552, i553, i554, i555, i556, i557], let v358 = tconst (fromList [2] [0,1]) ; w359 = ttranspose [0,1,5,2,3,4] (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (treplicate 2 (tconst 2) * v358)) + treplicate 2 (tconst (fromList [2] [0,1])))))))) in w359 ! [i551, i552, i553, i554, i555, i556, i557]]) ; w564 = tscatter [2,1,1,1,2,2] (tsum (tsum (tsum (ttranspose [0,2,3,1] (w353 * treshape [1,1,4,4,1,1,2,2] (ttranspose [1,2,3,4,0] (treplicate 4 u558))))))) (\\[i559, i560, i561, i562, i563] -> [ifF ((0 <=. i559 + i560 &&* 1 >. i559 + i560) &&* ((0 <=. i561 &&* 1 >. i561) &&* ((0 <=. i562 &&* 2 >. i562) &&* (0 <=. i563 &&* 2 >. i563)))) 0 1, i559, i560, i561, i562, i563]) in (tscatter [1,1,2,2] (w564 ! [0]) (\\[i565, i566] -> [i565 + i566]), tsum (tsum (tsum (ttranspose [0,2,3,1] u558))), tscatter [1,1,2,2] (w512 ! [0]) (\\[i513, i514] -> [i513 + i514]), tsum (tsum (tsum (ttranspose [0,2,3,1] u505))), tsum (ttranspose [2,1,0] (t468 * treplicate 1 m474)), tsum (ttranspose [1,0] m474), tsum (ttranspose [2,1,0] (t473 * treplicate 1 dret)), tsum (ttranspose [1,0] dret))"
  printPrimal6Pretty renames artifactRev
    @?= "\\u2 v3 u4 v5 m6 v7 m8 v9 -> let w353 = ttranspose [1,0] (treplicate 1 (tgather [1,4,4,1,1,2,2] (tfromList [tgather [1,4,4,1,1,2,2] (tgather [4,4,1,1,2,2] (tgather [4,1,1,2,2] (tgather [1,1,2,2] (tgather [1,2,2] (tgather [2,2] (treplicate 2 (tconst 7.0)) (\\[i285, i286] -> [i286])) (\\[i287, i288, i289] -> [i288, i289])) (\\[i290, i291, i292, i293] -> [i291, i292, i293])) (\\[i294, i295, i296, i297, i298] -> [i295, i296, i297, i298])) (\\[i299, i300, i301, i302, i303, i304] -> [i300, i301, i302, i303, i304])) (\\[i305, i306, i307, i308, i309, i310, i311] -> [i306, i307, i308, i309, i310, i311]), tgather [1,4,4,1,1,2,2] (tgather [4,4,1,1,2,2] (tgather [4,1,1,2,2] (tgather [1,1,2,2] (tgather [1,2,2] (tgather [2,2] (treplicate 2 (tconst 0.0)) (\\[i312, i313] -> [i313])) (\\[i314, i315, i316] -> [i315, i316])) (\\[i317, i318, i319, i320] -> [i318, i319, i320])) (\\[i321, i322, i323, i324, i325] -> [i322, i323, i324, i325])) (\\[i326, i327, i328, i329, i330, i331] -> [i327, i328, i329, i330, i331])) (\\[i332, i333, i334, i335, i336, i337, i338] -> [i333, i334, i335, i336, i337, i338])]) (\\[i339, i340, i341, i342, i343, i344, i345] -> [ifF ((0 <=. i339 + i342 &&* 1 >. i339 + i342) &&* ((0 <=. i343 &&* 1 >. i343) &&* ((0 <=. i340 + i344 &&* 4 >. i340 + i344) &&* (0 <=. i341 + i345 &&* 4 >. i341 + i345)))) 0 1, i339, i340, i341, i342, i343, i344, i345]))) ; w354 = ttranspose [0,3,1,2] (treplicate 1 (treplicate 4 (treplicate 4 (tgather [1,1,1,2,2] (tfromList [tgather [1,1,1,2,2] u2 (\\[i346, i347] -> [i346 + i347]), treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0)))))]) (\\[i348, i349, i350, i351, i352] -> [ifF ((0 <=. i348 + i349 &&* 1 >. i348 + i349) &&* ((0 <=. i350 &&* 1 >. i350) &&* ((0 <=. i351 &&* 2 >. i351) &&* (0 <=. i352 &&* 2 >. i352)))) 0 1, i348, i349, i350, i351, i352]))))) ; w355 = treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (tsum (ttranspose [4,0,1,2,3] (treshape [1,1,4,4,4] (w353 * w354))) + ttranspose [0,3,1,2] (treplicate 1 (treplicate 4 (treplicate 4 v3)))))))))) ; w375 = tgather [1,1,2,2,1,1,2,4] (tconst (fromList [2] [0.0,1.0])) (\\[i360, i361, i362, i363, i364, i365, i366, i367] -> [ifF (w355 ! [i360, i361, i362, i363, i364, i365, i366, let w356 = ttranspose [5,0,1,2,6,3,4] (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w356 ! [i360, i361, i362, i363, i364, i365, i366], let w357 = ttranspose [0,5,1,2,3,6,4] (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w357 ! [i360, i361, i362, i363, i364, i365, i366], let v358 = tconst (fromList [2] [0,1]) ; w359 = ttranspose [0,1,5,2,3,4] (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (treplicate 2 (tconst 2) * v358)) + treplicate 2 (tconst (fromList [2] [0,1])))))))) in w359 ! [i360, i361, i362, i363, i364, i365, i366], i367] <=. tconst 0.0) 0 1]) ; w376 = tgather [1,1,2,2,1,1,2,4] w355 (\\[i368, i369, i370, i371, i372, i373, i374] -> [i368, i369, i370, i371, i372, i373, i374, let w356 = ttranspose [5,0,1,2,6,3,4] (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w356 ! [i368, i369, i370, i371, i372, i373, i374], let w357 = ttranspose [0,5,1,2,3,6,4] (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w357 ! [i368, i369, i370, i371, i372, i373, i374], let v358 = tconst (fromList [2] [0,1]) ; w359 = ttranspose [0,1,5,2,3,4] (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (treplicate 2 (tconst 2) * v358)) + treplicate 2 (tconst (fromList [2] [0,1])))))))) in w359 ! [i368, i369, i370, i371, i372, i373, i374]]) ; w393 = treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (tgather [1,1,2,2,1,1,2,2] (tfromList [tgather [1,1,2,2,1,1,2,2] (w375 * w376) (\\[i377, i378, i379, i380, i381, i382, i383, i384] -> [i377, i378, i379, i380, i381, i382, i383, 2 * i380 + i384]), treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0))))))))]) (\\[i385, i386, i387, i388, i389, i390, i391, i392] -> [ifF ((0 <=. i385 + i389 &&* 1 >. i385 + i389) &&* ((0 <=. i386 + i390 &&* 1 >. i386 + i390) &&* ((0 <=. 2 * i387 + i391 &&* 4 >. 2 * i387 + i391) &&* (0 <=. 2 * i388 + i392 &&* 4 >. 2 * i388 + i392)))) 0 1, i385, i386, i387, i388, i389, i390, i391, i392]))))))) ; w421 = ttranspose [1,0] (treplicate 1 (tgather [1,2,2,1,1,2,2] (tfromList [tgather [1,2,2,1,1,2,2] w393 (\\[i396, i397, i398, i399, i400, i401, i402] -> [i396, i397, i398, i399, i400, i401, let w394 = ttranspose [4,0,1,5,2,3] (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0]))))))) in w394 ! [i396, i397, i398, i399, i400, i401], i400, let w395 = ttranspose [0,4,1,2,3] (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (tconst (fromList [2] [0,1]))) + treplicate 2 (tconst (fromList [2] [0,1]))))))) in w395 ! [i396, i397, i398, i399, i400, i401], i398 + i402, 0, 0, rem (quot (tmaxIndex (tgather [4] (w393 ! [i396, i397, i398, i399, i400, i401, let w394 = ttranspose [4,0,1,5,2,3] (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0]))))))) in w394 ! [i396, i397, i398, i399, i400, i401], i400, let w395 = ttranspose [0,4,1,2,3] (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (tconst (fromList [2] [0,1]))) + treplicate 2 (tconst (fromList [2] [0,1]))))))) in w395 ! [i396, i397, i398, i399, i400, i401], let i403 = i398 + i402 in i403, 0, 0]) (\\[i404] -> [rem (quot i404 2) 2, rem i404 2]))) 2) 2, rem (tmaxIndex (tgather [4] (w393 ! [i396, i397, i398, i399, i400, i401, let w394 = ttranspose [4,0,1,5,2,3] (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0]))))))) in w394 ! [i396, i397, i398, i399, i400, i401], i400, let w395 = ttranspose [0,4,1,2,3] (treplicate 1 (treplicate 2 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (tconst (fromList [2] [0,1]))) + treplicate 2 (tconst (fromList [2] [0,1]))))))) in w395 ! [i396, i397, i398, i399, i400, i401], let i405 = i398 + i402 in i405, 0, 0]) (\\[i406] -> [rem (quot i406 2) 2, rem i406 2]))) 2]), treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0)))))))]) (\\[i407, i408, i409, i410, i411, i412, i413] -> [ifF ((0 <=. i407 + i410 &&* 1 >. i407 + i410) &&* ((0 <=. i411 &&* 1 >. i411) &&* ((0 <=. i408 + i412 &&* 2 >. i408 + i412) &&* (0 <=. i409 + i413 &&* 2 >. i409 + i413)))) 0 1, i407, i408, i409, i410, i411, i412, i413]))) ; w422 = ttranspose [0,3,1,2] (treplicate 1 (treplicate 2 (treplicate 2 (tgather [1,1,1,2,2] (tfromList [tgather [1,1,1,2,2] u4 (\\[i414, i415] -> [i414 + i415]), treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0)))))]) (\\[i416, i417, i418, i419, i420] -> [ifF ((0 <=. i416 + i417 &&* 1 >. i416 + i417) &&* ((0 <=. i418 &&* 1 >. i418) &&* ((0 <=. i419 &&* 2 >. i419) &&* (0 <=. i420 &&* 2 >. i420)))) 0 1, i416, i417, i418, i419, i420]))))) ; w423 = treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (tsum (ttranspose [4,0,1,2,3] (treshape [1,1,2,2,4] (w421 * w422))) + ttranspose [0,3,1,2] (treplicate 1 (treplicate 2 (treplicate 2 v5)))))))))) ; w443 = tgather [1,1,1,1,1,1,2,2] (tconst (fromList [2] [0.0,1.0])) (\\[i428, i429, i430, i431, i432, i433, i434, i435] -> [ifF (w423 ! [i428, i429, i430, i431, i432, i433, i434, let w424 = ttranspose [5,0,1,2,6,3,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w424 ! [i428, i429, i430, i431, i432, i433, i434], let w425 = ttranspose [0,5,1,2,3,6,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w425 ! [i428, i429, i430, i431, i432, i433, i434], let v426 = tconst (fromList [1] [0]) ; w427 = ttranspose [0,1,5,2,3,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (treplicate 1 (tconst 2) * v426)) + treplicate 1 (tconst (fromList [2] [0,1])))))))) in w427 ! [i428, i429, i430, i431, i432, i433, i434], i435] <=. tconst 0.0) 0 1]) ; w444 = tgather [1,1,1,1,1,1,2,2] w423 (\\[i436, i437, i438, i439, i440, i441, i442] -> [i436, i437, i438, i439, i440, i441, i442, let w424 = ttranspose [5,0,1,2,6,3,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w424 ! [i436, i437, i438, i439, i440, i441, i442], let w425 = ttranspose [0,5,1,2,3,6,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (ttranspose [1,0] (treplicate 1 (tconst (fromList [1] [0]))) + treplicate 1 (tconst (fromList [1] [0])))))))) in w425 ! [i436, i437, i438, i439, i440, i441, i442], let v426 = tconst (fromList [1] [0]) ; w427 = ttranspose [0,1,5,2,3,4] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (ttranspose [1,0] (treplicate 2 (treplicate 1 (tconst 2) * v426)) + treplicate 1 (tconst (fromList [2] [0,1])))))))) in w427 ! [i436, i437, i438, i439, i440, i441, i442]]) ; w461 = tgather [1,1,1,1,1,1,2,2] (tfromList [tgather [1,1,1,1,1,1,2,2] (w443 * w444) (\\[i445, i446, i447, i448, i449, i450, i451, i452] -> [i445, i446, i447, i448, i449, i450, i451, 2 * i448 + i452]), treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0))))))))]) (\\[i453, i454, i455, i456, i457, i458, i459, i460] -> [ifF ((0 <=. i453 + i457 &&* 1 >. i453 + i457) &&* ((0 <=. i454 + i458 &&* 1 >. i454 + i458) &&* ((0 <=. 2 * i455 + i459 &&* 2 >. 2 * i455 + i459) &&* (0 <=. 2 * i456 + i460 &&* 2 >. 2 * i456 + i460)))) 0 1, i453, i454, i455, i456, i457, i458, i459, i460]) ; t468 = ttranspose [1,0] (treplicate 1 (ttranspose [1,0] (treshape [1,1] (tgather [1,1,1,1] w461 (\\[i462, i463, i464, i465] -> [i462, i463, i464, i465, 0, 0, rem (quot (tmaxIndex (tgather [4] (w461 ! [i462, i463, i464, i465, 0, 0]) (\\[i466] -> [rem (quot i466 2) 2, rem i466 2]))) 2) 2, rem (tmaxIndex (tgather [4] (w461 ! [i462, i463, i464, i465, 0, 0]) (\\[i467] -> [rem (quot i467 2) 2, rem i467 2]))) 2]))))) ; m469 = tsum (ttranspose [2,1,0] (treplicate 1 m6) * t468) + ttranspose [1,0] (treplicate 1 v7) ; m472 = tgather [1,1] (tconst (fromList [2] [0.0,1.0])) (\\[i470, i471] -> [ifF (m469 ! [i470, i471] <=. tconst 0.0) 0 1]) ; t473 = ttranspose [1,0] (treplicate 10 (m472 * m469)) in tsum (ttranspose [2,1,0] (treplicate 1 m8) * t473) + ttranspose [1,0] (treplicate 1 v9)"
  printGradient6Pretty renames (simplifyArtifactRev artifactRev)
    @?= "\\dret u2 v3 u4 v5 m6 v7 m8 v9 -> let w353 = ttranspose [1,0] (treplicate 1 (tgather [1,4,4,1,1,2,2] (tfromList [treplicate 1 (treplicate 4 (treplicate 4 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 7.0))))))), treplicate 1 (treplicate 4 (treplicate 4 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0)))))))]) (\\[i339, i340, i341, i342, i343, i344, i345] -> [ifF ((0 <=. i339 + i342 &&* 1 >. i339 + i342) &&* ((0 <=. i343 &&* 1 >. i343) &&* ((0 <=. i340 + i344 &&* 4 >. i340 + i344) &&* (0 <=. i341 + i345 &&* 4 >. i341 + i345)))) 0 1, i339, i340, i341, i342, i343, i344, i345]))) ; w355 = treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (tsum (tgather [4,1,1,4,4] (w353 ! [0, 0] * tgather [4,4,1,1,2,2] (tfromList [treplicate 4 (treplicate 4 u2), treplicate 4 (treplicate 4 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0))))))]) (\\[i635, i636, i637, i638, i639, i640] -> [ifF ((0 <=. i637 &&* 1 >. i637) &&* ((0 <=. i638 &&* 1 >. i638) &&* ((0 <=. i639 &&* 2 >. i639) &&* (0 <=. i640 &&* 2 >. i640)))) 0 1, i635, i636, i637, i638, i639, i640])) (\\[i614, i615, i616, i617, i618] -> [rem (quot (i614 + 4 * i618 + 16 * i617 + 64 * i615 + 64 * i616) 16) 4, rem (quot (i614 + 4 * i618 + 16 * i617 + 64 * i615 + 64 * i616) 4) 4, 0, 0, rem (quot (i614 + 4 * i618 + 16 * i617 + 64 * i615 + 64 * i616) 2) 2, rem (i614 + 4 * i618 + 16 * i617 + 64 * i615 + 64 * i616) 2])) + ttranspose [0,3,1,2] (treplicate 1 (treplicate 4 (treplicate 4 v3)))))))))) ; w375 = tgather [1,1,2,2,1,1,2,4] (tconst (fromList [2] [0.0,1.0])) (\\[i360, i361, i362, i363, i364, i365, i366, i367] -> [ifF (w355 ! [i360, i361, i362, i363, i364, i365, i366, tconst (fromList [1] [0]) ! [i360] + tconst (fromList [1] [0]) ! [i364], tconst (fromList [1] [0]) ! [i361] + tconst (fromList [1] [0]) ! [i365], 2 * tconst (fromList [2] [0,1]) ! [i362] + tconst (fromList [2] [0,1]) ! [i366], i367] <=. tconst 0.0) 0 1]) ; w393 = treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (tgather [1,1,2,2,1,1,2,2] (tfromList [tgather [1,1,2,2,1,1,2,2] (w375 * tgather [1,1,2,2,1,1,2,4] w355 (\\[i368, i369, i370, i371, i372, i373, i374] -> [i368, i369, i370, i371, i372, i373, i374, tconst (fromList [1] [0]) ! [i368] + tconst (fromList [1] [0]) ! [i372], tconst (fromList [1] [0]) ! [i369] + tconst (fromList [1] [0]) ! [i373], 2 * tconst (fromList [2] [0,1]) ! [i370] + tconst (fromList [2] [0,1]) ! [i374]])) (\\[i377, i378, i379, i380, i381, i382, i383, i384] -> [i377, i378, i379, i380, i381, i382, i383, 2 * i380 + i384]), treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0))))))))]) (\\[i385, i386, i387, i388, i389, i390, i391, i392] -> [ifF ((0 <=. i385 + i389 &&* 1 >. i385 + i389) &&* ((0 <=. i386 + i390 &&* 1 >. i386 + i390) &&* ((0 <=. 2 * i387 + i391 &&* 4 >. 2 * i387 + i391) &&* (0 <=. 2 * i388 + i392 &&* 4 >. 2 * i388 + i392)))) 0 1, i385, i386, i387, i388, i389, i390, i391, i392]))))))) ; w421 = ttranspose [1,0] (treplicate 1 (tgather [1,2,2,1,1,2,2] (tfromList [tgather [1,2,2,1,1,2,2] w393 (\\[i396, i397, i398, i399, i400, i401, i402] -> [i396, i397, i398, i399, i400, i401, tconst (fromList [1] [0]) ! [i396] + tconst (fromList [1] [0]) ! [i399], i400, tconst (fromList [2] [0,1]) ! [i397] + tconst (fromList [2] [0,1]) ! [i401], i398 + i402, 0, 0, rem (quot (tmaxIndex (tgather [4] (w393 ! [i396, i397, i398, i399, i400, i401, tconst (fromList [1] [0]) ! [i396] + tconst (fromList [1] [0]) ! [i399], i400, tconst (fromList [2] [0,1]) ! [i397] + tconst (fromList [2] [0,1]) ! [i401], i398 + i402, 0, 0]) (\\[i404] -> [rem (quot i404 2) 2, rem i404 2]))) 2) 2, rem (tmaxIndex (tgather [4] (w393 ! [i396, i397, i398, i399, i400, i401, tconst (fromList [1] [0]) ! [i396] + tconst (fromList [1] [0]) ! [i399], i400, tconst (fromList [2] [0,1]) ! [i397] + tconst (fromList [2] [0,1]) ! [i401], i398 + i402, 0, 0]) (\\[i406] -> [rem (quot i406 2) 2, rem i406 2]))) 2]), treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0)))))))]) (\\[i407, i408, i409, i410, i411, i412, i413] -> [ifF ((0 <=. i407 + i410 &&* 1 >. i407 + i410) &&* ((0 <=. i411 &&* 1 >. i411) &&* ((0 <=. i408 + i412 &&* 2 >. i408 + i412) &&* (0 <=. i409 + i413 &&* 2 >. i409 + i413)))) 0 1, i407, i408, i409, i410, i411, i412, i413]))) ; w422 = ttranspose [0,3,1,2] (treplicate 1 (treplicate 2 (treplicate 2 (tgather [1,1,1,2,2] (tfromList [tgather [1,1,1,2,2] u4 (\\[i414, i415] -> [i414 + i415]), treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0)))))]) (\\[i416, i417, i418, i419, i420] -> [ifF ((0 <=. i416 + i417 &&* 1 >. i416 + i417) &&* ((0 <=. i418 &&* 1 >. i418) &&* ((0 <=. i419 &&* 2 >. i419) &&* (0 <=. i420 &&* 2 >. i420)))) 0 1, i416, i417, i418, i419, i420]))))) ; w423 = treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (tsum (tgather [4,1,1,2,2] (w421 ! [0, 0] * w422 ! [0, 0]) (\\[i604, i605, i606, i607, i608] -> [rem (quot (i604 + 4 * i608 + 8 * i607 + 16 * i605 + 16 * i606) 8) 2, rem (quot (i604 + 4 * i608 + 8 * i607 + 16 * i605 + 16 * i606) 4) 2, 0, 0, rem (quot (i604 + 4 * i608 + 8 * i607 + 16 * i605 + 16 * i606) 2) 2, rem (i604 + 4 * i608 + 8 * i607 + 16 * i605 + 16 * i606) 2])) + ttranspose [0,3,1,2] (treplicate 1 (treplicate 2 (treplicate 2 v5)))))))))) ; w443 = tgather [1,1,1,1,1,1,2,2] (tconst (fromList [2] [0.0,1.0])) (\\[i428, i429, i430, i431, i432, i433, i434, i435] -> [ifF (w423 ! [i428, i429, i430, i431, i432, i433, i434, tconst (fromList [1] [0]) ! [i428] + tconst (fromList [1] [0]) ! [i432], tconst (fromList [1] [0]) ! [i429] + tconst (fromList [1] [0]) ! [i433], 2 * tconst (fromList [1] [0]) ! [i430] + tconst (fromList [2] [0,1]) ! [i434], i435] <=. tconst 0.0) 0 1]) ; w461 = tgather [1,1,1,1,1,1,2,2] (tfromList [tgather [1,1,1,1,1,1,2,2] (w443 * tgather [1,1,1,1,1,1,2,2] w423 (\\[i436, i437, i438, i439, i440, i441, i442] -> [i436, i437, i438, i439, i440, i441, i442, tconst (fromList [1] [0]) ! [i436] + tconst (fromList [1] [0]) ! [i440], tconst (fromList [1] [0]) ! [i437] + tconst (fromList [1] [0]) ! [i441], 2 * tconst (fromList [1] [0]) ! [i438] + tconst (fromList [2] [0,1]) ! [i442]])) (\\[i445, i446, i447, i448, i449, i450, i451, i452] -> [i445, i446, i447, i448, i449, i450, i451, 2 * i448 + i452]), treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0))))))))]) (\\[i453, i454, i455, i456, i457, i458, i459, i460] -> [ifF ((0 <=. i453 + i457 &&* 1 >. i453 + i457) &&* ((0 <=. i454 + i458 &&* 1 >. i454 + i458) &&* ((0 <=. 2 * i455 + i459 &&* 2 >. 2 * i455 + i459) &&* (0 <=. 2 * i456 + i460 &&* 2 >. 2 * i456 + i460)))) 0 1, i453, i454, i455, i456, i457, i458, i459, i460]) ; t468 = ttranspose [2,0,1] (treplicate 1 (treplicate 1 (treplicate 1 (w461 ! [0, 0, 0, 0, 0, 0, rem (quot (tmaxIndex (tgather [4] (w461 ! [0, 0, 0, 0, 0, 0]) (\\[i466] -> [rem (quot i466 2) 2, rem i466 2]))) 2) 2, rem (tmaxIndex (tgather [4] (w461 ! [0, 0, 0, 0, 0, 0]) (\\[i467] -> [rem (quot i467 2) 2, rem i467 2]))) 2])))) ; m469 = tsum (ttranspose [2,1,0] (treplicate 1 m6) * t468) + ttranspose [1,0] (treplicate 1 v7) ; m472 = tgather [1,1] (tconst (fromList [2] [0.0,1.0])) (\\[i470, i471] -> [ifF (m469 ! [i470, i471] <=. tconst 0.0) 0 1]) ; m474 = m472 * tsum (ttranspose [1,2,0] (treplicate 1 m8) * ttranspose [1,0] (treplicate 1 dret)) ; u505 = tscatter [1,1,2,2] (w443 * tscatter [1,1,1,1,1,1,2,2] (tscatter [2,1,1,1,1,1,1,2,2] (tscatter [1,1,1,1,1,1,2,2] (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (tsum (tgather [1] (m6 * tgather [1,1] m474 (\\[i598, i599] -> [i598, 0])) (\\[i601] -> [i601, 0]))))))) (\\[i475, i476, i477, i478] -> [i475, i476, i477, i478, 0, 0, rem (quot (tmaxIndex (tgather [4] (w461 ! [i475, i476, i477, i478, 0, 0]) (\\[i479] -> [rem (quot i479 2) 2, rem i479 2]))) 2) 2, rem (tmaxIndex (tgather [4] (w461 ! [i475, i476, i477, i478, 0, 0]) (\\[i480] -> [rem (quot i480 2) 2, rem i480 2]))) 2])) (\\[i481, i482, i483, i484, i485, i486, i487, i488] -> [ifF ((0 <=. i481 + i485 &&* 1 >. i481 + i485) &&* ((0 <=. i482 + i486 &&* 1 >. i482 + i486) &&* ((0 <=. 2 * i483 + i487 &&* 2 >. 2 * i483 + i487) &&* (0 <=. 2 * i484 + i488 &&* 2 >. 2 * i484 + i488)))) 0 1, i481, i482, i483, i484, i485, i486, i487, i488]) ! [0]) (\\[i490, i491, i492, i493, i494, i495, i496, i497] -> [i490, i491, i492, i493, i494, i495, i496, 2 * i493 + i497])) (\\[i498, i499, i500, i501, i502, i503, i504] -> [tconst (fromList [1] [0]) ! [i498] + tconst (fromList [1] [0]) ! [i502], tconst (fromList [1] [0]) ! [i499] + tconst (fromList [1] [0]) ! [i503], 2 * tconst (fromList [1] [0]) ! [i500] + tconst (fromList [2] [0,1]) ! [i504]]) ; w506 = tgather [1,1,2,2,1,1,2,2] (u505 ! [0, 0]) (\\[i580, i581, i582, i583, i584, i585, i586, i587] -> [rem (quot (i587 + 2 * i586 + 4 * i585 + 4 * i584 + 4 * i583 + 8 * i582 + 16 * i580 + 16 * i581) 8) 2, rem (quot (i587 + 2 * i586 + 4 * i585 + 4 * i584 + 4 * i583 + 8 * i582 + 16 * i580 + 16 * i581) 4) 2]) ; u558 = tscatter [1,1,4,4] (w375 * tscatter [1,1,2,2,1,1,2,4] (tscatter [2,1,1,2,2,1,1,2,2] (tscatter [1,1,2,2,1,1,2,2] (tscatter [2,1,2,2,1,1,2,2] (tsum (ttranspose [1,0] (w422 * w506))) (\\[i515, i516, i517, i518, i519, i520, i521] -> [ifF ((0 <=. i515 + i518 &&* 1 >. i515 + i518) &&* ((0 <=. i519 &&* 1 >. i519) &&* ((0 <=. i516 + i520 &&* 2 >. i516 + i520) &&* (0 <=. i517 + i521 &&* 2 >. i517 + i521)))) 0 1, i515, i516, i517, i518, i519, i520, i521]) ! [0]) (\\[i523, i524, i525, i526, i527, i528, i529] -> [tconst (fromList [1] [0]) ! [i523] + tconst (fromList [1] [0]) ! [i526], i527, tconst (fromList [2] [0,1]) ! [i524] + tconst (fromList [2] [0,1]) ! [i528], i525 + i529, 0, 0, rem (quot (tmaxIndex (tgather [4] (w393 ! [i523, i524, i525, i526, i527, i528, tconst (fromList [1] [0]) ! [i523] + tconst (fromList [1] [0]) ! [i526], i527, tconst (fromList [2] [0,1]) ! [i524] + tconst (fromList [2] [0,1]) ! [i528], i525 + i529, 0, 0]) (\\[i531] -> [rem (quot i531 2) 2, rem i531 2]))) 2) 2, rem (tmaxIndex (tgather [4] (w393 ! [i523, i524, i525, i526, i527, i528, tconst (fromList [1] [0]) ! [i523] + tconst (fromList [1] [0]) ! [i526], i527, tconst (fromList [2] [0,1]) ! [i524] + tconst (fromList [2] [0,1]) ! [i528], i525 + i529, 0, 0]) (\\[i533] -> [rem (quot i533 2) 2, rem i533 2]))) 2])) (\\[i534, i535, i536, i537, i538, i539, i540, i541] -> [ifF ((0 <=. i534 + i538 &&* 1 >. i534 + i538) &&* ((0 <=. i535 + i539 &&* 1 >. i535 + i539) &&* ((0 <=. 2 * i536 + i540 &&* 4 >. 2 * i536 + i540) &&* (0 <=. 2 * i537 + i541 &&* 4 >. 2 * i537 + i541)))) 0 1, i534, i535, i536, i537, i538, i539, i540, i541]) ! [0]) (\\[i543, i544, i545, i546, i547, i548, i549, i550] -> [i543, i544, i545, i546, i547, i548, i549, 2 * i546 + i550])) (\\[i551, i552, i553, i554, i555, i556, i557] -> [tconst (fromList [1] [0]) ! [i551] + tconst (fromList [1] [0]) ! [i555], tconst (fromList [1] [0]) ! [i552] + tconst (fromList [1] [0]) ! [i556], 2 * tconst (fromList [2] [0,1]) ! [i553] + tconst (fromList [2] [0,1]) ! [i557]]) in (tscatter [1,1,2,2] (tscatter [2,1,1,1,2,2] (tsum (tsum (tsum (ttranspose [0,2,3,1] (w353 * tgather [1,1,4,4,1,1,2,2] (u558 ! [0, 0]) (\\[i567, i568, i569, i570, i571, i572, i573, i574] -> [rem (quot (i574 + 2 * i573 + 4 * i572 + 4 * i571 + 4 * i570 + 16 * i569 + 64 * i567 + 64 * i568) 16) 4, rem (quot (i574 + 2 * i573 + 4 * i572 + 4 * i571 + 4 * i570 + 16 * i569 + 64 * i567 + 64 * i568) 4) 4])))))) (\\[i559, i560, i561, i562, i563] -> [ifF ((0 <=. i559 + i560 &&* 1 >. i559 + i560) &&* ((0 <=. i561 &&* 1 >. i561) &&* ((0 <=. i562 &&* 2 >. i562) &&* (0 <=. i563 &&* 2 >. i563)))) 0 1, i559, i560, i561, i562, i563]) ! [0]) (\\[i565, i566] -> [i565 + i566]), tsum (tsum (tsum (ttranspose [0,2,3,1] u558))), tscatter [1,1,2,2] (tscatter [2,1,1,1,2,2] (tsum (tsum (tsum (ttranspose [0,2,3,1] (w421 * w506))))) (\\[i507, i508, i509, i510, i511] -> [ifF ((0 <=. i507 + i508 &&* 1 >. i507 + i508) &&* ((0 <=. i509 &&* 1 >. i509) &&* ((0 <=. i510 &&* 2 >. i510) &&* (0 <=. i511 &&* 2 >. i511)))) 0 1, i507, i508, i509, i510, i511]) ! [0]) (\\[i513, i514] -> [i513 + i514]), tsum (tsum (tsum (ttranspose [0,2,3,1] u505))), tsum (ttranspose [2,1,0] (t468 * treplicate 1 m474)), tsum (ttranspose [1,0] m474), tsum (ttranspose [2,0,1] (treplicate 10 (m472 * m469)) * ttranspose [2,1,0] (treplicate 1 dret)), tsum (ttranspose [1,0] dret))"
  printPrimal6Pretty renames (simplifyArtifactRev artifactRev)
    @?= "\\u2 v3 u4 v5 m6 v7 m8 v9 -> let w355 = treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (tsum (tgather [4,1,1,4,4] (tgather [4,4,1,1,2,2] (tfromList [treplicate 4 (treplicate 4 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 7.0)))))), treplicate 4 (treplicate 4 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0))))))]) (\\[i703, i704, i705, i706, i707, i708] -> [ifF ((0 <=. i705 &&* 1 >. i705) &&* ((0 <=. i706 &&* 1 >. i706) &&* ((0 <=. i703 + i707 &&* 4 >. i703 + i707) &&* (0 <=. i704 + i708 &&* 4 >. i704 + i708)))) 0 1, i703, i704, i705, i706, i707, i708]) * tgather [4,4,1,1,2,2] (tfromList [treplicate 4 (treplicate 4 u2), treplicate 4 (treplicate 4 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0))))))]) (\\[i697, i698, i699, i700, i701, i702] -> [ifF ((0 <=. i699 &&* 1 >. i699) &&* ((0 <=. i700 &&* 1 >. i700) &&* ((0 <=. i701 &&* 2 >. i701) &&* (0 <=. i702 &&* 2 >. i702)))) 0 1, i697, i698, i699, i700, i701, i702])) (\\[i641, i642, i643, i644, i645] -> [rem (quot (i641 + 4 * i645 + 16 * i644 + 64 * i642 + 64 * i643) 16) 4, rem (quot (i641 + 4 * i645 + 16 * i644 + 64 * i642 + 64 * i643) 4) 4, 0, 0, rem (quot (i641 + 4 * i645 + 16 * i644 + 64 * i642 + 64 * i643) 2) 2, rem (i641 + 4 * i645 + 16 * i644 + 64 * i642 + 64 * i643) 2])) + ttranspose [0,3,1,2] (treplicate 1 (treplicate 4 (treplicate 4 v3)))))))))) ; w393 = treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (tgather [1,1,2,2,1,1,2,2] (tfromList [tgather [1,1,2,2,1,1,2,2] (tgather [1,1,2,2,1,1,2,4] (tconst (fromList [2] [0.0,1.0])) (\\[i360, i361, i362, i363, i364, i365, i366, i367] -> [ifF (w355 ! [i360, i361, i362, i363, i364, i365, i366, tconst (fromList [1] [0]) ! [i360] + tconst (fromList [1] [0]) ! [i364], tconst (fromList [1] [0]) ! [i361] + tconst (fromList [1] [0]) ! [i365], 2 * tconst (fromList [2] [0,1]) ! [i362] + tconst (fromList [2] [0,1]) ! [i366], i367] <=. tconst 0.0) 0 1]) * tgather [1,1,2,2,1,1,2,4] w355 (\\[i368, i369, i370, i371, i372, i373, i374] -> [i368, i369, i370, i371, i372, i373, i374, tconst (fromList [1] [0]) ! [i368] + tconst (fromList [1] [0]) ! [i372], tconst (fromList [1] [0]) ! [i369] + tconst (fromList [1] [0]) ! [i373], 2 * tconst (fromList [2] [0,1]) ! [i370] + tconst (fromList [2] [0,1]) ! [i374]])) (\\[i377, i378, i379, i380, i381, i382, i383, i384] -> [i377, i378, i379, i380, i381, i382, i383, 2 * i380 + i384]), treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0))))))))]) (\\[i385, i386, i387, i388, i389, i390, i391, i392] -> [ifF ((0 <=. i385 + i389 &&* 1 >. i385 + i389) &&* ((0 <=. i386 + i390 &&* 1 >. i386 + i390) &&* ((0 <=. 2 * i387 + i391 &&* 4 >. 2 * i387 + i391) &&* (0 <=. 2 * i388 + i392 &&* 4 >. 2 * i388 + i392)))) 0 1, i385, i386, i387, i388, i389, i390, i391, i392]))))))) ; w423 = treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (tsum (tgather [4,1,1,2,2] (tgather [2,2,1,1,2,2] (tfromList [tgather [2,2,1,1,2,2] (w393 ! [0]) (\\[i397, i398, i399, i400, i401, i402] -> [i397, i398, i399, i400, i401, tconst (fromList [1] [0]) ! [i399], i400, tconst (fromList [2] [0,1]) ! [i397] + tconst (fromList [2] [0,1]) ! [i401], i398 + i402, 0, 0, rem (quot (tmaxIndex (tgather [4] (w393 ! [0, i397, i398, i399, i400, i401, tconst (fromList [1] [0]) ! [i399], i400, tconst (fromList [2] [0,1]) ! [i397] + tconst (fromList [2] [0,1]) ! [i401], i398 + i402, 0, 0]) (\\[i404] -> [rem (quot i404 2) 2, rem i404 2]))) 2) 2, rem (tmaxIndex (tgather [4] (w393 ! [0, i397, i398, i399, i400, i401, tconst (fromList [1] [0]) ! [i399], i400, tconst (fromList [2] [0,1]) ! [i397] + tconst (fromList [2] [0,1]) ! [i401], i398 + i402, 0, 0]) (\\[i406] -> [rem (quot i406 2) 2, rem i406 2]))) 2]), treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0))))))]) (\\[i680, i681, i682, i683, i684, i685] -> [ifF ((0 <=. i682 &&* 1 >. i682) &&* ((0 <=. i683 &&* 1 >. i683) &&* ((0 <=. i680 + i684 &&* 2 >. i680 + i684) &&* (0 <=. i681 + i685 &&* 2 >. i681 + i685)))) 0 1, i680, i681, i682, i683, i684, i685]) * tgather [2,2,1,1,2,2] (tfromList [treplicate 2 (treplicate 2 u4), treplicate 2 (treplicate 2 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0))))))]) (\\[i674, i675, i676, i677, i678, i679] -> [ifF ((0 <=. i676 &&* 1 >. i676) &&* ((0 <=. i677 &&* 1 >. i677) &&* ((0 <=. i678 &&* 2 >. i678) &&* (0 <=. i679 &&* 2 >. i679)))) 0 1, i674, i675, i676, i677, i678, i679])) (\\[i651, i652, i653, i654, i655] -> [rem (quot (i651 + 4 * i655 + 8 * i654 + 16 * i652 + 16 * i653) 8) 2, rem (quot (i651 + 4 * i655 + 8 * i654 + 16 * i652 + 16 * i653) 4) 2, 0, 0, rem (quot (i651 + 4 * i655 + 8 * i654 + 16 * i652 + 16 * i653) 2) 2, rem (i651 + 4 * i655 + 8 * i654 + 16 * i652 + 16 * i653) 2])) + ttranspose [0,3,1,2] (treplicate 1 (treplicate 2 (treplicate 2 v5)))))))))) ; w461 = tgather [1,1,1,1,1,1,2,2] (tfromList [tgather [1,1,1,1,1,1,2,2] (tgather [1,1,1,1,1,1,2,2] (tconst (fromList [2] [0.0,1.0])) (\\[i428, i429, i430, i431, i432, i433, i434, i435] -> [ifF (w423 ! [i428, i429, i430, i431, i432, i433, i434, tconst (fromList [1] [0]) ! [i428] + tconst (fromList [1] [0]) ! [i432], tconst (fromList [1] [0]) ! [i429] + tconst (fromList [1] [0]) ! [i433], 2 * tconst (fromList [1] [0]) ! [i430] + tconst (fromList [2] [0,1]) ! [i434], i435] <=. tconst 0.0) 0 1]) * tgather [1,1,1,1,1,1,2,2] w423 (\\[i436, i437, i438, i439, i440, i441, i442] -> [i436, i437, i438, i439, i440, i441, i442, tconst (fromList [1] [0]) ! [i436] + tconst (fromList [1] [0]) ! [i440], tconst (fromList [1] [0]) ! [i437] + tconst (fromList [1] [0]) ! [i441], 2 * tconst (fromList [1] [0]) ! [i438] + tconst (fromList [2] [0,1]) ! [i442]])) (\\[i445, i446, i447, i448, i449, i450, i451, i452] -> [i445, i446, i447, i448, i449, i450, i451, 2 * i448 + i452]), treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 1 (treplicate 2 (treplicate 2 (tconst 0.0))))))))]) (\\[i453, i454, i455, i456, i457, i458, i459, i460] -> [ifF ((0 <=. i453 + i457 &&* 1 >. i453 + i457) &&* ((0 <=. i454 + i458 &&* 1 >. i454 + i458) &&* ((0 <=. 2 * i455 + i459 &&* 2 >. 2 * i455 + i459) &&* (0 <=. 2 * i456 + i460 &&* 2 >. 2 * i456 + i460)))) 0 1, i453, i454, i455, i456, i457, i458, i459, i460]) ; m469 = tsum (ttranspose [2,1,0] (treplicate 1 m6) * ttranspose [2,0,1] (treplicate 1 (treplicate 1 (treplicate 1 (w461 ! [0, 0, 0, 0, 0, 0, rem (quot (tmaxIndex (tgather [4] (w461 ! [0, 0, 0, 0, 0, 0]) (\\[i466] -> [rem (quot i466 2) 2, rem i466 2]))) 2) 2, rem (tmaxIndex (tgather [4] (w461 ! [0, 0, 0, 0, 0, 0]) (\\[i467] -> [rem (quot i467 2) 2, rem i467 2]))) 2]))))) + ttranspose [1,0] (treplicate 1 v7) in tsum (ttranspose [2,1,0] (treplicate 1 m8) * ttranspose [1,0] (treplicate 10 (tgather [1,1] (tconst (fromList [2] [0.0,1.0])) (\\[i470, i471] -> [ifF (m469 ! [i470, i471] <=. tconst 0.0) 0 1]) * m469))) + ttranspose [1,0] (treplicate 1 v9)"
