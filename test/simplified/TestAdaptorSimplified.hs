...
testFooPP = do
  ...
  resetVarCounter
  let artifact6 = revDtFun fooT (4, 5, 6)
...
testFooLetPP = do
  ...
  resetVarCounter
  let artifact6 = revDtFun fooLetT (4, 5, 6)
  printGradient6Simple renames artifact6
...
testReluPP = do
  ...
  resetVarCounter
  let artifact6 = revDtFun reluT (OR.constant [3, 4] 4)
  printGradient6Simple renames artifact6
...
testReluPP2 = do
  ...
  resetVarCounter
  let artifact6 = revDtFun reluT2 ((OR.constant [5] 128), 42)
...
fblowupPP = do
  ...
  let artifact6 = revDtFun fblowupT (OR.constant [4] 4)
  length (printGradient6Simple renames artifact6)
...
fblowupLetPP = do
  ...
  let artifact6 = revDtFun fblowupLetT (OR.constant [4] 4)
  length (printGradient6Simple renames artifact6)
