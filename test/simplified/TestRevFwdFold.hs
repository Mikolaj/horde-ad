...
testSin0Scan1RevPP1 = do
  ...
  printAstPrettyButNested IM.empty (simplifyInlineAst a1)
    @?= "let v29 = rconst (rfromListLinear [2] [42.0,42.0]) ; v14 = rconst (rfromListLinear [3] [1.0,1.0,1.0]) in rproject (dmapAccumRDer (SNat @2) (\\h31 -> [cos (rproject (tproject2 h31) 1) * (rproject (tproject2 h31) 0 + rproject (tproject1 h31) 0), 0]) (\\h63 -> [(rproject (tproject1 h63) 2 * negate (sin (rproject (tproject2 h63) 2))) * (rproject (tproject2 h63) 1 + rproject (tproject2 h63) 0) + (rproject (tproject1 h63) 1 + rproject (tproject1 h63) 0) * cos (rproject (tproject2 h63) 2), 0.0]) (\\h116 -> let x145 = cos (rproject (tproject2 h116) 2) * rproject (tproject1 h116) 0 in [x145, x145, negate (sin (rproject (tproject2 h116) 2)) * ((rproject (tproject2 h116) 1 + rproject (tproject2 h116) 0) * rproject (tproject1 h116) 0), 0]) [0.0] [rslice 1 2 v14, rproject (dmapAccumLDer (SNat @2) (\\h160 -> let x172 = sin (rproject (tproject1 h160) 0) in [x172, rproject (tproject1 h160) 0, x172]) (\\h174 -> let x197 = rproject (tproject1 h174) 0 * cos (rproject (tproject2 h174) 0) in [x197, rproject (tproject1 h174) 0, x197]) (\\h200 -> [cos (rproject (tproject2 h200) 0) * (rproject (tproject1 h200) 2 + rproject (tproject1 h200) 0) + rproject (tproject1 h200) 1, 0.0]) [1.1] [v29]) 1, v29]) 0 + v14 ! [0]"
...
testSin0ScanFwdPP = do
  ...
  let a1 = rfwd1 @(AstRanked PrimalSpan) @Double @0 @1
                 (\x0 -> rscan (\x _a -> sin x) x0
                           ((rrepl @Double @1 [2] 42))) (rscalar 1.1)
  printAstPrettyButNested IM.empty (simplifyInlineAst a1)
    @?= "let v11 = rconst (rfromListLinear [2] [42.0,42.0]) in rappend (rreplicate 1 1.0) (rproject (dmapAccumLDer (SNat @2) (\\h12 -> let x31 = rproject (tproject1 h12) 0 * cos (rproject (tproject2 h12) 1) in [x31, x31]) (\\h36 -> let x57 = rproject (tproject1 h36) 0 * cos (rproject (tproject2 h36) 2) + (rproject (tproject1 h36) 2 * negate (sin (rproject (tproject2 h36) 2))) * rproject (tproject2 h36) 0 in [x57, x57]) (\\h58 -> let x78 = rproject (tproject1 h58) 1 + rproject (tproject1 h58) 0 in [cos (rproject (tproject2 h58) 2) * x78, 0, negate (sin (rproject (tproject2 h58) 2)) * (rproject (tproject2 h58) 0 * x78), 0]) [1.0] [rreplicate 2 0.0, rproject (dmapAccumLDer (SNat @2) (\\h79 -> let x86 = sin (rproject (tproject1 h79) 0) in [x86, rproject (tproject1 h79) 0, x86]) (\\h89 -> let x96 = rproject (tproject1 h89) 0 * cos (rproject (tproject2 h89) 0) in [x96, rproject (tproject1 h89) 0, x96]) (\\h99 -> [cos (rproject (tproject2 h99) 0) * (rproject (tproject1 h99) 2 + rproject (tproject1 h99) 0) + rproject (tproject1 h99) 1, 0.0]) [1.1] [v11]) 1, v11]) 1)"
...
testSin0ScanFwdPPFull = do
  ...
  let a1 = rfwd1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscan (\x _a -> sin x) x0
                           ((rrepl @Double @1 [2] 42))) (rscalar 1.1)
  printAstPrettyButNested IM.empty (simplifyInlineAst a1)
    @?= "rproject ((\\h1 -> let v11 = rconst (rfromListLinear [2] [42.0,42.0]) in [rappend (rreplicate 1 (rproject (tproject1 h1) 0)) (rproject (dmapAccumLDer (SNat @2) (\\h12 -> let x31 = rproject (tproject1 h12) 0 * cos (rproject (tproject2 h12) 1) in [x31, x31]) (\\h36 -> let x57 = rproject (tproject1 h36) 0 * cos (rproject (tproject2 h36) 2) + (rproject (tproject1 h36) 2 * negate (sin (rproject (tproject2 h36) 2))) * rproject (tproject2 h36) 0 in [x57, x57]) (\\h58 -> let x78 = rproject (tproject1 h58) 1 + rproject (tproject1 h58) 0 in [cos (rproject (tproject2 h58) 2) * x78, 0, negate (sin (rproject (tproject2 h58) 2)) * (rproject (tproject2 h58) 0 * x78), 0]) [rproject (tproject1 h1) 0] [rreplicate 2 0.0, rproject (dmapAccumLDer (SNat @2) (\\h79 -> let x86 = sin (rproject (tproject1 h79) 0) in [x86, rproject (tproject1 h79) 0, x86]) (\\h89 -> let x96 = rproject (tproject1 h89) 0 * cos (rproject (tproject2 h89) 0) in [x96, rproject (tproject1 h89) 0, x96]) (\\h99 -> [cos (rproject (tproject2 h99) 0) * (rproject (tproject1 h99) 2 + rproject (tproject1 h99) 0) + rproject (tproject1 h99) 1, 0.0]) [rproject (tproject2 h1) 0] [v11]) 1, v11]) 1)]) (ttuple ([1.0], [1.1]))) 0"
...
testSin0Scan1Rev2PP1 = do
  ...
  printAstPretty IM.empty (simplifyInlineAst a1)
    @?= "let v29 = rconst (rfromListLinear [2] [5.0,7.0]) ; v14 = rconst (rfromListLinear [3] [1.0,1.0,1.0]) in rproject (dmapAccumRDer (SNat @2) <lambda> <lambda> <lambda> [0.0] [rslice 1 2 v14, rproject (dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [v29]) 1, v29]) 0 + v14 ! [0]"
...
testSin0Scan1Rev2PPA = do
  ...
  printArtifactPretty IM.empty (simplifyArtifact art)
    @?= "\\v7 x14 -> let v12 = rconst (rfromListLinear [2] [5.0,7.0]) in [rproject (dmapAccumRDer (SNat @2) <lambda> <lambda> <lambda> [0.0] [rslice 1 2 v7, rproject (dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [x14] [v12]) 1, v12]) 0 + v7 ! [0]]"
...
testSin0Scan1Rev3PP = do
  ...
  printAstPretty IM.empty (simplifyInlineAst a1)
    @?= "let v34 = rfromVector (fromList [1.1 * 5.0, 1.1 * 7.0]) ; v17 = rconst (rfromListLinear [3] [1.0,1.0,1.0]) ; h27 = dmapAccumRDer (SNat @2) <lambda> <lambda> <lambda> [0.0] [rslice 1 2 v17, rproject (dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [v34]) 1, v34] in 5.0 * rproject h27 1 ! [0] + 7.0 * rproject h27 1 ! [1] + rproject h27 0 + v17 ! [0]"
...
testSin0ScanFwd3PP = do
  ...
  let a1 = rfwd1 @(AstRanked PrimalSpan) @Double @0 @1
                 (\x0 -> rscan (\x a -> sin x - a) x0
                           (rfromList [x0 * 5, x0 * 7])) (rscalar 1.1)
  printAstPretty IM.empty (simplifyInlineAst a1)
    @?= "let v14 = rfromVector (fromList [1.1 * 5.0, 1.1 * 7.0]) in rappend (rreplicate 1 1.0) (rproject (dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.0] [rfromVector (fromList [1.0 * 5.0, 1.0 * 7.0]), rproject (dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [v14]) 1, v14]) 1)"
...
testSin0rmapAccumRD01SN531b0PP = do
  ...
  printAstHVectorPrettyButNested
    ...
    @?= "[rfromS (sproject (dmapAccumLDer (SNat @0) (\\h19 -> [sproject (tproject1 h19) 0, 0]) (\\h34 -> [sproject (tproject1 h34) 0, 0.0]) (\\h48 -> [sproject (tproject1 h48) 0, 0, 0]) [4.0] [sproject (dmapAccumRDer (SNat @0) (\\h61 -> [sproject (tproject1 h61) 0, sproject (tproject1 h61) 0]) (\\h71 -> [sproject (tproject1 h71) 0, sproject (tproject1 h71) 0]) (\\h87 -> [0.0 + sproject (tproject1 h87) 1 + sproject (tproject1 h87) 0, 0.0]) [1.1] [rconst (rfromListLinear [0] [])]) 1, rconst (rfromListLinear [0] [])]) 0)]"
...
testSin0rmapAccumRD01SN531b0PPj = do
  ...
  printAstHVectorPretty
    ...
    (simplifyInline
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 (rscalar 1.1)))
    @?= "[rfromS (ssum (ssum (sproject (dmapAccumLDer (SNat @0) <lambda> <lambda> <lambda> [sscatter (sconst @[2,2] (sfromListLinear [2,2] [1.0,1.0,1.0,1.0])) (\\[i20] -> [i20])] [sproject (dmapAccumRDer (SNat @0) <lambda> <lambda> <lambda> [sfromIntegral (sfromR (rtranspose [1,0] (rreplicate 2 (rconst (rfromListLinear [2] [0,1]))) + rreplicate 2 (rconst (rfromListLinear [2] [0,1])))) + sreplicate (sreplicate 1.1) + sconst @[2,2] (sfromListLinear [2,2] [0.0,0.0,0.0,0.0]) + sconst @[2,2] (sfromListLinear [2,2] [0.0,0.0,0.0,0.0])] [rtranspose [2,0,1] (rreplicate 2 (rreplicate 2 (rconst (rfromListLinear [0] []))))]) 1, rtranspose [2,0,1] (rreplicate 2 (rreplicate 2 (rconst (rfromListLinear [0] []))))]) 0)))]"
...
testSin0rmapAccumRD01SN531bRPPj = do
  ...
  printAstHVectorPretty
    ...
    (simplifyInline
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 (rscalar 1.1)))
    @?= "[rsum (rgather [4] (rproject (dmapAccumLDer (SNat @1) <lambda> <lambda> <lambda> [rconst (rfromListLinear [2,2] [1.0,1.0,1.0,1.0])] [rproject (dmapAccumRDer (SNat @1) <lambda> <lambda> <lambda> [rfromIntegral (rtranspose [1,0] (rreplicate 2 (rconst (rfromListLinear [2] [0,1]))) + rreplicate 2 (rconst (rfromListLinear [2] [0,1]))) + rreplicate 2 (rreplicate 2 1.1)] [rtranspose [2,0,1] (rreplicate 2 (rreplicate 2 (rconst (rfromListLinear [1] [0.0]))))]) 1, rtranspose [2,0,1] (rreplicate 2 (rreplicate 2 (rconst (rfromListLinear [1] [0.0]))))]) 0) (\\[i25] -> [remF (quotF i25 2) 2, remF i25 2]))]"
  ...
  let a1 = rrev1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x _a -> sin x)
                           ...
                           x0 (V.singleton $ DynamicRanked
                               $ (rrepl @Double @1 [2] 42))) (rscalar 1.1)
  printAstPretty IM.empty (simplifyInlineAst a1)
    @?= "let v29 = rconst (rfromListLinear [2] [42.0,42.0]) ; v14 = rconst (rfromListLinear [3] [1.0,1.0,1.0]) in rproject (dmapAccumRDer (SNat @2) <lambda> <lambda> <lambda> [0.0] [rslice 1 2 v14, rproject (dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [v29]) 1, v29]) 0 + v14 ! [0]"
  ...
  let a1 = rfwd1 @(AstRanked PrimalSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x _a -> sin x)
                           ...
                           x0 (V.singleton $ DynamicRanked
                               $ (rrepl @Double @1 [2] 42))) (rscalar 1.1)
  printAstPretty IM.empty (simplifyInlineAst a1)
    @?= "let v11 = rconst (rfromListLinear [2] [42.0,42.0]) in rappend (rreplicate 1 1.0) (rproject (dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.0] [rreplicate 2 0.0, rproject (dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [v11]) 1, v11]) 1)"
...
testSin0ScanDFwd2PP = do
  ...
  let a1 = rfwd1 @(AstRanked PrimalSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x a -> sin x - rfromD (a V.! 0))
                         ...
                         $ rconst (Nested.Internal.rfromListPrimLinear @Double @1 (fromList [2]) [5, 7]))) (rscalar 1.1)
  printAstPretty IM.empty (simplifyInlineAst a1)
    @?= "let v11 = rconst (rfromListLinear [2] [5.0,7.0]) in rappend (rreplicate 1 1.0) (rproject (dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.0] [rreplicate 2 0.0, rproject (dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [v11]) 1, v11]) 1)"
...
testSin0FoldNestedR1SimpNestedPP = do
  ...
  printAstHVectorPrettyButNested
    ...
    (simplifyInline
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 (rscalar 1.1)))
    @?= "let h13 = dmapAccumRDer (SNat @11) (\\h18 -> let h57 = dmapAccumRDer (SNat @22) (\\h62 -> let x89 = cos (rproject (tproject2 h62) 1) in [rproject (tproject1 h62) 0, recip (x89 * x89) * rproject (tproject1 h62) 0]) (\\h92 -> let x139 = cos (rproject (tproject2 h92) 2) ; x140 = x139 * x139 ; x147 = rproject (tproject1 h92) 2 * negate (sin (rproject (tproject2 h92) 2)) in [rproject (tproject1 h92) 0, ((x147 * x139 + x147 * x139) * negate (recip (x140 * x140))) * rproject (tproject2 h92) 0 + rproject (tproject1 h92) 0 * recip x140]) (\\h157 -> let x198 = cos (rproject (tproject2 h157) 2) ; x199 = x198 * x198 ; x205 = negate (recip (x199 * x199)) * (rproject (tproject2 h157) 0 * rproject (tproject1 h157) 1) in [recip x199 * rproject (tproject1 h157) 1 + rproject (tproject1 h157) 0, 0, negate (sin (rproject (tproject2 h157) 2)) * (x198 * x205 + x198 * x205)]) [rproject (tproject1 h18) 0] [rproject (dmapAccumLDer (SNat @22) (\\h213 -> [rproject (tproject1 h213) 0 + tan (rproject (tproject2 h213) 0), rproject (tproject1 h213) 0]) (\\h229 -> let x261 = cos (rproject (tproject2 h229) 1) in [rproject (tproject1 h229) 0 + rproject (tproject1 h229) 1 * recip (x261 * x261), rproject (tproject1 h229) 0]) (\\h268 -> let x291 = cos (rproject (tproject2 h268) 1) in [rproject (tproject1 h268) 0 + rproject (tproject1 h268) 1, recip (x291 * x291) * rproject (tproject1 h268) 0]) [rproject (tproject2 h18) 1] [rreplicate 22 (rproject (tproject2 h18) 0)]) 1, rreplicate 22 (rproject (tproject2 h18) 0)] in [rsum (rproject h57 1), rproject h57 0]) (\\h298 -> let h337 = dmapAccumLDer (SNat @22) (\\h381 -> [rproject (tproject1 h381) 0 + tan (rproject (tproject2 h381) 0), rproject (tproject1 h381) 0, rproject (tproject1 h381) 0]) (\\h397 -> let x424 = cos (rproject (tproject2 h397) 1) in [rproject (tproject1 h397) 0 + rproject (tproject1 h397) 1 * recip (x424 * x424), rproject (tproject1 h397) 0, rproject (tproject1 h397) 0]) (\\h433 -> let x461 = cos (rproject (tproject2 h433) 1) in [rproject (tproject1 h433) 1 + rproject (tproject1 h433) 0 + rproject (tproject1 h433) 2, recip (x461 * x461) * rproject (tproject1 h433) 0]) [rproject (tproject2 h298) 2] [rreplicate 22 (rproject (tproject2 h298) 1)] ; h376 = dmapAccumRDer (SNat @22) (\\h474 -> let x530 = cos (rproject (tproject2 h474) 4) ; x531 = x530 * x530 ; x542 = rproject (tproject2 h474) 1 * negate (sin (rproject (tproject2 h474) 4)) in [rproject (tproject1 h474) 0, ((x542 * x530 + x542 * x530) * negate (recip (x531 * x531))) * rproject (tproject2 h474) 2 + rproject (tproject1 h474) 0 * recip x531]) (\\h550 -> let x612 = cos (rproject (tproject2 h550) 5) ; x613 = x612 * x612 ; x620 = negate (sin (rproject (tproject2 h550) 5)) ; x627 = rproject (tproject2 h550) 2 * x620 ; x628 = x613 * x613 ; x629 = x627 * x612 + x627 * x612 ; x630 = negate (recip x628) ; x655 = rproject (tproject1 h550) 2 * x620 + ((rproject (tproject1 h550) 5 * cos (rproject (tproject2 h550) 5)) * -1.0) * rproject (tproject2 h550) 2 ; x668 = rproject (tproject1 h550) 5 * negate (sin (rproject (tproject2 h550) 5)) ; x669 = x668 * x612 + x668 * x612 in [rproject (tproject1 h550) 0, ((x655 * x612 + x668 * x627 + x655 * x612 + x668 * x627) * x630 + (((x669 * x613 + x669 * x613) * negate (recip (x628 * x628))) * -1.0) * x629) * rproject (tproject2 h550) 3 + rproject (tproject1 h550) 3 * (x629 * x630) + rproject (tproject1 h550) 0 * recip x613 + (x669 * negate (recip (x613 * x613))) * rproject (tproject2 h550) 0]) (\\h700 -> let x751 = cos (rproject (tproject2 h700) 5) ; x752 = x751 * x751 ; x759 = negate (sin (rproject (tproject2 h700) 5)) ; x766 = rproject (tproject2 h700) 2 * x759 ; x767 = x752 * x752 ; x768 = x766 * x751 + x766 * x751 ; x769 = negate (recip x767) ; x778 = rproject (tproject2 h700) 3 * rproject (tproject1 h700) 1 ; x779 = negate (recip (x767 * x767)) * (-1.0 * (x768 * x778)) ; x780 = x769 * x778 ; x781 = x751 * x780 + x751 * x780 ; x790 = x752 * x779 + x752 * x779 + negate (recip (x752 * x752)) * (rproject (tproject2 h700) 0 * rproject (tproject1 h700) 1) in [recip x752 * rproject (tproject1 h700) 1 + rproject (tproject1 h700) 0, 0, x759 * x781, (x768 * x769) * rproject (tproject1 h700) 1, 0, negate (sin (rproject (tproject2 h700) 5)) * (x751 * x790 + x751 * x790 + x766 * x780 + x766 * x780) + cos (rproject (tproject2 h700) 5) * (-1.0 * (rproject (tproject2 h700) 2 * x781))]) [rproject (tproject1 h298) 0] [rproject (dmapAccumLDer (SNat @22) (\\h815 -> let x833 = cos (rproject (tproject2 h815) 2) in [rproject (tproject1 h815) 0 + rproject (tproject2 h815) 0 * recip (x833 * x833), rproject (tproject1 h815) 0]) (\\h839 -> let x868 = cos (rproject (tproject2 h839) 3) ; x869 = x868 * x868 ; x878 = rproject (tproject1 h839) 3 * negate (sin (rproject (tproject2 h839) 3)) in [rproject (tproject1 h839) 0 + rproject (tproject1 h839) 1 * recip x869 + ((x878 * x868 + x878 * x868) * negate (recip (x869 * x869))) * rproject (tproject2 h839) 1, rproject (tproject1 h839) 0]) (\\h895 -> let x920 = cos (rproject (tproject2 h895) 3) ; x921 = x920 * x920 ; x928 = negate (recip (x921 * x921)) * (rproject (tproject2 h895) 1 * rproject (tproject1 h895) 0) in [rproject (tproject1 h895) 0 + rproject (tproject1 h895) 1, recip x921 * rproject (tproject1 h895) 0, 0, negate (sin (rproject (tproject2 h895) 3)) * (x920 * x928 + x920 * x928)]) [rproject (tproject1 h298) 2] [rreplicate 22 (rproject (tproject1 h298) 1), rproject h337 1, rreplicate 22 (rproject (tproject2 h298) 1)]) 1, rreplicate 22 (rproject (tproject1 h298) 1), rproject (dmapAccumRDer (SNat @22) (\\h939 -> let x957 = cos (rproject (tproject2 h939) 1) in [rproject (tproject1 h939) 0, rproject (tproject1 h939) 0, recip (x957 * x957) * rproject (tproject1 h939) 0]) (\\h961 -> let x992 = cos (rproject (tproject2 h961) 2) ; x993 = x992 * x992 ; x1000 = rproject (tproject1 h961) 2 * negate (sin (rproject (tproject2 h961) 2)) in [rproject (tproject1 h961) 0, rproject (tproject1 h961) 0, ((x1000 * x992 + x1000 * x992) * negate (recip (x993 * x993))) * rproject (tproject2 h961) 0 + rproject (tproject1 h961) 0 * recip x993]) (\\h1013 -> let x1061 = cos (rproject (tproject2 h1013) 2) ; x1062 = x1061 * x1061 ; x1069 = negate (recip (x1062 * x1062)) * (rproject (tproject2 h1013) 0 * rproject (tproject1 h1013) 2) in [rproject (tproject1 h1013) 1 + recip x1062 * rproject (tproject1 h1013) 2 + rproject (tproject1 h1013) 0, 0.0, negate (sin (rproject (tproject2 h1013) 2)) * (x1061 * x1069 + x1061 * x1069)]) [rproject (tproject2 h298) 0] [rproject h337 2, rreplicate 22 (rproject (tproject2 h298) 1)]) 1, rproject h337 2, rreplicate 22 (rproject (tproject2 h298) 1)] in [rsum (rproject h376 1), rproject h376 0]) (\\h1082 -> let h1132 = dmapAccumLDer (SNat @22) (\\h1176 -> [rproject (tproject1 h1176) 0 + tan (rproject (tproject2 h1176) 0), rproject (tproject1 h1176) 0, rproject (tproject1 h1176) 0]) (\\h1192 -> let x1219 = cos (rproject (tproject2 h1192) 1) in [rproject (tproject1 h1192) 0 + rproject (tproject1 h1192) 1 * recip (x1219 * x1219), rproject (tproject1 h1192) 0, rproject (tproject1 h1192) 0]) (\\h1228 -> let x1256 = cos (rproject (tproject2 h1228) 1) in [rproject (tproject1 h1228) 1 + rproject (tproject1 h1228) 0 + rproject (tproject1 h1228) 2, recip (x1256 * x1256) * rproject (tproject1 h1228) 0]) [rproject (tproject2 h1082) 2] [rreplicate 22 (rproject (tproject2 h1082) 1)] ; h1155 = dmapAccumLDer (SNat @22) (\\h1269 -> let x1317 = cos (rproject (tproject2 h1269) 3) ; x1318 = x1317 * x1317 ; x1327 = negate (recip (x1318 * x1318)) * (rproject (tproject2 h1269) 1 * rproject (tproject2 h1269) 0) in [recip x1318 * rproject (tproject2 h1269) 0 + rproject (tproject1 h1269) 0, 0, negate (sin (rproject (tproject2 h1269) 3)) * (x1317 * x1327 + x1317 * x1327)]) (\\h1337 -> let x1394 = cos (rproject (tproject2 h1337) 4) ; x1395 = x1394 * x1394 ; x1396 = x1395 * x1395 ; x1397 = negate (recip x1396) ; x1408 = rproject (tproject2 h1337) 2 * rproject (tproject2 h1337) 1 ; x1409 = x1397 * x1408 ; x1420 = rproject (tproject1 h1337) 4 * negate (sin (rproject (tproject2 h1337) 4)) ; x1421 = x1420 * x1394 + x1420 * x1394 ; x1442 = (((x1421 * x1395 + x1421 * x1395) * negate (recip (x1396 * x1396))) * -1.0) * x1408 + (rproject (tproject1 h1337) 2 * rproject (tproject2 h1337) 1 + rproject (tproject1 h1337) 1 * rproject (tproject2 h1337) 2) * x1397 in [rproject (tproject1 h1337) 0 + (x1421 * negate (recip (x1395 * x1395))) * rproject (tproject2 h1337) 1 + rproject (tproject1 h1337) 1 * recip x1395, 0.0, ((rproject (tproject1 h1337) 4 * cos (rproject (tproject2 h1337) 4)) * -1.0) * (x1394 * x1409 + x1394 * x1409) + (x1420 * x1409 + x1442 * x1394 + x1420 * x1409 + x1442 * x1394) * negate (sin (rproject (tproject2 h1337) 4))]) (\\h1473 -> let x1519 = cos (rproject (tproject2 h1473) 4) ; x1520 = x1519 * x1519 ; x1521 = x1520 * x1520 ; x1522 = negate (recip x1521) ; x1533 = rproject (tproject2 h1473) 2 * rproject (tproject2 h1473) 1 ; x1534 = x1522 * x1533 ; x1543 = negate (sin (rproject (tproject2 h1473) 4)) * rproject (tproject1 h1473) 2 ; x1544 = x1519 * x1543 + x1519 * x1543 ; x1545 = x1522 * x1544 ; x1546 = negate (recip (x1521 * x1521)) * (-1.0 * (x1533 * x1544)) ; x1555 = x1520 * x1546 + x1520 * x1546 + negate (recip (x1520 * x1520)) * (rproject (tproject2 h1473) 1 * rproject (tproject1 h1473) 0) in [rproject (tproject1 h1473) 0, rproject (tproject2 h1473) 2 * x1545 + recip x1520 * rproject (tproject1 h1473) 0, rproject (tproject2 h1473) 1 * x1545, 0, negate (sin (rproject (tproject2 h1473) 4)) * (x1519 * x1555 + x1519 * x1555 + x1534 * x1543 + x1534 * x1543) + cos (rproject (tproject2 h1473) 4) * (-1.0 * ((x1519 * x1534 + x1519 * x1534) * rproject (tproject1 h1473) 2))]) [0.0 + rproject (tproject1 h1082) 1] [rreplicate 22 (rproject (tproject1 h1082) 0) + rfromS (sreplicate 0.0), rproject (dmapAccumRDer (SNat @22) (\\h1585 -> let x1603 = cos (rproject (tproject2 h1585) 1) in [rproject (tproject1 h1585) 0, rproject (tproject1 h1585) 0, recip (x1603 * x1603) * rproject (tproject1 h1585) 0]) (\\h1607 -> let x1660 = cos (rproject (tproject2 h1607) 2) ; x1661 = x1660 * x1660 ; x1668 = rproject (tproject1 h1607) 2 * negate (sin (rproject (tproject2 h1607) 2)) in [rproject (tproject1 h1607) 0, rproject (tproject1 h1607) 0, ((x1668 * x1660 + x1668 * x1660) * negate (recip (x1661 * x1661))) * rproject (tproject2 h1607) 0 + rproject (tproject1 h1607) 0 * recip x1661]) (\\h1681 -> let x1710 = cos (rproject (tproject2 h1681) 2) ; x1711 = x1710 * x1710 ; x1718 = negate (recip (x1711 * x1711)) * (rproject (tproject2 h1681) 0 * rproject (tproject1 h1681) 2) in [rproject (tproject1 h1681) 1 + recip x1711 * rproject (tproject1 h1681) 2 + rproject (tproject1 h1681) 0, 0.0, negate (sin (rproject (tproject2 h1681) 2)) * (x1710 * x1718 + x1710 * x1718)]) [rproject (tproject2 h1082) 0] [rproject h1132 2, rreplicate 22 (rproject (tproject2 h1082) 1)]) 1, rproject h1132 2, rreplicate 22 (rproject (tproject2 h1082) 1)] ; h1165 = dmapAccumRDer (SNat @22) (\\h1731 -> let x1749 = cos (rproject (tproject2 h1731) 2) in [rproject (tproject1 h1731) 0 + rproject (tproject2 h1731) 0, recip (x1749 * x1749) * rproject (tproject1 h1731) 0]) (\\h1755 -> let x1784 = cos (rproject (tproject2 h1755) 3) ; x1785 = x1784 * x1784 ; x1794 = rproject (tproject1 h1755) 3 * negate (sin (rproject (tproject2 h1755) 3)) in [rproject (tproject1 h1755) 0 + rproject (tproject1 h1755) 1, ((x1794 * x1784 + x1794 * x1784) * negate (recip (x1785 * x1785))) * rproject (tproject2 h1755) 0 + rproject (tproject1 h1755) 0 * recip x1785]) (\\h1811 -> let x1836 = cos (rproject (tproject2 h1811) 3) ; x1837 = x1836 * x1836 ; x1844 = negate (recip (x1837 * x1837)) * (rproject (tproject2 h1811) 0 * rproject (tproject1 h1811) 1) in [rproject (tproject1 h1811) 0 + recip x1837 * rproject (tproject1 h1811) 1, rproject (tproject1 h1811) 0, 0, negate (sin (rproject (tproject2 h1811) 3)) * (x1836 * x1844 + x1836 * x1844)]) [0.0] [rproject h1155 1, rproject h1132 1, rreplicate 22 (rproject (tproject2 h1082) 1)] in [rproject h1155 0, rsum (rproject h1165 1) + rsum (rproject h1155 2), rproject h1165 0]) [1.0] [rproject (dmapAccumLDer (SNat @11) (\\h1855 -> [rproject (dmapAccumLDer (SNat @22) (\\h1871 -> [rproject (tproject1 h1871) 0 + tan (rproject (tproject2 h1871) 0)]) (\\h1880 -> let x1899 = cos (rproject (tproject2 h1880) 1) in [rproject (tproject1 h1880) 0 + rproject (tproject1 h1880) 1 * recip (x1899 * x1899)]) (\\h1904 -> let x1919 = cos (rproject (tproject2 h1904) 1) in [rproject (tproject1 h1904) 0, recip (x1919 * x1919) * rproject (tproject1 h1904) 0]) [rproject (tproject2 h1855) 0] [rreplicate 22 (rproject (tproject1 h1855) 0)]) 0, rproject (tproject1 h1855) 0]) (\\h1922 -> [rproject (dmapAccumLDer (SNat @22) (\\h1964 -> let x2003 = cos (rproject (tproject2 h1964) 2) in [rproject (tproject1 h1964) 0 + rproject (tproject2 h1964) 0 * recip (x2003 * x2003)]) (\\h2008 -> let x2069 = cos (rproject (tproject2 h2008) 3) ; x2070 = x2069 * x2069 ; x2079 = rproject (tproject1 h2008) 3 * negate (sin (rproject (tproject2 h2008) 3)) in [rproject (tproject1 h2008) 0 + rproject (tproject1 h2008) 1 * recip x2070 + ((x2079 * x2069 + x2079 * x2069) * negate (recip (x2070 * x2070))) * rproject (tproject2 h2008) 1]) (\\h2092 -> let x2140 = cos (rproject (tproject2 h2092) 3) ; x2141 = x2140 * x2140 ; x2147 = negate (recip (x2141 * x2141)) * (rproject (tproject2 h2092) 1 * rproject (tproject1 h2092) 0) in [rproject (tproject1 h2092) 0, recip x2141 * rproject (tproject1 h2092) 0, 0, negate (sin (rproject (tproject2 h2092) 3)) * (x2140 * x2147 + x2140 * x2147)]) [rproject (tproject1 h1922) 1] [rreplicate 22 (rproject (tproject1 h1922) 0), rproject (dmapAccumLDer (SNat @22) (\\h2154 -> [rproject (tproject1 h2154) 0 + tan (rproject (tproject2 h2154) 0), rproject (tproject1 h2154) 0]) (\\h2170 -> let x2194 = cos (rproject (tproject2 h2170) 1) in [rproject (tproject1 h2170) 0 + rproject (tproject1 h2170) 1 * recip (x2194 * x2194), rproject (tproject1 h2170) 0]) (\\h2201 -> let x2230 = cos (rproject (tproject2 h2201) 1) in [rproject (tproject1 h2201) 0 + rproject (tproject1 h2201) 1, recip (x2230 * x2230) * rproject (tproject1 h2201) 0]) [rproject (tproject2 h1922) 1] [rreplicate 22 (rproject (tproject2 h1922) 0)]) 1, rreplicate 22 (rproject (tproject2 h1922) 0)]) 0, rproject (tproject1 h1922) 0]) (\\h2237 -> let h2267 = dmapAccumRDer (SNat @22) (\\h2275 -> let x2284 = cos (rproject (tproject2 h2275) 1) in [rproject (tproject1 h2275) 0, recip (x2284 * x2284) * rproject (tproject1 h2275) 0]) (\\h2287 -> let x2313 = cos (rproject (tproject2 h2287) 2) ; x2314 = x2313 * x2313 ; x2321 = rproject (tproject1 h2287) 2 * negate (sin (rproject (tproject2 h2287) 2)) in [rproject (tproject1 h2287) 0, ((x2321 * x2313 + x2321 * x2313) * negate (recip (x2314 * x2314))) * rproject (tproject2 h2287) 0 + rproject (tproject1 h2287) 0 * recip x2314]) (\\h2331 -> let x2354 = cos (rproject (tproject2 h2331) 2) ; x2355 = x2354 * x2354 ; x2361 = negate (recip (x2355 * x2355)) * (rproject (tproject2 h2331) 0 * rproject (tproject1 h2331) 1) in [recip x2355 * rproject (tproject1 h2331) 1 + rproject (tproject1 h2331) 0, 0, negate (sin (rproject (tproject2 h2331) 2)) * (x2354 * x2361 + x2354 * x2361)]) [rproject (tproject1 h2237) 0] [rproject (dmapAccumLDer (SNat @22) (\\h2369 -> [rproject (tproject1 h2369) 0 + tan (rproject (tproject2 h2369) 0), rproject (tproject1 h2369) 0]) (\\h2377 -> let x2390 = cos (rproject (tproject2 h2377) 1) in [rproject (tproject1 h2377) 0 + rproject (tproject1 h2377) 1 * recip (x2390 * x2390), rproject (tproject1 h2377) 0]) (\\h2397 -> let x2410 = cos (rproject (tproject2 h2397) 1) in [rproject (tproject1 h2397) 0 + rproject (tproject1 h2397) 1, recip (x2410 * x2410) * rproject (tproject1 h2397) 0]) [rproject (tproject2 h2237) 1] [rreplicate 22 (rproject (tproject2 h2237) 0)]) 1, rreplicate 22 (rproject (tproject2 h2237) 0)] in [rsum (rproject h2267 1) + rproject (tproject1 h2237) 1, rproject h2267 0]) [1.1] [rreplicate 11 1.1]) 1, rreplicate 11 1.1] in [rsum (rproject h13 1) + rproject h13 0]"
...
testSin0MapAccumNestedR1PP = do
  ...
  printAstHVectorPrettyButNested
    ...
    (simplifyInline
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 (rscalar 1.1)))
    @?= "let h12 = dmapAccumRDer (SNat @2) (\\h17 -> let h55 = dmapAccumRDer (SNat @2) (\\h60 -> let x87 = cos (rproject (tproject2 h60) 1) in [rproject (tproject1 h60) 0, recip (x87 * x87) * rproject (tproject1 h60) 0]) (\\h90 -> let x137 = cos (rproject (tproject2 h90) 2) ; x138 = x137 * x137 ; x145 = rproject (tproject1 h90) 2 * negate (sin (rproject (tproject2 h90) 2)) in [rproject (tproject1 h90) 0, ((x145 * x137 + x145 * x137) * negate (recip (x138 * x138))) * rproject (tproject2 h90) 0 + rproject (tproject1 h90) 0 * recip x138]) (\\h155 -> let x196 = cos (rproject (tproject2 h155) 2) ; x197 = x196 * x196 ; x203 = negate (recip (x197 * x197)) * (rproject (tproject2 h155) 0 * rproject (tproject1 h155) 1) in [recip x197 * rproject (tproject1 h155) 1 + rproject (tproject1 h155) 0, 0, negate (sin (rproject (tproject2 h155) 2)) * (x196 * x203 + x196 * x203)]) [rproject (tproject1 h17) 0] [rproject (dmapAccumLDer (SNat @2) (\\h211 -> [rproject (tproject1 h211) 0 + tan (rproject (tproject2 h211) 0), rproject (tproject1 h211) 0]) (\\h227 -> let x259 = cos (rproject (tproject2 h227) 1) in [rproject (tproject1 h227) 0 + rproject (tproject1 h227) 1 * recip (x259 * x259), rproject (tproject1 h227) 0]) (\\h266 -> let x289 = cos (rproject (tproject2 h266) 1) in [rproject (tproject1 h266) 0 + rproject (tproject1 h266) 1, recip (x289 * x289) * rproject (tproject1 h266) 0]) [rproject (tproject2 h17) 1] [rreplicate 2 (rproject (tproject2 h17) 0)]) 1, rreplicate 2 (rproject (tproject2 h17) 0)] in [rsum (rproject h55 1), rproject h55 0]) (\\h296 -> let h335 = dmapAccumLDer (SNat @2) (\\h379 -> [rproject (tproject1 h379) 0 + tan (rproject (tproject2 h379) 0), rproject (tproject1 h379) 0, rproject (tproject1 h379) 0]) (\\h395 -> let x422 = cos (rproject (tproject2 h395) 1) in [rproject (tproject1 h395) 0 + rproject (tproject1 h395) 1 * recip (x422 * x422), rproject (tproject1 h395) 0, rproject (tproject1 h395) 0]) (\\h431 -> let x459 = cos (rproject (tproject2 h431) 1) in [rproject (tproject1 h431) 1 + rproject (tproject1 h431) 0 + rproject (tproject1 h431) 2, recip (x459 * x459) * rproject (tproject1 h431) 0]) [rproject (tproject2 h296) 2] [rreplicate 2 (rproject (tproject2 h296) 1)] ; h374 = dmapAccumRDer (SNat @2) (\\h472 -> let x528 = cos (rproject (tproject2 h472) 4) ; x529 = x528 * x528 ; x540 = rproject (tproject2 h472) 1 * negate (sin (rproject (tproject2 h472) 4)) in [rproject (tproject1 h472) 0, ((x540 * x528 + x540 * x528) * negate (recip (x529 * x529))) * rproject (tproject2 h472) 2 + rproject (tproject1 h472) 0 * recip x529]) (\\h548 -> let x610 = cos (rproject (tproject2 h548) 5) ; x611 = x610 * x610 ; x618 = negate (sin (rproject (tproject2 h548) 5)) ; x625 = rproject (tproject2 h548) 2 * x618 ; x626 = x611 * x611 ; x627 = x625 * x610 + x625 * x610 ; x628 = negate (recip x626) ; x653 = rproject (tproject1 h548) 2 * x618 + ((rproject (tproject1 h548) 5 * cos (rproject (tproject2 h548) 5)) * -1.0) * rproject (tproject2 h548) 2 ; x666 = rproject (tproject1 h548) 5 * negate (sin (rproject (tproject2 h548) 5)) ; x667 = x666 * x610 + x666 * x610 in [rproject (tproject1 h548) 0, ((x653 * x610 + x666 * x625 + x653 * x610 + x666 * x625) * x628 + (((x667 * x611 + x667 * x611) * negate (recip (x626 * x626))) * -1.0) * x627) * rproject (tproject2 h548) 3 + rproject (tproject1 h548) 3 * (x627 * x628) + rproject (tproject1 h548) 0 * recip x611 + (x667 * negate (recip (x611 * x611))) * rproject (tproject2 h548) 0]) (\\h698 -> let x749 = cos (rproject (tproject2 h698) 5) ; x750 = x749 * x749 ; x757 = negate (sin (rproject (tproject2 h698) 5)) ; x764 = rproject (tproject2 h698) 2 * x757 ; x765 = x750 * x750 ; x766 = x764 * x749 + x764 * x749 ; x767 = negate (recip x765) ; x776 = rproject (tproject2 h698) 3 * rproject (tproject1 h698) 1 ; x777 = negate (recip (x765 * x765)) * (-1.0 * (x766 * x776)) ; x778 = x767 * x776 ; x779 = x749 * x778 + x749 * x778 ; x788 = x750 * x777 + x750 * x777 + negate (recip (x750 * x750)) * (rproject (tproject2 h698) 0 * rproject (tproject1 h698) 1) in [recip x750 * rproject (tproject1 h698) 1 + rproject (tproject1 h698) 0, 0, x757 * x779, (x766 * x767) * rproject (tproject1 h698) 1, 0, negate (sin (rproject (tproject2 h698) 5)) * (x749 * x788 + x749 * x788 + x764 * x778 + x764 * x778) + cos (rproject (tproject2 h698) 5) * (-1.0 * (rproject (tproject2 h698) 2 * x779))]) [rproject (tproject1 h296) 0] [rproject (dmapAccumLDer (SNat @2) (\\h813 -> let x831 = cos (rproject (tproject2 h813) 2) in [rproject (tproject1 h813) 0 + rproject (tproject2 h813) 0 * recip (x831 * x831), rproject (tproject1 h813) 0]) (\\h837 -> let x866 = cos (rproject (tproject2 h837) 3) ; x867 = x866 * x866 ; x876 = rproject (tproject1 h837) 3 * negate (sin (rproject (tproject2 h837) 3)) in [rproject (tproject1 h837) 0 + rproject (tproject1 h837) 1 * recip x867 + ((x876 * x866 + x876 * x866) * negate (recip (x867 * x867))) * rproject (tproject2 h837) 1, rproject (tproject1 h837) 0]) (\\h893 -> let x918 = cos (rproject (tproject2 h893) 3) ; x919 = x918 * x918 ; x926 = negate (recip (x919 * x919)) * (rproject (tproject2 h893) 1 * rproject (tproject1 h893) 0) in [rproject (tproject1 h893) 0 + rproject (tproject1 h893) 1, recip x919 * rproject (tproject1 h893) 0, 0, negate (sin (rproject (tproject2 h893) 3)) * (x918 * x926 + x918 * x926)]) [rproject (tproject1 h296) 2] [rreplicate 2 (rproject (tproject1 h296) 1), rproject h335 1, rreplicate 2 (rproject (tproject2 h296) 1)]) 1, rreplicate 2 (rproject (tproject1 h296) 1), rproject (dmapAccumRDer (SNat @2) (\\h937 -> let x955 = cos (rproject (tproject2 h937) 1) in [rproject (tproject1 h937) 0, rproject (tproject1 h937) 0, recip (x955 * x955) * rproject (tproject1 h937) 0]) (\\h959 -> let x990 = cos (rproject (tproject2 h959) 2) ; x991 = x990 * x990 ; x998 = rproject (tproject1 h959) 2 * negate (sin (rproject (tproject2 h959) 2)) in [rproject (tproject1 h959) 0, rproject (tproject1 h959) 0, ((x998 * x990 + x998 * x990) * negate (recip (x991 * x991))) * rproject (tproject2 h959) 0 + rproject (tproject1 h959) 0 * recip x991]) (\\h1011 -> let x1059 = cos (rproject (tproject2 h1011) 2) ; x1060 = x1059 * x1059 ; x1067 = negate (recip (x1060 * x1060)) * (rproject (tproject2 h1011) 0 * rproject (tproject1 h1011) 2) in [rproject (tproject1 h1011) 1 + recip x1060 * rproject (tproject1 h1011) 2 + rproject (tproject1 h1011) 0, 0.0, negate (sin (rproject (tproject2 h1011) 2)) * (x1059 * x1067 + x1059 * x1067)]) [rproject (tproject2 h296) 0] [rproject h335 2, rreplicate 2 (rproject (tproject2 h296) 1)]) 1, rproject h335 2, rreplicate 2 (rproject (tproject2 h296) 1)] in [rsum (rproject h374 1), rproject h374 0]) (\\h1080 -> let h1130 = dmapAccumLDer (SNat @2) (\\h1174 -> [rproject (tproject1 h1174) 0 + tan (rproject (tproject2 h1174) 0), rproject (tproject1 h1174) 0, rproject (tproject1 h1174) 0]) (\\h1190 -> let x1217 = cos (rproject (tproject2 h1190) 1) in [rproject (tproject1 h1190) 0 + rproject (tproject1 h1190) 1 * recip (x1217 * x1217), rproject (tproject1 h1190) 0, rproject (tproject1 h1190) 0]) (\\h1226 -> let x1254 = cos (rproject (tproject2 h1226) 1) in [rproject (tproject1 h1226) 1 + rproject (tproject1 h1226) 0 + rproject (tproject1 h1226) 2, recip (x1254 * x1254) * rproject (tproject1 h1226) 0]) [rproject (tproject2 h1080) 2] [rreplicate 2 (rproject (tproject2 h1080) 1)] ; h1153 = dmapAccumLDer (SNat @2) (\\h1267 -> let x1315 = cos (rproject (tproject2 h1267) 3) ; x1316 = x1315 * x1315 ; x1325 = negate (recip (x1316 * x1316)) * (rproject (tproject2 h1267) 1 * rproject (tproject2 h1267) 0) in [recip x1316 * rproject (tproject2 h1267) 0 + rproject (tproject1 h1267) 0, 0, negate (sin (rproject (tproject2 h1267) 3)) * (x1315 * x1325 + x1315 * x1325)]) (\\h1335 -> let x1392 = cos (rproject (tproject2 h1335) 4) ; x1393 = x1392 * x1392 ; x1394 = x1393 * x1393 ; x1395 = negate (recip x1394) ; x1406 = rproject (tproject2 h1335) 2 * rproject (tproject2 h1335) 1 ; x1407 = x1395 * x1406 ; x1418 = rproject (tproject1 h1335) 4 * negate (sin (rproject (tproject2 h1335) 4)) ; x1419 = x1418 * x1392 + x1418 * x1392 ; x1440 = (((x1419 * x1393 + x1419 * x1393) * negate (recip (x1394 * x1394))) * -1.0) * x1406 + (rproject (tproject1 h1335) 2 * rproject (tproject2 h1335) 1 + rproject (tproject1 h1335) 1 * rproject (tproject2 h1335) 2) * x1395 in [rproject (tproject1 h1335) 0 + (x1419 * negate (recip (x1393 * x1393))) * rproject (tproject2 h1335) 1 + rproject (tproject1 h1335) 1 * recip x1393, 0.0, ((rproject (tproject1 h1335) 4 * cos (rproject (tproject2 h1335) 4)) * -1.0) * (x1392 * x1407 + x1392 * x1407) + (x1418 * x1407 + x1440 * x1392 + x1418 * x1407 + x1440 * x1392) * negate (sin (rproject (tproject2 h1335) 4))]) (\\h1471 -> let x1517 = cos (rproject (tproject2 h1471) 4) ; x1518 = x1517 * x1517 ; x1519 = x1518 * x1518 ; x1520 = negate (recip x1519) ; x1531 = rproject (tproject2 h1471) 2 * rproject (tproject2 h1471) 1 ; x1532 = x1520 * x1531 ; x1541 = negate (sin (rproject (tproject2 h1471) 4)) * rproject (tproject1 h1471) 2 ; x1542 = x1517 * x1541 + x1517 * x1541 ; x1543 = x1520 * x1542 ; x1544 = negate (recip (x1519 * x1519)) * (-1.0 * (x1531 * x1542)) ; x1553 = x1518 * x1544 + x1518 * x1544 + negate (recip (x1518 * x1518)) * (rproject (tproject2 h1471) 1 * rproject (tproject1 h1471) 0) in [rproject (tproject1 h1471) 0, rproject (tproject2 h1471) 2 * x1543 + recip x1518 * rproject (tproject1 h1471) 0, rproject (tproject2 h1471) 1 * x1543, 0, negate (sin (rproject (tproject2 h1471) 4)) * (x1517 * x1553 + x1517 * x1553 + x1532 * x1541 + x1532 * x1541) + cos (rproject (tproject2 h1471) 4) * (-1.0 * ((x1517 * x1532 + x1517 * x1532) * rproject (tproject1 h1471) 2))]) [0.0 + rproject (tproject1 h1080) 1] [rreplicate 2 (rproject (tproject1 h1080) 0) + rfromS (sreplicate 0.0), rproject (dmapAccumRDer (SNat @2) (\\h1583 -> let x1601 = cos (rproject (tproject2 h1583) 1) in [rproject (tproject1 h1583) 0, rproject (tproject1 h1583) 0, recip (x1601 * x1601) * rproject (tproject1 h1583) 0]) (\\h1605 -> let x1658 = cos (rproject (tproject2 h1605) 2) ; x1659 = x1658 * x1658 ; x1666 = rproject (tproject1 h1605) 2 * negate (sin (rproject (tproject2 h1605) 2)) in [rproject (tproject1 h1605) 0, rproject (tproject1 h1605) 0, ((x1666 * x1658 + x1666 * x1658) * negate (recip (x1659 * x1659))) * rproject (tproject2 h1605) 0 + rproject (tproject1 h1605) 0 * recip x1659]) (\\h1679 -> let x1708 = cos (rproject (tproject2 h1679) 2) ; x1709 = x1708 * x1708 ; x1716 = negate (recip (x1709 * x1709)) * (rproject (tproject2 h1679) 0 * rproject (tproject1 h1679) 2) in [rproject (tproject1 h1679) 1 + recip x1709 * rproject (tproject1 h1679) 2 + rproject (tproject1 h1679) 0, 0.0, negate (sin (rproject (tproject2 h1679) 2)) * (x1708 * x1716 + x1708 * x1716)]) [rproject (tproject2 h1080) 0] [rproject h1130 2, rreplicate 2 (rproject (tproject2 h1080) 1)]) 1, rproject h1130 2, rreplicate 2 (rproject (tproject2 h1080) 1)] ; h1163 = dmapAccumRDer (SNat @2) (\\h1729 -> let x1747 = cos (rproject (tproject2 h1729) 2) in [rproject (tproject1 h1729) 0 + rproject (tproject2 h1729) 0, recip (x1747 * x1747) * rproject (tproject1 h1729) 0]) (\\h1753 -> let x1782 = cos (rproject (tproject2 h1753) 3) ; x1783 = x1782 * x1782 ; x1792 = rproject (tproject1 h1753) 3 * negate (sin (rproject (tproject2 h1753) 3)) in [rproject (tproject1 h1753) 0 + rproject (tproject1 h1753) 1, ((x1792 * x1782 + x1792 * x1782) * negate (recip (x1783 * x1783))) * rproject (tproject2 h1753) 0 + rproject (tproject1 h1753) 0 * recip x1783]) (\\h1809 -> let x1834 = cos (rproject (tproject2 h1809) 3) ; x1835 = x1834 * x1834 ; x1842 = negate (recip (x1835 * x1835)) * (rproject (tproject2 h1809) 0 * rproject (tproject1 h1809) 1) in [rproject (tproject1 h1809) 0 + recip x1835 * rproject (tproject1 h1809) 1, rproject (tproject1 h1809) 0, 0, negate (sin (rproject (tproject2 h1809) 3)) * (x1834 * x1842 + x1834 * x1842)]) [0.0] [rproject h1153 1, rproject h1130 1, rreplicate 2 (rproject (tproject2 h1080) 1)] in [rproject h1153 0, rsum (rproject h1163 1) + rsum (rproject h1153 2), rproject h1163 0]) [1.0] [rproject (dmapAccumLDer (SNat @2) (\\h1853 -> [rproject (dmapAccumLDer (SNat @2) (\\h1867 -> [rproject (tproject1 h1867) 0 + tan (rproject (tproject2 h1867) 0)]) (\\h1876 -> let x1895 = cos (rproject (tproject2 h1876) 1) in [rproject (tproject1 h1876) 0 + rproject (tproject1 h1876) 1 * recip (x1895 * x1895)]) (\\h1900 -> let x1915 = cos (rproject (tproject2 h1900) 1) in [rproject (tproject1 h1900) 0, recip (x1915 * x1915) * rproject (tproject1 h1900) 0]) [rproject (tproject2 h1853) 0] [rreplicate 2 (rproject (tproject1 h1853) 0)]) 0, rproject (tproject1 h1853) 0]) (\\h1918 -> [rproject (dmapAccumLDer (SNat @2) (\\h1959 -> let x1998 = cos (rproject (tproject2 h1959) 2) in [rproject (tproject1 h1959) 0 + rproject (tproject2 h1959) 0 * recip (x1998 * x1998)]) (\\h2003 -> let x2064 = cos (rproject (tproject2 h2003) 3) ; x2065 = x2064 * x2064 ; x2074 = rproject (tproject1 h2003) 3 * negate (sin (rproject (tproject2 h2003) 3)) in [rproject (tproject1 h2003) 0 + rproject (tproject1 h2003) 1 * recip x2065 + ((x2074 * x2064 + x2074 * x2064) * negate (recip (x2065 * x2065))) * rproject (tproject2 h2003) 1]) (\\h2087 -> let x2135 = cos (rproject (tproject2 h2087) 3) ; x2136 = x2135 * x2135 ; x2142 = negate (recip (x2136 * x2136)) * (rproject (tproject2 h2087) 1 * rproject (tproject1 h2087) 0) in [rproject (tproject1 h2087) 0, recip x2136 * rproject (tproject1 h2087) 0, 0, negate (sin (rproject (tproject2 h2087) 3)) * (x2135 * x2142 + x2135 * x2142)]) [rproject (tproject1 h1918) 1] [rreplicate 2 (rproject (tproject1 h1918) 0), rproject (dmapAccumLDer (SNat @2) (\\h2149 -> [rproject (tproject1 h2149) 0 + tan (rproject (tproject2 h2149) 0), rproject (tproject1 h2149) 0]) (\\h2165 -> let x2189 = cos (rproject (tproject2 h2165) 1) in [rproject (tproject1 h2165) 0 + rproject (tproject1 h2165) 1 * recip (x2189 * x2189), rproject (tproject1 h2165) 0]) (\\h2196 -> let x2225 = cos (rproject (tproject2 h2196) 1) in [rproject (tproject1 h2196) 0 + rproject (tproject1 h2196) 1, recip (x2225 * x2225) * rproject (tproject1 h2196) 0]) [rproject (tproject2 h1918) 1] [rreplicate 2 (rproject (tproject2 h1918) 0)]) 1, rreplicate 2 (rproject (tproject2 h1918) 0)]) 0, rproject (tproject1 h1918) 0]) (\\h2232 -> let h2262 = dmapAccumRDer (SNat @2) (\\h2270 -> let x2279 = cos (rproject (tproject2 h2270) 1) in [rproject (tproject1 h2270) 0, recip (x2279 * x2279) * rproject (tproject1 h2270) 0]) (\\h2282 -> let x2308 = cos (rproject (tproject2 h2282) 2) ; x2309 = x2308 * x2308 ; x2316 = rproject (tproject1 h2282) 2 * negate (sin (rproject (tproject2 h2282) 2)) in [rproject (tproject1 h2282) 0, ((x2316 * x2308 + x2316 * x2308) * negate (recip (x2309 * x2309))) * rproject (tproject2 h2282) 0 + rproject (tproject1 h2282) 0 * recip x2309]) (\\h2326 -> let x2349 = cos (rproject (tproject2 h2326) 2) ; x2350 = x2349 * x2349 ; x2356 = negate (recip (x2350 * x2350)) * (rproject (tproject2 h2326) 0 * rproject (tproject1 h2326) 1) in [recip x2350 * rproject (tproject1 h2326) 1 + rproject (tproject1 h2326) 0, 0, negate (sin (rproject (tproject2 h2326) 2)) * (x2349 * x2356 + x2349 * x2356)]) [rproject (tproject1 h2232) 0] [rproject (dmapAccumLDer (SNat @2) (\\h2364 -> [rproject (tproject1 h2364) 0 + tan (rproject (tproject2 h2364) 0), rproject (tproject1 h2364) 0]) (\\h2372 -> let x2385 = cos (rproject (tproject2 h2372) 1) in [rproject (tproject1 h2372) 0 + rproject (tproject1 h2372) 1 * recip (x2385 * x2385), rproject (tproject1 h2372) 0]) (\\h2392 -> let x2405 = cos (rproject (tproject2 h2392) 1) in [rproject (tproject1 h2392) 0 + rproject (tproject1 h2392) 1, recip (x2405 * x2405) * rproject (tproject1 h2392) 0]) [rproject (tproject2 h2232) 1] [rreplicate 2 (rproject (tproject2 h2232) 0)]) 1, rreplicate 2 (rproject (tproject2 h2232) 0)] in [rsum (rproject h2262 1) + rproject (tproject1 h2232) 1, rproject h2262 0]) [1.1] [rreplicate 2 1.1]) 1, rreplicate 2 1.1] in [rsum (rproject h12 1) + rproject h12 0]"
