...
testSin0FoldNestedR1SimpNestedPP = do
  ...
  printAstHVectorPrettyButNested
    ...
    (simplifyInline
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 (rscalar 1.1)))
    @?= "let h12 = dmapAccumRDer (SNat @11) (\\h17 -> let [x45 @Natural @Double @[]] = tproject1 h17 in let [x46 @Natural @Double @[], x47 @Natural @Double @[]] = tproject2 h17 in let h48 = [x46, x47] ; h57 = dmapAccumRDer (SNat @22) (\\h62 -> let [x84 @Natural @Double @[]] = tproject1 h62 in let [x85 @Natural @Double @[], x86 @Natural @Double @[]] = tproject2 h62 in let x87 = cos x86 in [x84, recip (x87 * x87) * x84]) (\\h88 -> let h143 = [let [x137 @Natural @Double @[], x138 @Natural @Double @[], x139 @Natural @Double @[]] = tproject2 h88 in x138, let [x140 @Natural @Double @[], x141 @Natural @Double @[], x142 @Natural @Double @[]] = tproject2 h88 in x142] ; x146 = cos (let [x144 @Natural @Double @[], x145 @Natural @Double @[]] = h143 in x145) ; x147 = x146 * x146 ; x153 = let [x148 @Natural @Double @[], x149 @Natural @Double @[], x150 @Natural @Double @[]] = tproject1 h88 in x150 * negate (sin (let [x151 @Natural @Double @[], x152 @Natural @Double @[]] = h143 in x152)) in [let [x154 @Natural @Double @[], x155 @Natural @Double @[], x156 @Natural @Double @[]] = tproject1 h88 in x154, ((x153 * x146 + x153 * x146) * negate (recip (x147 * x147))) * let [x157 @Natural @Double @[], x158 @Natural @Double @[], x159 @Natural @Double @[]] = tproject2 h88 in x157 + let [x160 @Natural @Double @[], x161 @Natural @Double @[], x162 @Natural @Double @[]] = tproject1 h88 in x160 * recip x147]) (\\h163 -> let h212 = [let [x206 @Natural @Double @[], x207 @Natural @Double @[], x208 @Natural @Double @[]] = tproject2 h163 in x207, let [x209 @Natural @Double @[], x210 @Natural @Double @[], x211 @Natural @Double @[]] = tproject2 h163 in x211] ; x215 = cos (let [x213 @Natural @Double @[], x214 @Natural @Double @[]] = h212 in x214) ; x216 = x215 * x215 ; x222 = negate (recip (x216 * x216)) * (let [x217 @Natural @Double @[], x218 @Natural @Double @[], x219 @Natural @Double @[]] = tproject2 h163 in x217 * let [x220 @Natural @Double @[], x221 @Natural @Double @[]] = tproject1 h163 in x221) in [recip x216 * let [x223 @Natural @Double @[], x224 @Natural @Double @[]] = tproject1 h163 in x224 + let [x225 @Natural @Double @[], x226 @Natural @Double @[]] = tproject1 h163 in x225, 0, negate (sin (let [x227 @Natural @Double @[], x228 @Natural @Double @[]] = h212 in x228)) * (x215 * x222 + x215 * x222)]) [x45] [let [x53 @Natural @Double @[], v54 @Natural @Double @[22]] = dmapAccumLDer (SNat @22) (\\h229 -> let [x243 @Natural @Double @[]] = tproject1 h229 in let [x246 @Natural @Double @[]] = let [x244 @Natural @Double @[]] = tproject1 h229 in let [x245 @Natural @Double @[]] = tproject2 h229 in [x244 + tan x245] in [x246, x243]) (\\h247 -> let [x277 @Natural @Double @[], x278 @Natural @Double @[]] = tproject1 h247 in let x281 = cos (let [x279 @Natural @Double @[], x280 @Natural @Double @[]] = tproject2 h247 in x280) in [let [x282 @Natural @Double @[], x283 @Natural @Double @[]] = tproject1 h247 in x282 + let [x284 @Natural @Double @[], x285 @Natural @Double @[]] = tproject1 h247 in x285 * recip (x281 * x281), x277]) (\\h286 -> let [x303 @Natural @Double @[], x304 @Natural @Double @[]] = tproject1 h286 in let x307 = cos (let [x305 @Natural @Double @[], x306 @Natural @Double @[]] = tproject2 h286 in x306) in [x303 + x304, recip (x307 * x307) * x303]) [let [x49 @Natural @Double @[], x50 @Natural @Double @[]] = h48 in x50] [rreplicate 22 (let [x51 @Natural @Double @[], x52 @Natural @Double @[]] = h48 in x51)] in v54, rreplicate 22 (let [x55 @Natural @Double @[], x56 @Natural @Double @[]] = h48 in x55)] in [rsum (let [x58 @Natural @Double @[], v59 @Natural @Double @[22]] = h57 in v59), let [x60 @Natural @Double @[], v61 @Natural @Double @[22]] = h57 in x60]) (\\h308 -> let h345 = [let [x339 @Natural @Double @[], x340 @Natural @Double @[], x341 @Natural @Double @[]] = tproject2 h308 in x340, let [x342 @Natural @Double @[], x343 @Natural @Double @[], x344 @Natural @Double @[]] = tproject2 h308 in x344] ; h350 = dmapAccumLDer (SNat @22) (\\h391 -> let [x405 @Natural @Double @[]] = tproject1 h391 in let [x410 @Natural @Double @[], x411 @Natural @Double @[]] = let [x406 @Natural @Double @[]] = tproject1 h391 in let [x409 @Natural @Double @[]] = let [x407 @Natural @Double @[]] = tproject1 h391 in let [x408 @Natural @Double @[]] = tproject2 h391 in [x407 + tan x408] in [x409, x406] in [x410, x405, x411]) (\\h412 -> let [x437 @Natural @Double @[], x438 @Natural @Double @[]] = tproject1 h412 in let [x448 @Natural @Double @[], x449 @Natural @Double @[]] = let [x439 @Natural @Double @[], x440 @Natural @Double @[]] = tproject1 h412 in let x443 = cos (let [x441 @Natural @Double @[], x442 @Natural @Double @[]] = tproject2 h412 in x442) in [let [x444 @Natural @Double @[], x445 @Natural @Double @[]] = tproject1 h412 in x444 + let [x446 @Natural @Double @[], x447 @Natural @Double @[]] = tproject1 h412 in x447 * recip (x443 * x443), x439] in [x448, x437, x449]) (\\h450 -> let [x468 @Natural @Double @[], x469 @Natural @Double @[], x470 @Natural @Double @[]] = tproject1 h450 in let x473 = cos (let [x471 @Natural @Double @[], x472 @Natural @Double @[]] = tproject2 h450 in x472) in [x469 + x468 + x470, recip (x473 * x473) * x468]) [let [x346 @Natural @Double @[], x347 @Natural @Double @[]] = h345 in x347] [rreplicate 22 (let [x348 @Natural @Double @[], x349 @Natural @Double @[]] = h345 in x348)] ; h356 = [let [x351 @Natural @Double @[], v352 @Natural @Double @[22], v353 @Natural @Double @[22]] = h350 in v353, rreplicate 22 (let [x354 @Natural @Double @[], x355 @Natural @Double @[]] = h345 in x354)] ; h386 = dmapAccumRDer (SNat @22) (\\h474 -> let [x535 @Natural @Double @[]] = tproject1 h474 in let [x536 @Natural @Double @[], x537 @Natural @Double @[], x538 @Natural @Double @[], x539 @Natural @Double @[], x540 @Natural @Double @[]] = tproject2 h474 in let h541 = [x539, x540] ; x544 = cos (let [x542 @Natural @Double @[], x543 @Natural @Double @[]] = h541 in x543) ; x545 = x544 * x544 ; x548 = x537 * negate (sin (let [x546 @Natural @Double @[], x547 @Natural @Double @[]] = h541 in x547)) in [x535, ((x548 * x544 + x548 * x544) * negate (recip (x545 * x545))) * x538 + x535 * recip x545]) (\\h549 -> let h625 = [let [x613 @Natural @Double @[], x614 @Natural @Double @[], x615 @Natural @Double @[], x616 @Natural @Double @[], x617 @Natural @Double @[], x618 @Natural @Double @[]] = tproject2 h549 in x617, let [x619 @Natural @Double @[], x620 @Natural @Double @[], x621 @Natural @Double @[], x622 @Natural @Double @[], x623 @Natural @Double @[], x624 @Natural @Double @[]] = tproject2 h549 in x624] ; x628 = cos (let [x626 @Natural @Double @[], x627 @Natural @Double @[]] = h625 in x627) ; x629 = x628 * x628 ; x632 = negate (sin (let [x630 @Natural @Double @[], x631 @Natural @Double @[]] = h625 in x631)) ; x639 = let [x633 @Natural @Double @[], x634 @Natural @Double @[], x635 @Natural @Double @[], x636 @Natural @Double @[], x637 @Natural @Double @[], x638 @Natural @Double @[]] = tproject2 h549 in x635 * x632 ; x640 = x629 * x629 ; x641 = x639 * x628 + x639 * x628 ; x642 = negate (recip x640) ; x663 = let [x643 @Natural @Double @[], x644 @Natural @Double @[], x645 @Natural @Double @[], x646 @Natural @Double @[], x647 @Natural @Double @[], x648 @Natural @Double @[]] = tproject1 h549 in x645 * x632 + ((let [x649 @Natural @Double @[], x650 @Natural @Double @[], x651 @Natural @Double @[], x652 @Natural @Double @[], x653 @Natural @Double @[], x654 @Natural @Double @[]] = tproject1 h549 in x654 * cos (let [x655 @Natural @Double @[], x656 @Natural @Double @[]] = h625 in x656)) * -1.0) * let [x657 @Natural @Double @[], x658 @Natural @Double @[], x659 @Natural @Double @[], x660 @Natural @Double @[], x661 @Natural @Double @[], x662 @Natural @Double @[]] = tproject2 h549 in x659 ; x672 = let [x664 @Natural @Double @[], x665 @Natural @Double @[], x666 @Natural @Double @[], x667 @Natural @Double @[], x668 @Natural @Double @[], x669 @Natural @Double @[]] = tproject1 h549 in x669 * negate (sin (let [x670 @Natural @Double @[], x671 @Natural @Double @[]] = h625 in x671)) ; x673 = x672 * x628 + x672 * x628 in [let [x674 @Natural @Double @[], x675 @Natural @Double @[], x676 @Natural @Double @[], x677 @Natural @Double @[], x678 @Natural @Double @[], x679 @Natural @Double @[]] = tproject1 h549 in x674, ((x663 * x628 + x672 * x639 + x663 * x628 + x672 * x639) * x642 + (((x673 * x629 + x673 * x629) * negate (recip (x640 * x640))) * -1.0) * x641) * let [x680 @Natural @Double @[], x681 @Natural @Double @[], x682 @Natural @Double @[], x683 @Natural @Double @[], x684 @Natural @Double @[], x685 @Natural @Double @[]] = tproject2 h549 in x683 + let [x686 @Natural @Double @[], x687 @Natural @Double @[], x688 @Natural @Double @[], x689 @Natural @Double @[], x690 @Natural @Double @[], x691 @Natural @Double @[]] = tproject1 h549 in x689 * (x641 * x642) + let [x692 @Natural @Double @[], x693 @Natural @Double @[], x694 @Natural @Double @[], x695 @Natural @Double @[], x696 @Natural @Double @[], x697 @Natural @Double @[]] = tproject1 h549 in x692 * recip x629 + (x673 * negate (recip (x629 * x629))) * let [x698 @Natural @Double @[], x699 @Natural @Double @[], x700 @Natural @Double @[], x701 @Natural @Double @[], x702 @Natural @Double @[], x703 @Natural @Double @[]] = tproject2 h549 in x698]) (\\h704 -> let h769 = [let [x757 @Natural @Double @[], x758 @Natural @Double @[], x759 @Natural @Double @[], x760 @Natural @Double @[], x761 @Natural @Double @[], x762 @Natural @Double @[]] = tproject2 h704 in x761, let [x763 @Natural @Double @[], x764 @Natural @Double @[], x765 @Natural @Double @[], x766 @Natural @Double @[], x767 @Natural @Double @[], x768 @Natural @Double @[]] = tproject2 h704 in x768] ; x772 = cos (let [x770 @Natural @Double @[], x771 @Natural @Double @[]] = h769 in x771) ; x773 = x772 * x772 ; x776 = negate (sin (let [x774 @Natural @Double @[], x775 @Natural @Double @[]] = h769 in x775)) ; x783 = let [x777 @Natural @Double @[], x778 @Natural @Double @[], x779 @Natural @Double @[], x780 @Natural @Double @[], x781 @Natural @Double @[], x782 @Natural @Double @[]] = tproject2 h704 in x779 * x776 ; x784 = x773 * x773 ; x785 = x783 * x772 + x783 * x772 ; x786 = negate (recip x784) ; x795 = let [x787 @Natural @Double @[], x788 @Natural @Double @[], x789 @Natural @Double @[], x790 @Natural @Double @[], x791 @Natural @Double @[], x792 @Natural @Double @[]] = tproject2 h704 in x790 * let [x793 @Natural @Double @[], x794 @Natural @Double @[]] = tproject1 h704 in x794 ; x796 = negate (recip (x784 * x784)) * (-1.0 * (x785 * x795)) ; x797 = x786 * x795 ; x798 = x772 * x797 + x772 * x797 ; x807 = x773 * x796 + x773 * x796 + negate (recip (x773 * x773)) * (let [x799 @Natural @Double @[], x800 @Natural @Double @[], x801 @Natural @Double @[], x802 @Natural @Double @[], x803 @Natural @Double @[], x804 @Natural @Double @[]] = tproject2 h704 in x799 * let [x805 @Natural @Double @[], x806 @Natural @Double @[]] = tproject1 h704 in x806) in [recip x773 * let [x808 @Natural @Double @[], x809 @Natural @Double @[]] = tproject1 h704 in x809 + let [x810 @Natural @Double @[], x811 @Natural @Double @[]] = tproject1 h704 in x810, 0, x776 * x798, (x785 * x786) * let [x812 @Natural @Double @[], x813 @Natural @Double @[]] = tproject1 h704 in x813, 0, negate (sin (let [x814 @Natural @Double @[], x815 @Natural @Double @[]] = h769 in x815)) * (x772 * x807 + x772 * x807 + x783 * x797 + x783 * x797) + cos (let [x816 @Natural @Double @[], x817 @Natural @Double @[]] = h769 in x817) * (-1.0 * (let [x818 @Natural @Double @[], x819 @Natural @Double @[], x820 @Natural @Double @[], x821 @Natural @Double @[], x822 @Natural @Double @[], x823 @Natural @Double @[]] = tproject2 h704 in x820 * x798))]) [let [x357 @Natural @Double @[], x358 @Natural @Double @[], x359 @Natural @Double @[]] = tproject1 h308 in x357] [let [x371 @Natural @Double @[], v372 @Natural @Double @[22]] = dmapAccumLDer (SNat @22) (\\h824 -> let [x839 @Natural @Double @[]] = tproject1 h824 in let [x840 @Natural @Double @[], x841 @Natural @Double @[], x842 @Natural @Double @[]] = tproject2 h824 in let x843 = cos x842 in [x839 + x840 * recip (x843 * x843), x839]) (\\h844 -> let x873 = cos (let [x869 @Natural @Double @[], x870 @Natural @Double @[], x871 @Natural @Double @[], x872 @Natural @Double @[]] = tproject2 h844 in x872) ; x874 = x873 * x873 ; x883 = let [x875 @Natural @Double @[], x876 @Natural @Double @[], x877 @Natural @Double @[], x878 @Natural @Double @[]] = tproject1 h844 in x878 * negate (sin (let [x879 @Natural @Double @[], x880 @Natural @Double @[], x881 @Natural @Double @[], x882 @Natural @Double @[]] = tproject2 h844 in x882)) in [let [x884 @Natural @Double @[], x885 @Natural @Double @[], x886 @Natural @Double @[], x887 @Natural @Double @[]] = tproject1 h844 in x884 + let [x888 @Natural @Double @[], x889 @Natural @Double @[], x890 @Natural @Double @[], x891 @Natural @Double @[]] = tproject1 h844 in x889 * recip x874 + ((x883 * x873 + x883 * x873) * negate (recip (x874 * x874))) * let [x892 @Natural @Double @[], x893 @Natural @Double @[], x894 @Natural @Double @[], x895 @Natural @Double @[]] = tproject2 h844 in x893, let [x896 @Natural @Double @[], x897 @Natural @Double @[], x898 @Natural @Double @[], x899 @Natural @Double @[]] = tproject1 h844 in x896]) (\\h900 -> let x925 = cos (let [x921 @Natural @Double @[], x922 @Natural @Double @[], x923 @Natural @Double @[], x924 @Natural @Double @[]] = tproject2 h900 in x924) ; x926 = x925 * x925 ; x933 = negate (recip (x926 * x926)) * (let [x927 @Natural @Double @[], x928 @Natural @Double @[], x929 @Natural @Double @[], x930 @Natural @Double @[]] = tproject2 h900 in x928 * let [x931 @Natural @Double @[], x932 @Natural @Double @[]] = tproject1 h900 in x931) in [let [x934 @Natural @Double @[], x935 @Natural @Double @[]] = tproject1 h900 in x934 + let [x936 @Natural @Double @[], x937 @Natural @Double @[]] = tproject1 h900 in x937, recip x926 * let [x938 @Natural @Double @[], x939 @Natural @Double @[]] = tproject1 h900 in x938, 0, negate (sin (let [x940 @Natural @Double @[], x941 @Natural @Double @[], x942 @Natural @Double @[], x943 @Natural @Double @[]] = tproject2 h900 in x943)) * (x925 * x933 + x925 * x933)]) [let [x360 @Natural @Double @[], x361 @Natural @Double @[], x362 @Natural @Double @[]] = tproject1 h308 in x362] [rreplicate 22 (let [x363 @Natural @Double @[], x364 @Natural @Double @[], x365 @Natural @Double @[]] = tproject1 h308 in x364), let [x366 @Natural @Double @[], v367 @Natural @Double @[22], v368 @Natural @Double @[22]] = h350 in v367, rreplicate 22 (let [x369 @Natural @Double @[], x370 @Natural @Double @[]] = h345 in x369)] in v372, rreplicate 22 (let [x373 @Natural @Double @[], x374 @Natural @Double @[], x375 @Natural @Double @[]] = tproject1 h308 in x374), let [x379 @Natural @Double @[], v380 @Natural @Double @[22], v381 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\h944 -> let [x958 @Natural @Double @[]] = tproject1 h944 in let [x963 @Natural @Double @[], x964 @Natural @Double @[]] = let [x959 @Natural @Double @[]] = tproject1 h944 in let [x960 @Natural @Double @[], x961 @Natural @Double @[]] = tproject2 h944 in let x962 = cos x961 in [x959, recip (x962 * x962) * x959] in [x963, x958, x964]) (\\h965 -> let [x998 @Natural @Double @[], x999 @Natural @Double @[], x1000 @Natural @Double @[]] = tproject1 h965 in let h1007 = [let [x1001 @Natural @Double @[], x1002 @Natural @Double @[], x1003 @Natural @Double @[]] = tproject2 h965 in x1002, let [x1004 @Natural @Double @[], x1005 @Natural @Double @[], x1006 @Natural @Double @[]] = tproject2 h965 in x1006] ; x1010 = cos (let [x1008 @Natural @Double @[], x1009 @Natural @Double @[]] = h1007 in x1009) ; x1011 = x1010 * x1010 ; x1017 = let [x1012 @Natural @Double @[], x1013 @Natural @Double @[], x1014 @Natural @Double @[]] = tproject1 h965 in x1014 * negate (sin (let [x1015 @Natural @Double @[], x1016 @Natural @Double @[]] = h1007 in x1016)) in [let [x1018 @Natural @Double @[], x1019 @Natural @Double @[], x1020 @Natural @Double @[]] = tproject1 h965 in x1018, x998, ((x1017 * x1010 + x1017 * x1010) * negate (recip (x1011 * x1011))) * let [x1021 @Natural @Double @[], x1022 @Natural @Double @[], x1023 @Natural @Double @[]] = tproject2 h965 in x1021 + let [x1024 @Natural @Double @[], x1025 @Natural @Double @[], x1026 @Natural @Double @[]] = tproject1 h965 in x1024 * recip x1011]) (\\h1027 -> let [x1082 @Natural @Double @[], x1083 @Natural @Double @[], x1084 @Natural @Double @[]] = tproject1 h1027 in let h1091 = [let [x1085 @Natural @Double @[], x1086 @Natural @Double @[], x1087 @Natural @Double @[]] = tproject2 h1027 in x1086, let [x1088 @Natural @Double @[], x1089 @Natural @Double @[], x1090 @Natural @Double @[]] = tproject2 h1027 in x1090] ; x1094 = cos (let [x1092 @Natural @Double @[], x1093 @Natural @Double @[]] = h1091 in x1093) ; x1095 = x1094 * x1094 ; x1099 = negate (recip (x1095 * x1095)) * (let [x1096 @Natural @Double @[], x1097 @Natural @Double @[], x1098 @Natural @Double @[]] = tproject2 h1027 in x1096 * x1084) in [x1083 + recip x1095 * x1084 + x1082, 0.0, negate (sin (let [x1100 @Natural @Double @[], x1101 @Natural @Double @[]] = h1091 in x1101)) * (x1094 * x1099 + x1094 * x1099)]) [let [x376 @Natural @Double @[], x377 @Natural @Double @[], x378 @Natural @Double @[]] = tproject2 h308 in x376] h356 in v380, let [v382 @Natural @Double @[22], v383 @Natural @Double @[22]] = h356 in v382, let [v384 @Natural @Double @[22], v385 @Natural @Double @[22]] = h356 in v385] in [rsum (let [x387 @Natural @Double @[], v388 @Natural @Double @[22]] = h386 in v388), let [x389 @Natural @Double @[], v390 @Natural @Double @[22]] = h386 in x389]) (\\h1102 -> let h1142 = [let [x1136 @Natural @Double @[], x1137 @Natural @Double @[], x1138 @Natural @Double @[]] = tproject2 h1102 in x1137, let [x1139 @Natural @Double @[], x1140 @Natural @Double @[], x1141 @Natural @Double @[]] = tproject2 h1102 in x1141] ; h1147 = dmapAccumLDer (SNat @22) (\\h1208 -> let [x1222 @Natural @Double @[]] = tproject1 h1208 in let [x1227 @Natural @Double @[], x1228 @Natural @Double @[]] = let [x1223 @Natural @Double @[]] = tproject1 h1208 in let [x1226 @Natural @Double @[]] = let [x1224 @Natural @Double @[]] = tproject1 h1208 in let [x1225 @Natural @Double @[]] = tproject2 h1208 in [x1224 + tan x1225] in [x1226, x1223] in [x1227, x1222, x1228]) (\\h1229 -> let [x1254 @Natural @Double @[], x1255 @Natural @Double @[]] = tproject1 h1229 in let [x1265 @Natural @Double @[], x1266 @Natural @Double @[]] = let [x1256 @Natural @Double @[], x1257 @Natural @Double @[]] = tproject1 h1229 in let x1260 = cos (let [x1258 @Natural @Double @[], x1259 @Natural @Double @[]] = tproject2 h1229 in x1259) in [let [x1261 @Natural @Double @[], x1262 @Natural @Double @[]] = tproject1 h1229 in x1261 + let [x1263 @Natural @Double @[], x1264 @Natural @Double @[]] = tproject1 h1229 in x1264 * recip (x1260 * x1260), x1256] in [x1265, x1254, x1266]) (\\h1267 -> let [x1285 @Natural @Double @[], x1286 @Natural @Double @[], x1287 @Natural @Double @[]] = tproject1 h1267 in let x1290 = cos (let [x1288 @Natural @Double @[], x1289 @Natural @Double @[]] = tproject2 h1267 in x1289) in [x1286 + x1285 + x1287, recip (x1290 * x1290) * x1285]) [let [x1143 @Natural @Double @[], x1144 @Natural @Double @[]] = h1142 in x1144] [rreplicate 22 (let [x1145 @Natural @Double @[], x1146 @Natural @Double @[]] = h1142 in x1145)] ; h1153 = [let [x1148 @Natural @Double @[], v1149 @Natural @Double @[22], v1150 @Natural @Double @[22]] = h1147 in v1150, rreplicate 22 (let [x1151 @Natural @Double @[], x1152 @Natural @Double @[]] = h1142 in x1151)] ; h1156 = [let [x1154 @Natural @Double @[], x1155 @Natural @Double @[]] = tproject1 h1102 in x1155, 0] ; h1159 = [0, rreplicate 22 (let [x1157 @Natural @Double @[], x1158 @Natural @Double @[]] = tproject1 h1102 in x1157)] ; h1168 = [let [x1160 @Natural @Double @[], v1161 @Natural @Double @[22]] = h1159 in x1160 + let [x1162 @Natural @Double @[], v1163 @Natural @Double @[22]] = h1156 in x1162, let [x1164 @Natural @Double @[], v1165 @Natural @Double @[22]] = h1159 in v1165 + let [x1166 @Natural @Double @[], v1167 @Natural @Double @[22]] = h1156 in v1167] ; h1183 = dmapAccumLDer (SNat @22) (\\h1291 -> let [x1345 @Natural @Double @[]] = tproject1 h1291 in let [x1346 @Natural @Double @[], x1347 @Natural @Double @[], x1348 @Natural @Double @[], x1349 @Natural @Double @[]] = tproject2 h1291 in let h1350 = [x1348, x1349] ; x1353 = cos (let [x1351 @Natural @Double @[], x1352 @Natural @Double @[]] = h1350 in x1352) ; x1354 = x1353 * x1353 ; x1355 = negate (recip (x1354 * x1354)) * (x1347 * x1346) in [recip x1354 * x1346 + x1345, 0, negate (sin (let [x1356 @Natural @Double @[], x1357 @Natural @Double @[]] = h1350 in x1357)) * (x1353 * x1355 + x1353 * x1355)]) (\\h1358 -> let h1428 = [let [x1418 @Natural @Double @[], x1419 @Natural @Double @[], x1420 @Natural @Double @[], x1421 @Natural @Double @[], x1422 @Natural @Double @[]] = tproject2 h1358 in x1421, let [x1423 @Natural @Double @[], x1424 @Natural @Double @[], x1425 @Natural @Double @[], x1426 @Natural @Double @[], x1427 @Natural @Double @[]] = tproject2 h1358 in x1427] ; x1431 = cos (let [x1429 @Natural @Double @[], x1430 @Natural @Double @[]] = h1428 in x1430) ; x1432 = x1431 * x1431 ; x1433 = x1432 * x1432 ; x1434 = negate (recip x1433) ; x1445 = let [x1435 @Natural @Double @[], x1436 @Natural @Double @[], x1437 @Natural @Double @[], x1438 @Natural @Double @[], x1439 @Natural @Double @[]] = tproject2 h1358 in x1437 * let [x1440 @Natural @Double @[], x1441 @Natural @Double @[], x1442 @Natural @Double @[], x1443 @Natural @Double @[], x1444 @Natural @Double @[]] = tproject2 h1358 in x1441 ; x1446 = x1434 * x1445 ; x1454 = let [x1447 @Natural @Double @[], x1448 @Natural @Double @[], x1449 @Natural @Double @[], x1450 @Natural @Double @[], x1451 @Natural @Double @[]] = tproject1 h1358 in x1451 * negate (sin (let [x1452 @Natural @Double @[], x1453 @Natural @Double @[]] = h1428 in x1453)) ; x1455 = x1454 * x1431 + x1454 * x1431 ; x1476 = (((x1455 * x1432 + x1455 * x1432) * negate (recip (x1433 * x1433))) * -1.0) * x1445 + (let [x1456 @Natural @Double @[], x1457 @Natural @Double @[], x1458 @Natural @Double @[], x1459 @Natural @Double @[], x1460 @Natural @Double @[]] = tproject1 h1358 in x1458 * let [x1461 @Natural @Double @[], x1462 @Natural @Double @[], x1463 @Natural @Double @[], x1464 @Natural @Double @[], x1465 @Natural @Double @[]] = tproject2 h1358 in x1462 + let [x1466 @Natural @Double @[], x1467 @Natural @Double @[], x1468 @Natural @Double @[], x1469 @Natural @Double @[], x1470 @Natural @Double @[]] = tproject1 h1358 in x1467 * let [x1471 @Natural @Double @[], x1472 @Natural @Double @[], x1473 @Natural @Double @[], x1474 @Natural @Double @[], x1475 @Natural @Double @[]] = tproject2 h1358 in x1473) * x1434 in [let [x1477 @Natural @Double @[], x1478 @Natural @Double @[], x1479 @Natural @Double @[], x1480 @Natural @Double @[], x1481 @Natural @Double @[]] = tproject1 h1358 in x1477 + (x1455 * negate (recip (x1432 * x1432))) * let [x1482 @Natural @Double @[], x1483 @Natural @Double @[], x1484 @Natural @Double @[], x1485 @Natural @Double @[], x1486 @Natural @Double @[]] = tproject2 h1358 in x1483 + let [x1487 @Natural @Double @[], x1488 @Natural @Double @[], x1489 @Natural @Double @[], x1490 @Natural @Double @[], x1491 @Natural @Double @[]] = tproject1 h1358 in x1488 * recip x1432, 0.0, ((let [x1492 @Natural @Double @[], x1493 @Natural @Double @[], x1494 @Natural @Double @[], x1495 @Natural @Double @[], x1496 @Natural @Double @[]] = tproject1 h1358 in x1496 * cos (let [x1497 @Natural @Double @[], x1498 @Natural @Double @[]] = h1428 in x1498)) * -1.0) * (x1431 * x1446 + x1431 * x1446) + (x1454 * x1446 + x1476 * x1431 + x1454 * x1446 + x1476 * x1431) * negate (sin (let [x1499 @Natural @Double @[], x1500 @Natural @Double @[]] = h1428 in x1500))]) (\\h1501 -> let h1560 = [let [x1550 @Natural @Double @[], x1551 @Natural @Double @[], x1552 @Natural @Double @[], x1553 @Natural @Double @[], x1554 @Natural @Double @[]] = tproject2 h1501 in x1553, let [x1555 @Natural @Double @[], x1556 @Natural @Double @[], x1557 @Natural @Double @[], x1558 @Natural @Double @[], x1559 @Natural @Double @[]] = tproject2 h1501 in x1559] ; x1563 = cos (let [x1561 @Natural @Double @[], x1562 @Natural @Double @[]] = h1560 in x1562) ; x1564 = x1563 * x1563 ; x1565 = x1564 * x1564 ; x1566 = negate (recip x1565) ; x1577 = let [x1567 @Natural @Double @[], x1568 @Natural @Double @[], x1569 @Natural @Double @[], x1570 @Natural @Double @[], x1571 @Natural @Double @[]] = tproject2 h1501 in x1569 * let [x1572 @Natural @Double @[], x1573 @Natural @Double @[], x1574 @Natural @Double @[], x1575 @Natural @Double @[], x1576 @Natural @Double @[]] = tproject2 h1501 in x1573 ; x1578 = x1566 * x1577 ; x1584 = negate (sin (let [x1579 @Natural @Double @[], x1580 @Natural @Double @[]] = h1560 in x1580)) * let [x1581 @Natural @Double @[], x1582 @Natural @Double @[], x1583 @Natural @Double @[]] = tproject1 h1501 in x1583 ; x1585 = x1563 * x1584 + x1563 * x1584 ; x1586 = x1566 * x1585 ; x1587 = negate (recip (x1565 * x1565)) * (-1.0 * (x1577 * x1585)) ; x1596 = x1564 * x1587 + x1564 * x1587 + negate (recip (x1564 * x1564)) * (let [x1588 @Natural @Double @[], x1589 @Natural @Double @[], x1590 @Natural @Double @[], x1591 @Natural @Double @[], x1592 @Natural @Double @[]] = tproject2 h1501 in x1589 * let [x1593 @Natural @Double @[], x1594 @Natural @Double @[], x1595 @Natural @Double @[]] = tproject1 h1501 in x1593) in [let [x1597 @Natural @Double @[], x1598 @Natural @Double @[], x1599 @Natural @Double @[]] = tproject1 h1501 in x1597, let [x1600 @Natural @Double @[], x1601 @Natural @Double @[], x1602 @Natural @Double @[], x1603 @Natural @Double @[], x1604 @Natural @Double @[]] = tproject2 h1501 in x1602 * x1586 + recip x1564 * let [x1605 @Natural @Double @[], x1606 @Natural @Double @[], x1607 @Natural @Double @[]] = tproject1 h1501 in x1605, let [x1608 @Natural @Double @[], x1609 @Natural @Double @[], x1610 @Natural @Double @[], x1611 @Natural @Double @[], x1612 @Natural @Double @[]] = tproject2 h1501 in x1609 * x1586, 0, negate (sin (let [x1613 @Natural @Double @[], x1614 @Natural @Double @[]] = h1560 in x1614)) * (x1563 * x1596 + x1563 * x1596 + x1578 * x1584 + x1578 * x1584) + cos (let [x1615 @Natural @Double @[], x1616 @Natural @Double @[]] = h1560 in x1616) * (-1.0 * ((x1563 * x1578 + x1563 * x1578) * let [x1617 @Natural @Double @[], x1618 @Natural @Double @[], x1619 @Natural @Double @[]] = tproject1 h1501 in x1619))]) [let [x1169 @Natural @Double @[], v1170 @Natural @Double @[22]] = h1168 in x1169] [let [x1171 @Natural @Double @[], v1172 @Natural @Double @[22]] = h1168 in v1172, let [x1176 @Natural @Double @[], v1177 @Natural @Double @[22], v1178 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\h1620 -> let [x1634 @Natural @Double @[]] = tproject1 h1620 in let [x1639 @Natural @Double @[], x1640 @Natural @Double @[]] = let [x1635 @Natural @Double @[]] = tproject1 h1620 in let [x1636 @Natural @Double @[], x1637 @Natural @Double @[]] = tproject2 h1620 in let x1638 = cos x1637 in [x1635, recip (x1638 * x1638) * x1635] in [x1639, x1634, x1640]) (\\h1641 -> let [x1701 @Natural @Double @[], x1702 @Natural @Double @[], x1703 @Natural @Double @[]] = tproject1 h1641 in let h1710 = [let [x1704 @Natural @Double @[], x1705 @Natural @Double @[], x1706 @Natural @Double @[]] = tproject2 h1641 in x1705, let [x1707 @Natural @Double @[], x1708 @Natural @Double @[], x1709 @Natural @Double @[]] = tproject2 h1641 in x1709] ; x1713 = cos (let [x1711 @Natural @Double @[], x1712 @Natural @Double @[]] = h1710 in x1712) ; x1714 = x1713 * x1713 ; x1720 = let [x1715 @Natural @Double @[], x1716 @Natural @Double @[], x1717 @Natural @Double @[]] = tproject1 h1641 in x1717 * negate (sin (let [x1718 @Natural @Double @[], x1719 @Natural @Double @[]] = h1710 in x1719)) in [let [x1721 @Natural @Double @[], x1722 @Natural @Double @[], x1723 @Natural @Double @[]] = tproject1 h1641 in x1721, x1701, ((x1720 * x1713 + x1720 * x1713) * negate (recip (x1714 * x1714))) * let [x1724 @Natural @Double @[], x1725 @Natural @Double @[], x1726 @Natural @Double @[]] = tproject2 h1641 in x1724 + let [x1727 @Natural @Double @[], x1728 @Natural @Double @[], x1729 @Natural @Double @[]] = tproject1 h1641 in x1727 * recip x1714]) (\\h1730 -> let [x1761 @Natural @Double @[], x1762 @Natural @Double @[], x1763 @Natural @Double @[]] = tproject1 h1730 in let h1770 = [let [x1764 @Natural @Double @[], x1765 @Natural @Double @[], x1766 @Natural @Double @[]] = tproject2 h1730 in x1765, let [x1767 @Natural @Double @[], x1768 @Natural @Double @[], x1769 @Natural @Double @[]] = tproject2 h1730 in x1769] ; x1773 = cos (let [x1771 @Natural @Double @[], x1772 @Natural @Double @[]] = h1770 in x1772) ; x1774 = x1773 * x1773 ; x1778 = negate (recip (x1774 * x1774)) * (let [x1775 @Natural @Double @[], x1776 @Natural @Double @[], x1777 @Natural @Double @[]] = tproject2 h1730 in x1775 * x1763) in [x1762 + recip x1774 * x1763 + x1761, 0.0, negate (sin (let [x1779 @Natural @Double @[], x1780 @Natural @Double @[]] = h1770 in x1780)) * (x1773 * x1778 + x1773 * x1778)]) [let [x1173 @Natural @Double @[], x1174 @Natural @Double @[], x1175 @Natural @Double @[]] = tproject2 h1102 in x1173] h1153 in v1177, let [v1179 @Natural @Double @[22], v1180 @Natural @Double @[22]] = h1153 in v1179, let [v1181 @Natural @Double @[22], v1182 @Natural @Double @[22]] = h1153 in v1182] ; h1187 = [0, let [x1184 @Natural @Double @[], v1185 @Natural @Double @[22], v1186 @Natural @Double @[22]] = h1183 in v1185] ; h1197 = dmapAccumRDer (SNat @22) (\\h1781 -> let [x1792 @Natural @Double @[]] = tproject1 h1781 in let [x1793 @Natural @Double @[], x1794 @Natural @Double @[], x1795 @Natural @Double @[]] = tproject2 h1781 in let x1796 = cos x1795 in [x1792 + x1793, recip (x1796 * x1796) * x1792]) (\\h1797 -> let x1822 = cos (let [x1818 @Natural @Double @[], x1819 @Natural @Double @[], x1820 @Natural @Double @[], x1821 @Natural @Double @[]] = tproject2 h1797 in x1821) ; x1823 = x1822 * x1822 ; x1832 = let [x1824 @Natural @Double @[], x1825 @Natural @Double @[], x1826 @Natural @Double @[], x1827 @Natural @Double @[]] = tproject1 h1797 in x1827 * negate (sin (let [x1828 @Natural @Double @[], x1829 @Natural @Double @[], x1830 @Natural @Double @[], x1831 @Natural @Double @[]] = tproject2 h1797 in x1831)) in [let [x1833 @Natural @Double @[], x1834 @Natural @Double @[], x1835 @Natural @Double @[], x1836 @Natural @Double @[]] = tproject1 h1797 in x1833 + let [x1837 @Natural @Double @[], x1838 @Natural @Double @[], x1839 @Natural @Double @[], x1840 @Natural @Double @[]] = tproject1 h1797 in x1838, ((x1832 * x1822 + x1832 * x1822) * negate (recip (x1823 * x1823))) * let [x1841 @Natural @Double @[], x1842 @Natural @Double @[], x1843 @Natural @Double @[], x1844 @Natural @Double @[]] = tproject2 h1797 in x1841 + let [x1845 @Natural @Double @[], x1846 @Natural @Double @[], x1847 @Natural @Double @[], x1848 @Natural @Double @[]] = tproject1 h1797 in x1845 * recip x1823]) (\\h1849 -> let x1870 = cos (let [x1866 @Natural @Double @[], x1867 @Natural @Double @[], x1868 @Natural @Double @[], x1869 @Natural @Double @[]] = tproject2 h1849 in x1869) ; x1871 = x1870 * x1870 ; x1878 = negate (recip (x1871 * x1871)) * (let [x1872 @Natural @Double @[], x1873 @Natural @Double @[], x1874 @Natural @Double @[], x1875 @Natural @Double @[]] = tproject2 h1849 in x1872 * let [x1876 @Natural @Double @[], x1877 @Natural @Double @[]] = tproject1 h1849 in x1877) in [let [x1879 @Natural @Double @[], x1880 @Natural @Double @[]] = tproject1 h1849 in x1879 + recip x1871 * let [x1881 @Natural @Double @[], x1882 @Natural @Double @[]] = tproject1 h1849 in x1882, let [x1883 @Natural @Double @[], x1884 @Natural @Double @[]] = tproject1 h1849 in x1883, 0, negate (sin (let [x1885 @Natural @Double @[], x1886 @Natural @Double @[], x1887 @Natural @Double @[], x1888 @Natural @Double @[]] = tproject2 h1849 in x1888)) * (x1870 * x1878 + x1870 * x1878)]) [let [x1188 @Natural @Double @[], v1189 @Natural @Double @[22]] = h1187 in x1188] [let [x1190 @Natural @Double @[], v1191 @Natural @Double @[22]] = h1187 in v1191, let [x1192 @Natural @Double @[], v1193 @Natural @Double @[22], v1194 @Natural @Double @[22]] = h1147 in v1193, rreplicate 22 (let [x1195 @Natural @Double @[], x1196 @Natural @Double @[]] = h1142 in x1195)] in [let [x1198 @Natural @Double @[], v1199 @Natural @Double @[22], v1200 @Natural @Double @[22]] = h1183 in x1198, rsum (let [x1201 @Natural @Double @[], v1202 @Natural @Double @[22]] = h1197 in v1202) + rsum (let [x1203 @Natural @Double @[], v1204 @Natural @Double @[22], v1205 @Natural @Double @[22]] = h1183 in v1205), let [x1206 @Natural @Double @[], v1207 @Natural @Double @[22]] = h1197 in x1206]) [1.0] [let [x9 @Natural @Double @[], v10 @Natural @Double @[11]] = dmapAccumLDer (SNat @11) (\\h1889 -> let [x1900 @Natural @Double @[]] = tproject1 h1889 in let [x1904 @Natural @Double @[]] = let [x1901 @Natural @Double @[]] = tproject1 h1889 in let [x1902 @Natural @Double @[]] = tproject2 h1889 in [let [x1903 @Natural @Double @[]] = dmapAccumLDer (SNat @22) (\\h1905 -> let [x1912 @Natural @Double @[]] = tproject1 h1905 in let [x1913 @Natural @Double @[]] = tproject2 h1905 in [x1912 + tan x1913]) (\\h1914 -> let x1933 = cos (let [x1931 @Natural @Double @[], x1932 @Natural @Double @[]] = tproject2 h1914 in x1932) in [let [x1934 @Natural @Double @[], x1935 @Natural @Double @[]] = tproject1 h1914 in x1934 + let [x1936 @Natural @Double @[], x1937 @Natural @Double @[]] = tproject1 h1914 in x1937 * recip (x1933 * x1933)]) (\\h1938 -> let x1953 = cos (let [x1951 @Natural @Double @[], x1952 @Natural @Double @[]] = tproject2 h1938 in x1952) in [let [x1954 @Natural @Double @[]] = tproject1 h1938 in x1954, recip (x1953 * x1953) * let [x1955 @Natural @Double @[]] = tproject1 h1938 in x1955]) [x1902] [rreplicate 22 x1901] in x1903] in [x1904, x1900]) (\\h1956 -> let [x1982 @Natural @Double @[], x1983 @Natural @Double @[]] = tproject1 h1956 in [let [x1996 @Natural @Double @[]] = dmapAccumLDer (SNat @22) (\\h1998 -> let [x2032 @Natural @Double @[]] = tproject1 h1998 in let [x2033 @Natural @Double @[], x2034 @Natural @Double @[], x2035 @Natural @Double @[]] = tproject2 h1998 in let h2036 = [x2032, x2033] ; x2037 = cos x2035 in [let [x2038 @Natural @Double @[], x2039 @Natural @Double @[]] = h2036 in x2038 + let [x2040 @Natural @Double @[], x2041 @Natural @Double @[]] = h2036 in x2041 * recip (x2037 * x2037)]) (\\h2042 -> let h2112 = [let [x2104 @Natural @Double @[], x2105 @Natural @Double @[], x2106 @Natural @Double @[], x2107 @Natural @Double @[]] = tproject2 h2042 in x2106, let [x2108 @Natural @Double @[], x2109 @Natural @Double @[], x2110 @Natural @Double @[], x2111 @Natural @Double @[]] = tproject2 h2042 in x2111] ; x2115 = cos (let [x2113 @Natural @Double @[], x2114 @Natural @Double @[]] = h2112 in x2114) ; x2116 = x2115 * x2115 ; x2123 = let [x2117 @Natural @Double @[], x2118 @Natural @Double @[], x2119 @Natural @Double @[], x2120 @Natural @Double @[]] = tproject1 h2042 in x2120 * negate (sin (let [x2121 @Natural @Double @[], x2122 @Natural @Double @[]] = h2112 in x2122)) in [let [x2124 @Natural @Double @[], x2125 @Natural @Double @[], x2126 @Natural @Double @[], x2127 @Natural @Double @[]] = tproject1 h2042 in x2124 + let [x2128 @Natural @Double @[], x2129 @Natural @Double @[], x2130 @Natural @Double @[], x2131 @Natural @Double @[]] = tproject1 h2042 in x2129 * recip x2116 + ((x2123 * x2115 + x2123 * x2115) * negate (recip (x2116 * x2116))) * let [x2132 @Natural @Double @[], x2133 @Natural @Double @[], x2134 @Natural @Double @[], x2135 @Natural @Double @[]] = tproject2 h2042 in x2133]) (\\h2136 -> let h2193 = [let [x2185 @Natural @Double @[], x2186 @Natural @Double @[], x2187 @Natural @Double @[], x2188 @Natural @Double @[]] = tproject2 h2136 in x2187, let [x2189 @Natural @Double @[], x2190 @Natural @Double @[], x2191 @Natural @Double @[], x2192 @Natural @Double @[]] = tproject2 h2136 in x2192] ; x2196 = cos (let [x2194 @Natural @Double @[], x2195 @Natural @Double @[]] = h2193 in x2195) ; x2197 = x2196 * x2196 ; x2203 = negate (recip (x2197 * x2197)) * (let [x2198 @Natural @Double @[], x2199 @Natural @Double @[], x2200 @Natural @Double @[], x2201 @Natural @Double @[]] = tproject2 h2136 in x2199 * let [x2202 @Natural @Double @[]] = tproject1 h2136 in x2202) in [let [x2204 @Natural @Double @[]] = tproject1 h2136 in x2204, recip x2197 * let [x2205 @Natural @Double @[]] = tproject1 h2136 in x2205, 0, negate (sin (let [x2206 @Natural @Double @[], x2207 @Natural @Double @[]] = h2193 in x2207)) * (x2196 * x2203 + x2196 * x2203)]) [let [x1984 @Natural @Double @[], x1985 @Natural @Double @[]] = tproject1 h1956 in x1985] [rreplicate 22 (let [x1986 @Natural @Double @[], x1987 @Natural @Double @[]] = tproject1 h1956 in x1986), let [x1992 @Natural @Double @[], v1993 @Natural @Double @[22]] = dmapAccumLDer (SNat @22) (\\h2208 -> let [x2222 @Natural @Double @[]] = tproject1 h2208 in let [x2225 @Natural @Double @[]] = let [x2223 @Natural @Double @[]] = tproject1 h2208 in let [x2224 @Natural @Double @[]] = tproject2 h2208 in [x2223 + tan x2224] in [x2225, x2222]) (\\h2226 -> let [x2248 @Natural @Double @[], x2249 @Natural @Double @[]] = tproject1 h2226 in let x2252 = cos (let [x2250 @Natural @Double @[], x2251 @Natural @Double @[]] = tproject2 h2226 in x2251) in [let [x2253 @Natural @Double @[], x2254 @Natural @Double @[]] = tproject1 h2226 in x2253 + let [x2255 @Natural @Double @[], x2256 @Natural @Double @[]] = tproject1 h2226 in x2256 * recip (x2252 * x2252), x2248]) (\\h2257 -> let [x2280 @Natural @Double @[], x2281 @Natural @Double @[]] = tproject1 h2257 in let x2284 = cos (let [x2282 @Natural @Double @[], x2283 @Natural @Double @[]] = tproject2 h2257 in x2283) in [x2280 + x2281, recip (x2284 * x2284) * x2280]) [let [x1988 @Natural @Double @[], x1989 @Natural @Double @[]] = tproject2 h1956 in x1989] [rreplicate 22 (let [x1990 @Natural @Double @[], x1991 @Natural @Double @[]] = tproject2 h1956 in x1990)] in v1993, rreplicate 22 (let [x1994 @Natural @Double @[], x1995 @Natural @Double @[]] = tproject2 h1956 in x1994)] in x1996, x1982]) (\\h2285 -> let [x2305 @Natural @Double @[], x2306 @Natural @Double @[]] = tproject1 h2285 in let h2315 = dmapAccumRDer (SNat @22) (\\h2322 -> let [x2328 @Natural @Double @[]] = tproject1 h2322 in let [x2329 @Natural @Double @[], x2330 @Natural @Double @[]] = tproject2 h2322 in let x2331 = cos x2330 in [x2328, recip (x2331 * x2331) * x2328]) (\\h2332 -> let h2366 = [let [x2360 @Natural @Double @[], x2361 @Natural @Double @[], x2362 @Natural @Double @[]] = tproject2 h2332 in x2361, let [x2363 @Natural @Double @[], x2364 @Natural @Double @[], x2365 @Natural @Double @[]] = tproject2 h2332 in x2365] ; x2369 = cos (let [x2367 @Natural @Double @[], x2368 @Natural @Double @[]] = h2366 in x2368) ; x2370 = x2369 * x2369 ; x2376 = let [x2371 @Natural @Double @[], x2372 @Natural @Double @[], x2373 @Natural @Double @[]] = tproject1 h2332 in x2373 * negate (sin (let [x2374 @Natural @Double @[], x2375 @Natural @Double @[]] = h2366 in x2375)) in [let [x2377 @Natural @Double @[], x2378 @Natural @Double @[], x2379 @Natural @Double @[]] = tproject1 h2332 in x2377, ((x2376 * x2369 + x2376 * x2369) * negate (recip (x2370 * x2370))) * let [x2380 @Natural @Double @[], x2381 @Natural @Double @[], x2382 @Natural @Double @[]] = tproject2 h2332 in x2380 + let [x2383 @Natural @Double @[], x2384 @Natural @Double @[], x2385 @Natural @Double @[]] = tproject1 h2332 in x2383 * recip x2370]) (\\h2386 -> let h2417 = [let [x2411 @Natural @Double @[], x2412 @Natural @Double @[], x2413 @Natural @Double @[]] = tproject2 h2386 in x2412, let [x2414 @Natural @Double @[], x2415 @Natural @Double @[], x2416 @Natural @Double @[]] = tproject2 h2386 in x2416] ; x2420 = cos (let [x2418 @Natural @Double @[], x2419 @Natural @Double @[]] = h2417 in x2419) ; x2421 = x2420 * x2420 ; x2427 = negate (recip (x2421 * x2421)) * (let [x2422 @Natural @Double @[], x2423 @Natural @Double @[], x2424 @Natural @Double @[]] = tproject2 h2386 in x2422 * let [x2425 @Natural @Double @[], x2426 @Natural @Double @[]] = tproject1 h2386 in x2426) in [recip x2421 * let [x2428 @Natural @Double @[], x2429 @Natural @Double @[]] = tproject1 h2386 in x2429 + let [x2430 @Natural @Double @[], x2431 @Natural @Double @[]] = tproject1 h2386 in x2430, 0, negate (sin (let [x2432 @Natural @Double @[], x2433 @Natural @Double @[]] = h2417 in x2433)) * (x2420 * x2427 + x2420 * x2427)]) [x2305] [let [x2311 @Natural @Double @[], v2312 @Natural @Double @[22]] = dmapAccumLDer (SNat @22) (\\h2434 -> let [x2440 @Natural @Double @[]] = tproject1 h2434 in let [x2443 @Natural @Double @[]] = let [x2441 @Natural @Double @[]] = tproject1 h2434 in let [x2442 @Natural @Double @[]] = tproject2 h2434 in [x2441 + tan x2442] in [x2443, x2440]) (\\h2444 -> let [x2455 @Natural @Double @[], x2456 @Natural @Double @[]] = tproject1 h2444 in let x2459 = cos (let [x2457 @Natural @Double @[], x2458 @Natural @Double @[]] = tproject2 h2444 in x2458) in [let [x2460 @Natural @Double @[], x2461 @Natural @Double @[]] = tproject1 h2444 in x2460 + let [x2462 @Natural @Double @[], x2463 @Natural @Double @[]] = tproject1 h2444 in x2463 * recip (x2459 * x2459), x2455]) (\\h2464 -> let [x2471 @Natural @Double @[], x2472 @Natural @Double @[]] = tproject1 h2464 in let x2475 = cos (let [x2473 @Natural @Double @[], x2474 @Natural @Double @[]] = tproject2 h2464 in x2474) in [x2471 + x2472, recip (x2475 * x2475) * x2471]) [let [x2307 @Natural @Double @[], x2308 @Natural @Double @[]] = tproject2 h2285 in x2308] [rreplicate 22 (let [x2309 @Natural @Double @[], x2310 @Natural @Double @[]] = tproject2 h2285 in x2309)] in v2312, rreplicate 22 (let [x2313 @Natural @Double @[], x2314 @Natural @Double @[]] = tproject2 h2285 in x2313)] in [rsum (let [x2316 @Natural @Double @[], v2317 @Natural @Double @[22]] = h2315 in v2317) + x2306, let [x2319 @Natural @Double @[], v2320 @Natural @Double @[22]] = h2315 in x2319]) [1.1] [rreplicate 11 1.1] in v10, rreplicate 11 1.1] in [rsum (let [x13 @Natural @Double @[], v14 @Natural @Double @[11]] = h12 in v14) + let [x15 @Natural @Double @[], v16 @Natural @Double @[11]] = h12 in x15]"
