...
testSin0Scan1RevPP1 = do
  ...
  printAstPrettyButNested IM.empty (simplifyInlineAst a1)
    @?= "let v30 = rconst (rfromListLinear [2] [42.0,42.0]) ; v15 = rconst (rfromListLinear [3] [1.0,1.0,1.0]) in rproject (dmapAccumRDer (SNat @2) (\\h32 -> ttuple ([cos (rproject (tproject2 h32) 1) * (rproject (tproject2 h32) 0 + rproject (tproject1 h32) 0)], [0.0])) (\\h64 -> ttuple ([(rproject (tproject2 (tproject1 h64)) 1 * negate (sin (rproject (tproject2 (tproject2 h64)) 1))) * (rproject (tproject2 (tproject2 h64)) 0 + rproject (tproject1 (tproject2 h64)) 0) + (rproject (tproject2 (tproject1 h64)) 0 + rproject (tproject1 (tproject1 h64)) 0) * cos (rproject (tproject2 (tproject2 h64)) 1)], [0.0])) (\\h111 -> let x158 = cos (rproject (tproject2 (tproject2 h111)) 1) * rproject (tproject1 (tproject1 h111)) 0 in ttuple ([0.0 + x158], [0.0 + x158, 0.0 + negate (sin (rproject (tproject2 (tproject2 h111)) 1)) * ((rproject (tproject2 (tproject2 h111)) 0 + rproject (tproject1 (tproject2 h111)) 0) * rproject (tproject1 (tproject1 h111)) 0), 0.0])) [0.0] [rslice 1 2 v15, rproject (dmapAccumLDer (SNat @2) (\\h167 -> let x178 = sin (rproject (tproject1 h167) 0) in ttuple ([x178], [rproject (tproject1 h167) 0, x178])) (\\h180 -> let x197 = rproject (tproject1 (tproject1 h180)) 0 * cos (rproject (tproject1 (tproject2 h180)) 0) in ttuple ([x197], [rproject (tproject1 (tproject1 h180)) 0, x197])) (\\h199 -> ttuple ([cos (rproject (tproject1 (tproject2 h199)) 0) * (rproject (tproject2 (tproject1 h199)) 1 + rproject (tproject1 (tproject1 h199)) 0) + rproject (tproject2 (tproject1 h199)) 0], [0.0])) [1.1] [v30]) 1, v30]) 0 + v15 ! [0]"
...
testSin0rmapAccumRD01SN531b0PP = do
  ...
  printAstHVectorPrettyButNested
    ...
    @?= "[rfromS (sproject (dmapAccumLDer (SNat @0) (\\h22 -> ttuple ([sproject (tproject1 h22) 0], [0.0])) (\\h36 -> ttuple ([sproject (tproject1 (tproject1 h36)) 0], [0.0])) (\\h49 -> ttuple ([sproject (tproject1 (tproject1 h49)) 0], [0.0, 0.0])) [4.0] [sproject (dmapAccumRDer (SNat @0) (\\h66 -> ttuple ([sproject (tproject1 h66) 0], [sproject (tproject1 h66) 0])) (\\h74 -> ttuple ([sproject (tproject1 (tproject1 h74)) 0], [sproject (tproject1 (tproject1 h74)) 0])) (\\h84 -> ttuple ([0.0 + sproject (tproject2 (tproject1 h84)) 0 + sproject (tproject1 (tproject1 h84)) 0], [0.0])) [1.1] [rconst (rfromListLinear [0] [])]) 1, rconst (rfromListLinear [0] [])]) 0)]"
...
testSin0rmapAccumRD01SN531bRPP = do
  ...
  printAstHVectorSimple
    ...
    (simplifyInline
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 (rscalar 1.1)))
    @?= "dmkHVector (fromList [DynamicRanked (rproject (dmapAccumLDer (SNat @1) (\\h21 -> ttuple (dmkHVector (fromList [DynamicRanked (rproject (tproject1 h21) 0)]), dmkHVector (fromList [DynamicRanked 0.0]))) (\\h35 -> ttuple (dmkHVector (fromList [DynamicRanked (rproject (tproject1 (tproject1 h35)) 0)]), dmkHVector (fromList [DynamicRanked 0.0]))) (\\h48 -> ttuple (dmkHVector (fromList [DynamicRanked (rproject (tproject1 (tproject1 h48)) 0)]), dmkHVector (fromList [DynamicRanked 0.0, DynamicRanked 0.0]))) (dmkHVector (fromList [DynamicRanked (rconstant 4.0)])) (dmkHVector (fromList [DynamicRanked (rproject (dmapAccumRDer (SNat @1) (\\h65 -> ttuple (dmkHVector (fromList [DynamicRanked (rproject (tproject1 h65) 0)]), dmkHVector (fromList [DynamicRanked (rproject (tproject1 h65) 0)]))) (\\h73 -> ttuple (dmkHVector (fromList [DynamicRanked (rproject (tproject1 (tproject1 h73)) 0)]), dmkHVector (fromList [DynamicRanked (rproject (tproject1 (tproject1 h73)) 0)]))) (\\h83 -> ttuple (dmkHVector (fromList [DynamicRanked (rproject (tproject1 (tproject1 h83)) 0 + rproject (tproject2 (tproject1 h83)) 0)]), dmkHVector (fromList [DynamicRanked 0.0]))) (dmkHVector (fromList [DynamicRanked (rconstant 1.1)])) (dmkHVector (fromList [DynamicRanked (rconstant (rconst (rfromListLinear [1] [0.0])))]))) 1), DynamicRanked (rconstant (rconst (rfromListLinear [1] [0.0])))]))) 0)])"
