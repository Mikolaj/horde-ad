...
testSin0Fold0S = do
  assertEqualUpToEpsilon' 1e-10
    ...
    (rev' (let f :: forall f. ADReady f => f (TKS '[] Double) -> f (TKS '[] Double)
               f x0 = sfold @f @0 @'[] @'[] @(TKScalar Double) @(TKScalar Double)
                            (\x _a -> sin x)
                            x0 (srepl 0)
...
testSin0Fold6S = do
  assertEqualUpToEpsilon' 1e-10
    ...
    (rev' (let f :: forall f. ADReady f => f (TKS '[] Double) -> f (TKS '[2, 1] Double)
               f a0 = sfold @f @2 @'[2, 1] @'[] @(TKScalar Double) @(TKScalar Double)
                        (\x a -> str
...
testSin0Fold7S = do
  assertEqualUpToEpsilon' 1e-10
    ...
    (rev' (let f :: forall f. ADReady f => f (TKS '[] Double) -> f (TKS '[2, 5] Double)
               f a0 = sfold @f @2 @'[2, 5] @'[] @(TKScalar Double) @(TKScalar Double)
...
testSin0Fold8S = do
  assertEqualUpToEpsilon' 1e-10
    (rscalar (-2.200311410593445) :: RepN (TKR 0 Double))
    (rev' (let f :: forall f. ADReady f => f (TKS '[] Double) -> f (TKS '[2, 5] Double)
               f a0 = sfold @f @3 @'[2, 5] @'[] @(TKScalar Double) @(TKScalar Double)
...
testSin0Fold182Srev = do
  assertEqualUpToEpsilon 1e-10
    ...
    (rrev1 (let f :: forall f. ADReady f => f (TKS '[] Double) -> f (TKS '[5] Double)
                f a0 = sfold @f @1 @'[5] @'[] @(TKScalar Double) @(TKScalar Double)
...
testSin0Scan1Rev2PPA = do
  ...
  let (art, _) =
        revArtifactAdapt
                 True
                 (\x0 -> rscan @_ @_ @_ @_ @(TKScalar Double) (\x a -> sin x - a) x0
...
testSin0FoldNestedS1PP = do
  ...
  printAstPretty
    ...
    @?= "let v4 = tmapAccumRDer (SNat @11) <lambda> <lambda> <lambda> (sscalar 1.0) (tpair (sconcrete (sfromListLinear [11] [Z0,Z0,Z0,Z0,Z0,Z0,Z0,Z0,Z0,Z0,Z0]), tpair (tproject1 (tproject2 (tmapAccumLDer (SNat @11) <lambda> <lambda> <lambda> (sscalar 1.1) (sreplicate @_ @11 (sscalar 1.1)))), sreplicate @_ @11 (sscalar 1.1)))) in ssum @_ @11 (tproject2 v4) + tproject1 v4"
...
testSin0FoldNestedR1PP = do
  ...
  printAstPretty
    ...
    @?= "rfromS (let v4 = tmapAccumRDer (SNat @11) <lambda> <lambda> <lambda> (sscalar 1.0) (tpair (sconcrete (sfromListLinear [11] [Z0,Z0,Z0,Z0,Z0,Z0,Z0,Z0,Z0,Z0,Z0]), tpair (tproject1 (tproject2 (tmapAccumLDer (SNat @11) <lambda> <lambda> <lambda> (sscalar 1.1) (sreplicate @_ @11 (sscalar 1.1)))), sreplicate @_ @11 (sscalar 1.1)))) in ssum @_ @11 (sfromR (tproject2 v4)) + tproject1 v4)"
