  ...
  let a1 = rrev1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x a -> sin x - rfromD (a V.! 0))
                                ...
                                x0 (V.singleton $ DynamicRanked
                                    $ rfromList [x0 * 5, x0 * 7])) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v74 = rscanZipDer (\\x64 [x65 @Natural @Double @[]] -> sin x64 - x65) (\\x66 [x67 @Natural @Double @[]] x68 [x69 @Natural @Double @[]] -> x66 * cos x68 + x67 * rconst -1.0) (\\x71 x72 [x73 @Natural @Double @[]] -> (cos x72 * x71, rconst -1.0 * x71)) (rconst 1.1) (rfromList [rconst 1.1 * rconst 5.0, rconst 1.1 * rconst 7.0]) ; m75 = rfromList [rappend (rreverse (rscanZipDer (\\x76 [x77 @Natural @Double @[], x78 @Natural @Double @[]] -> cos x77 * x76) (\\x79 [x80 @Natural @Double @[], x81 @Natural @Double @[]] x82 [x83 @Natural @Double @[], x84 @Natural @Double @[]] -> (x80 * negate (sin x83)) * x82 + x79 * cos x83) (\\x88 x89 [x90 @Natural @Double @[], x91 @Natural @Double @[]] -> (cos x90 * x88, negate (sin x90) * (x89 * x88), 0)) (rconst 1.0) (rreverse (rslice 0 1 v74), rreplicate 1 (rconst 1.1 * rconst 5.0)))) (rconstant (rreplicate 1 (rconst 0.0))), rappend (rreverse (rscanZipDer (\\x127 [x128 @Natural @Double @[], x129 @Natural @Double @[]] -> cos x128 * x127) (\\x130 [x131 @Natural @Double @[], x132 @Natural @Double @[]] x133 [x134 @Natural @Double @[], x135 @Natural @Double @[]] -> (x131 * negate (sin x134)) * x133 + x130 * cos x134) (\\x139 x140 [x141 @Natural @Double @[], x142 @Natural @Double @[]] -> (cos x141 * x139, negate (sin x141) * (x140 * x139), 0)) (rconst 1.0) (rreverse (rslice 0 2 v74), rfromList [rconst 1.1 * rconst 7.0, rconst 1.1 * rconst 5.0]))) (rconstant (rreplicate 0 (rconst 0.0)))] ; v101 = rappend (rconstant (rreplicate 1 (rconst -1.0)) * rgather [1] (m75 ! [0]) (\\[i99] -> [1 + i99])) (rconstant (rreplicate 1 (rconst 0.0))) + rappend (rconstant (rreplicate 2 (rconst -1.0)) * rgather [2] (m75 ! [1]) (\\[i95] -> [1 + i95])) (rconstant (rreplicate 0 (rconst 0.0))) in rconst 5.0 * v101 ! [0] + rconst 7.0 * v101 ! [1] + rconst 1.0 + rsum (rgather [2] m75 (\\[i103] -> [i103, 0]))"
