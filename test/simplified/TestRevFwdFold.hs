...
testSin0rmapAccumRD01SN531b0PP = do
  ...
  printAstHVectorPrettyButNested
    ...
    @?= "let v58 = rconst (fromList [0] []) in let [x59 @[Natural] @Double @[], v60 @[Natural] @Double @[0]] = dmapAccumRDer (SNat @0) (\\[x61] [x62] -> [x61, x61]) (\\[x63] [x64] [x65] [x66] -> [x63, x63]) (\\[x67] [x68] [x69] [x70] -> [0.0 + x67 + x68, 0.0]) [1.1] [v58] in let [x72 @[Natural] @Double @[], v73 @Natural @Double @[0]] = dmapAccumLDer (SNat @0) (\\[x74] [x75, x76] -> [x74, 0]) (\\[x77] [x78, x79] [x80] [x81, x82] -> [x77, 0.0]) (\\[x83] [x84] [x85] [x86, x87] -> [x83, 0, 0]) [sfromR (rsum (rreplicate 4 1.0))] [v60, v58] in [rfromS x72]"
...
testSin0rmapAccumRD01SN531bSPP = do
  ...
  printAstHVectorPretty
    ...
    @?= "let v58 = sconst @[1] (fromList @[1] [0.0]) in let [x59 @[Natural] @Double @[], v60 @[Natural] @Double @[1]] = dmapAccumRDer (SNat @1) <lambda> <lambda> <lambda> [1.1] [v58] in let [x72 @[Natural] @Double @[], v73 @[Natural] @Double @[1]] = dmapAccumLDer (SNat @1) <lambda> <lambda> <lambda> [4.0] [v60, v58] in [x72]"
...
testSin0rmapAccumRD01SN531bRPP = do
  ...
  printAstHVectorSimple
    ...
    (simplifyAstHVector6
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 1.1))
    @?= "rletInHVector (rconstant (rconst (fromList [1] [0.0]))) (\\v58 -> dletHVectorInHVector (dmapAccumRDer (SNat @1) (\\[x61 @Natural @Double @[]] [x62 @Natural @Double @[]] -> dmkHVector (fromList [DynamicRanked x61, DynamicRanked x61])) (\\[x63 @Natural @Double @[]] [x64 @Natural @Double @[]] [x65 @Natural @Double @[]] [x66 @Natural @Double @[]] -> dmkHVector (fromList [DynamicRanked x63, DynamicRanked x63])) (\\[x67 @Natural @Double @[]] [x68 @Natural @Double @[]] [x69 @Natural @Double @[]] [x70 @Natural @Double @[]] -> dmkHVector (fromList [DynamicRanked (x67 + x68), DynamicRanked 0.0])) (fromList [DynamicRanked (rconstant 1.1)]) (fromList [DynamicRanked v58])) (\\[x59 @Natural @Double @[], v60 @Natural @Double @[1]] -> dletHVectorInHVector (dmapAccumLDer (SNat @1) (\\[x74 @Natural @Double @[]] [x75 @Natural @Double @[], x76 @Natural @Double @[]] -> dmkHVector (fromList [DynamicRanked x74, DynamicRankedDummy])) (\\[x77 @Natural @Double @[]] [x78 @Natural @Double @[], x79 @Natural @Double @[]] [x80 @Natural @Double @[]] [x81 @Natural @Double @[], x82 @Natural @Double @[]] -> dmkHVector (fromList [DynamicRanked x77, DynamicRanked 0.0])) (\\[x83 @Natural @Double @[]] [x84 @Natural @Double @[]] [x85 @Natural @Double @[]] [x86 @Natural @Double @[], x87 @Natural @Double @[]] -> dmkHVector (fromList [DynamicRanked x83, DynamicRankedDummy, DynamicRankedDummy])) (fromList [DynamicRanked (rconstant (rsum (rreplicate 4 1.0)))]) (fromList [DynamicRanked v60, DynamicRanked v58])) (\\[x72 @Natural @Double @[], v73 @Natural @Double @[1]] -> dmkHVector (fromList [DynamicRanked x72]))))"
...
testSin0rmapAccumRD01SN531b0PPj = do
  ...
  printAstHVectorPretty
    ...
    (simplifyAstHVector6
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 1.1))
    @?= "let t133 = rtranspose [2,0,1] (rreplicate 2 (rreplicate 2 (rconst (fromList [0] [])))) in let [m134 @[Natural] @Double @[2,2], t135 @[Natural] @Double @[0,2,2]] = dmapAccumRDer (SNat @0) <lambda> <lambda> <lambda> [sfromIntegral (sfromR (rtranspose [1,0] (rreplicate 2 (rconst (fromList [2] [0,1]))) + rreplicate 2 (rconst (fromList [2] [0,1])))) + sconst @[2,2] (fromList @[2,2] [0.0,0.0,0.0,0.0]) + sreplicate (sconst @[2] (fromList @[2] [0.0,0.0])) + sreplicate (sreplicate 1.1) + sconst @[2,2] (fromList @[2,2] [0.0,0.0,0.0,0.0]) + sconst @[2,2] (fromList @[2,2] [0.0,0.0,0.0,0.0]) + sconst @[2,2] (fromList @[2,2] [0.0,0.0,0.0,0.0])] [t133] in let [m165 @[Natural] @Double @[2,2], t166 @Natural @Double @[0,2,2]] = dmapAccumLDer (SNat @0) <lambda> <lambda> <lambda> [sscatter (sfromR (rreplicate 2 (rreplicate 2 1.0))) (\\[i164] -> [i164])] [t135, t133] in [rfromS (ssum (ssum m165))]"
...
testSin0rmapAccumRD01SN531bSPPj = do
  ...
  printAstHVectorPretty
    ...
    (simplifyAstHVector6
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicShaped @Double @'[] 1.1))
    @?= "let t134 = stranspose (sreplicate (sreplicate (sconst @[1] (fromList @[1] [0.0])))) in let [m135 @[Natural] @Double @[2,2], t136 @[Natural] @Double @[1,2,2]] = dmapAccumRDer (SNat @1) <lambda> <lambda> <lambda> [sfromIntegral (sfromR (rtranspose [1,0] (rreplicate 2 (rconst (fromList [2] [0,1]))) + rreplicate 2 (rconst (fromList [2] [0,1])))) + sconst @[2,2] (fromList @[2,2] [0.0,0.0,0.0,0.0]) + sreplicate (sconst @[2] (fromList @[2] [0.0,0.0])) + sreplicate (sreplicate 1.1) + sconst @[2,2] (fromList @[2,2] [0.0,0.0,0.0,0.0]) + sconst @[2,2] (fromList @[2,2] [0.0,0.0,0.0,0.0]) + sconst @[2,2] (fromList @[2,2] [0.0,0.0,0.0,0.0])] [t134] in let [m166 @[Natural] @Double @[2,2], t167 @[Natural] @Double @[1,2,2]] = dmapAccumLDer (SNat @1) <lambda> <lambda> <lambda> [sscatter (sconst @[2,2] (fromList @[2,2] [1.0,1.0,1.0,1.0])) (\\[i165] -> [i165])] [t136, t134] in [ssum (ssum m166)]"
...
testSin0rmapAccumRD01SN531bRPPj = do
  ...
  printAstHVectorPretty
    ...
    (simplifyAstHVector6
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 1.1))
    @?= "let t62 = rtranspose [2,0,1] (rreplicate 2 (rreplicate 2 (rconst (fromList [1] [0.0])))) in let [m63 @Natural @Double @[2,2], t64 @Natural @Double @[1,2,2]] = dmapAccumRDer (SNat @1) <lambda> <lambda> <lambda> [rfromIntegral (rtranspose [1,0] (rreplicate 2 (rconst (fromList [2] [0,1]))) + rreplicate 2 (rconst (fromList [2] [0,1]))) + rreplicate 2 (rreplicate 2 1.1)] [t62] in let [m77 @Natural @Double @[2,2], t78 @Natural @Double @[1,2,2]] = dmapAccumLDer (SNat @1) <lambda> <lambda> <lambda> [rreplicate 2 (rreplicate 2 1.0)] [t64, t62] in [rsum (rreshape [4] m77)]"
  ...
  let a1 = rrev1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x _a -> sin x)
                           ...
                           x0 (V.singleton $ DynamicRanked
                               $ rconst (OR.constant @Double @1 [2] 42))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v94 = rconst (fromList [2] [42.0,42.0]) in let [x95 @Natural @Double @[], v96 @Natural @Double @[2], v97 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [v94] in let [x116 @Natural @Double @[], v117 @Natural @Double @[2]] = dmapAccumRDer (SNat @2) <lambda> <lambda> <lambda> [0.0] [rreplicate 2 1.0, v96, v94] in x116 + 1.0"
  ...
  let a1 = rfwd1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x _a -> sin x)
                           ...
                           x0 (V.singleton $ DynamicRanked
                               $ rconst (OR.constant @Double @1 [2] 42))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v91 = rconst (fromList [2] [42.0,42.0]) in let [x92 @Natural @Double @[], v93 @Natural @Double @[2], v94 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [v91] in let [x96 @Natural @Double @[], v97 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [rreplicate 2 0.0, v93, v91] in rappend (rreplicate 1 1.1) v97"
  ...
  let a1 = rrev1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x a -> sin x - rfromD (a V.! 0))
                         ...
                         x0 (V.singleton $ DynamicRanked
                             $ rconst (OR.fromList @Double @1 [2] [5, 7]))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v102 = rconst (fromList [2] [5.0,7.0]) in let [x103 @Natural @Double @[], v104 @Natural @Double @[2], v105 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [v102] in let [x127 @Natural @Double @[], v128 @Natural @Double @[2]] = dmapAccumRDer (SNat @2) <lambda> <lambda> <lambda> [0.0] [rreplicate 2 1.0, v104, v102] in x127 + 1.0"
...
testSin0ScanDFwd2PP = do
  ...
  let a1 = rfwd1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x a -> sin x - rfromD (a V.! 0))
                         ...
                         $ rconst (OR.fromList @Double @1 [2] [5, 7]))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v102 = rconst (fromList [2] [5.0,7.0]) in let [x103 @Natural @Double @[], v104 @Natural @Double @[2], v105 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [v102] in let [x107 @Natural @Double @[], v108 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [rreplicate 2 0.0, v104, v102] in rappend (rreplicate 1 1.1) v108"
  ...
  let a1 = rfwd1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x a -> sin x - rfromD (a V.! 0))
                                ...
                                x0 (V.singleton $ DynamicRanked
                                    $ rfromList [x0 * 5, x0 * 7])) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v105 = rfromList [1.1 * 5.0, 1.1 * 7.0] in let [x106 @Natural @Double @[], v107 @Natural @Double @[2], v108 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [v105] in let [x113 @Natural @Double @[], v114 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) <lambda> <lambda> <lambda> [1.1] [rfromList [1.1 * 5.0, 1.1 * 7.0], v107, v105] in rappend (rreplicate 1 1.1) v114"
...
testSin0FoldNestedS1PP = do
  ...
  printAstHVectorPretty
    IM.empty
    (g @(AstRanked FullSpan) (V.singleton $ DynamicShaped @Double @'[] 1.1))
    @?= "let v908 = sscanDer <lambda> <lambda> <lambda> 1.1 (sreplicate 1.1) in let [x909 @[Natural] @Double @[], v910 @[Natural] @Double @[11]] = dmapAccumRDer (SNat @11) <lambda> <lambda> <lambda> [1.0] [sslice v908, sreplicate 1.1] in [x909 + 0.0 + ssum v910]"
...
testSin0FoldNestedR1PP = do
  ...
  printAstHVectorPretty
    IM.empty
    (g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 1.1))
    @?= "let v909 = rscanDer <lambda> <lambda> <lambda> 1.1 (rreplicate 11 1.1) ; x910 = rreshape [] (rreplicate 1 1.0) in let [x911 @Natural @Double @[], v912 @Natural @Double @[11]] = dmapAccumRDer (SNat @11) <lambda> <lambda> <lambda> [x910] [rslice 0 11 v909, rreplicate 11 1.1] in [rsum v912 + x911]"
...
testSin0FoldNestedR1SimpPP = do
  ...
  printAstHVectorPretty
    ...
    (simplifyAstHVector6
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 1.1))
    @?= "let [x911 @Natural @Double @[], v912 @Natural @Double @[11]] = dmapAccumRDer (SNat @11) <lambda> <lambda> <lambda> [1.0] [rslice 0 11 (rscanDer <lambda> <lambda> <lambda> 1.1 (rreplicate 11 1.1)), rreplicate 11 1.1] in [rsum v912 + x911]"
...
testSin0FoldNestedR1SimpNestedPP = do
  ...
  printAstHVectorPrettyButNested
    ...
    (simplifyAstHVector6
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 1.1))
    @?= "let [x911 @Natural @Double @[], v912 @Natural @Double @[11]] = dmapAccumRDer (SNat @11) (\\[x913] [x914, x915] -> let [x929 @Natural @Double @[], v930 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x931] [x932, x933] -> let x934 = cos x933 in [x931, recip (x934 * x934) * x931]) (\\[x935] [x936, x937] [x938] [x939, x940] -> let x941 = cos x940 ; x942 = x941 * x941 ; x944 = x937 * negate (sin x940) in [x935, ((x944 * x941 + x944 * x941) * negate (recip (x942 * x942))) * x938 + x935 * recip x942]) (\\[x948] [x949] [x950] [x951, x952] -> let x953 = cos x952 ; x954 = x953 * x953 ; x956 = negate (recip (x954 * x954)) * (x950 * x949) in [recip x954 * x949 + x948, 0, negate (sin x952) * (x953 * x956 + x953 * x956)]) [x913] [rslice 0 22 (rscanDer (\\x916 x917 -> x916 + tan x917) (\\x918 x919 x920 x921 -> let x922 = cos x921 in x918 + x919 * recip (x922 * x922)) (\\x924 x925 x926 -> let x927 = cos x926 in [x924, recip (x927 * x927) * x924]) x915 (rreplicate 22 x914)), rreplicate 22 x914] in [rsum v930, x929]) (\\[x957] [x958, x959] [x960] [x961, x962] -> let v975 = rscanDer (\\x963 x964 -> x963 + tan x964) (\\x965 x966 x967 x968 -> let x969 = cos x968 in x965 + x966 * recip (x969 * x969)) (\\x971 x972 x973 -> let x974 = cos x973 in [x971, recip (x974 * x974) * x971]) x962 (rreplicate 22 x961) in let [x978 @Natural @Double @[], v979 @Natural @Double @[22], v980 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x981] [x982, x983] -> let x984 = cos x983 in [x981, x981, recip (x984 * x984) * x981]) (\\[x986] [x987, x988] [x989] [x990, x991] -> let x992 = cos x991 ; x993 = x992 * x992 ; x995 = x988 * negate (sin x991) in [x986, x986, ((x995 * x992 + x995 * x992) * negate (recip (x993 * x993))) * x989 + x986 * recip x993]) (\\[x999] [x1000, x1001] [x1002] [x1003, x1004] -> let x1005 = cos x1004 ; x1006 = x1005 * x1005 ; x1008 = negate (recip (x1006 * x1006)) * (x1002 * x1001) in [x1000 + recip x1006 * x1001 + x999, 0.0, negate (sin x1004) * (x1005 * x1008 + x1005 * x1008)]) [x960] [rslice 0 22 v975, rreplicate 22 x961] in let [x1054 @Natural @Double @[], v1055 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x1056] [x1057, x1058, x1059, x1060, x1061] -> let x1062 = cos x1061 ; x1063 = x1062 * x1062 ; x1065 = x1058 * negate (sin x1061) in [x1056, ((x1065 * x1062 + x1065 * x1062) * negate (recip (x1063 * x1063))) * x1059 + x1056 * recip x1063]) (\\[x1069] [x1070, x1071, x1072, x1073, x1074] [x1075] [x1076, x1077, x1078, x1079, x1080] -> let x1081 = cos x1080 ; x1082 = x1081 * x1081 ; x1084 = negate (sin x1080) ; x1085 = x1077 * x1084 ; x1086 = x1085 * x1081 + x1085 * x1081 ; x1087 = x1082 * x1082 ; x1088 = negate (recip x1087) ; x1093 = x1071 * x1084 + ((x1074 * cos x1080) * -1.0) * x1077 ; x1094 = x1074 * negate (sin x1080) ; x1098 = x1094 * x1081 + x1094 * x1081 in [x1069, ((x1093 * x1081 + x1094 * x1085 + x1093 * x1081 + x1094 * x1085) * x1088 + (((x1098 * x1082 + x1098 * x1082) * negate (recip (x1087 * x1087))) * -1.0) * x1086) * x1078 + x1072 * (x1086 * x1088) + x1069 * recip x1082 + (x1098 * negate (recip (x1082 * x1082))) * x1075]) (\\[x1107] [x1108] [x1109] [x1110, x1111, x1112, x1113, x1114] -> let x1115 = cos x1114 ; x1116 = x1115 * x1115 ; x1118 = negate (sin x1114) ; x1119 = x1111 * x1118 ; x1120 = x1119 * x1115 + x1119 * x1115 ; x1121 = x1116 * x1116 ; x1122 = negate (recip x1121) ; x1127 = x1112 * x1108 ; x1128 = negate (recip (x1121 * x1121)) * (-1.0 * (x1120 * x1127)) ; x1129 = x1122 * x1127 ; x1130 = x1115 * x1129 + x1115 * x1129 ; x1131 = negate (recip (x1116 * x1116)) * (x1109 * x1108) + x1116 * x1128 + x1116 * x1128 in [recip x1116 * x1108 + x1107, 0, x1118 * x1130, (x1120 * x1122) * x1108, 0, negate (sin x1114) * (x1115 * x1131 + x1115 * x1131 + x1119 * x1129 + x1119 * x1129) + cos x1114 * (-1.0 * (x1111 * x1130))]) [x957] [rslice 0 22 (let [x1011 @Natural @Double @[], v1012 @Natural @Double @[22]] = dmapAccumLDer (SNat @22) (\\[x1013] [x1014, x1015, x1016] -> let x1019 = let x1017 = cos x1016 in x1013 + x1014 * recip (x1017 * x1017) in [x1019, x1019]) (\\[x1020] [x1021, x1022, x1023] [x1024] [x1025, x1026, x1027] -> let x1028 = cos x1027 ; x1029 = x1028 * x1028 ; x1033 = x1023 * negate (sin x1027) ; x1037 = x1020 + x1021 * recip x1029 + ((x1033 * x1028 + x1033 * x1028) * negate (recip (x1029 * x1029))) * x1025 in [x1037, x1037]) (\\[x1038] [x1039] [x1040] [x1041, x1042, x1043] -> let x1044 = cos x1043 ; x1045 = x1044 * x1044 ; x1051 = x1039 + x1038 ; x1052 = negate (recip (x1045 * x1045)) * (x1041 * x1051) in [x1051, recip x1045 * x1051, 0, negate (sin x1043) * (x1044 * x1052 + x1044 * x1052)]) [x959] [rreplicate 22 x958, rslice 0 22 v975, rreplicate 22 x961] in rappend (rreplicate 1 x959) v1012), rreplicate 22 x958, v979, rslice 0 22 v975, rreplicate 22 x961] in [rsum v1055, x1054]) (\\[x1133] [x1134] [x1135] [x1136, x1137] -> let v1150 = rscanDer (\\x1138 x1139 -> x1138 + tan x1139) (\\x1140 x1141 x1142 x1143 -> let x1144 = cos x1143 in x1140 + x1141 * recip (x1144 * x1144)) (\\x1146 x1147 x1148 -> let x1149 = cos x1148 in [x1146, recip (x1149 * x1149) * x1146]) x1137 (rreplicate 22 x1136) in let [x1153 @Natural @Double @[], v1154 @Natural @Double @[22], v1155 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x1156] [x1157, x1158] -> let x1159 = cos x1158 in [x1156, x1156, recip (x1159 * x1159) * x1156]) (\\[x1161] [x1162, x1163] [x1164] [x1165, x1166] -> let x1167 = cos x1166 ; x1168 = x1167 * x1167 ; x1170 = x1163 * negate (sin x1166) in [x1161, x1161, ((x1170 * x1167 + x1170 * x1167) * negate (recip (x1168 * x1168))) * x1164 + x1161 * recip x1168]) (\\[x1174] [x1175, x1176] [x1177] [x1178, x1179] -> let x1180 = cos x1179 ; x1181 = x1180 * x1180 ; x1183 = negate (recip (x1181 * x1181)) * (x1177 * x1176) in [x1175 + recip x1181 * x1176 + x1174, 0.0, negate (sin x1179) * (x1180 * x1183 + x1180 * x1183)]) [x1135] [rslice 0 22 v1150, rreplicate 22 x1136] in let [x1190 @Natural @Double @[], v1191 @Natural @Double @[22], v1192 @Natural @Double @[22]] = dmapAccumLDer (SNat @22) (\\[x1193] [x1194, x1195, x1196, x1197] -> let x1198 = cos x1197 ; x1199 = x1198 * x1198 ; x1201 = negate (recip (x1199 * x1199)) * (x1195 * x1194) in [recip x1199 * x1194 + x1193, 0, negate (sin x1197) * (x1198 * x1201 + x1198 * x1201)]) (\\[x1202] [x1203, x1204, x1205, x1206] [x1207] [x1208, x1209, x1210, x1211] -> let x1212 = cos x1211 ; x1213 = x1212 * x1212 ; x1215 = x1213 * x1213 ; x1216 = negate (recip x1215) ; x1217 = x1209 * x1208 ; x1218 = x1216 * x1217 ; x1221 = x1206 * negate (sin x1211) ; x1222 = x1221 * x1212 + x1221 * x1212 ; x1232 = (((x1222 * x1213 + x1222 * x1213) * negate (recip (x1215 * x1215))) * -1.0) * x1217 + (x1204 * x1208 + x1203 * x1209) * x1216 in [x1202 + (x1222 * negate (recip (x1213 * x1213))) * x1208 + x1203 * recip x1213, 0.0, ((x1206 * cos x1211) * -1.0) * (x1212 * x1218 + x1212 * x1218) + (x1221 * x1218 + x1232 * x1212 + x1221 * x1218 + x1232 * x1212) * negate (sin x1211)]) (\\[x1237] [x1238, x1239] [x1240] [x1241, x1242, x1243, x1244] -> let x1245 = cos x1244 ; x1246 = x1245 * x1245 ; x1248 = x1246 * x1246 ; x1249 = negate (recip x1248) ; x1250 = x1242 * x1241 ; x1251 = x1249 * x1250 ; x1257 = negate (sin x1244) * x1239 ; x1258 = x1245 * x1257 + x1245 * x1257 ; x1259 = x1249 * x1258 ; x1260 = negate (recip (x1248 * x1248)) * (-1.0 * (x1250 * x1258)) ; x1261 = negate (recip (x1246 * x1246)) * (x1241 * x1237) + x1246 * x1260 + x1246 * x1260 in [x1237, x1242 * x1259 + recip x1246 * x1237, x1241 * x1259, 0, negate (sin x1244) * (x1245 * x1261 + x1245 * x1261 + x1251 * x1257 + x1251 * x1257) + cos x1244 * (-1.0 * ((x1245 * x1251 + x1245 * x1251) * x1239))]) [x1134] [rreplicate 22 x1133, v1154, rslice 0 22 v1150, rreplicate 22 x1136] in let v1262 = rappend (rreplicate 0 0.0) (rappend v1191 (rreplicate 1 0.0)) in let [x1263 @Natural @Double @[], v1264 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x1265] [x1266, x1267, x1268] -> let x1269 = cos x1268 in [x1265 + x1266, recip (x1269 * x1269) * (x1265 + x1266)]) (\\[x1270] [x1271, x1272, x1273] [x1274] [x1275, x1276, x1277] -> let x1278 = cos x1277 ; x1279 = x1278 * x1278 ; x1283 = x1273 * negate (sin x1277) in [x1270 + x1271, ((x1283 * x1278 + x1283 * x1278) * negate (recip (x1279 * x1279))) * (x1274 + x1275) + (x1270 + x1271) * recip x1279]) (\\[x1288] [x1289] [x1290] [x1291, x1292, x1293] -> let x1294 = cos x1293 ; x1295 = x1294 * x1294 ; x1300 = recip x1295 * x1289 ; x1301 = negate (recip (x1295 * x1295)) * ((x1290 + x1291) * x1289) in [x1288 + x1300, x1288 + x1300, 0, negate (sin x1293) * (x1294 * x1301 + x1294 * x1301)]) [0.0] [rslice 1 22 v1262, rslice 0 22 v1150, rreplicate 22 x1136] in [x1190, rsum v1264 + rsum v1192, x1263 + v1262 ! [0]]) [1.0] [rslice 0 11 (rscanDer (\\x797 x798 -> rfoldDer (\\x799 x800 -> x799 + tan x800) (\\x801 x802 x803 x804 -> let x805 = cos x804 in x801 + x802 * recip (x805 * x805)) (\\x807 x808 x809 -> let x810 = cos x809 in [x807, recip (x810 * x810) * x807]) x798 (rreplicate 22 x797)) (\\x811 x812 x813 x814 -> let [x828 @Natural @Double @[]] = dmapAccumLDer (SNat @22) (\\[x829] [x830, x831, x832] -> [let x833 = cos x832 in x829 + x830 * recip (x833 * x833)]) (\\[x836] [x837, x838, x839] [x840] [x841, x842, x843] -> let x844 = cos x843 ; x845 = x844 * x844 ; x849 = x839 * negate (sin x843) in [x836 + x837 * recip x845 + ((x849 * x844 + x849 * x844) * negate (recip (x845 * x845))) * x841]) (\\[x854] [] [x855] [x856, x857, x858] -> let x859 = cos x858 ; x860 = x859 * x859 ; x864 = negate (recip (x860 * x860)) * (x856 * x854) in [x854, recip x860 * x854, 0, negate (sin x858) * (x859 * x864 + x859 * x864)]) [x812] [rreplicate 22 x811, rslice 0 22 (rscanDer (\\x815 x816 -> x815 + tan x816) (\\x817 x818 x819 x820 -> let x821 = cos x820 in x817 + x818 * recip (x821 * x821)) (\\x823 x824 x825 -> let x826 = cos x825 in [x823, recip (x826 * x826) * x823]) x814 (rreplicate 22 x813)), rreplicate 22 x813] in x828) (\\x865 x866 x867 -> let [x881 @Natural @Double @[], v882 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x883] [x884, x885] -> let x886 = cos x885 in [x883, recip (x886 * x886) * x883]) (\\[x887] [x888, x889] [x890] [x891, x892] -> let x893 = cos x892 ; x894 = x893 * x893 ; x896 = x889 * negate (sin x892) in [x887, ((x896 * x893 + x896 * x893) * negate (recip (x894 * x894))) * x890 + x887 * recip x894]) (\\[x900] [x901] [x902] [x903, x904] -> let x905 = cos x904 ; x906 = x905 * x905 ; x908 = negate (recip (x906 * x906)) * (x902 * x901) in [recip x906 * x901 + x900, 0, negate (sin x904) * (x905 * x908 + x905 * x908)]) [x865] [rslice 0 22 (rscanDer (\\x868 x869 -> x868 + tan x869) (\\x870 x871 x872 x873 -> let x874 = cos x873 in x870 + x871 * recip (x874 * x874)) (\\x876 x877 x878 -> let x879 = cos x878 in [x876, recip (x879 * x879) * x876]) x867 (rreplicate 22 x866)), rreplicate 22 x866] in [rsum v882, x881]) 1.1 (rreplicate 11 1.1)), rreplicate 11 1.1] in [rsum v912 + x911]"
...
testSin0MapAccumNestedR1PP = do
  ...
  printAstHVectorPrettyButNested
    ...
    (simplifyAstHVector6
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 1.1))
    @?= "let [x897 @Natural @Double @[], v898 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) (\\[x899] [x900] -> let [x901 @Natural @Double @[]] = dmapAccumLDer (SNat @2) (\\[x902] [x903] -> [x902 + tan x903]) (\\[x904] [x905] [x906] [x907] -> let x908 = cos x907 in [x904 + x905 * recip (x908 * x908)]) (\\[x911] [] [x912] [x913] -> let x914 = cos x913 in [x911, recip (x914 * x914) * x911]) [x900] [rreplicate 2 x899] in [x901, x899]) (\\[x915] [x916] [x917] [x918] -> let [x919 @Natural @Double @[]] = let [x920 @Natural @Double @[], v921 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) (\\[x922] [x923] -> [x922 + tan x923, x922]) (\\[x925] [x926] [x927] [x928] -> let x929 = cos x928 in [x925 + x926 * recip (x929 * x929), x925]) (\\[x932] [x933] [x934] [x935] -> let x936 = cos x935 in [x932 + x933, recip (x936 * x936) * x932]) [x918] [rreplicate 2 x917] in let [x938 @Natural @Double @[]] = dmapAccumLDer (SNat @2) (\\[x939] [x940, x941, x942] -> let x943 = cos x942 in [x939 + x940 * recip (x943 * x943)]) (\\[x946] [x947, x948, x949] [x950] [x951, x952, x953] -> let x954 = cos x953 ; x955 = x954 * x954 ; x959 = x949 * negate (sin x953) in [x946 + x947 * recip x955 + ((x959 * x954 + x959 * x954) * negate (recip (x955 * x955))) * x951]) (\\[x964] [] [x965] [x966, x967, x968] -> let x969 = cos x968 ; x970 = x969 * x969 ; x974 = negate (recip (x970 * x970)) * (x966 * x964) in [x964, recip x970 * x964, 0, negate (sin x968) * (x969 * x974 + x969 * x974)]) [x916] [rreplicate 2 x915, v921, rreplicate 2 x917] in [x938] in [x919, x915]) (\\[x975] [x976] [x977] [x978] -> let [x979 @Natural @Double @[], x980 @Natural @Double @[]] = let [x981 @Natural @Double @[], v982 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) (\\[x983] [x984] -> [x983 + tan x984, x983]) (\\[x986] [x987] [x988] [x989] -> let x990 = cos x989 in [x986 + x987 * recip (x990 * x990), x986]) (\\[x993] [x994] [x995] [x996] -> let x997 = cos x996 in [x993 + x994, recip (x997 * x997) * x993]) [x978] [rreplicate 2 x977] in let [x999 @Natural @Double @[], v1000 @Natural @Double @[2]] = dmapAccumRDer (SNat @2) (\\[x1001] [x1002, x1003] -> let x1004 = cos x1003 in [x1001, recip (x1004 * x1004) * x1001]) (\\[x1005] [x1006, x1007] [x1008] [x1009, x1010] -> let x1011 = cos x1010 ; x1012 = x1011 * x1011 ; x1014 = x1007 * negate (sin x1010) in [x1005, ((x1014 * x1011 + x1014 * x1011) * negate (recip (x1012 * x1012))) * x1008 + x1005 * recip x1012]) (\\[x1018] [x1019] [x1020] [x1021, x1022] -> let x1023 = cos x1022 ; x1024 = x1023 * x1023 ; x1026 = negate (recip (x1024 * x1024)) * (x1020 * x1019) in [recip x1024 * x1019 + x1018, 0, negate (sin x1022) * (x1023 * x1026 + x1023 * x1026)]) [x975] [v982, rreplicate 2 x977] in [rsum v1000, x999] in [x979 + x976, x980]) [1.1] [rreplicate 2 1.1] in let [x1028 @Natural @Double @[], v1029 @Natural @Double @[2]] = dmapAccumRDer (SNat @2) (\\[x1030] [x1031, x1032] -> let [x1033 @Natural @Double @[], v1034 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) (\\[x1035] [x1036] -> [x1035 + tan x1036, x1035]) (\\[x1038] [x1039] [x1040] [x1041] -> let x1042 = cos x1041 in [x1038 + x1039 * recip (x1042 * x1042), x1038]) (\\[x1045] [x1046] [x1047] [x1048] -> let x1049 = cos x1048 in [x1045 + x1046, recip (x1049 * x1049) * x1045]) [x1032] [rreplicate 2 x1031] in let [x1051 @Natural @Double @[], v1052 @Natural @Double @[2]] = dmapAccumRDer (SNat @2) (\\[x1053] [x1054, x1055] -> let x1056 = cos x1055 in [x1053, recip (x1056 * x1056) * x1053]) (\\[x1057] [x1058, x1059] [x1060] [x1061, x1062] -> let x1063 = cos x1062 ; x1064 = x1063 * x1063 ; x1066 = x1059 * negate (sin x1062) in [x1057, ((x1066 * x1063 + x1066 * x1063) * negate (recip (x1064 * x1064))) * x1060 + x1057 * recip x1064]) (\\[x1070] [x1071] [x1072] [x1073, x1074] -> let x1075 = cos x1074 ; x1076 = x1075 * x1075 ; x1078 = negate (recip (x1076 * x1076)) * (x1072 * x1071) in [recip x1076 * x1071 + x1070, 0, negate (sin x1074) * (x1075 * x1078 + x1075 * x1078)]) [x1030] [v1034, rreplicate 2 x1031] in [rsum v1052, x1051]) (\\[x1079] [x1080, x1081] [x1082] [x1083, x1084] -> let [x1086 @Natural @Double @[], v1087 @Natural @Double @[2], v1088 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) (\\[x1089] [x1090] -> [x1089 + tan x1090, x1089, x1089]) (\\[x1092] [x1093] [x1094] [x1095] -> let x1096 = cos x1095 in [x1092 + x1093 * recip (x1096 * x1096), x1092, x1092]) (\\[x1099] [x1100, x1101] [x1102] [x1103] -> let x1104 = cos x1103 in [x1100 + x1099 + x1101, recip (x1104 * x1104) * x1099]) [x1084] [rreplicate 2 x1083] in let [x1109 @Natural @Double @[], v1110 @Natural @Double @[2], v1111 @Natural @Double @[2]] = dmapAccumRDer (SNat @2) (\\[x1112] [x1113, x1114] -> let x1115 = cos x1114 in [x1112, x1112, recip (x1115 * x1115) * x1112]) (\\[x1117] [x1118, x1119] [x1120] [x1121, x1122] -> let x1123 = cos x1122 ; x1124 = x1123 * x1123 ; x1126 = x1119 * negate (sin x1122) in [x1117, x1117, ((x1126 * x1123 + x1126 * x1123) * negate (recip (x1124 * x1124))) * x1120 + x1117 * recip x1124]) (\\[x1130] [x1131, x1132] [x1133] [x1134, x1135] -> let x1136 = cos x1135 ; x1137 = x1136 * x1136 ; x1139 = negate (recip (x1137 * x1137)) * (x1133 * x1132) in [x1131 + recip x1137 * x1132 + x1130, 0.0, negate (sin x1135) * (x1136 * x1139 + x1136 * x1139)]) [x1082] [v1088, rreplicate 2 x1083] in let [x1142 @Natural @Double @[], v1143 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) (\\[x1144] [x1145, x1146, x1147] -> let x1148 = cos x1147 in [x1144 + x1145 * recip (x1148 * x1148), x1144]) (\\[x1151] [x1152, x1153, x1154] [x1155] [x1156, x1157, x1158] -> let x1159 = cos x1158 ; x1160 = x1159 * x1159 ; x1164 = x1154 * negate (sin x1158) in [x1151 + x1152 * recip x1160 + ((x1164 * x1159 + x1164 * x1159) * negate (recip (x1160 * x1160))) * x1156, x1151]) (\\[x1169] [x1170] [x1171] [x1172, x1173, x1174] -> let x1175 = cos x1174 ; x1176 = x1175 * x1175 ; x1182 = negate (recip (x1176 * x1176)) * (x1172 * x1169) in [x1169 + x1170, recip x1176 * x1169, 0, negate (sin x1174) * (x1175 * x1182 + x1175 * x1182)]) [x1081] [rreplicate 2 x1080, v1087, rreplicate 2 x1083] in let [x1183 @Natural @Double @[], v1184 @Natural @Double @[2]] = dmapAccumRDer (SNat @2) (\\[x1185] [x1186, x1187, x1188, x1189, x1190] -> let x1191 = cos x1190 ; x1192 = x1191 * x1191 ; x1194 = x1187 * negate (sin x1190) in [x1185, ((x1194 * x1191 + x1194 * x1191) * negate (recip (x1192 * x1192))) * x1188 + x1185 * recip x1192]) (\\[x1198] [x1199, x1200, x1201, x1202, x1203] [x1204] [x1205, x1206, x1207, x1208, x1209] -> let x1210 = cos x1209 ; x1211 = x1210 * x1210 ; x1213 = negate (sin x1209) ; x1214 = x1206 * x1213 ; x1215 = x1214 * x1210 + x1214 * x1210 ; x1216 = x1211 * x1211 ; x1217 = negate (recip x1216) ; x1222 = x1200 * x1213 + ((x1203 * cos x1209) * -1.0) * x1206 ; x1223 = x1203 * negate (sin x1209) ; x1227 = x1223 * x1210 + x1223 * x1210 in [x1198, ((x1222 * x1210 + x1223 * x1214 + x1222 * x1210 + x1223 * x1214) * x1217 + (((x1227 * x1211 + x1227 * x1211) * negate (recip (x1216 * x1216))) * -1.0) * x1215) * x1207 + x1201 * (x1215 * x1217) + x1198 * recip x1211 + (x1227 * negate (recip (x1211 * x1211))) * x1204]) (\\[x1236] [x1237] [x1238] [x1239, x1240, x1241, x1242, x1243] -> let x1244 = cos x1243 ; x1245 = x1244 * x1244 ; x1247 = negate (sin x1243) ; x1248 = x1240 * x1247 ; x1249 = x1248 * x1244 + x1248 * x1244 ; x1250 = x1245 * x1245 ; x1251 = negate (recip x1250) ; x1256 = x1241 * x1237 ; x1257 = negate (recip (x1250 * x1250)) * (-1.0 * (x1249 * x1256)) ; x1258 = x1251 * x1256 ; x1259 = x1244 * x1258 + x1244 * x1258 ; x1260 = negate (recip (x1245 * x1245)) * (x1238 * x1237) + x1245 * x1257 + x1245 * x1257 in [recip x1245 * x1237 + x1236, 0, x1247 * x1259, (x1249 * x1251) * x1237, 0, negate (sin x1243) * (x1244 * x1260 + x1244 * x1260 + x1248 * x1258 + x1248 * x1258) + cos x1243 * (-1.0 * (x1240 * x1259))]) [x1079] [v1143, rreplicate 2 x1080, v1110, v1088, rreplicate 2 x1083] in [rsum v1184, x1183]) (\\[x1262] [x1263] [x1264] [x1265, x1266] -> let [x1268 @Natural @Double @[], v1269 @Natural @Double @[2], v1270 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) (\\[x1271] [x1272] -> [x1271 + tan x1272, x1271, x1271]) (\\[x1274] [x1275] [x1276] [x1277] -> let x1278 = cos x1277 in [x1274 + x1275 * recip (x1278 * x1278), x1274, x1274]) (\\[x1281] [x1282, x1283] [x1284] [x1285] -> let x1286 = cos x1285 in [x1282 + x1281 + x1283, recip (x1286 * x1286) * x1281]) [x1266] [rreplicate 2 x1265] in let [x1291 @Natural @Double @[], v1292 @Natural @Double @[2], v1293 @Natural @Double @[2]] = dmapAccumRDer (SNat @2) (\\[x1294] [x1295, x1296] -> let x1297 = cos x1296 in [x1294, x1294, recip (x1297 * x1297) * x1294]) (\\[x1299] [x1300, x1301] [x1302] [x1303, x1304] -> let x1305 = cos x1304 ; x1306 = x1305 * x1305 ; x1308 = x1301 * negate (sin x1304) in [x1299, x1299, ((x1308 * x1305 + x1308 * x1305) * negate (recip (x1306 * x1306))) * x1302 + x1299 * recip x1306]) (\\[x1312] [x1313, x1314] [x1315] [x1316, x1317] -> let x1318 = cos x1317 ; x1319 = x1318 * x1318 ; x1321 = negate (recip (x1319 * x1319)) * (x1315 * x1314) in [x1313 + recip x1319 * x1314 + x1312, 0.0, negate (sin x1317) * (x1318 * x1321 + x1318 * x1321)]) [x1264] [v1270, rreplicate 2 x1265] in let [x1328 @Natural @Double @[], v1329 @Natural @Double @[2], v1330 @Natural @Double @[2]] = dmapAccumLDer (SNat @2) (\\[x1331] [x1332, x1333, x1334, x1335] -> let x1336 = cos x1335 ; x1337 = x1336 * x1336 ; x1339 = negate (recip (x1337 * x1337)) * (x1333 * x1332) in [recip x1337 * x1332 + x1331, 0, negate (sin x1335) * (x1336 * x1339 + x1336 * x1339)]) (\\[x1340] [x1341, x1342, x1343, x1344] [x1345] [x1346, x1347, x1348, x1349] -> let x1350 = cos x1349 ; x1351 = x1350 * x1350 ; x1353 = x1351 * x1351 ; x1354 = negate (recip x1353) ; x1355 = x1347 * x1346 ; x1356 = x1354 * x1355 ; x1359 = x1344 * negate (sin x1349) ; x1360 = x1359 * x1350 + x1359 * x1350 ; x1370 = (((x1360 * x1351 + x1360 * x1351) * negate (recip (x1353 * x1353))) * -1.0) * x1355 + (x1342 * x1346 + x1341 * x1347) * x1354 in [x1340 + (x1360 * negate (recip (x1351 * x1351))) * x1346 + x1341 * recip x1351, 0.0, ((x1344 * cos x1349) * -1.0) * (x1350 * x1356 + x1350 * x1356) + (x1359 * x1356 + x1370 * x1350 + x1359 * x1356 + x1370 * x1350) * negate (sin x1349)]) (\\[x1375] [x1376, x1377] [x1378] [x1379, x1380, x1381, x1382] -> let x1383 = cos x1382 ; x1384 = x1383 * x1383 ; x1386 = x1384 * x1384 ; x1387 = negate (recip x1386) ; x1388 = x1380 * x1379 ; x1389 = x1387 * x1388 ; x1395 = negate (sin x1382) * x1377 ; x1396 = x1383 * x1395 + x1383 * x1395 ; x1397 = x1387 * x1396 ; x1398 = negate (recip (x1386 * x1386)) * (-1.0 * (x1388 * x1396)) ; x1399 = negate (recip (x1384 * x1384)) * (x1379 * x1375) + x1384 * x1398 + x1384 * x1398 in [x1375, x1380 * x1397 + recip x1384 * x1375, x1379 * x1397, 0, negate (sin x1382) * (x1383 * x1399 + x1383 * x1399 + x1389 * x1395 + x1389 * x1395) + cos x1382 * (-1.0 * ((x1383 * x1389 + x1383 * x1389) * x1377))]) [x1263] [rreplicate 2 x1262, v1292, v1270, rreplicate 2 x1265] in let [x1402 @Natural @Double @[], v1403 @Natural @Double @[2]] = dmapAccumRDer (SNat @2) (\\[x1404] [x1405, x1406, x1407] -> let x1408 = cos x1407 in [x1404 + x1405, recip (x1408 * x1408) * x1404]) (\\[x1410] [x1411, x1412, x1413] [x1414] [x1415, x1416, x1417] -> let x1418 = cos x1417 ; x1419 = x1418 * x1418 ; x1423 = x1413 * negate (sin x1417) in [x1410 + x1411, ((x1423 * x1418 + x1423 * x1418) * negate (recip (x1419 * x1419))) * x1414 + x1410 * recip x1419]) (\\[x1427] [x1428] [x1429] [x1430, x1431, x1432] -> let x1433 = cos x1432 ; x1434 = x1433 * x1433 ; x1439 = negate (recip (x1434 * x1434)) * (x1429 * x1428) in [recip x1434 * x1428 + x1427, x1427, 0, negate (sin x1432) * (x1433 * x1439 + x1433 * x1439)]) [0.0] [v1329, v1269, rreplicate 2 x1265] in [x1328, rsum v1403 + rsum v1330, x1402]) [1.0] [v898, rreplicate 2 1.1] in [rsum v1029 + x1028]"
