...
testSin0Scan1RevPP1 = do
  ...
  printAstPrettyButNested IM.empty (simplifyInlineAst a1)
    @?= "let v30 = rconst (rfromListLinear [2] [42.0,42.0]) ; v15 = rconst (rfromListLinear [3] [1.0,1.0,1.0]) in rproject (dmapAccumRDer (SNat @2) (\\h32 -> [cos (rproject (tproject2 h32) 1) * (rproject (tproject2 h32) 0 + rproject (tproject1 h32) 0), 0]) (\\h68 -> [(rproject (tproject1 h68) 2 * negate (sin (rproject (tproject2 h68) 2))) * (rproject (tproject2 h68) 1 + rproject (tproject2 h68) 0) + (rproject (tproject1 h68) 1 + rproject (tproject1 h68) 0) * cos (rproject (tproject2 h68) 2), 0.0]) (\\h137 -> let x182 = cos (rproject (tproject2 h137) 2) * rproject (tproject1 h137) 0 in [x182, x182, negate (sin (rproject (tproject2 h137) 2)) * ((rproject (tproject2 h137) 1 + rproject (tproject2 h137) 0) * rproject (tproject1 h137) 0), 0]) [0.0] [rslice 1 2 v15, rproject (dmapAccumLDer (SNat @2) (\\h197 -> let x209 = sin (rproject (tproject1 h197) 0) in [x209, rproject (tproject1 h197) 0, x209]) (\\h211 -> let x238 = rproject (tproject1 h211) 0 * cos (rproject (tproject2 h211) 0) in [x238, rproject (tproject1 h211) 0, x238]) (\\h241 -> [cos (rproject (tproject2 h241) 0) * (rproject (tproject1 h241) 2 + rproject (tproject1 h241) 0) + rproject (tproject1 h241) 1, 0.0]) [1.1] [v30]) 1, v30]) 0 + v15 ! [0]"
...
testSin0ScanFwdPP = do
  ...
  let a1 = rfwd1 @(AstRanked PrimalSpan) @Double @0 @1
                 (\x0 -> rscan (\x _a -> sin x) x0
                           (rrepl @Double @1 [2] 42)) (rscalar 1.1)
  printAstPrettyButNested IM.empty (simplifyInlineAst a1)
    @?= "let v12 = rconst (rfromListLinear [2] [42.0,42.0]) in rappend (rreplicate 1 1.0) (rproject (dmapAccumLDer (SNat @2) (\\h13 -> let x36 = rproject (tproject1 h13) 0 * cos (rproject (tproject2 h13) 1) in [x36, x36]) (\\h41 -> let x66 = rproject (tproject1 h41) 0 * cos (rproject (tproject2 h41) 2) + (rproject (tproject1 h41) 2 * negate (sin (rproject (tproject2 h41) 2))) * rproject (tproject2 h41) 0 in [x66, x66]) (\\h75 -> let x99 = rproject (tproject1 h75) 1 + rproject (tproject1 h75) 0 in [cos (rproject (tproject2 h75) 2) * x99, 0, negate (sin (rproject (tproject2 h75) 2)) * (rproject (tproject2 h75) 0 * x99), 0]) [1.0] [rreplicate 2 0.0, rproject (dmapAccumLDer (SNat @2) (\\h108 -> let x115 = sin (rproject (tproject1 h108) 0) in [x115, rproject (tproject1 h108) 0, x115]) (\\h118 -> let x125 = rproject (tproject1 h118) 0 * cos (rproject (tproject2 h118) 0) in [x125, rproject (tproject1 h118) 0, x125]) (\\h128 -> [cos (rproject (tproject2 h128) 0) * (rproject (tproject1 h128) 2 + rproject (tproject1 h128) 0) + rproject (tproject1 h128) 1, 0.0]) [1.1] [v12]) 1, v12]) 1)"
...
testSin0ScanFwdPPFull = do
  ...
  let a1 = rfwd1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscan (\x _a -> sin x) x0
                           (rrepl @Double @1 [2] 42)) (rscalar 1.1)
  printAstPrettyButNested IM.empty (simplifyInlineAst a1)
    @?= "rproject ((\\h1 -> let v12 = rconst (rfromListLinear [2] [42.0,42.0]) in [rappend (rreplicate 1 (rproject (tproject1 h1) 0)) (rproject (dmapAccumLDer (SNat @2) (\\h13 -> let x36 = rproject (tproject1 h13) 0 * cos (rproject (tproject2 h13) 1) in [x36, x36]) (\\h41 -> let x66 = rproject (tproject1 h41) 0 * cos (rproject (tproject2 h41) 2) + (rproject (tproject1 h41) 2 * negate (sin (rproject (tproject2 h41) 2))) * rproject (tproject2 h41) 0 in [x66, x66]) (\\h75 -> let x99 = rproject (tproject1 h75) 1 + rproject (tproject1 h75) 0 in [cos (rproject (tproject2 h75) 2) * x99, 0, negate (sin (rproject (tproject2 h75) 2)) * (rproject (tproject2 h75) 0 * x99), 0]) [rproject (tproject1 h1) 0] [rreplicate 2 0.0, rproject (dmapAccumLDer (SNat @2) (\\h108 -> let x115 = sin (rproject (tproject1 h108) 0) in [x115, rproject (tproject1 h108) 0, x115]) (\\h118 -> let x125 = rproject (tproject1 h118) 0 * cos (rproject (tproject2 h118) 0) in [x125, rproject (tproject1 h118) 0, x125]) (\\h128 -> [cos (rproject (tproject2 h128) 0) * (rproject (tproject1 h128) 2 + rproject (tproject1 h128) 0) + rproject (tproject1 h128) 1, 0.0]) [rproject (tproject2 h1) 0] [v12]) 1, v12]) 1)]) (ttuple ([1.0], [1.1]))) 0"
...
testSin0rmapAccumRD01SN531b0PP = do
  ...
  printAstHVectorPrettyButNested
    ...
    @?= "[rfromS (sproject (dmapAccumLDer (SNat @0) (\\h22 -> [sproject (tproject1 h22) 0, 0]) (\\h38 -> [sproject (tproject1 h38) 0, 0.0]) (\\h53 -> [sproject (tproject1 h53) 0, 0, 0]) [4.0] [sproject (dmapAccumRDer (SNat @0) (\\h67 -> [sproject (tproject1 h67) 0, sproject (tproject1 h67) 0]) (\\h77 -> [sproject (tproject1 h77) 0, sproject (tproject1 h77) 0]) (\\h94 -> [0.0 + sproject (tproject1 h94) 1 + sproject (tproject1 h94) 0, 0.0]) [1.1] [rconst (rfromListLinear [0] [])]) 1, rconst (rfromListLinear [0] [])]) 0)]"
...
testSin0rmapAccumRD01SN531bRPP = do
  ...
  printAstHVectorSimple
    ...
    (simplifyInline
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 (rscalar 1.1)))
    @?= "dmkHVector (fromList [DynamicRanked (rproject (dmapAccumLDer (SNat @1) (\\h21 -> dmkHVector (fromList [DynamicRanked (rproject (tproject1 h21) 0), DynamicRankedDummy])) (\\h37 -> dmkHVector (fromList [DynamicRanked (rproject (tproject1 h37) 0), DynamicRanked 0.0])) (\\h52 -> dmkHVector (fromList [DynamicRanked (rproject (tproject1 h52) 0), DynamicRankedDummy, DynamicRankedDummy])) (dmkHVector (fromList [DynamicRanked (rconstant 4.0)])) (dmkHVector (fromList [DynamicRanked (rproject (dmapAccumRDer (SNat @1) (\\h66 -> dmkHVector (fromList [DynamicRanked (rproject (tproject1 h66) 0), DynamicRanked (rproject (tproject1 h66) 0)])) (\\h76 -> dmkHVector (fromList [DynamicRanked (rproject (tproject1 h76) 0), DynamicRanked (rproject (tproject1 h76) 0)])) (\\h93 -> dmkHVector (fromList [DynamicRanked (rproject (tproject1 h93) 0 + rproject (tproject1 h93) 1), DynamicRanked 0.0])) (dmkHVector (fromList [DynamicRanked (rconstant 1.1)])) (dmkHVector (fromList [DynamicRanked (rconstant (rconst (rfromListLinear [1] [0.0])))]))) 1), DynamicRanked (rconstant (rconst (rfromListLinear [1] [0.0])))]))) 0)])"
...
testSin0FoldNestedR1SimpNestedPP = do
  ...
  printAstHVectorPrettyButNested
    ...
    (simplifyInline
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 (rscalar 1.1)))
    @?= "let h14 = dmapAccumRDer (SNat @11) (\\h19 -> let h66 = dmapAccumRDer (SNat @22) (\\h71 -> let x103 = cos (rproject (tproject2 h71) 1) in [rproject (tproject1 h71) 0, recip (x103 * x103) * rproject (tproject1 h71) 0]) (\\h106 -> let x164 = cos (rproject (tproject2 h106) 2) ; x165 = x164 * x164 ; x172 = rproject (tproject1 h106) 2 * negate (sin (rproject (tproject2 h106) 2)) in [rproject (tproject1 h106) 0, ((x172 * x164 + x172 * x164) * negate (recip (x165 * x165))) * rproject (tproject2 h106) 0 + rproject (tproject1 h106) 0 * recip x165]) (\\h182 -> let x234 = cos (rproject (tproject2 h182) 2) ; x235 = x234 * x234 ; x241 = negate (recip (x235 * x235)) * (rproject (tproject2 h182) 0 * rproject (tproject1 h182) 1) in [recip x235 * rproject (tproject1 h182) 1 + rproject (tproject1 h182) 0, 0, negate (sin (rproject (tproject2 h182) 2)) * (x234 * x241 + x234 * x241)]) [rproject (tproject1 h19) 0] [rproject (dmapAccumLDer (SNat @22) (\\h249 -> [rproject (tproject1 h249) 0 + tan (rproject (tproject2 h249) 0), rproject (tproject1 h249) 0]) (\\h265 -> let x302 = cos (rproject (tproject2 h265) 1) in [rproject (tproject1 h265) 0 + rproject (tproject1 h265) 1 * recip (x302 * x302), rproject (tproject1 h265) 0]) (\\h309 -> let x332 = cos (rproject (tproject2 h309) 1) in [rproject (tproject1 h309) 0 + rproject (tproject1 h309) 1, recip (x332 * x332) * rproject (tproject1 h309) 0]) [rproject (tproject2 h19) 1] [rreplicate 22 (rproject (tproject2 h19) 0)]) 1, rreplicate 22 (rproject (tproject2 h19) 0)] in [rsum (rproject h66 1), rproject h66 0]) (\\h339 -> let h400 = dmapAccumLDer (SNat @22) (\\h444 -> [rproject (tproject1 h444) 0 + tan (rproject (tproject2 h444) 0), rproject (tproject1 h444) 0, rproject (tproject1 h444) 0]) (\\h460 -> let x487 = cos (rproject (tproject2 h460) 1) in [rproject (tproject1 h460) 0 + rproject (tproject1 h460) 1 * recip (x487 * x487), rproject (tproject1 h460) 0, rproject (tproject1 h460) 0]) (\\h496 -> let x524 = cos (rproject (tproject2 h496) 1) in [rproject (tproject1 h496) 1 + rproject (tproject1 h496) 0 + rproject (tproject1 h496) 2, recip (x524 * x524) * rproject (tproject1 h496) 0]) [rproject (tproject2 h339) 2] [rreplicate 22 (rproject (tproject2 h339) 1)] ; h439 = dmapAccumRDer (SNat @22) (\\h537 -> let x593 = cos (rproject (tproject2 h537) 4) ; x594 = x593 * x593 ; x605 = rproject (tproject2 h537) 1 * negate (sin (rproject (tproject2 h537) 4)) in [rproject (tproject1 h537) 0, ((x605 * x593 + x605 * x593) * negate (recip (x594 * x594))) * rproject (tproject2 h537) 2 + rproject (tproject1 h537) 0 * recip x594]) (\\h613 -> let x716 = cos (rproject (tproject2 h613) 5) ; x717 = x716 * x716 ; x724 = negate (sin (rproject (tproject2 h613) 5)) ; x731 = rproject (tproject2 h613) 2 * x724 ; x732 = x717 * x717 ; x733 = x731 * x716 + x731 * x716 ; x734 = negate (recip x732) ; x759 = rproject (tproject1 h613) 2 * x724 + ((rproject (tproject1 h613) 5 * cos (rproject (tproject2 h613) 5)) * -1.0) * rproject (tproject2 h613) 2 ; x772 = rproject (tproject1 h613) 5 * negate (sin (rproject (tproject2 h613) 5)) ; x773 = x772 * x716 + x772 * x716 in [rproject (tproject1 h613) 0, ((x759 * x716 + x772 * x731 + x759 * x716 + x772 * x731) * x734 + (((x773 * x717 + x773 * x717) * negate (recip (x732 * x732))) * -1.0) * x733) * rproject (tproject2 h613) 3 + rproject (tproject1 h613) 3 * (x733 * x734) + rproject (tproject1 h613) 0 * recip x717 + (x773 * negate (recip (x717 * x717))) * rproject (tproject2 h613) 0]) (\\h804 -> let x896 = cos (rproject (tproject2 h804) 5) ; x897 = x896 * x896 ; x904 = negate (sin (rproject (tproject2 h804) 5)) ; x911 = rproject (tproject2 h804) 2 * x904 ; x912 = x897 * x897 ; x913 = x911 * x896 + x911 * x896 ; x914 = negate (recip x912) ; x923 = rproject (tproject2 h804) 3 * rproject (tproject1 h804) 1 ; x924 = negate (recip (x912 * x912)) * (-1.0 * (x913 * x923)) ; x925 = x914 * x923 ; x926 = x896 * x925 + x896 * x925 ; x935 = x897 * x924 + x897 * x924 + negate (recip (x897 * x897)) * (rproject (tproject2 h804) 0 * rproject (tproject1 h804) 1) in [recip x897 * rproject (tproject1 h804) 1 + rproject (tproject1 h804) 0, 0, x904 * x926, (x913 * x914) * rproject (tproject1 h804) 1, 0, negate (sin (rproject (tproject2 h804) 5)) * (x896 * x935 + x896 * x935 + x911 * x925 + x911 * x925) + cos (rproject (tproject2 h804) 5) * (-1.0 * (rproject (tproject2 h804) 2 * x926))]) [rproject (tproject1 h339) 0] [rproject (dmapAccumLDer (SNat @22) (\\h960 -> let x978 = cos (rproject (tproject2 h960) 2) in [rproject (tproject1 h960) 0 + rproject (tproject2 h960) 0 * recip (x978 * x978), rproject (tproject1 h960) 0]) (\\h984 -> let x1027 = cos (rproject (tproject2 h984) 3) ; x1028 = x1027 * x1027 ; x1037 = rproject (tproject1 h984) 3 * negate (sin (rproject (tproject2 h984) 3)) in [rproject (tproject1 h984) 0 + rproject (tproject1 h984) 1 * recip x1028 + ((x1037 * x1027 + x1037 * x1027) * negate (recip (x1028 * x1028))) * rproject (tproject2 h984) 1, rproject (tproject1 h984) 0]) (\\h1054 -> let x1093 = cos (rproject (tproject2 h1054) 3) ; x1094 = x1093 * x1093 ; x1101 = negate (recip (x1094 * x1094)) * (rproject (tproject2 h1054) 1 * rproject (tproject1 h1054) 0) in [rproject (tproject1 h1054) 0 + rproject (tproject1 h1054) 1, recip x1094 * rproject (tproject1 h1054) 0, 0, negate (sin (rproject (tproject2 h1054) 3)) * (x1093 * x1101 + x1093 * x1101)]) [rproject (tproject1 h339) 2] [rreplicate 22 (rproject (tproject1 h339) 1), rproject h400 1, rreplicate 22 (rproject (tproject2 h339) 1)]) 1, rreplicate 22 (rproject (tproject1 h339) 1), rproject (dmapAccumRDer (SNat @22) (\\h1112 -> let x1130 = cos (rproject (tproject2 h1112) 1) in [rproject (tproject1 h1112) 0, rproject (tproject1 h1112) 0, recip (x1130 * x1130) * rproject (tproject1 h1112) 0]) (\\h1134 -> let x1165 = cos (rproject (tproject2 h1134) 2) ; x1166 = x1165 * x1165 ; x1173 = rproject (tproject1 h1134) 2 * negate (sin (rproject (tproject2 h1134) 2)) in [rproject (tproject1 h1134) 0, rproject (tproject1 h1134) 0, ((x1173 * x1165 + x1173 * x1165) * negate (recip (x1166 * x1166))) * rproject (tproject2 h1134) 0 + rproject (tproject1 h1134) 0 * recip x1166]) (\\h1186 -> let x1234 = cos (rproject (tproject2 h1186) 2) ; x1235 = x1234 * x1234 ; x1242 = negate (recip (x1235 * x1235)) * (rproject (tproject2 h1186) 0 * rproject (tproject1 h1186) 2) in [rproject (tproject1 h1186) 1 + recip x1235 * rproject (tproject1 h1186) 2 + rproject (tproject1 h1186) 0, 0.0, negate (sin (rproject (tproject2 h1186) 2)) * (x1234 * x1242 + x1234 * x1242)]) [rproject (tproject2 h339) 0] [rproject h400 2, rreplicate 22 (rproject (tproject2 h339) 1)]) 1, rproject h400 2, rreplicate 22 (rproject (tproject2 h339) 1)] in [rsum (rproject h439 1), rproject h439 0]) (\\h1255 -> let h1327 = dmapAccumLDer (SNat @22) (\\h1371 -> [rproject (tproject1 h1371) 0 + tan (rproject (tproject2 h1371) 0), rproject (tproject1 h1371) 0, rproject (tproject1 h1371) 0]) (\\h1387 -> let x1414 = cos (rproject (tproject2 h1387) 1) in [rproject (tproject1 h1387) 0 + rproject (tproject1 h1387) 1 * recip (x1414 * x1414), rproject (tproject1 h1387) 0, rproject (tproject1 h1387) 0]) (\\h1423 -> let x1451 = cos (rproject (tproject2 h1423) 1) in [rproject (tproject1 h1423) 1 + rproject (tproject1 h1423) 0 + rproject (tproject1 h1423) 2, recip (x1451 * x1451) * rproject (tproject1 h1423) 0]) [rproject (tproject2 h1255) 2] [rreplicate 22 (rproject (tproject2 h1255) 1)] ; h1350 = dmapAccumLDer (SNat @22) (\\h1464 -> let x1512 = cos (rproject (tproject2 h1464) 3) ; x1513 = x1512 * x1512 ; x1522 = negate (recip (x1513 * x1513)) * (rproject (tproject2 h1464) 1 * rproject (tproject2 h1464) 0) in [recip x1513 * rproject (tproject2 h1464) 0 + rproject (tproject1 h1464) 0, 0, negate (sin (rproject (tproject2 h1464) 3)) * (x1512 * x1522 + x1512 * x1522)]) (\\h1532 -> let x1625 = cos (rproject (tproject2 h1532) 4) ; x1626 = x1625 * x1625 ; x1627 = x1626 * x1626 ; x1628 = negate (recip x1627) ; x1639 = rproject (tproject2 h1532) 2 * rproject (tproject2 h1532) 1 ; x1640 = x1628 * x1639 ; x1651 = rproject (tproject1 h1532) 4 * negate (sin (rproject (tproject2 h1532) 4)) ; x1652 = x1651 * x1625 + x1651 * x1625 ; x1673 = (((x1652 * x1626 + x1652 * x1626) * negate (recip (x1627 * x1627))) * -1.0) * x1639 + (rproject (tproject1 h1532) 2 * rproject (tproject2 h1532) 1 + rproject (tproject1 h1532) 1 * rproject (tproject2 h1532) 2) * x1628 in [rproject (tproject1 h1532) 0 + (x1652 * negate (recip (x1626 * x1626))) * rproject (tproject2 h1532) 1 + rproject (tproject1 h1532) 1 * recip x1626, 0.0, ((rproject (tproject1 h1532) 4 * cos (rproject (tproject2 h1532) 4)) * -1.0) * (x1625 * x1640 + x1625 * x1640) + (x1651 * x1640 + x1673 * x1625 + x1651 * x1640 + x1673 * x1625) * negate (sin (rproject (tproject2 h1532) 4))]) (\\h1704 -> let x1786 = cos (rproject (tproject2 h1704) 4) ; x1787 = x1786 * x1786 ; x1788 = x1787 * x1787 ; x1789 = negate (recip x1788) ; x1800 = rproject (tproject2 h1704) 2 * rproject (tproject2 h1704) 1 ; x1801 = x1789 * x1800 ; x1810 = negate (sin (rproject (tproject2 h1704) 4)) * rproject (tproject1 h1704) 2 ; x1811 = x1786 * x1810 + x1786 * x1810 ; x1812 = x1789 * x1811 ; x1813 = negate (recip (x1788 * x1788)) * (-1.0 * (x1800 * x1811)) ; x1822 = x1787 * x1813 + x1787 * x1813 + negate (recip (x1787 * x1787)) * (rproject (tproject2 h1704) 1 * rproject (tproject1 h1704) 0) in [rproject (tproject1 h1704) 0, rproject (tproject2 h1704) 2 * x1812 + recip x1787 * rproject (tproject1 h1704) 0, rproject (tproject2 h1704) 1 * x1812, 0, negate (sin (rproject (tproject2 h1704) 4)) * (x1786 * x1822 + x1786 * x1822 + x1801 * x1810 + x1801 * x1810) + cos (rproject (tproject2 h1704) 4) * (-1.0 * ((x1786 * x1801 + x1786 * x1801) * rproject (tproject1 h1704) 2))]) [0.0 + rproject (tproject1 h1255) 1] [rreplicate 22 (rproject (tproject1 h1255) 0) + rfromS (sreplicate 0.0), rproject (dmapAccumRDer (SNat @22) (\\h1852 -> let x1870 = cos (rproject (tproject2 h1852) 1) in [rproject (tproject1 h1852) 0, rproject (tproject1 h1852) 0, recip (x1870 * x1870) * rproject (tproject1 h1852) 0]) (\\h1874 -> let x1927 = cos (rproject (tproject2 h1874) 2) ; x1928 = x1927 * x1927 ; x1935 = rproject (tproject1 h1874) 2 * negate (sin (rproject (tproject2 h1874) 2)) in [rproject (tproject1 h1874) 0, rproject (tproject1 h1874) 0, ((x1935 * x1927 + x1935 * x1927) * negate (recip (x1928 * x1928))) * rproject (tproject2 h1874) 0 + rproject (tproject1 h1874) 0 * recip x1928]) (\\h1948 -> let x1977 = cos (rproject (tproject2 h1948) 2) ; x1978 = x1977 * x1977 ; x1985 = negate (recip (x1978 * x1978)) * (rproject (tproject2 h1948) 0 * rproject (tproject1 h1948) 2) in [rproject (tproject1 h1948) 1 + recip x1978 * rproject (tproject1 h1948) 2 + rproject (tproject1 h1948) 0, 0.0, negate (sin (rproject (tproject2 h1948) 2)) * (x1977 * x1985 + x1977 * x1985)]) [rproject (tproject2 h1255) 0] [rproject h1327 2, rreplicate 22 (rproject (tproject2 h1255) 1)]) 1, rproject h1327 2, rreplicate 22 (rproject (tproject2 h1255) 1)] ; h1360 = dmapAccumRDer (SNat @22) (\\h1998 -> let x2016 = cos (rproject (tproject2 h1998) 2) in [rproject (tproject1 h1998) 0 + rproject (tproject2 h1998) 0, recip (x2016 * x2016) * rproject (tproject1 h1998) 0]) (\\h2022 -> let x2065 = cos (rproject (tproject2 h2022) 3) ; x2066 = x2065 * x2065 ; x2075 = rproject (tproject1 h2022) 3 * negate (sin (rproject (tproject2 h2022) 3)) in [rproject (tproject1 h2022) 0 + rproject (tproject1 h2022) 1, ((x2075 * x2065 + x2075 * x2065) * negate (recip (x2066 * x2066))) * rproject (tproject2 h2022) 0 + rproject (tproject1 h2022) 0 * recip x2066]) (\\h2092 -> let x2131 = cos (rproject (tproject2 h2092) 3) ; x2132 = x2131 * x2131 ; x2139 = negate (recip (x2132 * x2132)) * (rproject (tproject2 h2092) 0 * rproject (tproject1 h2092) 1) in [rproject (tproject1 h2092) 0 + recip x2132 * rproject (tproject1 h2092) 1, rproject (tproject1 h2092) 0, 0, negate (sin (rproject (tproject2 h2092) 3)) * (x2131 * x2139 + x2131 * x2139)]) [0.0] [rproject h1350 1, rproject h1327 1, rreplicate 22 (rproject (tproject2 h1255) 1)] in [rproject h1350 0, rsum (rproject h1360 1) + rsum (rproject h1350 2), rproject h1360 0]) [1.0] [rproject (dmapAccumLDer (SNat @11) (\\h2150 -> [rproject (dmapAccumLDer (SNat @22) (\\h2166 -> [rproject (tproject1 h2166) 0 + tan (rproject (tproject2 h2166) 0)]) (\\h2175 -> let x2199 = cos (rproject (tproject2 h2175) 1) in [rproject (tproject1 h2175) 0 + rproject (tproject1 h2175) 1 * recip (x2199 * x2199)]) (\\h2204 -> let x2224 = cos (rproject (tproject2 h2204) 1) in [rproject (tproject1 h2204) 0, recip (x2224 * x2224) * rproject (tproject1 h2204) 0]) [rproject (tproject2 h2150) 0] [rreplicate 22 (rproject (tproject1 h2150) 0)]) 0, rproject (tproject1 h2150) 0]) (\\h2227 -> [rproject (dmapAccumLDer (SNat @22) (\\h2277 -> let x2321 = cos (rproject (tproject2 h2277) 2) in [rproject (tproject1 h2277) 0 + rproject (tproject2 h2277) 0 * recip (x2321 * x2321)]) (\\h2326 -> let x2400 = cos (rproject (tproject2 h2326) 3) ; x2401 = x2400 * x2400 ; x2410 = rproject (tproject1 h2326) 3 * negate (sin (rproject (tproject2 h2326) 3)) in [rproject (tproject1 h2326) 0 + rproject (tproject1 h2326) 1 * recip x2401 + ((x2410 * x2400 + x2410 * x2400) * negate (recip (x2401 * x2401))) * rproject (tproject2 h2326) 1]) (\\h2423 -> let x2484 = cos (rproject (tproject2 h2423) 3) ; x2485 = x2484 * x2484 ; x2491 = negate (recip (x2485 * x2485)) * (rproject (tproject2 h2423) 1 * rproject (tproject1 h2423) 0) in [rproject (tproject1 h2423) 0, recip x2485 * rproject (tproject1 h2423) 0, 0, negate (sin (rproject (tproject2 h2423) 3)) * (x2484 * x2491 + x2484 * x2491)]) [rproject (tproject1 h2227) 1] [rreplicate 22 (rproject (tproject1 h2227) 0), rproject (dmapAccumLDer (SNat @22) (\\h2498 -> [rproject (tproject1 h2498) 0 + tan (rproject (tproject2 h2498) 0), rproject (tproject1 h2498) 0]) (\\h2514 -> let x2538 = cos (rproject (tproject2 h2514) 1) in [rproject (tproject1 h2514) 0 + rproject (tproject1 h2514) 1 * recip (x2538 * x2538), rproject (tproject1 h2514) 0]) (\\h2545 -> let x2579 = cos (rproject (tproject2 h2545) 1) in [rproject (tproject1 h2545) 0 + rproject (tproject1 h2545) 1, recip (x2579 * x2579) * rproject (tproject1 h2545) 0]) [rproject (tproject2 h2227) 1] [rreplicate 22 (rproject (tproject2 h2227) 0)]) 1, rreplicate 22 (rproject (tproject2 h2227) 0)]) 0, rproject (tproject1 h2227) 0]) (\\h2586 -> let h2616 = dmapAccumRDer (SNat @22) (\\h2624 -> let x2633 = cos (rproject (tproject2 h2624) 1) in [rproject (tproject1 h2624) 0, recip (x2633 * x2633) * rproject (tproject1 h2624) 0]) (\\h2636 -> let x2662 = cos (rproject (tproject2 h2636) 2) ; x2663 = x2662 * x2662 ; x2670 = rproject (tproject1 h2636) 2 * negate (sin (rproject (tproject2 h2636) 2)) in [rproject (tproject1 h2636) 0, ((x2670 * x2662 + x2670 * x2662) * negate (recip (x2663 * x2663))) * rproject (tproject2 h2636) 0 + rproject (tproject1 h2636) 0 * recip x2663]) (\\h2680 -> let x2703 = cos (rproject (tproject2 h2680) 2) ; x2704 = x2703 * x2703 ; x2710 = negate (recip (x2704 * x2704)) * (rproject (tproject2 h2680) 0 * rproject (tproject1 h2680) 1) in [recip x2704 * rproject (tproject1 h2680) 1 + rproject (tproject1 h2680) 0, 0, negate (sin (rproject (tproject2 h2680) 2)) * (x2703 * x2710 + x2703 * x2710)]) [rproject (tproject1 h2586) 0] [rproject (dmapAccumLDer (SNat @22) (\\h2718 -> [rproject (tproject1 h2718) 0 + tan (rproject (tproject2 h2718) 0), rproject (tproject1 h2718) 0]) (\\h2726 -> let x2739 = cos (rproject (tproject2 h2726) 1) in [rproject (tproject1 h2726) 0 + rproject (tproject1 h2726) 1 * recip (x2739 * x2739), rproject (tproject1 h2726) 0]) (\\h2746 -> let x2759 = cos (rproject (tproject2 h2746) 1) in [rproject (tproject1 h2746) 0 + rproject (tproject1 h2746) 1, recip (x2759 * x2759) * rproject (tproject1 h2746) 0]) [rproject (tproject2 h2586) 1] [rreplicate 22 (rproject (tproject2 h2586) 0)]) 1, rreplicate 22 (rproject (tproject2 h2586) 0)] in [rsum (rproject h2616 1) + rproject (tproject1 h2586) 1, rproject h2616 0]) [1.1] [rreplicate 11 1.1]) 1, rreplicate 11 1.1] in [rsum (rproject h14 1) + rproject h14 0]"
...
testSin0MapAccumNestedR1PP = do
  ...
  printAstHVectorPrettyButNested
    ...
    (simplifyInline
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 (rscalar 1.1)))
    @?= "let h13 = dmapAccumRDer (SNat @2) (\\h18 -> let h63 = dmapAccumRDer (SNat @2) (\\h68 -> let x100 = cos (rproject (tproject2 h68) 1) in [rproject (tproject1 h68) 0, recip (x100 * x100) * rproject (tproject1 h68) 0]) (\\h103 -> let x161 = cos (rproject (tproject2 h103) 2) ; x162 = x161 * x161 ; x169 = rproject (tproject1 h103) 2 * negate (sin (rproject (tproject2 h103) 2)) in [rproject (tproject1 h103) 0, ((x169 * x161 + x169 * x161) * negate (recip (x162 * x162))) * rproject (tproject2 h103) 0 + rproject (tproject1 h103) 0 * recip x162]) (\\h179 -> let x231 = cos (rproject (tproject2 h179) 2) ; x232 = x231 * x231 ; x238 = negate (recip (x232 * x232)) * (rproject (tproject2 h179) 0 * rproject (tproject1 h179) 1) in [recip x232 * rproject (tproject1 h179) 1 + rproject (tproject1 h179) 0, 0, negate (sin (rproject (tproject2 h179) 2)) * (x231 * x238 + x231 * x238)]) [rproject (tproject1 h18) 0] [rproject (dmapAccumLDer (SNat @2) (\\h246 -> [rproject (tproject1 h246) 0 + tan (rproject (tproject2 h246) 0), rproject (tproject1 h246) 0]) (\\h262 -> let x299 = cos (rproject (tproject2 h262) 1) in [rproject (tproject1 h262) 0 + rproject (tproject1 h262) 1 * recip (x299 * x299), rproject (tproject1 h262) 0]) (\\h306 -> let x329 = cos (rproject (tproject2 h306) 1) in [rproject (tproject1 h306) 0 + rproject (tproject1 h306) 1, recip (x329 * x329) * rproject (tproject1 h306) 0]) [rproject (tproject2 h18) 1] [rreplicate 2 (rproject (tproject2 h18) 0)]) 1, rreplicate 2 (rproject (tproject2 h18) 0)] in [rsum (rproject h63 1), rproject h63 0]) (\\h336 -> let h397 = dmapAccumLDer (SNat @2) (\\h441 -> [rproject (tproject1 h441) 0 + tan (rproject (tproject2 h441) 0), rproject (tproject1 h441) 0, rproject (tproject1 h441) 0]) (\\h457 -> let x484 = cos (rproject (tproject2 h457) 1) in [rproject (tproject1 h457) 0 + rproject (tproject1 h457) 1 * recip (x484 * x484), rproject (tproject1 h457) 0, rproject (tproject1 h457) 0]) (\\h493 -> let x521 = cos (rproject (tproject2 h493) 1) in [rproject (tproject1 h493) 1 + rproject (tproject1 h493) 0 + rproject (tproject1 h493) 2, recip (x521 * x521) * rproject (tproject1 h493) 0]) [rproject (tproject2 h336) 2] [rreplicate 2 (rproject (tproject2 h336) 1)] ; h436 = dmapAccumRDer (SNat @2) (\\h534 -> let x590 = cos (rproject (tproject2 h534) 4) ; x591 = x590 * x590 ; x602 = rproject (tproject2 h534) 1 * negate (sin (rproject (tproject2 h534) 4)) in [rproject (tproject1 h534) 0, ((x602 * x590 + x602 * x590) * negate (recip (x591 * x591))) * rproject (tproject2 h534) 2 + rproject (tproject1 h534) 0 * recip x591]) (\\h610 -> let x713 = cos (rproject (tproject2 h610) 5) ; x714 = x713 * x713 ; x721 = negate (sin (rproject (tproject2 h610) 5)) ; x728 = rproject (tproject2 h610) 2 * x721 ; x729 = x714 * x714 ; x730 = x728 * x713 + x728 * x713 ; x731 = negate (recip x729) ; x756 = rproject (tproject1 h610) 2 * x721 + ((rproject (tproject1 h610) 5 * cos (rproject (tproject2 h610) 5)) * -1.0) * rproject (tproject2 h610) 2 ; x769 = rproject (tproject1 h610) 5 * negate (sin (rproject (tproject2 h610) 5)) ; x770 = x769 * x713 + x769 * x713 in [rproject (tproject1 h610) 0, ((x756 * x713 + x769 * x728 + x756 * x713 + x769 * x728) * x731 + (((x770 * x714 + x770 * x714) * negate (recip (x729 * x729))) * -1.0) * x730) * rproject (tproject2 h610) 3 + rproject (tproject1 h610) 3 * (x730 * x731) + rproject (tproject1 h610) 0 * recip x714 + (x770 * negate (recip (x714 * x714))) * rproject (tproject2 h610) 0]) (\\h801 -> let x893 = cos (rproject (tproject2 h801) 5) ; x894 = x893 * x893 ; x901 = negate (sin (rproject (tproject2 h801) 5)) ; x908 = rproject (tproject2 h801) 2 * x901 ; x909 = x894 * x894 ; x910 = x908 * x893 + x908 * x893 ; x911 = negate (recip x909) ; x920 = rproject (tproject2 h801) 3 * rproject (tproject1 h801) 1 ; x921 = negate (recip (x909 * x909)) * (-1.0 * (x910 * x920)) ; x922 = x911 * x920 ; x923 = x893 * x922 + x893 * x922 ; x932 = x894 * x921 + x894 * x921 + negate (recip (x894 * x894)) * (rproject (tproject2 h801) 0 * rproject (tproject1 h801) 1) in [recip x894 * rproject (tproject1 h801) 1 + rproject (tproject1 h801) 0, 0, x901 * x923, (x910 * x911) * rproject (tproject1 h801) 1, 0, negate (sin (rproject (tproject2 h801) 5)) * (x893 * x932 + x893 * x932 + x908 * x922 + x908 * x922) + cos (rproject (tproject2 h801) 5) * (-1.0 * (rproject (tproject2 h801) 2 * x923))]) [rproject (tproject1 h336) 0] [rproject (dmapAccumLDer (SNat @2) (\\h957 -> let x975 = cos (rproject (tproject2 h957) 2) in [rproject (tproject1 h957) 0 + rproject (tproject2 h957) 0 * recip (x975 * x975), rproject (tproject1 h957) 0]) (\\h981 -> let x1024 = cos (rproject (tproject2 h981) 3) ; x1025 = x1024 * x1024 ; x1034 = rproject (tproject1 h981) 3 * negate (sin (rproject (tproject2 h981) 3)) in [rproject (tproject1 h981) 0 + rproject (tproject1 h981) 1 * recip x1025 + ((x1034 * x1024 + x1034 * x1024) * negate (recip (x1025 * x1025))) * rproject (tproject2 h981) 1, rproject (tproject1 h981) 0]) (\\h1051 -> let x1090 = cos (rproject (tproject2 h1051) 3) ; x1091 = x1090 * x1090 ; x1098 = negate (recip (x1091 * x1091)) * (rproject (tproject2 h1051) 1 * rproject (tproject1 h1051) 0) in [rproject (tproject1 h1051) 0 + rproject (tproject1 h1051) 1, recip x1091 * rproject (tproject1 h1051) 0, 0, negate (sin (rproject (tproject2 h1051) 3)) * (x1090 * x1098 + x1090 * x1098)]) [rproject (tproject1 h336) 2] [rreplicate 2 (rproject (tproject1 h336) 1), rproject h397 1, rreplicate 2 (rproject (tproject2 h336) 1)]) 1, rreplicate 2 (rproject (tproject1 h336) 1), rproject (dmapAccumRDer (SNat @2) (\\h1109 -> let x1127 = cos (rproject (tproject2 h1109) 1) in [rproject (tproject1 h1109) 0, rproject (tproject1 h1109) 0, recip (x1127 * x1127) * rproject (tproject1 h1109) 0]) (\\h1131 -> let x1162 = cos (rproject (tproject2 h1131) 2) ; x1163 = x1162 * x1162 ; x1170 = rproject (tproject1 h1131) 2 * negate (sin (rproject (tproject2 h1131) 2)) in [rproject (tproject1 h1131) 0, rproject (tproject1 h1131) 0, ((x1170 * x1162 + x1170 * x1162) * negate (recip (x1163 * x1163))) * rproject (tproject2 h1131) 0 + rproject (tproject1 h1131) 0 * recip x1163]) (\\h1183 -> let x1231 = cos (rproject (tproject2 h1183) 2) ; x1232 = x1231 * x1231 ; x1239 = negate (recip (x1232 * x1232)) * (rproject (tproject2 h1183) 0 * rproject (tproject1 h1183) 2) in [rproject (tproject1 h1183) 1 + recip x1232 * rproject (tproject1 h1183) 2 + rproject (tproject1 h1183) 0, 0.0, negate (sin (rproject (tproject2 h1183) 2)) * (x1231 * x1239 + x1231 * x1239)]) [rproject (tproject2 h336) 0] [rproject h397 2, rreplicate 2 (rproject (tproject2 h336) 1)]) 1, rproject h397 2, rreplicate 2 (rproject (tproject2 h336) 1)] in [rsum (rproject h436 1), rproject h436 0]) (\\h1252 -> let h1324 = dmapAccumLDer (SNat @2) (\\h1368 -> [rproject (tproject1 h1368) 0 + tan (rproject (tproject2 h1368) 0), rproject (tproject1 h1368) 0, rproject (tproject1 h1368) 0]) (\\h1384 -> let x1411 = cos (rproject (tproject2 h1384) 1) in [rproject (tproject1 h1384) 0 + rproject (tproject1 h1384) 1 * recip (x1411 * x1411), rproject (tproject1 h1384) 0, rproject (tproject1 h1384) 0]) (\\h1420 -> let x1448 = cos (rproject (tproject2 h1420) 1) in [rproject (tproject1 h1420) 1 + rproject (tproject1 h1420) 0 + rproject (tproject1 h1420) 2, recip (x1448 * x1448) * rproject (tproject1 h1420) 0]) [rproject (tproject2 h1252) 2] [rreplicate 2 (rproject (tproject2 h1252) 1)] ; h1347 = dmapAccumLDer (SNat @2) (\\h1461 -> let x1509 = cos (rproject (tproject2 h1461) 3) ; x1510 = x1509 * x1509 ; x1519 = negate (recip (x1510 * x1510)) * (rproject (tproject2 h1461) 1 * rproject (tproject2 h1461) 0) in [recip x1510 * rproject (tproject2 h1461) 0 + rproject (tproject1 h1461) 0, 0, negate (sin (rproject (tproject2 h1461) 3)) * (x1509 * x1519 + x1509 * x1519)]) (\\h1529 -> let x1622 = cos (rproject (tproject2 h1529) 4) ; x1623 = x1622 * x1622 ; x1624 = x1623 * x1623 ; x1625 = negate (recip x1624) ; x1636 = rproject (tproject2 h1529) 2 * rproject (tproject2 h1529) 1 ; x1637 = x1625 * x1636 ; x1648 = rproject (tproject1 h1529) 4 * negate (sin (rproject (tproject2 h1529) 4)) ; x1649 = x1648 * x1622 + x1648 * x1622 ; x1670 = (((x1649 * x1623 + x1649 * x1623) * negate (recip (x1624 * x1624))) * -1.0) * x1636 + (rproject (tproject1 h1529) 2 * rproject (tproject2 h1529) 1 + rproject (tproject1 h1529) 1 * rproject (tproject2 h1529) 2) * x1625 in [rproject (tproject1 h1529) 0 + (x1649 * negate (recip (x1623 * x1623))) * rproject (tproject2 h1529) 1 + rproject (tproject1 h1529) 1 * recip x1623, 0.0, ((rproject (tproject1 h1529) 4 * cos (rproject (tproject2 h1529) 4)) * -1.0) * (x1622 * x1637 + x1622 * x1637) + (x1648 * x1637 + x1670 * x1622 + x1648 * x1637 + x1670 * x1622) * negate (sin (rproject (tproject2 h1529) 4))]) (\\h1701 -> let x1783 = cos (rproject (tproject2 h1701) 4) ; x1784 = x1783 * x1783 ; x1785 = x1784 * x1784 ; x1786 = negate (recip x1785) ; x1797 = rproject (tproject2 h1701) 2 * rproject (tproject2 h1701) 1 ; x1798 = x1786 * x1797 ; x1807 = negate (sin (rproject (tproject2 h1701) 4)) * rproject (tproject1 h1701) 2 ; x1808 = x1783 * x1807 + x1783 * x1807 ; x1809 = x1786 * x1808 ; x1810 = negate (recip (x1785 * x1785)) * (-1.0 * (x1797 * x1808)) ; x1819 = x1784 * x1810 + x1784 * x1810 + negate (recip (x1784 * x1784)) * (rproject (tproject2 h1701) 1 * rproject (tproject1 h1701) 0) in [rproject (tproject1 h1701) 0, rproject (tproject2 h1701) 2 * x1809 + recip x1784 * rproject (tproject1 h1701) 0, rproject (tproject2 h1701) 1 * x1809, 0, negate (sin (rproject (tproject2 h1701) 4)) * (x1783 * x1819 + x1783 * x1819 + x1798 * x1807 + x1798 * x1807) + cos (rproject (tproject2 h1701) 4) * (-1.0 * ((x1783 * x1798 + x1783 * x1798) * rproject (tproject1 h1701) 2))]) [0.0 + rproject (tproject1 h1252) 1] [rreplicate 2 (rproject (tproject1 h1252) 0) + rfromS (sreplicate 0.0), rproject (dmapAccumRDer (SNat @2) (\\h1849 -> let x1867 = cos (rproject (tproject2 h1849) 1) in [rproject (tproject1 h1849) 0, rproject (tproject1 h1849) 0, recip (x1867 * x1867) * rproject (tproject1 h1849) 0]) (\\h1871 -> let x1924 = cos (rproject (tproject2 h1871) 2) ; x1925 = x1924 * x1924 ; x1932 = rproject (tproject1 h1871) 2 * negate (sin (rproject (tproject2 h1871) 2)) in [rproject (tproject1 h1871) 0, rproject (tproject1 h1871) 0, ((x1932 * x1924 + x1932 * x1924) * negate (recip (x1925 * x1925))) * rproject (tproject2 h1871) 0 + rproject (tproject1 h1871) 0 * recip x1925]) (\\h1945 -> let x1974 = cos (rproject (tproject2 h1945) 2) ; x1975 = x1974 * x1974 ; x1982 = negate (recip (x1975 * x1975)) * (rproject (tproject2 h1945) 0 * rproject (tproject1 h1945) 2) in [rproject (tproject1 h1945) 1 + recip x1975 * rproject (tproject1 h1945) 2 + rproject (tproject1 h1945) 0, 0.0, negate (sin (rproject (tproject2 h1945) 2)) * (x1974 * x1982 + x1974 * x1982)]) [rproject (tproject2 h1252) 0] [rproject h1324 2, rreplicate 2 (rproject (tproject2 h1252) 1)]) 1, rproject h1324 2, rreplicate 2 (rproject (tproject2 h1252) 1)] ; h1357 = dmapAccumRDer (SNat @2) (\\h1995 -> let x2013 = cos (rproject (tproject2 h1995) 2) in [rproject (tproject1 h1995) 0 + rproject (tproject2 h1995) 0, recip (x2013 * x2013) * rproject (tproject1 h1995) 0]) (\\h2019 -> let x2062 = cos (rproject (tproject2 h2019) 3) ; x2063 = x2062 * x2062 ; x2072 = rproject (tproject1 h2019) 3 * negate (sin (rproject (tproject2 h2019) 3)) in [rproject (tproject1 h2019) 0 + rproject (tproject1 h2019) 1, ((x2072 * x2062 + x2072 * x2062) * negate (recip (x2063 * x2063))) * rproject (tproject2 h2019) 0 + rproject (tproject1 h2019) 0 * recip x2063]) (\\h2089 -> let x2128 = cos (rproject (tproject2 h2089) 3) ; x2129 = x2128 * x2128 ; x2136 = negate (recip (x2129 * x2129)) * (rproject (tproject2 h2089) 0 * rproject (tproject1 h2089) 1) in [rproject (tproject1 h2089) 0 + recip x2129 * rproject (tproject1 h2089) 1, rproject (tproject1 h2089) 0, 0, negate (sin (rproject (tproject2 h2089) 3)) * (x2128 * x2136 + x2128 * x2136)]) [0.0] [rproject h1347 1, rproject h1324 1, rreplicate 2 (rproject (tproject2 h1252) 1)] in [rproject h1347 0, rsum (rproject h1357 1) + rsum (rproject h1347 2), rproject h1357 0]) [1.0] [rproject (dmapAccumLDer (SNat @2) (\\h2147 -> [rproject (dmapAccumLDer (SNat @2) (\\h2161 -> [rproject (tproject1 h2161) 0 + tan (rproject (tproject2 h2161) 0)]) (\\h2170 -> let x2194 = cos (rproject (tproject2 h2170) 1) in [rproject (tproject1 h2170) 0 + rproject (tproject1 h2170) 1 * recip (x2194 * x2194)]) (\\h2199 -> let x2219 = cos (rproject (tproject2 h2199) 1) in [rproject (tproject1 h2199) 0, recip (x2219 * x2219) * rproject (tproject1 h2199) 0]) [rproject (tproject2 h2147) 0] [rreplicate 2 (rproject (tproject1 h2147) 0)]) 0, rproject (tproject1 h2147) 0]) (\\h2222 -> [rproject (dmapAccumLDer (SNat @2) (\\h2270 -> let x2314 = cos (rproject (tproject2 h2270) 2) in [rproject (tproject1 h2270) 0 + rproject (tproject2 h2270) 0 * recip (x2314 * x2314)]) (\\h2319 -> let x2393 = cos (rproject (tproject2 h2319) 3) ; x2394 = x2393 * x2393 ; x2403 = rproject (tproject1 h2319) 3 * negate (sin (rproject (tproject2 h2319) 3)) in [rproject (tproject1 h2319) 0 + rproject (tproject1 h2319) 1 * recip x2394 + ((x2403 * x2393 + x2403 * x2393) * negate (recip (x2394 * x2394))) * rproject (tproject2 h2319) 1]) (\\h2416 -> let x2477 = cos (rproject (tproject2 h2416) 3) ; x2478 = x2477 * x2477 ; x2484 = negate (recip (x2478 * x2478)) * (rproject (tproject2 h2416) 1 * rproject (tproject1 h2416) 0) in [rproject (tproject1 h2416) 0, recip x2478 * rproject (tproject1 h2416) 0, 0, negate (sin (rproject (tproject2 h2416) 3)) * (x2477 * x2484 + x2477 * x2484)]) [rproject (tproject1 h2222) 1] [rreplicate 2 (rproject (tproject1 h2222) 0), rproject (dmapAccumLDer (SNat @2) (\\h2491 -> [rproject (tproject1 h2491) 0 + tan (rproject (tproject2 h2491) 0), rproject (tproject1 h2491) 0]) (\\h2507 -> let x2531 = cos (rproject (tproject2 h2507) 1) in [rproject (tproject1 h2507) 0 + rproject (tproject1 h2507) 1 * recip (x2531 * x2531), rproject (tproject1 h2507) 0]) (\\h2538 -> let x2572 = cos (rproject (tproject2 h2538) 1) in [rproject (tproject1 h2538) 0 + rproject (tproject1 h2538) 1, recip (x2572 * x2572) * rproject (tproject1 h2538) 0]) [rproject (tproject2 h2222) 1] [rreplicate 2 (rproject (tproject2 h2222) 0)]) 1, rreplicate 2 (rproject (tproject2 h2222) 0)]) 0, rproject (tproject1 h2222) 0]) (\\h2579 -> let h2609 = dmapAccumRDer (SNat @2) (\\h2617 -> let x2626 = cos (rproject (tproject2 h2617) 1) in [rproject (tproject1 h2617) 0, recip (x2626 * x2626) * rproject (tproject1 h2617) 0]) (\\h2629 -> let x2655 = cos (rproject (tproject2 h2629) 2) ; x2656 = x2655 * x2655 ; x2663 = rproject (tproject1 h2629) 2 * negate (sin (rproject (tproject2 h2629) 2)) in [rproject (tproject1 h2629) 0, ((x2663 * x2655 + x2663 * x2655) * negate (recip (x2656 * x2656))) * rproject (tproject2 h2629) 0 + rproject (tproject1 h2629) 0 * recip x2656]) (\\h2673 -> let x2696 = cos (rproject (tproject2 h2673) 2) ; x2697 = x2696 * x2696 ; x2703 = negate (recip (x2697 * x2697)) * (rproject (tproject2 h2673) 0 * rproject (tproject1 h2673) 1) in [recip x2697 * rproject (tproject1 h2673) 1 + rproject (tproject1 h2673) 0, 0, negate (sin (rproject (tproject2 h2673) 2)) * (x2696 * x2703 + x2696 * x2703)]) [rproject (tproject1 h2579) 0] [rproject (dmapAccumLDer (SNat @2) (\\h2711 -> [rproject (tproject1 h2711) 0 + tan (rproject (tproject2 h2711) 0), rproject (tproject1 h2711) 0]) (\\h2719 -> let x2732 = cos (rproject (tproject2 h2719) 1) in [rproject (tproject1 h2719) 0 + rproject (tproject1 h2719) 1 * recip (x2732 * x2732), rproject (tproject1 h2719) 0]) (\\h2739 -> let x2752 = cos (rproject (tproject2 h2739) 1) in [rproject (tproject1 h2739) 0 + rproject (tproject1 h2739) 1, recip (x2752 * x2752) * rproject (tproject1 h2739) 0]) [rproject (tproject2 h2579) 1] [rreplicate 2 (rproject (tproject2 h2579) 0)]) 1, rreplicate 2 (rproject (tproject2 h2579) 0)] in [rsum (rproject h2609 1) + rproject (tproject1 h2579) 1, rproject h2609 0]) [1.1] [rreplicate 2 1.1]) 1, rreplicate 2 1.1] in [rsum (rproject h13 1) + rproject h13 0]"
