                 ...
                 (\x0 -> rscanZip (\x a -> x + rfromD (a V.! 0))
                           ...
                           (V.singleton $ DynamicRanked
                            $ rscan (\x a -> a * x) x0
                                    (rfromList [x0 * 5, x0]))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v112 = rfromList [rconst 1.1 * rconst 5.0, rconst 1.1] ; v122 = rscanDer (\\x113 x114 -> x114 * x113) (\\x115 x116 x117 x118 -> x116 * x117 + x115 * x118) (\\x119 x120 x121 -> (x121 * x119, x120 * x119)) (rconst 1.1) v112 ; v132 = rscanZipDer (\\x123 [x124 @Natural @Double @[]] -> x123 + x124) (\\x125 [x126 @Natural @Double @[]] x127 [x128 @Natural @Double @[]] -> x125 + x126) (\\x129 x130 [x131 @Natural @Double @[]] -> (x129, x129)) (rconst 1.1) (v122) ; m133 = rfromList [rappend (rreverse (rscanZipDer (\\x134 [x135 @Natural @Double @[], x136 @Natural @Double @[]] -> x134) (\\x137 [x138 @Natural @Double @[], x139 @Natural @Double @[]] x140 [x141 @Natural @Double @[], x142 @Natural @Double @[]] -> x137) (\\x143 x144 [x145 @Natural @Double @[], x146 @Natural @Double @[]] -> (x143, 0, 0)) (rconst 1.0) (rreverse (rslice 0 1 v132), rreverse (rslice 0 1 v122)))) (rconstant (rreplicate 2 (rconst 0.0))), rappend (rreverse (rscanZipDer (\\x243 [x244 @Natural @Double @[], x245 @Natural @Double @[]] -> x243) (\\x246 [x247 @Natural @Double @[], x248 @Natural @Double @[]] x249 [x250 @Natural @Double @[], x251 @Natural @Double @[]] -> x246) (\\x252 x253 [x254 @Natural @Double @[], x255 @Natural @Double @[]] -> (x252, 0, 0)) (rconst 1.0) (rreverse (rslice 0 2 v132), rreverse (rslice 0 2 v122)))) (rconstant (rreplicate 1 (rconst 0.0))), rappend (rreverse (rscanZipDer (\\x275 [x276 @Natural @Double @[], x277 @Natural @Double @[]] -> x275) (\\x278 [x279 @Natural @Double @[], x280 @Natural @Double @[]] x281 [x282 @Natural @Double @[], x283 @Natural @Double @[]] -> x278) (\\x284 x285 [x286 @Natural @Double @[], x287 @Natural @Double @[]] -> (x284, 0, 0)) (rconst 1.0) (rreverse (rslice 0 3 v132), rreverse v122))) (rconstant (rreplicate 0 (rconst 0.0)))] ; v159 = rappend (rgather [3] (m133 ! [2]) (\\[i149] -> [1 + i149])) (rconstant (rreplicate 0 (rconst 0.0))) + rappend (rgather [1] (m133 ! [0]) (\\[i157] -> [1 + i157])) (rconstant (rreplicate 2 (rconst 0.0))) + rappend (rgather [2] (m133 ! [1]) (\\[i153] -> [1 + i153])) (rconstant (rreplicate 1 (rconst 0.0))) ; m160 = rfromList [rappend (rreverse (rscanZipDer (\\x161 [x162 @Natural @Double @[], x163 @Natural @Double @[]] -> x163 * x161) (\\x164 [x165 @Natural @Double @[], x166 @Natural @Double @[]] x167 [x168 @Natural @Double @[], x169 @Natural @Double @[]] -> x166 * x167 + x164 * x169) (\\x171 x172 [x173 @Natural @Double @[], x174 @Natural @Double @[]] -> (x174 * x171, 0, x172 * x171)) (v159 ! [1]) (rreverse (rslice 0 1 v122), rreverse (rslice 0 1 v112)))) (rconstant (rreplicate 1 (rconst 0.0))), rappend (rreverse (rscanZipDer (\\x199 [x200 @Natural @Double @[], x201 @Natural @Double @[]] -> x201 * x199) (\\x202 [x203 @Natural @Double @[], x204 @Natural @Double @[]] x205 [x206 @Natural @Double @[], x207 @Natural @Double @[]] -> x204 * x205 + x202 * x207) (\\x209 x210 [x211 @Natural @Double @[], x212 @Natural @Double @[]] -> (x212 * x209, 0, x210 * x209)) (v159 ! [2]) (rreverse (rslice 0 2 v122), rreverse v112))) (rconstant (rreplicate 0 (rconst 0.0)))] ; v175 = rsum (rfromList [rappend (rgather [1] v122 (\\[i177] -> [i177]) * rgather [1] (m160 ! [0]) (\\[i178] -> [1 + i178])) (rconstant (rreplicate 1 (rconst 0.0))), rappend (rgather [2] v122 (\\[i218] -> [i218]) * rgather [2] (m160 ! [1]) (\\[i219] -> [1 + i219])) (rconstant (rreplicate 0 (rconst 0.0)))]) in rconst 5.0 * v175 ! [0] + v175 ! [1] + v159 ! [0] + rsum (rgather [2] m160 (\\[i221] -> [i221, 0])) + rconst 1.0 + rsum (rgather [3] m133 (\\[i223] -> [i223, 0]))"
