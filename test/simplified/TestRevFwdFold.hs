...
testSin0Scan1RevPP = do
  ...
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v50 = rconst (fromList [2] [42.0,42.0]) ; v60 = rscanDer (\\x51 x52 -> sin x51) (\\x53 x54 x55 x56 -> x53 * cos x55) (\\x57 x58 x59 -> (cos x58 * x57, 0)) (rconst 1.1) v50 in rconst 1.0 + rsum (rgather [2] (rfromList [rreplicate 2 (rscanZipDer (\\x62 [x63 @Natural @Double @[], x64 @Natural @Double @[]] -> cos x63 * x62) (\\x65 [x66 @Natural @Double @[], x67 @Natural @Double @[]] x68 [x69 @Natural @Double @[], x70 @Natural @Double @[]] -> (x66 * negate (sin x69)) * x68 + x65 * cos x69) (\\x74 x75 [x76 @Natural @Double @[], x77 @Natural @Double @[]] -> (cos x76 * x74, negate (sin x76) * (x75 * x74), 0)) (rconst 1.0) (rreverse (rslice 0 1 v60), rreverse (rslice 0 1 v50)) ! [1]), rreplicate 2 (rscanZipDer (\\x104 [x105 @Natural @Double @[], x106 @Natural @Double @[]] -> cos x105 * x104) (\\x107 [x108 @Natural @Double @[], x109 @Natural @Double @[]] x110 [x111 @Natural @Double @[], x112 @Natural @Double @[]] -> (x108 * negate (sin x111)) * x110 + x107 * cos x111) (\\x116 x117 [x118 @Natural @Double @[], x119 @Natural @Double @[]] -> (cos x118 * x116, negate (sin x118) * (x117 * x116), 0)) (rconst 1.0) (rreverse (rslice 0 2 v60), rreverse v50) ! [2])]) (\\[i121] -> [i121, i121]))"
...
testSin0ScanFwdPP = do
  ...
  let a1 = rfwd1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscan (\x _a -> sin x) x0
                           (rconst (OR.constant @Double @1 [2] 42))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v49 = rconst (fromList [2] [42.0,42.0]) in rscanZipDer (\\x60 [x61 @Natural @Double @[], x62 @Natural @Double @[], x63 @Natural @Double @[]] -> x60 * cos x62) (\\x64 [x65 @Natural @Double @[], x66 @Natural @Double @[], x67 @Natural @Double @[]] x68 [x69 @Natural @Double @[], x70 @Natural @Double @[], x71 @Natural @Double @[]] -> x64 * cos x70 + (x66 * negate (sin x70)) * x68) (\\x75 x76 [x77 @Natural @Double @[], x78 @Natural @Double @[], x79 @Natural @Double @[]] -> (cos x78 * x75, 0, negate (sin x78) * (x76 * x75), 0)) (rconst 1.1) (rconstant (rreplicate 2 (rconst 0.0)), rslice 0 2 (rscanDer (\\x50 x51 -> sin x50) (\\x52 x53 x54 x55 -> x52 * cos x54) (\\x56 x57 x58 -> (cos x57 * x56, 0)) (rconst 1.1) v49), v49)"
...
testSin0Scan1Rev2PP = do
  ...
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v52 = rconst (fromList [2] [5.0,7.0]) ; v63 = rscanDer (\\x53 x54 -> sin x53 - x54) (\\x55 x56 x57 x58 -> x55 * cos x57 + x56 * rconst -1.0) (\\x60 x61 x62 -> (cos x61 * x60, rconst -1.0 * x60)) (rconst 1.1) v52 in rconst 1.0 + rsum (rgather [2] (rfromList [rreplicate 2 (rscanZipDer (\\x65 [x66 @Natural @Double @[], x67 @Natural @Double @[]] -> cos x66 * x65) (\\x68 [x69 @Natural @Double @[], x70 @Natural @Double @[]] x71 [x72 @Natural @Double @[], x73 @Natural @Double @[]] -> (x69 * negate (sin x72)) * x71 + x68 * cos x72) (\\x77 x78 [x79 @Natural @Double @[], x80 @Natural @Double @[]] -> (cos x79 * x77, negate (sin x79) * (x78 * x77), 0)) (rconst 1.0) (rreverse (rslice 0 1 v63), rreverse (rslice 0 1 v52)) ! [1]), rreplicate 2 (rscanZipDer (\\x107 [x108 @Natural @Double @[], x109 @Natural @Double @[]] -> cos x108 * x107) (\\x110 [x111 @Natural @Double @[], x112 @Natural @Double @[]] x113 [x114 @Natural @Double @[], x115 @Natural @Double @[]] -> (x111 * negate (sin x114)) * x113 + x110 * cos x114) (\\x119 x120 [x121 @Natural @Double @[], x122 @Natural @Double @[]] -> (cos x121 * x119, negate (sin x121) * (x120 * x119), 0)) (rconst 1.0) (rreverse (rslice 0 2 v63), rreverse v52) ! [2])]) (\\[i124] -> [i124, i124]))"
...
testSin0ScanFwd2PP = do
  ...
  let a1 = rfwd1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscan (\x a -> sin x - a) x0
                           (rconst (OR.fromList @Double @1 [2] [5, 7]))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v58 = rconst (fromList [2] [5.0,7.0]) in rscanZipDer (\\x70 [x71 @Natural @Double @[], x72 @Natural @Double @[], x73 @Natural @Double @[]] -> x70 * cos x72 + x71 * rconst -1.0) (\\x75 [x76 @Natural @Double @[], x77 @Natural @Double @[], x78 @Natural @Double @[]] x79 [x80 @Natural @Double @[], x81 @Natural @Double @[], x82 @Natural @Double @[]] -> x76 * rconst -1.0 + x75 * cos x81 + (x77 * negate (sin x81)) * x79) (\\x89 x90 [x91 @Natural @Double @[], x92 @Natural @Double @[], x93 @Natural @Double @[]] -> (cos x92 * x89, rconst -1.0 * x89, negate (sin x92) * (x90 * x89), 0)) (rconst 1.1) (rconstant (rreplicate 2 (rconst 0.0)), rslice 0 2 (rscanDer (\\x59 x60 -> sin x59 - x60) (\\x61 x62 x63 x64 -> x61 * cos x63 + x62 * rconst -1.0) (\\x66 x67 x68 -> (cos x67 * x66, rconst -1.0 * x66)) (rconst 1.1) v58), v58)"
...
testSin0Scan1Rev3PP = do
  ...
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v57 = rfromList [rconst 1.1 * rconst 5.0, rconst 1.1 * rconst 7.0] ; v68 = rscanDer (\\x58 x59 -> sin x58 - x59) (\\x60 x61 x62 x63 -> x60 * cos x62 + x61 * rconst -1.0) (\\x65 x66 x67 -> (cos x66 * x65, rconst -1.0 * x65)) (rconst 1.1) v57 ; m69 = rfromList [rappend (rreverse (rscanZipDer (\\x70 [x71 @Natural @Double @[], x72 @Natural @Double @[]] -> cos x71 * x70) (\\x73 [x74 @Natural @Double @[], x75 @Natural @Double @[]] x76 [x77 @Natural @Double @[], x78 @Natural @Double @[]] -> (x74 * negate (sin x77)) * x76 + x73 * cos x77) (\\x82 x83 [x84 @Natural @Double @[], x85 @Natural @Double @[]] -> (cos x84 * x82, negate (sin x84) * (x83 * x82), 0)) (rconst 1.0) (rreverse (rslice 0 1 v68), rreverse (rslice 0 1 v57)))) (rconstant (rreplicate 1 (rconst 0.0))), rappend (rreverse (rscanZipDer (\\x121 [x122 @Natural @Double @[], x123 @Natural @Double @[]] -> cos x122 * x121) (\\x124 [x125 @Natural @Double @[], x126 @Natural @Double @[]] x127 [x128 @Natural @Double @[], x129 @Natural @Double @[]] -> (x125 * negate (sin x128)) * x127 + x124 * cos x128) (\\x133 x134 [x135 @Natural @Double @[], x136 @Natural @Double @[]] -> (cos x135 * x133, negate (sin x135) * (x134 * x133), 0)) (rconst 1.0) (rreverse (rslice 0 2 v68), rreverse v57))) (rconstant (rreplicate 0 (rconst 0.0)))] ; v87 = rsum (rfromList [rappend (rconstant (rreplicate 1 (rconst -1.0)) * rgather [1] (m69 ! [0]) (\\[i89] -> [1 + i89])) (rconstant (rreplicate 1 (rconst 0.0))), rappend (rconstant (rreplicate 2 (rconst -1.0)) * rgather [2] (m69 ! [1]) (\\[i97] -> [1 + i97])) (rconstant (rreplicate 0 (rconst 0.0)))]) in rconst 5.0 * v87 ! [0] + rconst 7.0 * v87 ! [1] + rconst 1.0 + rsum (rgather [2] m69 (\\[i91] -> [i91, 0]))"
...
testSin0ScanFwd3PP = do
  ...
  let a1 = rfwd1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscan (\x a -> sin x - a) x0
                           (rfromList [x0 * 5, x0 * 7])) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v61 = rfromList [rconst 1.1 * rconst 5.0, rconst 1.1 * rconst 7.0] in rscanZipDer (\\x76 [x77 @Natural @Double @[], x78 @Natural @Double @[], x79 @Natural @Double @[]] -> x76 * cos x78 + x77 * rconst -1.0) (\\x81 [x82 @Natural @Double @[], x83 @Natural @Double @[], x84 @Natural @Double @[]] x85 [x86 @Natural @Double @[], x87 @Natural @Double @[], x88 @Natural @Double @[]] -> x82 * rconst -1.0 + x81 * cos x87 + (x83 * negate (sin x87)) * x85) (\\x95 x96 [x97 @Natural @Double @[], x98 @Natural @Double @[], x99 @Natural @Double @[]] -> (cos x98 * x95, rconst -1.0 * x95, negate (sin x98) * (x96 * x95), 0)) (rconst 1.1) (rfromList [rconst 1.1 * rconst 5.0, rconst 1.1 * rconst 7.0], rslice 0 2 (rscanDer (\\x62 x63 -> sin x62 - x63) (\\x64 x65 x66 x67 -> x64 * cos x66 + x65 * rconst -1.0) (\\x69 x70 x71 -> (cos x70 * x69, rconst -1.0 * x69)) (rconst 1.1) v61), v61)"
  ...
  let a1 = rrev1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x _a -> sin x)
                           ...
                           x0 (V.singleton $ DynamicRanked
                               $ rconst (OR.constant @Double @1 [2] 42))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v60 = rconst (fromList [2] [42.0,42.0]) ; v70 = rscanZipDer (\\x61 [x62 @Natural @Double @[]] -> sin x61) (\\x63 [x64 @Natural @Double @[]] x65 [x66 @Natural @Double @[]] -> x63 * cos x65) (\\x67 x68 [x69 @Natural @Double @[]] -> (cos x68 * x67, 0)) (rconst 1.1) (v60) in rconst 1.0 + rsum (rgather [2] (rfromList [rreplicate 2 (rscanZipDer (\\x72 [x73 @Natural @Double @[], x74 @Natural @Double @[]] -> cos x73 * x72) (\\x75 [x76 @Natural @Double @[], x77 @Natural @Double @[]] x78 [x79 @Natural @Double @[], x80 @Natural @Double @[]] -> (x76 * negate (sin x79)) * x78 + x75 * cos x79) (\\x84 x85 [x86 @Natural @Double @[], x87 @Natural @Double @[]] -> (cos x86 * x84, negate (sin x86) * (x85 * x84), 0)) (rconst 1.0) (rreverse (rslice 0 1 v70), rreverse (rslice 0 1 v60)) ! [1]), rreplicate 2 (rscanZipDer (\\x118 [x119 @Natural @Double @[], x120 @Natural @Double @[]] -> cos x119 * x118) (\\x121 [x122 @Natural @Double @[], x123 @Natural @Double @[]] x124 [x125 @Natural @Double @[], x126 @Natural @Double @[]] -> (x122 * negate (sin x125)) * x124 + x121 * cos x125) (\\x130 x131 [x132 @Natural @Double @[], x133 @Natural @Double @[]] -> (cos x132 * x130, negate (sin x132) * (x131 * x130), 0)) (rconst 1.0) (rreverse (rslice 0 2 v70), rreverse v60) ! [2])]) (\\[i135] -> [i135, i135]))"
  ...
  let a1 = rfwd1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x _a -> sin x)
                           ...
                           x0 (V.singleton $ DynamicRanked
                               $ rconst (OR.constant @Double @1 [2] 42))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v49 = rconst (fromList [2] [42.0,42.0]) in rscanZipDer (\\x60 [x61 @Natural @Double @[], x62 @Natural @Double @[], x63 @Natural @Double @[]] -> x60 * cos x62) (\\x64 [x65 @Natural @Double @[], x66 @Natural @Double @[], x67 @Natural @Double @[]] x68 [x69 @Natural @Double @[], x70 @Natural @Double @[], x71 @Natural @Double @[]] -> x64 * cos x70 + (x66 * negate (sin x70)) * x68) (\\x75 x76 [x77 @Natural @Double @[], x78 @Natural @Double @[], x79 @Natural @Double @[]] -> (cos x78 * x75, 0, negate (sin x78) * (x76 * x75), 0)) (rconst 1.1) (rconstant (rreplicate 2 (rconst 0.0)), rslice 0 2 (rscanZipDer (\\x50 [x51 @Natural @Double @[]] -> sin x50) (\\x52 [x53 @Natural @Double @[]] x54 [x55 @Natural @Double @[]] -> x52 * cos x54) (\\x56 x57 [x58 @Natural @Double @[]] -> (cos x57 * x56, 0)) (rconst 1.1) (v49)), v49)"
  ...
  let a1 = rrev1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x a -> sin x - rfromD (a V.! 0))
                         ...
                         x0 (V.singleton $ DynamicRanked
                             $ rconst (OR.fromList @Double @1 [2] [5, 7]))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v64 = rconst (fromList [2] [5.0,7.0]) ; v75 = rscanZipDer (\\x65 [x66 @Natural @Double @[]] -> sin x65 - x66) (\\x67 [x68 @Natural @Double @[]] x69 [x70 @Natural @Double @[]] -> x67 * cos x69 + x68 * rconst -1.0) (\\x72 x73 [x74 @Natural @Double @[]] -> (cos x73 * x72, rconst -1.0 * x72)) (rconst 1.1) (v64) in rconst 1.0 + rsum (rgather [2] (rfromList [rreplicate 2 (rscanZipDer (\\x77 [x78 @Natural @Double @[], x79 @Natural @Double @[]] -> cos x78 * x77) (\\x80 [x81 @Natural @Double @[], x82 @Natural @Double @[]] x83 [x84 @Natural @Double @[], x85 @Natural @Double @[]] -> (x81 * negate (sin x84)) * x83 + x80 * cos x84) (\\x89 x90 [x91 @Natural @Double @[], x92 @Natural @Double @[]] -> (cos x91 * x89, negate (sin x91) * (x90 * x89), 0)) (rconst 1.0) (rreverse (rslice 0 1 v75), rreverse (rslice 0 1 v64)) ! [1]), rreplicate 2 (rscanZipDer (\\x127 [x128 @Natural @Double @[], x129 @Natural @Double @[]] -> cos x128 * x127) (\\x130 [x131 @Natural @Double @[], x132 @Natural @Double @[]] x133 [x134 @Natural @Double @[], x135 @Natural @Double @[]] -> (x131 * negate (sin x134)) * x133 + x130 * cos x134) (\\x139 x140 [x141 @Natural @Double @[], x142 @Natural @Double @[]] -> (cos x141 * x139, negate (sin x141) * (x140 * x139), 0)) (rconst 1.0) (rreverse (rslice 0 2 v75), rreverse v64) ! [2])]) (\\[i144] -> [i144, i144]))"
...
testSin0ScanDFwd2PP = do
  ...
  let a1 = rfwd1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x a -> sin x - rfromD (a V.! 0))
                         ...
                         $ rconst (OR.fromList @Double @1 [2] [5, 7]))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v58 = rconst (fromList [2] [5.0,7.0]) in rscanZipDer (\\x70 [x71 @Natural @Double @[], x72 @Natural @Double @[], x73 @Natural @Double @[]] -> x70 * cos x72 + x71 * rconst -1.0) (\\x75 [x76 @Natural @Double @[], x77 @Natural @Double @[], x78 @Natural @Double @[]] x79 [x80 @Natural @Double @[], x81 @Natural @Double @[], x82 @Natural @Double @[]] -> x76 * rconst -1.0 + x75 * cos x81 + (x77 * negate (sin x81)) * x79) (\\x89 x90 [x91 @Natural @Double @[], x92 @Natural @Double @[], x93 @Natural @Double @[]] -> (cos x92 * x89, rconst -1.0 * x89, negate (sin x92) * (x90 * x89), 0)) (rconst 1.1) (rconstant (rreplicate 2 (rconst 0.0)), rslice 0 2 (rscanZipDer (\\x59 [x60 @Natural @Double @[]] -> sin x59 - x60) (\\x61 [x62 @Natural @Double @[]] x63 [x64 @Natural @Double @[]] -> x61 * cos x63 + x62 * rconst -1.0) (\\x66 x67 [x68 @Natural @Double @[]] -> (cos x67 * x66, rconst -1.0 * x66)) (rconst 1.1) (v58)), v58)"
                 ...
                 (\x0 -> rscanZip (\x a -> x + rfromD (a V.! 0))
                           ...
                           (V.singleton $ DynamicRanked
                            $ rscan (\x a -> a * x) x0
                                    (rfromList [x0 * 5, x0]))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v113 = rfromList [rconst 1.1 * rconst 5.0, rconst 1.1] ; v123 = rscanDer (\\x114 x115 -> x115 * x114) (\\x116 x117 x118 x119 -> x117 * x118 + x116 * x119) (\\x120 x121 x122 -> (x122 * x120, x121 * x120)) (rconst 1.1) v113 ; v134 = rscanZipDer (\\x125 [x126 @Natural @Double @[]] -> x125 + x126) (\\x127 [x128 @Natural @Double @[]] x129 [x130 @Natural @Double @[]] -> x127 + x128) (\\x131 x132 [x133 @Natural @Double @[]] -> (x131, x131)) (rconst 1.1) (v123) ; m135 = rfromList [rappend (rreverse (rscanZipDer (\\x136 [x137 @Natural @Double @[], x138 @Natural @Double @[]] -> x136) (\\x139 [x140 @Natural @Double @[], x141 @Natural @Double @[]] x142 [x143 @Natural @Double @[], x144 @Natural @Double @[]] -> x139) (\\x145 x146 [x147 @Natural @Double @[], x148 @Natural @Double @[]] -> (x145, 0, 0)) (rconst 1.0) (rreverse (rslice 0 1 v134), rreverse (rslice 0 1 v123)))) (rconstant (rreplicate 2 (rconst 0.0))), rappend (rreverse (rscanZipDer (\\x245 [x246 @Natural @Double @[], x247 @Natural @Double @[]] -> x245) (\\x248 [x249 @Natural @Double @[], x250 @Natural @Double @[]] x251 [x252 @Natural @Double @[], x253 @Natural @Double @[]] -> x248) (\\x254 x255 [x256 @Natural @Double @[], x257 @Natural @Double @[]] -> (x254, 0, 0)) (rconst 1.0) (rreverse (rslice 0 2 v134), rreverse (rslice 0 2 v123)))) (rconstant (rreplicate 1 (rconst 0.0))), rappend (rreverse (rscanZipDer (\\x277 [x278 @Natural @Double @[], x279 @Natural @Double @[]] -> x277) (\\x280 [x281 @Natural @Double @[], x282 @Natural @Double @[]] x283 [x284 @Natural @Double @[], x285 @Natural @Double @[]] -> x280) (\\x286 x287 [x288 @Natural @Double @[], x289 @Natural @Double @[]] -> (x286, 0, 0)) (rconst 1.0) (rreverse (rslice 0 3 v134), rreverse v123))) (rconstant (rreplicate 0 (rconst 0.0)))] ; v161 = rappend (rgather [3] (m135 ! [2]) (\\[i151] -> [1 + i151])) (rconstant (rreplicate 0 (rconst 0.0))) + rappend (rgather [1] (m135 ! [0]) (\\[i159] -> [1 + i159])) (rconstant (rreplicate 2 (rconst 0.0))) + rappend (rgather [2] (m135 ! [1]) (\\[i155] -> [1 + i155])) (rconstant (rreplicate 1 (rconst 0.0))) ; m162 = rfromList [rappend (rreverse (rscanZipDer (\\x163 [x164 @Natural @Double @[], x165 @Natural @Double @[]] -> x165 * x163) (\\x166 [x167 @Natural @Double @[], x168 @Natural @Double @[]] x169 [x170 @Natural @Double @[], x171 @Natural @Double @[]] -> x168 * x169 + x166 * x171) (\\x173 x174 [x175 @Natural @Double @[], x176 @Natural @Double @[]] -> (x176 * x173, 0, x174 * x173)) (v161 ! [1]) (rreverse (rslice 0 1 v123), rreverse (rslice 0 1 v113)))) (rconstant (rreplicate 1 (rconst 0.0))), rappend (rreverse (rscanZipDer (\\x201 [x202 @Natural @Double @[], x203 @Natural @Double @[]] -> x203 * x201) (\\x204 [x205 @Natural @Double @[], x206 @Natural @Double @[]] x207 [x208 @Natural @Double @[], x209 @Natural @Double @[]] -> x206 * x207 + x204 * x209) (\\x211 x212 [x213 @Natural @Double @[], x214 @Natural @Double @[]] -> (x214 * x211, 0, x212 * x211)) (v161 ! [2]) (rreverse (rslice 0 2 v123), rreverse v113))) (rconstant (rreplicate 0 (rconst 0.0)))] ; v177 = rsum (rfromList [rappend (rgather [1] v123 (\\[i179] -> [i179]) * rgather [1] (m162 ! [0]) (\\[i180] -> [1 + i180])) (rconstant (rreplicate 1 (rconst 0.0))), rappend (rgather [2] v123 (\\[i220] -> [i220]) * rgather [2] (m162 ! [1]) (\\[i221] -> [1 + i221])) (rconstant (rreplicate 0 (rconst 0.0)))]) in rconst 5.0 * v177 ! [0] + v177 ! [1] + v161 ! [0] + rsum (rgather [2] m162 (\\[i223] -> [i223, 0])) + rconst 1.0 + rsum (rgather [3] m135 (\\[i225] -> [i225, 0]))"
  ...
  let a1 = rfwd1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x a -> sin x - rfromD (a V.! 0))
                                ...
                                x0 (V.singleton $ DynamicRanked
                                    $ rfromList [x0 * 5, x0 * 7])) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v61 = rfromList [rconst 1.1 * rconst 5.0, rconst 1.1 * rconst 7.0] in rscanZipDer (\\x76 [x77 @Natural @Double @[], x78 @Natural @Double @[], x79 @Natural @Double @[]] -> x76 * cos x78 + x77 * rconst -1.0) (\\x81 [x82 @Natural @Double @[], x83 @Natural @Double @[], x84 @Natural @Double @[]] x85 [x86 @Natural @Double @[], x87 @Natural @Double @[], x88 @Natural @Double @[]] -> x82 * rconst -1.0 + x81 * cos x87 + (x83 * negate (sin x87)) * x85) (\\x95 x96 [x97 @Natural @Double @[], x98 @Natural @Double @[], x99 @Natural @Double @[]] -> (cos x98 * x95, rconst -1.0 * x95, negate (sin x98) * (x96 * x95), 0)) (rconst 1.1) (rfromList [rconst 1.1 * rconst 5.0, rconst 1.1 * rconst 7.0], rslice 0 2 (rscanZipDer (\\x62 [x63 @Natural @Double @[]] -> sin x62 - x63) (\\x64 [x65 @Natural @Double @[]] x66 [x67 @Natural @Double @[]] -> x64 * cos x66 + x65 * rconst -1.0) (\\x69 x70 [x71 @Natural @Double @[]] -> (cos x70 * x69, rconst -1.0 * x69)) (rconst 1.1) (v61)), v61)"
          ...
          (let f :: forall f. ADReady f => f Double 0 -> f Double 0
               f a0 = rfold (\x a -> rlet (x + a) $ \xpa ->
                          rfold (\x3 a3 -> 0.1 * x3 * a3)
                            ...
                            a0 (rreplicate 2 a0)
           in f) 1.1
  length (printAstPretty IM.empty (simplifyAst6 a1))
    @?= 52297
