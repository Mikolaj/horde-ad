  ...
  let a1 = rrev1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x _a -> sin x)
                           ...
                           x0 (V.singleton $ DynamicRanked
                               $ rconst (OR.constant @Double @1 [2] 42))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v32 = rconst (fromList [2] [42.0,42.0]) in let [x43 @Natural @Double @[], v44 @Natural @Double @[2]] = dmapAccumRDer f df rf [rconst 0.0] [rconstant (rreplicate 2 (rconst 1.0)), rslice 0 2 (rscanZipDer f df rf (rconst 1.1) [v32]), v32] in x43 + rconst 1.0"
  ...
  let a1 = rrev1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x a -> sin x - rfromD (a V.! 0))
                         ...
                         x0 (V.singleton $ DynamicRanked
                             $ rconst (OR.fromList @Double @1 [2] [5, 7]))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v34 = rconst (fromList [2] [5.0,7.0]) in let [x46 @Natural @Double @[], v47 @Natural @Double @[2]] = dmapAccumRDer f df rf [rconst 0.0] [rconstant (rreplicate 2 (rconst 1.0)), rslice 0 2 (rscanZipDer f df rf (rconst 1.1) [v34]), v34] in x46 + rconst 1.0"
...
testSin0FoldNestedR1PP = do
  ...
  printAstHVectorPretty
    IM.empty
    (g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 1.1))
    @?= "let v419 = rscanDer f df rf (rconst 1.1) (rreplicate 11 (rconst 1.1)) ; x420 = rreshape [] (rreplicate 1 (rconst 1.0)) in let [x421 @Natural @Double @[], v422 @Natural @Double @[11]] = dmapAccumRDer f df rf [x420] [rslice 0 11 v419, rreplicate 11 (rconst 1.1)] in [rsum v422 + x421]"
...
testSin0FoldNestedR1SimpPP = do
  ...
  printAstHVectorPretty
    ...
    (simplifyAstHVector6
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 1.1))
    @?= "let [x421 @Natural @Double @[], v422 @Natural @Double @[11]] = dmapAccumRDer f df rf [rconst 1.0] [rslice 0 11 (rscanDer f df rf (rconst 1.1) (rconstant (rreplicate 11 (rconst 1.1)))), rconstant (rreplicate 11 (rconst 1.1))] in [rsum v422 + x421]"
...
testSin0FoldNestedR1SimpNestedPP = do
  ...
  printAstHVectorPrettyButNested
    ...
    (simplifyAstHVector6
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 1.1))
    @?= "let [x421 @Natural @Double @[], v422 @Natural @Double @[11]] = dmapAccumRDer (SNat @11) (\\[x423] [x424, x425] -> let [x439 @Natural @Double @[], v440 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x441] [x442, x443] -> let x444 = cos x443 in [x441, recip (x444 * x444) * x441]) (\\[x445] [x446, x447] [x448] [x449, x450] -> let x451 = cos x450 ; x452 = x451 * x451 ; x454 = x447 * negate (sin x450) in [x445, ((x454 * x451 + x454 * x451) * negate (recip (x452 * x452))) * x448 + x445 * recip x452]) (\\[x458] [x459] [x460] [x461, x462] -> let x463 = cos x462 ; x464 = x463 * x463 ; x466 = negate (recip (x464 * x464)) * (x460 * x459) in [recip x464 * x459 + x458, 0, negate (sin x462) * (x463 * x466 + x463 * x466)]) [x423] [rslice 0 22 (rscanDer (\\x426 x427 -> x426 + tan x427) (\\x428 x429 x430 x431 -> let x432 = cos x431 in x428 + x429 * recip (x432 * x432)) (\\x434 x435 x436 -> let x437 = cos x436 in [x434, recip (x437 * x437) * x434]) x425 (rreplicate 22 x424)), rreplicate 22 x424] in [rsum v440, x439]) (\\[x467] [x468, x469] [x470] [x471, x472] -> let v616 = rscanDer (\\x604 x605 -> x604 + tan x605) (\\x606 x607 x608 x609 -> let x610 = cos x609 in x606 + x607 * recip (x610 * x610)) (\\x612 x613 x614 -> let x615 = cos x614 in [x612, recip (x615 * x615) * x612]) x472 (rreplicate 22 x471) in let [x619 @Natural @Double @[], v620 @Natural @Double @[22], v621 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x622] [x623, x624] -> let x625 = cos x624 in [x622, x622, recip (x625 * x625) * x622]) (\\[x627] [x628, x629] [x630] [x631, x632] -> let x650 = cos x632 ; x651 = x650 * x650 ; x654 = x629 * negate (sin x632) in [x627, x627, ((x654 * x650 + x654 * x650) * negate (recip (x651 * x651))) * x630 + x627 * recip x651]) (\\[x658] [x659, x660] [x661] [x662, x663] -> let x681 = cos x663 ; x682 = x681 * x681 ; x688 = negate (recip (x682 * x682)) * (x661 * x660) in [recip x682 * x660 + x659 + x658, 0, negate (sin x663) * (x681 * x688 + x681 * x688)]) [x470] [rslice 0 22 v616, rreplicate 22 x471] in let [x723 @Natural @Double @[], v724 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x725] [x726, x727, x728, x729, x730] -> let x731 = cos x730 ; x732 = x731 * x731 ; x734 = x727 * negate (sin x730) in [x725, ((x734 * x731 + x734 * x731) * negate (recip (x732 * x732))) * x728 + x725 * recip x732]) (\\[x738] [x739, x740, x741, x742, x743] [x744] [x745, x746, x747, x748, x749] -> let x795 = cos x749 ; x796 = x795 * x795 ; x798 = negate (sin x749) ; x799 = x746 * x798 ; x800 = x799 * x795 + x799 * x795 ; x801 = x796 * x796 ; x802 = negate (recip x801) ; x807 = x740 * x798 + ((x743 * cos x749) * rconst -1.0) * x746 ; x808 = x743 * negate (sin x749) ; x812 = x808 * x795 + x808 * x795 in [x738, ((x807 * x795 + x808 * x799 + x807 * x795 + x808 * x799) * x802 + (((x812 * x796 + x812 * x796) * negate (recip (x801 * x801))) * rconst -1.0) * x800) * x747 + x741 * (x800 * x802) + x738 * recip x796 + (x812 * negate (recip (x796 * x796))) * x744]) (\\[x821] [x822] [x823] [x824, x825, x826, x827, x828] -> let x861 = cos x828 ; x862 = x861 * x861 ; x864 = negate (sin x828) ; x865 = x825 * x864 ; x866 = x865 * x861 + x865 * x861 ; x867 = x862 * x862 ; x868 = negate (recip x867) ; x873 = x826 * x822 ; x874 = negate (recip (x867 * x867)) * (rconst -1.0 * (x866 * x873)) ; x875 = x868 * x873 ; x876 = x861 * x875 + x861 * x875 ; x877 = negate (recip (x862 * x862)) * (x823 * x822) + x862 * x874 + x862 * x874 in [recip x862 * x822 + x821, 0, x864 * x876, (x866 * x868) * x822, 0, negate (sin x828) * (x861 * x877 + x861 * x877 + x865 * x875 + x865 * x875) + cos x828 * (rconst -1.0 * (x825 * x876))]) [x467] [rslice 0 22 (rscanZipDer (\\x689 [x690, x691, x692] -> let x693 = cos x692 in x689 + x690 * recip (x693 * x693)) (\\x695 [x696, x697, x698] x699 [x700, x701, x702] -> let x703 = cos x702 ; x704 = x703 * x703 ; x707 = x698 * negate (sin x702) in x695 + x696 * recip x704 + ((x707 * x703 + x707 * x703) * negate (recip (x704 * x704))) * x700) (\\x712 x713 [x714, x715, x716] -> let x717 = cos x716 ; x718 = x717 * x717 ; x721 = negate (recip (x718 * x718)) * (x714 * x712) in [x712, recip x718 * x712, 0, negate (sin x716) * (x717 * x721 + x717 * x721)]) x469 [rreplicate 22 x468, rslice 0 22 v616, rreplicate 22 x471]), rreplicate 22 x468, v620, rslice 0 22 v616, rreplicate 22 x471] in [rsum v724, x723]) (\\[x879] [x880] [x881] [x882, x883] -> let v992 = rscanDer (\\x980 x981 -> x980 + tan x981) (\\x982 x983 x984 x985 -> let x986 = cos x985 in x982 + x983 * recip (x986 * x986)) (\\x988 x989 x990 -> let x991 = cos x990 in [x988, recip (x991 * x991) * x988]) x883 (rreplicate 22 x882) in let [x995 @Natural @Double @[], v996 @Natural @Double @[22], v997 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x998] [x999, x1000] -> let x1001 = cos x1000 in [x998, x998, recip (x1001 * x1001) * x998]) (\\[x1003] [x1004, x1005] [x1006] [x1007, x1008] -> let x1026 = cos x1008 ; x1027 = x1026 * x1026 ; x1030 = x1005 * negate (sin x1008) in [x1003, x1003, ((x1030 * x1026 + x1030 * x1026) * negate (recip (x1027 * x1027))) * x1006 + x1003 * recip x1027]) (\\[x1034] [x1035, x1036] [x1037] [x1038, x1039] -> let x1057 = cos x1039 ; x1058 = x1057 * x1057 ; x1064 = negate (recip (x1058 * x1058)) * (x1037 * x1036) in [recip x1058 * x1036 + x1035 + x1034, 0, negate (sin x1039) * (x1057 * x1064 + x1057 * x1064)]) [x881] [rslice 0 22 v992, rreplicate 22 x882] in let [x1069 @Natural @Double @[], v1070 @Natural @Double @[22], v1071 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x1072] [x1073, x1074, x1075, x1076] -> let x1077 = cos x1076 ; x1078 = x1077 * x1077 ; x1080 = negate (recip (x1078 * x1078)) * (x1074 * x1073) in [recip x1078 * x1073 + x1072, 0, negate (sin x1076) * (x1077 * x1080 + x1077 * x1080)]) (\\[x1081] [x1082, x1083, x1084, x1085] [x1086] [x1087, x1088, x1089, x1090] -> let x1130 = cos x1090 ; x1131 = x1130 * x1130 ; x1133 = x1131 * x1131 ; x1134 = negate (recip x1133) ; x1135 = x1088 * x1087 ; x1136 = x1134 * x1135 ; x1139 = x1085 * negate (sin x1090) ; x1140 = x1139 * x1130 + x1139 * x1130 ; x1150 = (((x1140 * x1131 + x1140 * x1131) * negate (recip (x1133 * x1133))) * rconst -1.0) * x1135 + (x1083 * x1087 + x1082 * x1088) * x1134 in [x1081 + (x1140 * negate (recip (x1131 * x1131))) * x1087 + x1082 * recip x1131, rconst 0.0, ((x1085 * cos x1090) * rconst -1.0) * (x1130 * x1136 + x1130 * x1136) + (x1139 * x1136 + x1150 * x1130 + x1139 * x1136 + x1150 * x1130) * negate (sin x1090)]) (\\[x1155] [x1156, x1157] [x1158] [x1159, x1160, x1161, x1162] -> let x1192 = cos x1162 ; x1193 = x1192 * x1192 ; x1195 = x1193 * x1193 ; x1196 = negate (recip x1195) ; x1197 = x1160 * x1159 ; x1198 = x1196 * x1197 ; x1204 = negate (sin x1162) * x1157 ; x1205 = x1192 * x1204 + x1192 * x1204 ; x1206 = x1196 * x1205 ; x1207 = negate (recip (x1195 * x1195)) * (rconst -1.0 * (x1197 * x1205)) ; x1208 = negate (recip (x1193 * x1193)) * (x1159 * x1155) + x1193 * x1207 + x1193 * x1207 in [x1155, x1160 * x1206 + recip x1193 * x1155, x1159 * x1206, 0, negate (sin x1162) * (x1192 * x1208 + x1192 * x1208 + x1198 * x1204 + x1198 * x1204) + cos x1162 * (rconst -1.0 * ((x1192 * x1198 + x1192 * x1198) * x1157))]) [x880] [rreplicate 22 x879, rreverse v996, rreverse (rslice 0 22 v992), rreplicate 22 x882] in let v1209 = rappend (rreplicate 0 (rconst 0.0)) (rappend (rreverse v1070) (rreplicate 1 (rconst 0.0))) in let [x1210 @Natural @Double @[], v1211 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x1212] [x1213, x1214, x1215] -> let x1216 = cos x1215 in [x1212 + x1213, recip (x1216 * x1216) * (x1212 + x1213)]) (\\[x1217] [x1218, x1219, x1220] [x1221] [x1222, x1223, x1224] -> let x1244 = cos x1224 ; x1245 = x1244 * x1244 ; x1249 = x1220 * negate (sin x1224) in [x1217 + x1218, ((x1249 * x1244 + x1249 * x1244) * negate (recip (x1245 * x1245))) * (x1221 + x1222) + (x1217 + x1218) * recip x1245]) (\\[x1254] [x1255] [x1256] [x1257, x1258, x1259] -> let x1275 = cos x1259 ; x1276 = x1275 * x1275 ; x1281 = recip x1276 * x1255 ; x1282 = negate (recip (x1276 * x1276)) * ((x1256 + x1257) * x1255) in [x1254 + x1281, x1254 + x1281, 0, negate (sin x1259) * (x1275 * x1282 + x1275 * x1282)]) [rconst 0.0] [rslice 1 22 v1209, rslice 0 22 v992, rreplicate 22 x882] in [x1069, rsum v1211 + rsum v1071, x1210 + v1209 ! [0]]) [rconst 1.0] [rslice 0 11 (rscanDer (\\x312 x313 -> rfoldDer (\\x314 x315 -> x314 + tan x315) (\\x316 x317 x318 x319 -> let x320 = cos x319 in x316 + x317 * recip (x320 * x320)) (\\x322 x323 x324 -> let x325 = cos x324 in [x322, recip (x325 * x325) * x322]) x313 (rreplicate 22 x312)) (\\x326 x327 x328 x329 -> rfoldZipDer (\\x343 [x344, x345, x346] -> let x347 = cos x346 in x343 + x344 * recip (x347 * x347)) (\\x349 [x350, x351, x352] x353 [x354, x355, x356] -> let x357 = cos x356 ; x358 = x357 * x357 ; x361 = x352 * negate (sin x356) in x349 + x350 * recip x358 + ((x361 * x357 + x361 * x357) * negate (recip (x358 * x358))) * x354) (\\x365 x366 [x367, x368, x369] -> let x370 = cos x369 ; x371 = x370 * x370 ; x374 = negate (recip (x371 * x371)) * (x367 * x365) in [x365, recip x371 * x365, 0, negate (sin x369) * (x370 * x374 + x370 * x374)]) x327 [rreplicate 22 x326, rslice 0 22 (rscanDer (\\x330 x331 -> x330 + tan x331) (\\x332 x333 x334 x335 -> let x336 = cos x335 in x332 + x333 * recip (x336 * x336)) (\\x338 x339 x340 -> let x341 = cos x340 in [x338, recip (x341 * x341) * x338]) x329 (rreplicate 22 x328)), rreplicate 22 x328]) (\\x375 x376 x377 -> let [x391 @Natural @Double @[], v392 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x393] [x394, x395] -> let x396 = cos x395 in [x393, recip (x396 * x396) * x393]) (\\[x397] [x398, x399] [x400] [x401, x402] -> let x403 = cos x402 ; x404 = x403 * x403 ; x406 = x399 * negate (sin x402) in [x397, ((x406 * x403 + x406 * x403) * negate (recip (x404 * x404))) * x400 + x397 * recip x404]) (\\[x410] [x411] [x412] [x413, x414] -> let x415 = cos x414 ; x416 = x415 * x415 ; x418 = negate (recip (x416 * x416)) * (x412 * x411) in [recip x416 * x411 + x410, 0, negate (sin x414) * (x415 * x418 + x415 * x418)]) [x375] [rslice 0 22 (rscanDer (\\x378 x379 -> x378 + tan x379) (\\x380 x381 x382 x383 -> let x384 = cos x383 in x380 + x381 * recip (x384 * x384)) (\\x386 x387 x388 -> let x389 = cos x388 in [x386, recip (x389 * x389) * x386]) x377 (rreplicate 22 x376)), rreplicate 22 x376] in [rsum v392, x391]) (rconst 1.1) (rconstant (rreplicate 11 (rconst 1.1)))), rconstant (rreplicate 11 (rconst 1.1))] in [rsum v422 + x421]"
