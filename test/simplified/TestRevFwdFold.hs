...
testSin0FoldNestedR1SimpNestedPP = do
  ...
  printAstHVectorPrettyButNested
    ...
    (simplifyAstHVector6
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 1.1))
    @?= "let v656 = rscanDer (\\x582 x583 -> rfoldDer (\\x584 x585 -> x584 * x585) (\\x586 x587 x588 x589 -> x586 * x589 + x587 * x588) (\\x590 x591 x592 -> [x592 * x590, x591 * x590]) x583 (rreplicate 2 x582)) (\\x593 x594 x595 x596 -> rfoldZipDer (\\x607 [x608 @Natural @Double @[], x609 @Natural @Double @[], x610 @Natural @Double @[]] -> x607 * x610 + x608 * x609) (\\x611 [x612 @Natural @Double @[], x613 @Natural @Double @[], x614 @Natural @Double @[]] x615 [x616 @Natural @Double @[], x617 @Natural @Double @[], x618 @Natural @Double @[]] -> x611 * x618 + x614 * x615 + x612 * x617 + x613 * x616) (\\x621 x622 [x623 @Natural @Double @[], x624 @Natural @Double @[], x625 @Natural @Double @[]] -> [x625 * x621, x624 * x621, x623 * x621, x622 * x621]) x594 [rreplicate 2 x593, rslice 0 2 (rscanDer (\\x597 x598 -> x597 * x598) (\\x599 x600 x601 x602 -> x599 * x602 + x600 * x601) (\\x603 x604 x605 -> [x605 * x603, x604 * x603]) x596 (rreplicate 2 x595)), rreplicate 2 x595]) (\\x626 x627 x628 -> let v638 = rscanDer (\\x629 x630 -> x629 * x630) (\\x631 x632 x633 x634 -> x631 * x634 + x632 * x633) (\\x635 x636 x637 -> [x637 * x635, x636 * x635]) x628 (rreplicate 2 x627) ; v652 = rreverse (rscanZipDer (\\x639 [x640 @Natural @Double @[], x641 @Natural @Double @[]] -> x641 * x639) (\\x642 [x643 @Natural @Double @[], x644 @Natural @Double @[]] x645 [x646 @Natural @Double @[], x647 @Natural @Double @[]] -> x644 * x645 + x642 * x647) (\\x648 x649 [x650 @Natural @Double @[], x651 @Natural @Double @[]] -> [x651 * x648, 0, x649 * x648]) x626 [rreverse (rslice 0 2 v638), rreplicate 2 x627]) in [rsum (rgather [2] v638 (\\[i654] -> [i654]) * rgather [2] v652 (\\[i655] -> [1 + i655])), v652 ! [0]]) (rconst 1.1) (rconstant (rreplicate 3 (rconst 1.1))) ; v936 = rreverse (rscanZipDer (\\x658 [x659 @Natural @Double @[], x660 @Natural @Double @[]] -> let v670 = rscanDer (\\x661 x662 -> x661 * x662) (\\x663 x664 x665 x666 -> x663 * x666 + x664 * x665) (\\x667 x668 x669 -> [x669 * x667, x668 * x667]) x660 (rreplicate 2 x659) in rsum (rgather [2] v670 (\\[i686] -> [i686]) * rgather [2] (rscanZipDer (\\x671 [x672 @Natural @Double @[], x673 @Natural @Double @[]] -> x673 * x671) (\\x674 [x675 @Natural @Double @[], x676 @Natural @Double @[]] x677 [x678 @Natural @Double @[], x679 @Natural @Double @[]] -> x676 * x677 + x674 * x679) (\\x680 x681 [x682 @Natural @Double @[], x683 @Natural @Double @[]] -> [x683 * x680, 0, x681 * x680]) x658 [rreverse (rslice 0 2 v670), rreplicate 2 x659]) (\\[i687] -> [1 + negate i687]))) (\\x688 [x689 @Natural @Double @[], x690 @Natural @Double @[]] x691 [x692 @Natural @Double @[], x693 @Natural @Double @[]] -> let v703 = rscanDer (\\x694 x695 -> x694 * x695) (\\x696 x697 x698 x699 -> x696 * x699 + x697 * x698) (\\x700 x701 x702 -> [x702 * x700, x701 * x700]) x693 (rreplicate 2 x692) ; v704 = rreverse (rslice 0 2 v703) ; v719 = rscanZipDer (\\x706 [x707 @Natural @Double @[], x708 @Natural @Double @[]] -> x708 * x706) (\\x709 [x710 @Natural @Double @[], x711 @Natural @Double @[]] x712 [x713 @Natural @Double @[], x714 @Natural @Double @[]] -> x711 * x712 + x709 * x714) (\\x715 x716 [x717 @Natural @Double @[], x718 @Natural @Double @[]] -> [x718 * x715, 0, x716 * x715]) x691 [v704, rreplicate 2 x692] in rsum (rgather [2] v719 (\\[i723] -> [1 + negate i723]) * rgather [2] (rscanZipDer (\\x725 [x726 @Natural @Double @[], x727 @Natural @Double @[], x728 @Natural @Double @[]] -> x725 * x728 + x726 * x727) (\\x729 [x730 @Natural @Double @[], x731 @Natural @Double @[], x732 @Natural @Double @[]] x733 [x734 @Natural @Double @[], x735 @Natural @Double @[], x736 @Natural @Double @[]] -> x729 * x736 + x732 * x733 + x730 * x735 + x731 * x734) (\\x740 x741 [x742 @Natural @Double @[], x743 @Natural @Double @[], x744 @Natural @Double @[]] -> [x744 * x740, x743 * x740, x742 * x740, x741 * x740]) x690 [rreplicate 2 x689, rslice 0 2 v703, rreplicate 2 x692]) (\\[i745] -> [i745])) + rsum (rgather [2] v703 (\\[i721] -> [i721]) * rgather [2] (rscanZipDer (\\x770 [x771 @Natural @Double @[], x772 @Natural @Double @[], x773 @Natural @Double @[], x774 @Natural @Double @[], x775 @Natural @Double @[]] -> x772 * x773 + x770 * x775) (\\x776 [x777 @Natural @Double @[], x778 @Natural @Double @[], x779 @Natural @Double @[], x780 @Natural @Double @[], x781 @Natural @Double @[]] x782 [x783 @Natural @Double @[], x784 @Natural @Double @[], x785 @Natural @Double @[], x786 @Natural @Double @[], x787 @Natural @Double @[]] -> x778 * x785 + x779 * x784 + x776 * x787 + x781 * x782) (\\x791 x792 [x793 @Natural @Double @[], x794 @Natural @Double @[], x795 @Natural @Double @[], x796 @Natural @Double @[], x797 @Natural @Double @[]] -> [x797 * x791, 0, x795 * x791, x794 * x791, 0, x792 * x791]) x688 [rreverse (rslice 0 2 (rscanZipDer (\\x747 [x748 @Natural @Double @[], x749 @Natural @Double @[], x750 @Natural @Double @[]] -> x747 * x750 + x748 * x749) (\\x751 [x752 @Natural @Double @[], x753 @Natural @Double @[], x754 @Natural @Double @[]] x755 [x756 @Natural @Double @[], x757 @Natural @Double @[], x758 @Natural @Double @[]] -> x751 * x758 + x754 * x755 + x752 * x757 + x753 * x756) (\\x762 x763 [x764 @Natural @Double @[], x765 @Natural @Double @[], x766 @Natural @Double @[]] -> [x766 * x762, x765 * x762, x764 * x762, x763 * x762]) x690 [rreplicate 2 x689, rslice 0 2 v703, rreplicate 2 x692])), rreplicate 2 x689, rslice 0 2 v719, v704, rreplicate 2 x692]) (\\[i799] -> [1 + negate i799]))) (\\x802 x803 [x804 @Natural @Double @[], x805 @Natural @Double @[]] -> let v821 = rscanDer (\\x812 x813 -> x812 * x813) (\\x814 x815 x816 x817 -> x814 * x817 + x815 * x816) (\\x818 x819 x820 -> [x820 * x818, x819 * x818]) x805 (rreplicate 2 x804) ; v822 = rreverse (rslice 0 2 v821) ; v837 = rscanZipDer (\\x824 [x825 @Natural @Double @[], x826 @Natural @Double @[]] -> x826 * x824) (\\x827 [x828 @Natural @Double @[], x829 @Natural @Double @[]] x830 [x831 @Natural @Double @[], x832 @Natural @Double @[]] -> x829 * x830 + x827 * x832) (\\x833 x834 [x835 @Natural @Double @[], x836 @Natural @Double @[]] -> [x836 * x833, 0, x834 * x833]) x803 [v822, rreplicate 2 x804] ; v844 = rscatter [3] (rgather [2] v837 (\\[i841] -> [1 + negate i841]) * rreplicate 2 x802) (\\[i843] -> [i843]) ; v867 = rreverse (rscanZipDer (\\x845 [x846 @Natural @Double @[], x847 @Natural @Double @[], x848 @Natural @Double @[]] -> x848 * (x845 + x846)) (\\x849 [x850 @Natural @Double @[], x851 @Natural @Double @[], x852 @Natural @Double @[]] x853 [x854 @Natural @Double @[], x855 @Natural @Double @[], x856 @Natural @Double @[]] -> x852 * (x853 + x854) + (x849 + x850) * x856) (\\x860 x861 [x862 @Natural @Double @[], x863 @Natural @Double @[], x864 @Natural @Double @[]] -> let x866 = x864 * x860 in [x866, x866, 0, (x861 + x862) * x860]) (rconst 0.0) [rreverse (rslice 1 2 v844), rreverse (rslice 0 2 v821), rreplicate 2 x804]) ; v869 = rreverse (rscatter [3] (rgather [2] v821 (\\[i839] -> [i839]) * rreplicate 2 x802) (\\[i868] -> [1 + i868])) ; v896 = rreverse (rscanZipDer (\\x870 [x871 @Natural @Double @[], x872 @Natural @Double @[], x873 @Natural @Double @[], x874 @Natural @Double @[]] -> x874 * (x870 + x871)) (\\x875 [x876 @Natural @Double @[], x877 @Natural @Double @[], x878 @Natural @Double @[], x879 @Natural @Double @[]] x880 [x881 @Natural @Double @[], x882 @Natural @Double @[], x883 @Natural @Double @[], x884 @Natural @Double @[]] -> x879 * (x880 + x881) + (x875 + x876) * x884) (\\x888 x889 [x890 @Natural @Double @[], x891 @Natural @Double @[], x892 @Natural @Double @[], x893 @Natural @Double @[]] -> let x895 = x893 * x888 in [x895, x895, 0, 0, (x889 + x890) * x888]) (rconst 0.0) [rreverse (rslice 1 2 v869), rreverse (rslice 0 2 v837), rreverse v822, rreplicate 2 x804]) ; v904 = rappend (rreplicate 0 (rconst 0.0)) (rappend (rreplicate 2 (sconst @[] 0.0)) (rreplicate 1 (rconst 0.0))) ; v927 = rreverse (rscanZipDer (\\x905 [x906 @Natural @Double @[], x907 @Natural @Double @[], x908 @Natural @Double @[]] -> x908 * (x905 + x906)) (\\x909 [x910 @Natural @Double @[], x911 @Natural @Double @[], x912 @Natural @Double @[]] x913 [x914 @Natural @Double @[], x915 @Natural @Double @[], x916 @Natural @Double @[]] -> x912 * (x913 + x914) + (x909 + x910) * x916) (\\x920 x921 [x922 @Natural @Double @[], x923 @Natural @Double @[], x924 @Natural @Double @[]] -> let x926 = x924 * x920 in [x926, x926, 0, (x921 + x922) * x920]) (rconst 0.0) [rreverse (rslice 1 2 v904), rreverse (rslice 0 2 v821), rreplicate 2 x804]) in [v896 ! [0] + v869 ! [0], rsum (rgather [2] v821 (\\[i929] -> [i929]) * (rgather [2] v927 (\\[i930] -> [1 + i930]) + rgather [2] v904 (\\[i931] -> [1 + i931])) + rgather [2] v821 (\\[i933] -> [i933]) * (rgather [2] v867 (\\[i934] -> [1 + i934]) + rgather [2] v844 (\\[i935] -> [1 + i935]))) + rsum (rgather [2] v837 (\\[i900] -> [i900]) * (rgather [2] v896 (\\[i901] -> [1 + i901]) + rgather [2] v869 (\\[i902] -> [1 + i902]))), v927 ! [0] + v904 ! [0] + v867 ! [0] + v844 ! [0]]) (rconst 1.0) [rreverse (rslice 0 3 v656), rconstant (rreplicate 3 (rconst 1.1))]) in [rsum (rscanZipDer (\\v951 [v952 @Natural @Double @[3], v953 @Natural @Double @[3]] -> v953 * v951) (\\v956 [v957 @Natural @Double @[3], v958 @Natural @Double @[3]] v959 [v960 @Natural @Double @[3], v961 @Natural @Double @[3]] -> v958 * v959 + v956 * v961) (\\v963 v964 [v965 @Natural @Double @[3], v966 @Natural @Double @[3]] -> [v966 * v963, sconst @[3] (fromList @[3] [0.0,0.0,0.0]), v964 * v963]) (rgather [3] v936 (\\[i955] -> [1 + i955])) [rreverse (rslice 0 2 (rscanDer (\\v937 v938 -> v937 * v938) (\\v940 v941 v942 v943 -> v940 * v943 + v941 * v942) (\\v945 v946 v947 -> [v947 * v945, v946 * v945]) (rconstant (rreplicate 3 (rconst 1.1))) (rreplicate 2 (rslice 0 3 v656)))), rreplicate 2 (rgather [3] v656 (\\[i950] -> [i950]))] ! [2]) + v936 ! [0]]"
