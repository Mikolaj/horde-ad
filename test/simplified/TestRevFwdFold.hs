  ...
  let a1 = rrev1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x _a -> sin x)
                           ...
                           x0 (V.singleton $ DynamicRanked
                               $ rconst (OR.constant @Double @1 [2] 42))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v37 = rconst (fromList [2] [42.0,42.0]) in let [x38 @Natural @Double @[], v39 @Natural @Double @[2], v40 @Natural @Double @[2]] = dmapAccumLDer f df rf [rconst 1.1] [v37] in let [x82 @Natural @Double @[], v83 @Natural @Double @[2]] = dmapAccumLDer f df rf [rconstant (sconst @[] 0.0)] [rconstant (rreplicate 2 (rconst 1.0)), rreverse v39, rreverse v37] in x82 + rconst 1.0"
  ...
  let a1 = rrev1 @(AstRanked FullSpan) @Double @0 @1
                 (\x0 -> rscanZip (\x a -> sin x - rfromD (a V.! 0))
                         ...
                         x0 (V.singleton $ DynamicRanked
                             $ rconst (OR.fromList @Double @1 [2] [5, 7]))) 1.1
  printAstPretty IM.empty (simplifyAst6 a1)
    @?= "let v39 = rconst (fromList [2] [5.0,7.0]) in let [x40 @Natural @Double @[], v41 @Natural @Double @[2], v42 @Natural @Double @[2]] = dmapAccumLDer f df rf [rconst 1.1] [v39] in let [x88 @Natural @Double @[], v89 @Natural @Double @[2]] = dmapAccumLDer f df rf [rconstant (sconst @[] 0.0)] [rconstant (rreplicate 2 (rconst 1.0)), rreverse v41, rreverse v39] in x88 + rconst 1.0"
