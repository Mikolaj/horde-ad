...
testSin0FoldNestedR1SimpNestedPP = do
  ...
  printAstHVectorPrettyButNested
    ...
    (simplifyAstHVector6
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 1.1))
    @?= "let [x421 @Natural @Double @[], v422 @Natural @Double @[11]] = dmapAccumRDer (SNat @11) (\\[x423] [x424, x425] -> let [x439 @Natural @Double @[], v440 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x441] [x442, x443] -> let x444 = cos x443 in [x441, recip (x444 * x444) * x441]) (\\[x445] [x446, x447] [x448] [x449, x450] -> let x451 = cos x450 ; x452 = x451 * x451 ; x454 = x447 * negate (sin x450) in [x445, ((x454 * x451 + x454 * x451) * negate (recip (x452 * x452))) * x448 + x445 * recip x452]) (\\[x458] [x459] [x460] [x461, x462] -> let x463 = cos x462 ; x464 = x463 * x463 ; x466 = negate (recip (x464 * x464)) * (x460 * x459) in [recip x464 * x459 + x458, 0, negate (sin x462) * (x463 * x466 + x463 * x466)]) [x423] [rslice 0 22 (rscanDer (\\x426 x427 -> x426 + tan x427) (\\x428 x429 x430 x431 -> let x432 = cos x431 in x428 + x429 * recip (x432 * x432)) (\\x434 x435 x436 -> let x437 = cos x436 in [x434, recip (x437 * x437) * x434]) x425 (rreplicate 22 x424)), rreplicate 22 x424] in [rsum v440, x439]) (\\[x467] [x468, x469] [x470] [x471, x472] -> let v588 = rscanDer (\\x576 x577 -> x576 + tan x577) (\\x578 x579 x580 x581 -> let x582 = cos x581 in x578 + x579 * recip (x582 * x582)) (\\x584 x585 x586 -> let x587 = cos x586 in [x584, recip (x587 * x587) * x584]) x472 (rreplicate 22 x471) in let [x591 @Natural @Double @[], v592 @Natural @Double @[22], v593 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x594] [x595, x596] -> let x597 = cos x596 in [x594, x594, recip (x597 * x597) * x594]) (\\[x599] [x600, x601] [x602] [x603, x604] -> let x622 = cos x604 ; x623 = x622 * x622 ; x626 = x601 * negate (sin x604) in [x599, x599, ((x626 * x622 + x626 * x622) * negate (recip (x623 * x623))) * x602 + x599 * recip x623]) (\\[x630] [x631, x632] [x633] [x634, x635] -> let x653 = cos x635 ; x654 = x653 * x653 ; x660 = negate (recip (x654 * x654)) * (x633 * x632) in [recip x654 * x632 + x631 + x630, 0, negate (sin x635) * (x653 * x660 + x653 * x660)]) [x470] [rslice 0 22 v588, rreplicate 22 x471] in let [x743 @Natural @Double @[], v744 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x745] [x746, x747, x748, x749, x750] -> let x751 = cos x750 ; x752 = x751 * x751 ; x754 = x747 * negate (sin x750) in [x745, ((x754 * x751 + x754 * x751) * negate (recip (x752 * x752))) * x748 + x745 * recip x752]) (\\[x758] [x759, x760, x761, x762, x763] [x764] [x765, x766, x767, x768, x769] -> let x815 = cos x769 ; x816 = x815 * x815 ; x818 = negate (sin x769) ; x819 = x766 * x818 ; x820 = x819 * x815 + x819 * x815 ; x821 = x816 * x816 ; x822 = negate (recip x821) ; x827 = x760 * x818 + ((x763 * cos x769) * rconst -1.0) * x766 ; x828 = x763 * negate (sin x769) ; x832 = x828 * x815 + x828 * x815 in [x758, ((x827 * x815 + x828 * x819 + x827 * x815 + x828 * x819) * x822 + (((x832 * x816 + x832 * x816) * negate (recip (x821 * x821))) * rconst -1.0) * x820) * x767 + x761 * (x820 * x822) + x758 * recip x816 + (x832 * negate (recip (x816 * x816))) * x764]) (\\[x841] [x842] [x843] [x844, x845, x846, x847, x848] -> let x881 = cos x848 ; x882 = x881 * x881 ; x884 = negate (sin x848) ; x885 = x845 * x884 ; x886 = x885 * x881 + x885 * x881 ; x887 = x882 * x882 ; x888 = negate (recip x887) ; x893 = x846 * x842 ; x894 = negate (recip (x887 * x887)) * (rconst -1.0 * (x886 * x893)) ; x895 = x888 * x893 ; x896 = x881 * x895 + x881 * x895 ; x897 = negate (recip (x882 * x882)) * (x843 * x842) + x882 * x894 + x882 * x894 in [recip x882 * x842 + x841, 0, x884 * x896, (x886 * x888) * x842, 0, negate (sin x848) * (x881 * x897 + x881 * x897 + x885 * x895 + x885 * x895) + cos x848 * (rconst -1.0 * (x845 * x896))]) [x467] [rslice 0 22 (let [x661 @Natural @Double @[], v662 @Natural @Double @[22]] = dmapAccumLDer (SNat @22) (\\[x663] [x664, x665, x666] -> let x669 = let x667 = cos x666 in x663 + x664 * recip (x667 * x667) in [x669, x669]) (\\[x670] [x671, x672, x673] [x674] [x675, x676, x677] -> let x699 = cos x677 ; x700 = x699 * x699 ; x704 = x673 * negate (sin x677) ; x708 = x670 + x671 * recip x700 + ((x704 * x699 + x704 * x699) * negate (recip (x700 * x700))) * x675 in [x708, x708]) (\\[x709] [x710] [x711] [x712, x713, x714] -> let x733 = cos x714 ; x734 = x733 * x733 ; x740 = x710 + x709 ; x741 = negate (recip (x734 * x734)) * (x712 * x740) in [x740, recip x734 * x740, 0, negate (sin x714) * (x733 * x741 + x733 * x741)]) [x469] [rreplicate 22 x468, rslice 0 22 v588, rreplicate 22 x471] in rappend (rreplicate 1 x469) v662), rreplicate 22 x468, v592, rslice 0 22 v588, rreplicate 22 x471] in [rsum v744, x743]) (\\[x899] [x900] [x901] [x902, x903] -> let v1012 = rscanDer (\\x1000 x1001 -> x1000 + tan x1001) (\\x1002 x1003 x1004 x1005 -> let x1006 = cos x1005 in x1002 + x1003 * recip (x1006 * x1006)) (\\x1008 x1009 x1010 -> let x1011 = cos x1010 in [x1008, recip (x1011 * x1011) * x1008]) x903 (rreplicate 22 x902) in let [x1015 @Natural @Double @[], v1016 @Natural @Double @[22], v1017 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x1018] [x1019, x1020] -> let x1021 = cos x1020 in [x1018, x1018, recip (x1021 * x1021) * x1018]) (\\[x1023] [x1024, x1025] [x1026] [x1027, x1028] -> let x1046 = cos x1028 ; x1047 = x1046 * x1046 ; x1050 = x1025 * negate (sin x1028) in [x1023, x1023, ((x1050 * x1046 + x1050 * x1046) * negate (recip (x1047 * x1047))) * x1026 + x1023 * recip x1047]) (\\[x1054] [x1055, x1056] [x1057] [x1058, x1059] -> let x1077 = cos x1059 ; x1078 = x1077 * x1077 ; x1084 = negate (recip (x1078 * x1078)) * (x1057 * x1056) in [recip x1078 * x1056 + x1055 + x1054, 0, negate (sin x1059) * (x1077 * x1084 + x1077 * x1084)]) [x901] [rslice 0 22 v1012, rreplicate 22 x902] in let [x1089 @Natural @Double @[], v1090 @Natural @Double @[22], v1091 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x1092] [x1093, x1094, x1095, x1096] -> let x1097 = cos x1096 ; x1098 = x1097 * x1097 ; x1100 = negate (recip (x1098 * x1098)) * (x1094 * x1093) in [recip x1098 * x1093 + x1092, 0, negate (sin x1096) * (x1097 * x1100 + x1097 * x1100)]) (\\[x1101] [x1102, x1103, x1104, x1105] [x1106] [x1107, x1108, x1109, x1110] -> let x1150 = cos x1110 ; x1151 = x1150 * x1150 ; x1153 = x1151 * x1151 ; x1154 = negate (recip x1153) ; x1155 = x1108 * x1107 ; x1156 = x1154 * x1155 ; x1159 = x1105 * negate (sin x1110) ; x1160 = x1159 * x1150 + x1159 * x1150 ; x1170 = (((x1160 * x1151 + x1160 * x1151) * negate (recip (x1153 * x1153))) * rconst -1.0) * x1155 + (x1103 * x1107 + x1102 * x1108) * x1154 in [x1101 + (x1160 * negate (recip (x1151 * x1151))) * x1107 + x1102 * recip x1151, rconst 0.0, ((x1105 * cos x1110) * rconst -1.0) * (x1150 * x1156 + x1150 * x1156) + (x1159 * x1156 + x1170 * x1150 + x1159 * x1156 + x1170 * x1150) * negate (sin x1110)]) (\\[x1175] [x1176, x1177] [x1178] [x1179, x1180, x1181, x1182] -> let x1212 = cos x1182 ; x1213 = x1212 * x1212 ; x1215 = x1213 * x1213 ; x1216 = negate (recip x1215) ; x1217 = x1180 * x1179 ; x1218 = x1216 * x1217 ; x1224 = negate (sin x1182) * x1177 ; x1225 = x1212 * x1224 + x1212 * x1224 ; x1226 = x1216 * x1225 ; x1227 = negate (recip (x1215 * x1215)) * (rconst -1.0 * (x1217 * x1225)) ; x1228 = negate (recip (x1213 * x1213)) * (x1179 * x1175) + x1213 * x1227 + x1213 * x1227 in [x1175, x1180 * x1226 + recip x1213 * x1175, x1179 * x1226, 0, negate (sin x1182) * (x1212 * x1228 + x1212 * x1228 + x1218 * x1224 + x1218 * x1224) + cos x1182 * (rconst -1.0 * ((x1212 * x1218 + x1212 * x1218) * x1177))]) [x900] [rreplicate 22 x899, rreverse v1016, rreverse (rslice 0 22 v1012), rreplicate 22 x902] in let v1229 = rappend (rreplicate 0 (rconst 0.0)) (rappend (rreverse v1090) (rreplicate 1 (rconst 0.0))) in let [x1230 @Natural @Double @[], v1231 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x1232] [x1233, x1234, x1235] -> let x1236 = cos x1235 in [x1232 + x1233, recip (x1236 * x1236) * (x1232 + x1233)]) (\\[x1237] [x1238, x1239, x1240] [x1241] [x1242, x1243, x1244] -> let x1264 = cos x1244 ; x1265 = x1264 * x1264 ; x1269 = x1240 * negate (sin x1244) in [x1237 + x1238, ((x1269 * x1264 + x1269 * x1264) * negate (recip (x1265 * x1265))) * (x1241 + x1242) + (x1237 + x1238) * recip x1265]) (\\[x1274] [x1275] [x1276] [x1277, x1278, x1279] -> let x1295 = cos x1279 ; x1296 = x1295 * x1295 ; x1301 = recip x1296 * x1275 ; x1302 = negate (recip (x1296 * x1296)) * ((x1276 + x1277) * x1275) in [x1274 + x1301, x1274 + x1301, 0, negate (sin x1279) * (x1295 * x1302 + x1295 * x1302)]) [rconst 0.0] [rslice 1 22 v1229, rslice 0 22 v1012, rreplicate 22 x902] in [x1089, rsum v1231 + rsum v1091, x1230 + v1229 ! [0]]) [rconst 1.0] [rslice 0 11 (rscanDer (\\x312 x313 -> rfoldDer (\\x314 x315 -> x314 + tan x315) (\\x316 x317 x318 x319 -> let x320 = cos x319 in x316 + x317 * recip (x320 * x320)) (\\x322 x323 x324 -> let x325 = cos x324 in [x322, recip (x325 * x325) * x322]) x313 (rreplicate 22 x312)) (\\x326 x327 x328 x329 -> rfoldZipDer (\\x343 [x344, x345, x346] -> let x347 = cos x346 in x343 + x344 * recip (x347 * x347)) (\\x349 [x350, x351, x352] x353 [x354, x355, x356] -> let x357 = cos x356 ; x358 = x357 * x357 ; x361 = x352 * negate (sin x356) in x349 + x350 * recip x358 + ((x361 * x357 + x361 * x357) * negate (recip (x358 * x358))) * x354) (\\x365 x366 [x367, x368, x369] -> let x370 = cos x369 ; x371 = x370 * x370 ; x374 = negate (recip (x371 * x371)) * (x367 * x365) in [x365, recip x371 * x365, 0, negate (sin x369) * (x370 * x374 + x370 * x374)]) x327 [rreplicate 22 x326, rslice 0 22 (rscanDer (\\x330 x331 -> x330 + tan x331) (\\x332 x333 x334 x335 -> let x336 = cos x335 in x332 + x333 * recip (x336 * x336)) (\\x338 x339 x340 -> let x341 = cos x340 in [x338, recip (x341 * x341) * x338]) x329 (rreplicate 22 x328)), rreplicate 22 x328]) (\\x375 x376 x377 -> let [x391 @Natural @Double @[], v392 @Natural @Double @[22]] = dmapAccumRDer (SNat @22) (\\[x393] [x394, x395] -> let x396 = cos x395 in [x393, recip (x396 * x396) * x393]) (\\[x397] [x398, x399] [x400] [x401, x402] -> let x403 = cos x402 ; x404 = x403 * x403 ; x406 = x399 * negate (sin x402) in [x397, ((x406 * x403 + x406 * x403) * negate (recip (x404 * x404))) * x400 + x397 * recip x404]) (\\[x410] [x411] [x412] [x413, x414] -> let x415 = cos x414 ; x416 = x415 * x415 ; x418 = negate (recip (x416 * x416)) * (x412 * x411) in [recip x416 * x411 + x410, 0, negate (sin x414) * (x415 * x418 + x415 * x418)]) [x375] [rslice 0 22 (rscanDer (\\x378 x379 -> x378 + tan x379) (\\x380 x381 x382 x383 -> let x384 = cos x383 in x380 + x381 * recip (x384 * x384)) (\\x386 x387 x388 -> let x389 = cos x388 in [x386, recip (x389 * x389) * x386]) x377 (rreplicate 22 x376)), rreplicate 22 x376] in [rsum v392, x391]) (rconst 1.1) (rconstant (rreplicate 11 (rconst 1.1)))), rconstant (rreplicate 11 (rconst 1.1))] in [rsum v422 + x421]"
