...
testSin0FoldNestedR1SimpNestedPP = do
  ...
  printAstHVectorPrettyButNested
    ...
    (simplifyAstHVector6
     $ g @(AstRanked FullSpan) (V.singleton $ DynamicRanked @Double @0 1.1))
    @?= "let v656 = rscanDer (\\x582 x583 -> rfoldDer (\\x584 x585 -> x584 * x585) (\\x586 x587 x588 x589 -> x586 * x589 + x587 * x588) (\\x590 x591 x592 -> [x592 * x590, x591 * x590]) x583 (rreplicate 2 x582)) (\\x593 x594 x595 x596 -> rfoldZipDer (\\x607 [x608, x609, x610] -> x607 * x610 + x608 * x609) (\\x611 [x612, x613, x614] x615 [x616, x617, x618] -> x611 * x618 + x614 * x615 + x612 * x617 + x613 * x616) (\\x621 x622 [x623, x624, x625] -> [x625 * x621, x624 * x621, x623 * x621, x622 * x621]) x594 [rreplicate 2 x593, rslice 0 2 (rscanDer (\\x597 x598 -> x597 * x598) (\\x599 x600 x601 x602 -> x599 * x602 + x600 * x601) (\\x603 x604 x605 -> [x605 * x603, x604 * x603]) x596 (rreplicate 2 x595)), rreplicate 2 x595]) (\\x626 x627 x628 -> let v638 = rscanDer (\\x629 x630 -> x629 * x630) (\\x631 x632 x633 x634 -> x631 * x634 + x632 * x633) (\\x635 x636 x637 -> [x637 * x635, x636 * x635]) x628 (rreplicate 2 x627) ; v652 = rreverse (rscanZipDer (\\x639 [x640, x641] -> x641 * x639) (\\x642 [x643, x644] x645 [x646, x647] -> x644 * x645 + x642 * x647) (\\x648 x649 [x650, x651] -> [x651 * x648, 0, x649 * x648]) x626 [rreverse (rslice 0 2 v638), rreplicate 2 x627]) in [rsum (rgather [2] v638 (\\[i654] -> [i654]) * rgather [2] v652 (\\[i655] -> [1 + i655])), v652 ! [0]]) (rconst 1.1) (rconstant (rreplicate 3 (rconst 1.1))) ; v936 = rreverse (rscanZipDer (\\x658 [x659, x660] -> let v670 = rscanDer (\\x661 x662 -> x661 * x662) (\\x663 x664 x665 x666 -> x663 * x666 + x664 * x665) (\\x667 x668 x669 -> [x669 * x667, x668 * x667]) x660 (rreplicate 2 x659) in rsum (rgather [2] v670 (\\[i686] -> [i686]) * rgather [2] (rscanZipDer (\\x671 [x672, x673] -> x673 * x671) (\\x674 [x675, x676] x677 [x678, x679] -> x676 * x677 + x674 * x679) (\\x680 x681 [x682, x683] -> [x683 * x680, 0, x681 * x680]) x658 [rreverse (rslice 0 2 v670), rreplicate 2 x659]) (\\[i687] -> [1 + negate i687]))) (\\x688 [x689, x690] x691 [x692, x693] -> let v703 = rscanDer (\\x694 x695 -> x694 * x695) (\\x696 x697 x698 x699 -> x696 * x699 + x697 * x698) (\\x700 x701 x702 -> [x702 * x700, x701 * x700]) x693 (rreplicate 2 x692) ; v704 = rreverse (rslice 0 2 v703) ; v719 = rscanZipDer (\\x706 [x707, x708] -> x708 * x706) (\\x709 [x710, x711] x712 [x713, x714] -> x711 * x712 + x709 * x714) (\\x715 x716 [x717, x718] -> [x718 * x715, 0, x716 * x715]) x691 [v704, rreplicate 2 x692] in rsum (rgather [2] v719 (\\[i723] -> [1 + negate i723]) * rgather [2] (rscanZipDer (\\x725 [x726, x727, x728] -> x725 * x728 + x726 * x727) (\\x729 [x730, x731, x732] x733 [x734, x735, x736] -> x729 * x736 + x732 * x733 + x730 * x735 + x731 * x734) (\\x740 x741 [x742, x743, x744] -> [x744 * x740, x743 * x740, x742 * x740, x741 * x740]) x690 [rreplicate 2 x689, rslice 0 2 v703, rreplicate 2 x692]) (\\[i745] -> [i745])) + rsum (rgather [2] v703 (\\[i721] -> [i721]) * rgather [2] (rscanZipDer (\\x770 [x771, x772, x773, x774, x775] -> x772 * x773 + x770 * x775) (\\x776 [x777, x778, x779, x780, x781] x782 [x783, x784, x785, x786, x787] -> x778 * x785 + x779 * x784 + x776 * x787 + x781 * x782) (\\x791 x792 [x793, x794, x795, x796, x797] -> [x797 * x791, 0, x795 * x791, x794 * x791, 0, x792 * x791]) x688 [rreverse (rslice 0 2 (rscanZipDer (\\x747 [x748, x749, x750] -> x747 * x750 + x748 * x749) (\\x751 [x752, x753, x754] x755 [x756, x757, x758] -> x751 * x758 + x754 * x755 + x752 * x757 + x753 * x756) (\\x762 x763 [x764, x765, x766] -> [x766 * x762, x765 * x762, x764 * x762, x763 * x762]) x690 [rreplicate 2 x689, rslice 0 2 v703, rreplicate 2 x692])), rreplicate 2 x689, rslice 0 2 v719, v704, rreplicate 2 x692]) (\\[i799] -> [1 + negate i799]))) (\\x802 x803 [x804, x805] -> let v821 = rscanDer (\\x812 x813 -> x812 * x813) (\\x814 x815 x816 x817 -> x814 * x817 + x815 * x816) (\\x818 x819 x820 -> [x820 * x818, x819 * x818]) x805 (rreplicate 2 x804) ; v822 = rreverse (rslice 0 2 v821) ; v837 = rscanZipDer (\\x824 [x825, x826] -> x826 * x824) (\\x827 [x828, x829] x830 [x831, x832] -> x829 * x830 + x827 * x832) (\\x833 x834 [x835, x836] -> [x836 * x833, 0, x834 * x833]) x803 [v822, rreplicate 2 x804] ; v844 = rscatter [3] (rgather [2] v837 (\\[i841] -> [1 + negate i841]) * rreplicate 2 x802) (\\[i843] -> [i843]) ; v867 = rreverse (rscanZipDer (\\x845 [x846, x847, x848] -> x848 * (x845 + x846)) (\\x849 [x850, x851, x852] x853 [x854, x855, x856] -> x852 * (x853 + x854) + (x849 + x850) * x856) (\\x860 x861 [x862, x863, x864] -> let x866 = x864 * x860 in [x866, x866, 0, (x861 + x862) * x860]) (rconst 0.0) [rreverse (rslice 1 2 v844), rreverse (rslice 0 2 v821), rreplicate 2 x804]) ; v869 = rreverse (rscatter [3] (rgather [2] v821 (\\[i839] -> [i839]) * rreplicate 2 x802) (\\[i868] -> [1 + i868])) ; v896 = rreverse (rscanZipDer (\\x870 [x871, x872, x873, x874] -> x874 * (x870 + x871)) (\\x875 [x876, x877, x878, x879] x880 [x881, x882, x883, x884] -> x879 * (x880 + x881) + (x875 + x876) * x884) (\\x888 x889 [x890, x891, x892, x893] -> let x895 = x893 * x888 in [x895, x895, 0, 0, (x889 + x890) * x888]) (rconst 0.0) [rreverse (rslice 1 2 v869), rreverse (rslice 0 2 v837), rreverse v822, rreplicate 2 x804]) ; v904 = rappend (rreplicate 0 (rconst 0.0)) (rappend (rreplicate 2 (sconst @[] 0.0)) (rreplicate 1 (rconst 0.0))) ; v927 = rreverse (rscanZipDer (\\x905 [x906, x907, x908] -> x908 * (x905 + x906)) (\\x909 [x910, x911, x912] x913 [x914, x915, x916] -> x912 * (x913 + x914) + (x909 + x910) * x916) (\\x920 x921 [x922, x923, x924] -> let x926 = x924 * x920 in [x926, x926, 0, (x921 + x922) * x920]) (rconst 0.0) [rreverse (rslice 1 2 v904), rreverse (rslice 0 2 v821), rreplicate 2 x804]) in [v896 ! [0] + v869 ! [0], rsum (rgather [2] v821 (\\[i929] -> [i929]) * (rgather [2] v927 (\\[i930] -> [1 + i930]) + rgather [2] v904 (\\[i931] -> [1 + i931])) + rgather [2] v821 (\\[i933] -> [i933]) * (rgather [2] v867 (\\[i934] -> [1 + i934]) + rgather [2] v844 (\\[i935] -> [1 + i935]))) + rsum (rgather [2] v837 (\\[i900] -> [i900]) * (rgather [2] v896 (\\[i901] -> [1 + i901]) + rgather [2] v869 (\\[i902] -> [1 + i902]))), v927 ! [0] + v904 ! [0] + v867 ! [0] + v844 ! [0]]) (rconst 1.0) [rreverse (rslice 0 3 v656), rconstant (rreplicate 3 (rconst 1.1))]) in [rsum (rscanZipDer (\\v951 [v952, v953] -> v953 * v951) (\\v956 [v957, v958] v959 [v960, v961] -> v958 * v959 + v956 * v961) (\\v963 v964 [v965, v966] -> [v966 * v963, sconst @[3] (fromList @[3] [0.0,0.0,0.0]), v964 * v963]) (rgather [3] v936 (\\[i955] -> [1 + i955])) [rreverse (rslice 0 2 (rscanDer (\\v937 v938 -> v937 * v938) (\\v940 v941 v942 v943 -> v940 * v943 + v941 * v942) (\\v945 v946 v947 -> [v947 * v945, v946 * v945]) (rconstant (rreplicate 3 (rconst 1.1))) (rreplicate 2 (rslice 0 3 v656)))), rreplicate 2 (rgather [3] v656 (\\[i950] -> [i950]))] ! [2]) + v936 ! [0]]"
