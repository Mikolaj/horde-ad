...
mnistTestCase2S
  ...
  -> Double
  -> TestTree
mnistTestCase2S widthHidden@SNat widthHidden2@SNat
  ...
  let seed = mkStdGen 44
      ...
      name = prefix ++ ": "
             ++ unwords [ show epochs, show maxBatches
                        ...
                        , show (sNatValue widthHidden2 :: Int)
...
mnistTestCase2O
  ...
  -> Double
  -> TestTree
mnistTestCase2O widthHidden@SNat widthHidden2@SNat
                prefix epochs maxBatches trainWithLoss gamma expected =
...
longMnistTests = testGroup "MNIST fused LL tests with a 2-hidden-layer nn"
  ...
  , mnistTestCase2L "F 1 epoch, all batches" 1 99
                    fcnnMnistLossFused2 300 100 0.02
                    5.1100000000000034e-2
  , mnistTestCase2S (SNat @500) (SNat @150)
                    "S 1 epoch, 1 batch, wider" 1 1 afcnnMnistLossFusedS 0.02
                    0.13829999999999998
  , mnistTestCase2S (SNat @300) (SNat @100)
  ...
  , mnistTestCase2S (SNat @300) (SNat @100)
                    ...
                    0.5462
  , mnistTestCase2O (SNat @500) (SNat @150)
                    "O 1 epoch, 1 batch, wider" 1 1 fcnnMnistLossFusedS 0.02
                    0.12470000000000003
  , mnistTestCase2O (SNat @300) (SNat @100)
