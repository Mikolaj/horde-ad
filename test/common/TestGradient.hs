...
barS :: (ADModeAndNum d r, Sh.Shape sh)
     => SNat n1 -> SNat n2
     -> ( ADVal d r
...
dotGeneral :: (ADModeAndNum d r, Sh.Shape sh, KnownNat n1)
           => ADVal d (OS.Array '[n1, n2] r)
           -> ADVal d (OS.Array (n2 ': sh) r)
           -> ADVal d (OS.Array (n1 ': sh) r)
...
slicezOS :: forall shOut sh r. (Numeric r, Sh.Shape sh, Sh.Shape shOut)
...
indexzOS :: forall sh r. (Numeric r, Sh.Shape sh)
         => OS.Array sh r -> [Int] -> r
