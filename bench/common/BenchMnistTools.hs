...
inspect $ hasNoTypeClassesExcept 'mnistTrainBench2VTC [''(~), ''Nested.FloatElt, ''RealFloatF, ''GoodScalar, ''Num, ''Show, ''Ord, ''Eq, ''Nested.Elt, ''Nested.PrimElt, ''Nested.KnownElt, ''Nested.NumElt, ''Typeable, ''IfDifferentiable, ''NFData, ''Default.Default, ''KnownNat, ''Nested.KnownShX, ''WithDict, ''AstSpan, ''Nested.KnownShS, ''Numeric, ''SplitGen, ''RandomGen, ''Random, ''KnownSTK]
inspect $ hasNoTypeClassesExcept 'mnistTrainBench1VTO [''(~), ''SplitGen, ''RandomGen, ''AdaptableTarget, ''RandomValue, ''KnownSTK, ''Nested.FloatElt, ''RealFloatF, ''GoodScalar, ''Num, ''Show, ''Ord, ''Eq, ''Nested.Elt, ''Nested.PrimElt, ''Nested.KnownElt, ''Nested.NumElt, ''Typeable, ''IfDifferentiable, ''NFData, ''Default.Default, ''KnownNat, ''Nested.KnownShX, ''WithDict, ''AstSpan, ''Nested.KnownShS]
