...
inspect $ hasNoTypeClassesExcept 'mnistTrainBench2VTC [''(~), ''RealFrac, ''Nested.FloatElt, ''RealFloatF, ''GoodScalar, ''Num, ''Show, ''Ord, ''Eq, ''Nested.Elt, ''Nested.PrimElt, ''Nested.KnownElt, ''Nested.NumElt, ''Typeable, ''IfDifferentiable, ''NFData, ''Default.Default, ''KnownNat, ''Nested.Storable, ''IntegralF, ''Nested.KnownShX, ''WithDict, ''Integral, ''AstSpan, ''Nested.KnownShS, ''Numeric, ''SplitGen, ''RandomGen, ''Fractional, ''Random, ''KnownSTK]
inspect $ hasNoTypeClassesExcept 'mnistTrainBench1VTO [''(~), ''RealFrac, ''Nested.FloatElt, ''RealFloatF, ''GoodScalar, ''Num, ''Show, ''Ord, ''Eq, ''Nested.Elt, ''Nested.PrimElt, ''Nested.KnownElt, ''Nested.NumElt, ''Typeable, ''IfDifferentiable, ''NFData, ''Default.Default, ''KnownNat, ''Nested.Storable, ''IntegralF, ''Nested.KnownShX, ''WithDict, ''Integral, ''AstSpan, ''Nested.KnownShS, ''Numeric, ''SplitGen, ''RandomGen, ''Fractional, ''Random, ''Nested.KnownPerm, ''KnownSTK, ''Boolean, ''RandomValue, ''AdaptableTarget]
