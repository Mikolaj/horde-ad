...
astGatherStepS @b @c v (vars, ix) = Ast.AstGatherS @b @c v (vars, ix)  -- TODO
...
astGatherS
  ...
  -> (AstVarListS sh2, AstIndexS (OS.Take p sh))
  -> AstShaped s r (sh2 OS.++ OS.Drop p sh)
astGatherS @b @c = Ast.AstGatherS @b @c  -- TODO
...
astScatterS @b @c (Ast.AstConstantS v) (vars, ix) =
  Ast.AstConstantS $ astScatterS @b @c v (vars, ix)
astScatterS @b @c (Ast.AstLetADShareS l v) (vars, ix) =
  Ast.AstLetADShareS l $ astScatterS @b @c v (vars, ix)
astScatterS @b @c v (vars, ix) = Ast.AstScatterS @b @c v (vars, ix)
...
astPrimalPartS t = case t of
  ...
  Ast.AstScatterS @b @c v (var, ix) -> astScatterS @b @c (astPrimalPartS v) (var, ix)
  ...
  Ast.AstGatherS @b @c v (vars, ix) -> astGatherS @b @c (astPrimalPartS v) (vars, ix)
...
astDualPartS t = case t of
  ...
  Ast.AstScatterS @b @c v (var, ix) -> astScatterS  @b @c (astDualPartS v) (var, ix)
  ...
  Ast.AstGatherS @b @c v (vars, ix) -> astGatherS @b @c (astDualPartS v) (vars, ix)
...
simplifyAstS t = case t of
  ...
  Ast.AstScatterS @b @c v (var, ix) ->
    astScatterS @b @c (simplifyAstS v) (var, fmap simplifyAst ix)
  ...
  Ast.AstGatherS @b @c v (vars, ix) ->
    astGatherS @b @c (simplifyAstS v) (vars, fmap simplifyAst ix)
...
substitute1AstS i var = \case
  ...
  Ast.AstScatterS @b @c v (vars, ix) ->
    case (substitute1AstS i var v, substitute1AstIndexS i var ix) of
      (Nothing, Nothing) -> Nothing
      (mv, mix) -> Just $ astScatterS @b @c (fromMaybe v mv)
                                      (vars, fromMaybe ix mix)
  ...
  Ast.AstGatherS @b @c v (vars, ix) ->
    case (substitute1AstS i var v, substitute1AstIndexS i var ix) of
      (Nothing, Nothing) -> Nothing
      (mv, mix) -> Just $ astGatherS @b @c (fromMaybe v mv)
                                     (vars, fromMaybe ix mix)
