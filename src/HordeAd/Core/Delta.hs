          ...
          Just (_, d) -> case shapeDynamic d of
            ...
            width : _ ->
              let !_A1 = assert (rlength p == width + 1) ()
                  ...
                  g2s = map g2 [1 .. width]  -- can't be rmap, rbuild nor rscan
