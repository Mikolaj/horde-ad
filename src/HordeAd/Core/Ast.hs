...
module HordeAd.Core.Ast
  ...
  , AstRaw(..), AstRawWrap(..)
  , AstNoVectorize(..), AstNoVectorizeWrap(..)
  , AstNoSimplify(..), AstNoSimplifyWrap(..)
  ) where
...
type instance HVectorOf (AstTensor ms s) = AstTensor ms s TKUntyped
...
type instance HFunOf (AstTensor AstMethodLet PrimalSpan) x z = AstHFun x z
...
type instance HVectorOf (AstRaw s) =
  AstRawWrap (AstTensor AstMethodShare s TKUntyped)
