...
data AstTensor :: AstSpanType -> TensorKindType -> Type where
  ...
  AstProject1 :: TensorKind z => AstTensor s (TKProduct x z) -> AstTensor s x
  AstProject2 :: TensorKind x => AstTensor s (TKProduct x z) -> AstTensor s z
  ...
  AstIota :: AstTensor PrimalSpan (TKR r 1)
  ...
  AstFromIntegralS :: (GoodScalar r1, Integral r1, GoodScalar r2, KnownShS sh)
                   => AstTensor PrimalSpan (TKS r1 sh) -> AstTensor PrimalSpan (TKS r2 sh)
